...
function SelectMethodComponent_Conditional_0_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(2, 4, "COMMON.EXECUTE_METHOD_SELECT"));
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.method);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r1.method_filter())("placeholder", \u0275\u0275pipeBind2(6, 6, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction0(9, _c1)));
    \u0275\u0275advance(3);
...
function SelectMethodComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SelectMethodComponent_Conditional_0_Conditional_0_Template, 9, 10, "mat-form-field", 2)(1, SelectMethodComponent_Conditional_0_Conditional_1_Template, 4, 3, "div", 1);
  }
  if (rf & 2) {
...
var SelectMethodComponent = class _SelectMethodComponent extends AsyncHandler {
  ...
  _system = signal("", ...ngDevMode ? [{ debugName: "_system" }] : []);
  _module = signal({}, ...ngDevMode ? [{ debugName: "_module" }] : []);
  method = signal(void 0, ...ngDevMode ? [{ debugName: "method" }] : []);
  method_filter = signal("", ...ngDevMode ? [{ debugName: "method_filter" }] : []);
  loading = signal(false, ...ngDevMode ? [{ debugName: "loading" }] : []);
  _method_list = toSignal(combineLatest([
    toObservable(this._system),
    toObservable(this._module)
  ]).pipe(distinctUntilChanged(), tap(() => this.loading.set(true)), switchMap(([id, { module, index }]) => !!id && !!module ? Kl(id, module, index) : of({})), catchError(() => of({})), map((fn_mapping) => Object.keys(fn_mapping || {}).map((i) => __spreadValues({
    name: i
  }, fn_mapping[i])).sort((a, b) => a.name.localeCompare(b.name))), tap(() => this.loading.set(false)), shareReplay(1)), { initialValue: [] });
  method_list = this._method_list;
  ...
  _search_el = viewChild("method_search", ...ngDevMode ? [{ debugName: "_search_el" }] : []);
  /** Form control on change handler */
  _onChange;
  /** Form control on touch handler */
  _onTouch;
...
(() => {
  ...
  }], () => [], { system: [{ type: Input, args: [{ isSignal: true, alias: "system", required: false }] }], module: [{ type: Input, args: [{ isSignal: true, alias: "module", required: false }] }], _search_el: [{ type: ViewChild, args: ["method_search", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SelectMethodComponent, { className: "SelectMethodComponent", filePath: "src/app/ui/custom-fields/system-exec/select-method.component.ts", lineNumber: 128 });
})();

// src/app/ui/custom-fields/system-exec/select-module.component.ts
var _c02 = ["module_search"];
...
function SelectModuleComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(2, 4, "COMMON.EXECUTE_MODULE_SELECT"));
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.module);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r1.module_filter())("placeholder", \u0275\u0275pipeBind2(6, 6, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction0(9, _c12)));
    \u0275\u0275advance(3);
...
var SelectModuleComponent = class _SelectModuleComponent extends AsyncHandler {
  ...
  module_filter = signal("", ...ngDevMode ? [{ debugName: "module_filter" }] : []);
  loading = signal(false, ...ngDevMode ? [{ debugName: "loading" }] : []);
  _modules = toSignal(combineLatest([
    toObservable(this._system),
    toObservable(this._change)
  ]).pipe(distinctUntilChanged(([id1, time1], [id2, time2]) => id1 === id2 && time1 === time2), tap(() => this.loading.set(true)), switchMap(([id]) => id ? Ea({
  ...
  _search_el = viewChild("module_search", ...ngDevMode ? [{ debugName: "_search_el" }] : []);
  /** Form control on change handler */
  _onChange;
  /** Form control on touch handler */
  _onTouch;
  ...
  }, inputs: { system: [1, "system"], refresh: [1, "refresh"] }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => _SelectModuleComponent),
      multi: true
    }
  ]), \u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 2, vars: 1, consts: [["module_search", ""], ["appearance", "outline", 1, "h-14", "w-full"], [1, "flex", "items-center", "justify-center", "space-x-2", "p-4"], [3, "ngModelChange", "openedChange", "placeholder", "ngModel"], [1, "relative", "hover:bg-transparent!"], ["matInput", "", "name", "module-search", 1, "module-search-input", "pointer-event-auto", "focus:bg-base-200/30", "absolute", "inset-1", "h-auto", "w-[calc(100%-0.5rem)]", "cursor-text", "rounded-sm", "p-4", 3, "ngModelChange", "mousedown", "click", "keydown", "ngModel", "placeholder"], [3, "disabled", "value"], ["diameter", "32"]], template: function SelectModuleComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, SelectModuleComponent_Conditional_0_Template, 9, 10, "mat-form-field", 1)(1, SelectModuleComponent_Conditional_1_Template, 5, 3, "div", 2);
    }
    if (rf & 2) {
      \u0275\u0275conditional(!ctx.loading() ? 0 : 1);
    }
...
(() => {
  ...
  }], () => [], { system: [{ type: Input, args: [{ isSignal: true, alias: "system", required: false }] }], refresh: [{ type: Input, args: [{ isSignal: true, alias: "refresh", required: false }] }], _search_el: [{ type: ViewChild, args: ["module_search", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SelectModuleComponent, { className: "SelectModuleComponent", filePath: "src/app/ui/custom-fields/system-exec/select-module.component.ts", lineNumber: 117 });
})();
...
//# sourceMappingURL=chunk-R35ARW2L.js.map
