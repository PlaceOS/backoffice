...
var ItemDetailsSkeletonComponent = class _ItemDetailsSkeletonComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemDetailsSkeletonComponent, selectors: [["item-details-skeleton"]], decls: 19, vars: 0, consts: [[1, "flex", "flex-col", "animate-pulse"], [1, "flex", "items-center", "justify-between", "px-4", "py-2"], [1, "flex", "flex-col", "space-y-2"], [1, "h-8", "w-48", "rounded", "bg-base-300"], [1, "flex", "items-center", "space-x-2"], [1, "h-4", "w-32", "rounded", "bg-base-300"], [1, "h-6", "w-16", "rounded-xl", "bg-base-300"], [1, "h-10", "w-10", "rounded", "bg-base-300"], [1, "h-12", "w-full", "border-b", "border-base-300"], [1, "flex", "h-full", "items-center", "space-x-4", "px-4"], [1, "h-8", "w-24", "rounded", "bg-base-300"], [1, "h-8", "w-28", "rounded", "bg-base-300"], [1, "h-8", "w-20", "rounded", "bg-base-300"], [1, "space-y-4", "p-4"], [1, "h-4", "w-3/4", "rounded", "bg-base-300"], [1, "h-4", "w-1/2", "rounded", "bg-base-300"], [1, "h-4", "w-2/3", "rounded", "bg-base-300"], [1, "mt-6", "h-32", "w-full", "rounded", "bg-base-300"]], template: function ItemDetailsSkeletonComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-SHI4BYY4.js.map
