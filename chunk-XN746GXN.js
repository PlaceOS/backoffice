...
import {
  ...
  CustomTooltipData
} from "./chunk-K6RPAWNX.js";
import {
  AuthenticatedImageDirective
} from "./chunk-UM3WNNMW.js";
import {
  HotkeysService
...
var SidebarMenuComponent = class _SidebarMenuComponent extends AsyncHandler {
  ...
  get alerts_url() {
    return kt()?.config?.backoffice?.alerts_url;
  }
  get metrics_url() {
    return kt()?.config?.backoffice?.metrics_url;
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarMenuComponent, { className: "SidebarMenuComponent", filePath: "src/app/ui/sidebar-menu.component.ts", lineNumber: 196 });
})();
...
//# sourceMappingURL=chunk-XN746GXN.js.map
