...
function DriverUpdateListModalComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, "DRIVERS.UPDATE_COUNT", \u0275\u0275pureFunction1(4, _c0, ctx_r0.drivers_with_updates().total || 0)), " ");
  }
}
...
function DriverUpdateListModalComponent_Conditional_7_Conditional_16_Conditional_0_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind3(8, 7, driver_r4.commit, 0, 9));
    \u0275\u0275advance(3);
    \u0275\u0275property("matTooltip", driver_r4.update_info.commit);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind3(12, 11, driver_r4.update_info.commit, 0, 9));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(15, 15, driver_r4.update_info.date), " ");
  }
}
function DriverUpdateListModalComponent_Conditional_7_Conditional_16_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, DriverUpdateListModalComponent_Conditional_7_Conditional_16_Conditional_0_For_1_Template, 16, 17, "tr", null, _forTrack0);
  }
  if (rf & 2) {
...
function DriverUpdateListModalComponent_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional((tmp_6_0 = ctx_r0.drivers_with_updates()) ? 16 : -1, tmp_6_0);
  }
}
function DriverUpdateListModalComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function DriverUpdateListModalComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "footer", 6)(1, "button", 16);
    \u0275\u0275listener("click", function DriverUpdateListModalComponent_Conditional_9_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
...
var DriverUpdateListModalComponent = class _DriverUpdateListModalComponent {
  ...
  _drivers_with_updates = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_drivers_with_updates" } : (
    /* istanbul ignore next */
    {}
  )), {
    params: () => this._change(),
    loader: async () => {
      ...
      response.data = response.data.filter((_) => _.commit !== _.update_info.commit);
  ...
  drivers_with_updates = computed(
    () => this._drivers_with_updates.value() || { data: [], total: 0 },
    ...ngDevMode ? [{ debugName: "drivers_with_updates" }] : (
      /* istanbul ignore next */
      []
    )
  );
  selected_drivers = signal(
    [],
    ...ngDevMode ? [{ debugName: "selected_drivers" }] : (
      /* istanbul ignore next */
      []
    )
  );
  all_selected = computed(
    () => this.selected_drivers().length === this.drivers_with_updates().total,
    ...ngDevMode ? [{ debugName: "all_selected" }] : (
      /* istanbul ignore next */
      []
    )
  );
  some_selected = computed(
    () => this.selected_drivers().length > 0 && !this.all_selected(),
    ...ngDevMode ? [{ debugName: "some_selected" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  toggleAll(state) {
    ...
    this.selected_drivers.set(this.drivers_with_updates().data.map((_) => _.id));
  }
  async updateDrivers() {
    ...
    await Promise.all(selected.map((driver) => driver.commit !== driver.update_info.commit ? eu(driver.id, __spreadProps(__spreadValues({}, driver), {
      commit: driver.update_info.commit
    })) : Promise.resolve())).catch((_) => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DriverUpdateListModalComponent, selectors: [["driver-update-list-modal"]], decls: 10, vars: 7, consts: [[1, "border-base-100", "bg-base-200", "z-10", "mx-auto", "my-2", "flex", "w-[calc(100%-1rem)]", "justify-between", "rounded-sm", "border", "px-4", "py-2"], [1, "flex", "items-center", "space-x-4", "text-xl", "font-medium"], [1, "mono", "bg-base-300", "rounded-sm", "px-2", "py-1", "text-xs"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "max-h-[65vh]", "w-[80vw]", "max-w-3xl", "overflow-y-auto"], [1, "flex", "h-48", "w-[20rem]", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "border-base-100", "bg-base-200", "z-10", "mx-auto", "my-2", "flex", "w-[calc(100%-1rem)]", "justify-end", "space-x-2", "rounded-sm", "border", "p-2"], [1, "mx-2", "w-[calc(100%-1rem)]", "rounded-sm"], [1, "sticky", "top-0", "z-10", "text-left"], [1, "bg-base-300!"], [3, "change", "checked", "indeterminate"], [3, "ngModelChange", "ngModel"], [3, "matTooltip"], [1, "text-xs", "opacity-60"], ["colspan", "4", 1, "opacity-30"], [3, "diameter"], ["btn", "", "matRipple", "", 3, "click", "disabled"]], template: function DriverUpdateListModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "header", 0)(1, "h2", 1)(2, "div");
      \u0275\u0275text(3);
      \u0275\u0275pipe(4, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(5, DriverUpdateListModalComponent_Conditional_5_Template, 3, 6, "code", 2);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(6, DriverUpdateListModalComponent_Conditional_6_Template, 3, 0, "button", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(7, DriverUpdateListModalComponent_Conditional_7_Template, 17, 12, "main", 4)(8, DriverUpdateListModalComponent_Conditional_8_Template, 5, 4, "div", 5);
      \u0275\u0275conditionalCreate(9, DriverUpdateListModalComponent_Conditional_9_Template, 4, 5, "footer", 6);
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.drivers_with_updates() && !ctx.loading() ? 7 : 8);
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DriverUpdateListModalComponent, { className: "DriverUpdateListModalComponent", filePath: "src/app/drivers/driver-update-list-modal.component.ts", lineNumber: 163 });
})();
...
var DriverStateService = class _DriverStateService {
  ...
  _last_error = signal(
    null,
    ...ngDevMode ? [{ debugName: "_last_error" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  _updates_available = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_updates_available" } : (
    /* istanbul ignore next */
    {}
  )), {
    params: () => this._poll(),
  ...
  updates_available = computed(
    () => this._updates_available.value() || false,
    ...ngDevMode ? [{ debugName: "updates_available" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  _docs = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_docs" } : (
    /* istanbul ignore next */
    {}
  )), {
    params: () => this.item(),
  ...
  async updateDriver() {
    ...
    const success = await eu(item.id, __spreadProps(__spreadValues({}, item), {
  ...
  async recompileDriver() {
    ...
    await su(item.id).catch(async (e) => {
      console.log("Error:", e);
      const content = e instanceof Response ? await e.text() : e;
      this._last_error.set(content);
      notifyError("Failed to recompile driver.", "View Error", () => this._dialog.open(ViewResponseModalComponent, { data: { content } }));
    });
  ...
  async reloadDriver() {
    ...
    const success = await iu(item.id).catch(() => false);
    if (success === false) {
      notifyError("Failed to reload driver. Driver may not be compiled. Try recompiling first.");
    } else {
  ...
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineService({ token: _DriverStateService, factory: _DriverStateService.\u0275fac });
};
(() => {
...
//# sourceMappingURL=chunk-FNVU6WFF.js.map
