...
function ExtensionModalComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 6)(1, "span", 13);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ExtensionModalComponent_For_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "mat-form-field", 4)(3, "input", 14);
    \u0275\u0275pipe(4, "translate");
    ...
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 2)(6, "mat-form-field", 4)(7, "mat-select", 15);
    \u0275\u0275pipe(8, "translate");
    ...
    \u0275\u0275repeaterCreate(9, ExtensionModalComponent_For_41_For_10_Template, 3, 2, "mat-option", 6, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 2)(12, "mat-form-field", 4)(13, "input", 16);
    \u0275\u0275pipe(14, "translate");
...
var ExtensionModalComponent = class _ExtensionModalComponent extends AsyncHandler {
  ...
  ngOnInit() {
    ...
    this.formModel.update((value) => __spreadValues(__spreadValues({}, value), this.item));
  }
  addCondition() {
  ...
  async submit() {
    await submit(this.form, async () => {
      const value = __spreadProps(__spreadValues({}, this.formModel()), {
        conditions: this.formModel().conditions.filter((c) => c[0] && c[1])
      });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExtensionModalComponent, selectors: [["extension-modal"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 45, vars: 32, consts: [[3, "save", "heading", "loading"], [1, "fieldset"], [1, "field"], ["for", "type"], ["appearance", "outline"], [3, "formField"], [3, "value"], ["for", "name"], ["matInput", "", 3, "placeholder", "formField"], ["for", "url"], [1, "w-full"], [1, "label"], ["type", "button", "btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "capitalize"], ["matInput", "", "name", "condition-field", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["matInput", "", "name", "value", 3, "ngModelChange", "disabled", "ngModel", "ngModelOptions", "placeholder"], ["type", "button", "icon", "", "matRipple", "", 1, "border-error", "text-error", "h-12", "w-12", "rounded-sm", "border", 3, "click"]], template: function ExtensionModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(12, ExtensionModalComponent_For_13_Template, 3, 2, "mat-option", 6, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd();
      \u0275\u0275controlCreate();
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "div", 2)(15, "label", 7);
      \u0275\u0275text(16);
      \u0275\u0275pipe(17, "translate");
      ...
      \u0275\u0275conditionalCreate(39, ExtensionModalComponent_Conditional_39_Template, 3, 3, "span", 11);
      \u0275\u0275repeaterCreate(40, ExtensionModalComponent_For_41_Template, 18, 19, "div", 1, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementStart(42, "button", 12);
    ...
    if (rf & 2) {
      \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 14, ctx.item ? "ADMIN.EXTENSIONS_EDIT" : "ADMIN.EXTENSIONS_NEW"))("loading", ctx.loading());
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 16, "ADMIN.EXTENSIONS_FIELD_TYPE"), " ");
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 18, "COMMON.FIELD_NAME"), " ");
      \u0275\u0275advance(5);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(22, 20, "ADMIN.EXTENSIONS_FIELD_NAME"))("formField", ctx.form.name);
      \u0275\u0275control();
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(25, 22, "ADMIN.EXTENSIONS_NAME_REQUIRED"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(29, 24, "ADMIN.EXTENSIONS_FIELD_URL"), " ");
      \u0275\u0275advance(5);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(34, 26, "ADMIN.EXTENSIONS_FIELD_URL"))("formField", ctx.form.url);
      \u0275\u0275control();
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 28, "ADMIN.EXTENSIONS_URL_REQUIRED"));
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.formModel().conditions.length ? 39 : -1);
      \u0275\u0275advance();
      \u0275\u0275repeater(ctx.formModel().conditions);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(44, 30, "ADMIN.EXTENSIONS_CONDITION_ADD"), " ");
    }
  }, dependencies: [
    FullscreenModalShellComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExtensionModalComponent, { className: "ExtensionModalComponent", filePath: "src/app/admin/extension-modal/extension-modal.component.ts", lineNumber: 197 });
})();

// src/app/admin/extensions.component.ts
var _c02 = (a0, a1) => ({ key: "type", name: a0, content: a1, size: "5rem" });
var _c1 = (a0) => ({ key: "name", name: a0, size: "10rem" });
var _c2 = (a0, a1) => ({ key: "url", name: a0, content: a1 });
var _c3 = (a0, a1) => ({ key: "conditions", name: a0, content: a1, size: "6rem" });
var _c4 = (a0) => ({ key: "actions", name: " ", size: "6rem", content: a0, sortable: false });
...
function PlaceExtensionsComponent_ng_template_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 19)(1, "button", 20);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function PlaceExtensionsComponent_ng_template_34_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function PlaceExtensionsComponent_ng_template_34_Template_button_click_5_listener() {
      const row_r7 = \u0275\u0275restoreView(_r6).row;
      const ctx_r7 = \u0275\u0275nextContext();
...
var PlaceExtensionsComponent = class _PlaceExtensionsComponent {
  ...
  domain = this._admin_data.selectedDomain("extensions");
  extensions = computed(
    () => {
      if (!this.domain())
        return [];
  ...
  editExtension(item) {
    ...
    waitForEvent(ref.componentInstance.event, (__) => __.reason === "done").then(async (event) => {
  ...
  async removeExtension(item) {
    ...
    waitForEvent(ref.componentInstance.event, (__) => __.reason === "done").then(async (__) => {
  ...
  async updateDomain(extension_list) {
    ...
    const updated = new Yi(__spreadProps(__spreadValues({}, domain), {
    ...
    const new_domain = await Ko(domain.id, updated);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceExtensionsComponent, selectors: [["", "app-extensions", ""]], decls: 36, vars: 51, consts: [["type_template", ""], ["url_template", ""], ["conditions_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-12"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["icon", "", "default", "", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"], [1, "bg-info", "text-info-content", "mx-4", "mb-4", "flex", "items-center", "space-x-4", "rounded-sm", "p-4", "text-sm", "shadow-sm"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "p-4", "font-mono", "text-xs", "uppercase"], [1, "truncate", "p-4", "underline", 3, "href"], [1, "p-4"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function PlaceExtensionsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function PlaceExtensionsComponent_Template_button_click_11_listener() {
        return ctx.editExtension();
      });
      \u0275\u0275elementStart(14, "icon");
      \u0275\u0275text(15, "add");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(16, "div", 12)(17, "p");
      \u0275\u0275text(18);
      \u0275\u0275pipe(19, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(20, "div", 13);
      \u0275\u0275element(21, "mat-progress-bar", 14)(22, "simple-table", 15);
      \u0275\u0275pipe(23, "translate");
      \u0275\u0275pipe(24, "translate");
      \u0275\u0275pipe(25, "translate");
      \u0275\u0275pipe(26, "translate");
      \u0275\u0275pipe(27, "translate");
      \u0275\u0275template(28, PlaceExtensionsComponent_ng_template_28_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(30, PlaceExtensionsComponent_ng_template_30_Template, 3, 5, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(32, PlaceExtensionsComponent_ng_template_32_Template, 2, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(34, PlaceExtensionsComponent_ng_template_34_Template, 9, 6, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      const type_template_r9 = \u0275\u0275reference(29);
      const url_template_r10 = \u0275\u0275reference(31);
      const conditions_template_r11 = \u0275\u0275reference(33);
      const actions_template_r12 = \u0275\u0275reference(35);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 12, "ADMIN.EXTENSIONS_HEADER"), " ");
      \u0275\u0275advance(4);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(12, 16, "ADMIN.EXTENSIONS_ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 18, "ADMIN.EXTENSIONS_ADD"));
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(19, 20, "ADMIN.EXTENSIONS_NOTICE"));
      \u0275\u0275advance(3);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.extensions())("columns", \u0275\u0275pureFunction5(45, _c5, \u0275\u0275pureFunction2(32, _c02, \u0275\u0275pipeBind1(23, 22, "ADMIN.EXTENSIONS_FIELD_TYPE"), type_template_r9), \u0275\u0275pureFunction1(35, _c1, \u0275\u0275pipeBind1(24, 24, "ADMIN.EXTENSIONS_FIELD_TAB")), \u0275\u0275pureFunction2(37, _c2, \u0275\u0275pipeBind1(25, 26, "ADMIN.EXTENSIONS_FIELD_URL"), url_template_r10), \u0275\u0275pureFunction2(40, _c3, \u0275\u0275pipeBind1(26, 28, "ADMIN.EXTENSIONS_FIELD_CHECKS"), conditions_template_r11), \u0275\u0275pureFunction1(43, _c4, actions_template_r12)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(27, 30, "ADMIN.EXTENSIONS_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceExtensionsComponent, { className: "PlaceExtensionsComponent", filePath: "src/app/admin/extensions.component.ts", lineNumber: 194 });
})();
export {
  PlaceExtensionsComponent
};
//# sourceMappingURL=chunk-X5YCOOA2.js.map
