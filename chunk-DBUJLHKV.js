...
var ModulesComponent = class _ModulesComponent {
  ...
  async loadValues(item) {
    ...
    this.system_count.set((await Kc(query)).total);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModulesComponent, { className: "ModulesComponent", filePath: "src/app/modules/modules.component.ts", lineNumber: 111 });
})();
export {
  ModulesComponent
};
//# sourceMappingURL=chunk-DBUJLHKV.js.map
