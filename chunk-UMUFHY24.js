...
var FullscreenModalShellComponent = class _FullscreenModalShellComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FullscreenModalShellComponent, selectors: [["fullscreen-modal-shell"], ["", "fs-modal-shell", ""]], inputs: { loading: [1, "loading"], heading: [1, "heading"], confirm_text: [1, "confirm_text"], hide_confirm: [1, "hide_confirm"] }, outputs: { save: "save" }, ngContentSelectors: _c0, decls: 12, vars: 4, consts: [["load_state", ""], [1, "bg-base-200", "flex", "h-screen", "w-screen", "flex-col", "items-center", "overflow-auto"], [1, "border-base-300", "bg-base-100", "fixed", "top-0", "mx-auto", "h-screen", "w-160", "max-w-full", "border-x"], [1, "border-base-100", "bg-base-200", "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "w-156", "max-w-full", "items-center", "justify-between", "rounded-sm", "border", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "z-0", "mx-auto", "flex", "min-h-1/2", "w-156", "max-w-full", "flex-1", "flex-col", "p-2"], [1, "min-h-16", "w-full"], [1, "border-base-100", "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-156", "max-w-full", "-translate-x-1/2", "items-center", "justify-end", "rounded-sm", "border", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", "pr-0", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1"], [1, "keycap"], [1, "flex", "h-1/2", "w-full", "flex-1", "flex-col", "items-center", "justify-center", "p-12"], [3, "diameter"], [1, "text-center"]], template: function FullscreenModalShellComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      ...
      \u0275\u0275projection(7);
      \u0275\u0275conditionalCreate(8, FullscreenModalShellComponent_Conditional_8_Template, 1, 0, "div", 7);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275conditional(!ctx.loading() && !ctx.hide_confirm() ? 8 : -1);
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FullscreenModalShellComponent, { className: "FullscreenModalShellComponent", filePath: "src/app/ui/fullscreen-modal-shell.component.ts", lineNumber: 80 });
})();

export {
  FullscreenModalShellComponent
};
//# sourceMappingURL=chunk-UMUFHY24.js.map
