...
export class MetadataDetailsModalComponent implements OnInit {
    ...
    public readonly addEditor = (e) => addChipItem(this.form.controls.editors as any, e);
    public readonly removeEditor = (i) => removeChipItem(this.form.controls.editors as any, i);
