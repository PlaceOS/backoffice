// Match the existing web language support without importing Shiki's theme registry.
// Add a language and its aliases here when more highlighting support is needed.
