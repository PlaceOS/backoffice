...
var SelectModuleComponent = class _SelectModuleComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SelectModuleComponent, selectors: [["select-system-module"]], inputs: { system: [1, "system"], refresh: [1, "refresh"] }, features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, SelectModuleComponent_Conditional_0_Template, 5, 4, "mat-form-field", 0)(1, SelectModuleComponent_Conditional_1_Template, 5, 3, "div", 1);
    }
    if (rf & 2) {
      \u0275\u0275conditional(!ctx.loading() ? 0 : 1);
    }
...
(() => {
  ...
  }], () => [], { system: [{ type: Input, args: [{ isSignal: true, alias: "system", required: false }] }], refresh: [{ type: Input, args: [{ isSignal: true, alias: "refresh", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SelectModuleComponent, { className: "SelectModuleComponent", filePath: "src/app/ui/custom-fields/system-exec/select-module.component.ts", lineNumber: 82 });
})();
...
//# sourceMappingURL=chunk-WCLNOYXA.js.map
