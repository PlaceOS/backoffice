...
var IconComponent = class _IconComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IconComponent, selectors: [["app-icon"], ["icon"]], inputs: { className: [1, "className"], icon: [1, "icon"] }, ngContentSelectors: _c03, decls: 3, vars: 2, consts: [[1, "flex", "h-[1.25em]", "w-[1.25em]", "items-center", "justify-center"], [3, "class"], [1, "h-[1em]", "w-[1em]", 3, "src"]], template: function IconComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
//# sourceMappingURL=chunk-L3UICUJN.js.map
