...
var BookingLimitsModalComponent = class _BookingLimitsModalComponent {
  ...
  async save() {
    ...
    const call = T(`/api/staff/v1/tenants/${this.tenant.id}/limits`, booking_limits);
...
function StaffTenantModalComponent_Conditional_74_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "label", 24);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
...
function StaffTenantModalComponent_Conditional_78_For_2_Case_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "textarea", 29);
  }
  if (rf & 2) {
    const item_r1 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("id", "credential-" + item_r1.key)("formControlName", item_r1.key)("placeholder", ctx_r1.name_map[item_r1.key] || item_r1.key);
  }
}
...
function StaffTenantModalComponent_Conditional_78_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, StaffTenantModalComponent_Conditional_78_For_2_Case_5_Template, 1, 3, "textarea", 29)(6, StaffTenantModalComponent_Conditional_78_For_2_Case_6_Template, 1, 3, "input", 29);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("for", "credential-" + item_r1.key);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional((tmp_15_0 = item_r1.key) === "signing_key" ? 5 : 6);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(9, 7, "ADMIN.TENANT_ITEM_REQUIRED", \u0275\u0275pureFunction1(10, _c11, item_r1.key)), " ");
  }
}
function StaffTenantModalComponent_Conditional_78_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form", 19);
    \u0275\u0275repeaterCreate(1, StaffTenantModalComponent_Conditional_78_For_2_Template, 10, 12, "div", 26, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(3, "keyvalue");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function StaffTenantModalComponent_Conditional_79_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 20)(1, "settings-toggle", 30);
    \u0275\u0275pipe(2, "translate");
...
function StaffTenantModalComponent_Conditional_80_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form", 21)(1, "div", 2)(2, "div", 3)(3, "label", 31);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "translate");
    ...
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "div", 3)(15, "label", 33);
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(24, "div", 2)(25, "div", 3)(26, "label", 35);
    \u0275\u0275text(27);
    \u0275\u0275pipe(28, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "mat-form-field", 5);
    \u0275\u0275element(30, "input", 36);
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementStart(32, "mat-error");
    \u0275\u0275text(33);
    \u0275\u0275pipe(34, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(35, "div", 3)(36, "label", 37);
    \u0275\u0275text(37);
    \u0275\u0275pipe(38, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "mat-form-field", 5);
    \u0275\u0275element(40, "input", 38);
    \u0275\u0275pipe(41, "translate");
    \u0275\u0275elementStart(42, "mat-error");
    \u0275\u0275text(43);
    \u0275\u0275pipe(44, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(45, "div", 39)(46, "div", 3)(47, "label", 40);
    \u0275\u0275text(48);
    \u0275\u0275pipe(49, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "mat-form-field", 5);
...
var StaffTenantModalComponent = class _StaffTenantModalComponent {
  ...
  show_outlook = model(false, ...ngDevMode ? [{ debugName: "show_outlook" }] : []);
  form = new FormGroup({
  ...
  _platform = toSignal(this.form.controls.platform.valueChanges.pipe(startWith(this.form.controls.platform.value)), { initialValue: this.form.controls.platform.value });
  _delegated = toSignal(this.form.controls.delegated.valueChanges.pipe(startWith(this.form.controls.delegated.value)), { initialValue: this.form.controls.delegated.value });
  constructor() {
    effect(() => {
  ...
  async save() {
    ...
    const data = Ms(__spreadProps(__spreadValues(__spreadValues({}, this.tenant || {}), value), {
      booking_limits
    }), ["", null, void 0]);
    const call = this.tenant?.id ? fe(`/api/staff/v1/tenants/${this.tenant.id}`, data) : T("/api/staff/v1/tenants", data);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffTenantModalComponent, selectors: [["staff-tenant-modal"]], inputs: { show_outlook: [1, "show_outlook"] }, outputs: { event: "event", show_outlook: "show_outlookChange" }, decls: 86, vars: 101, consts: [[3, "save", "heading", "loading"], [1, "mb-16", 3, "formGroup"], [1, "flex", "flex-wrap", "items-center", "space-x-0", "sm:space-x-2"], [1, "flex", "flex-1", "flex-col"], ["for", "tenant-name"], ["appearance", "outline"], ["id", "tenant-name", "matInput", "", "formControlName", "name", 3, "placeholder"], ["for", "tenant-platform"], ["id", "tenant-platform", "formControlName", "platform"], ["value", "google"], ["value", "office365"], ["for", "tenant-email-domain"], ["id", "tenant-email-domain", "matInput", "", "formControlName", "email_domain", 3, "placeholder"], [1, "flex", "flex-col", "space-y-2"], ["for", "tenant-early-checkin"], ["id", "tenant-early-checkin", "name", "early_checkin", "formControlName", "early_checkin", "placeholder", "Select time"], [3, "value"], [1, "mb-6", "flex", "items-center"], ["formControlName", "delegated", 1, "w-1/2", 3, "name"], [3, "formGroup"], [1, "mb-4", "flex", "items-center"], ["formGroupName", "outlook_config"], [1, "label"], ["formControlName", "booking_limits", 3, "fields"], ["for", "tenant-service-account"], ["id", "tenant-service-account", "matInput", "", "formControlName", "service_account", 3, "placeholder"], [1, "flex", "flex-col", 3, "hidden"], [1, "flex", "flex-col"], [1, "capitalize", 3, "for"], ["matInput", "", 3, "id", "formControlName", "placeholder"], [1, "w-1/2", 3, "ngModelChange", "name", "ngModel", "ngModelOptions"], ["for", "outlook-app-id"], ["id", "outlook-app-id", "matInput", "", "formControlName", "app_id", 3, "placeholder"], ["for", "outlook-app-domain"], ["id", "outlook-app-domain", "matInput", "", "formControlName", "app_domain", 3, "placeholder"], ["for", "outlook-app-resource"], ["id", "outlook-app-resource", "matInput", "", "formControlName", "app_resource", 3, "placeholder"], ["for", "outlook-source-location"], ["id", "outlook-source-location", "matInput", "", "formControlName", "source_location", 3, "placeholder"], [1, "flex", "flex-wrap", "items-center", "space-x-0", "sm:space-x-4"], ["for", "outlook-base-path"], ["id", "outlook-base-path", "matInput", "", "formControlName", "base_path", 3, "placeholder"]], template: function StaffTenantModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
      \u0275\u0275pipe(1, "translate");
      ...
      \u0275\u0275pipe(77, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(78, StaffTenantModalComponent_Conditional_78_Template, 4, 3, "form", 19);
      \u0275\u0275conditionalCreate(79, StaffTenantModalComponent_Conditional_79_Template, 3, 6, "div", 20);
      \u0275\u0275conditionalCreate(80, StaffTenantModalComponent_Conditional_80_Template, 56, 45, "form", 21);
      \u0275\u0275elementStart(81, "div", 13)(82, "span", 22);
      \u0275\u0275text(83);
      \u0275\u0275pipe(84, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275element(85, "object-list-field", 23);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
...
(() => {
  ...
  }], () => [], { event: [{ type: Output, args: ["event"] }], show_outlook: [{ type: Input, args: [{ isSignal: true, alias: "show_outlook", required: false }] }, { type: Output, args: ["show_outlookChange"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffTenantModalComponent, { className: "StaffTenantModalComponent", filePath: "src/app/admin/staff-tenant-modal.component.ts", lineNumber: 466 });
})();
...
var PlaceStaffAPIComponent = class _PlaceStaffAPIComponent {
  ...
  async ngOnInit() {
    ...
    const domain_list = await hc().pipe(map((r) => r.data)).toPromise();
  ...
  async removeTenant(tenant) {
    ...
    const system = await ne(`/api/staff/v1/tenants/${tenant.id}`).toPromise().catch((err) => {
  ...
  async loadTenants() {
    ...
    const tenants = await v("/api/staff/v1/tenants").toPromise().catch(() => []);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceStaffAPIComponent, selectors: [["staff-api"]], decls: 25, vars: 38, consts: [["expires_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-56"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "matRipple", "", 1, "h-12", "w-32", 3, "click"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-3xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "px-2"], [1, "rounded-2xl", "px-3", "py-1", "text-xs"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"]], template: function PlaceStaffAPIComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(9, PlaceStaffAPIComponent_For_10_Template, 2, 2, "mat-option", 8, _forTrack0);
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      const expires_template_r8 = \u0275\u0275reference(22);
      const actions_template_r9 = \u0275\u0275reference(24);
      \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceStaffAPIComponent, { className: "PlaceStaffAPIComponent", filePath: "src/app/admin/staff-api.component.ts", lineNumber: 191 });
})();
export {
  PlaceStaffAPIComponent
};
//# sourceMappingURL=chunk-G5TAUCKO.js.map
