...
function PlaceClusterDetailsComponent_Conditional_5_For_2_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("show_name", ctx_r2.cluster_nodes.length > 1)("node", node_r1)("history", (ctx_r2.usage_history[cluster_r2.id] || \u0275\u0275pureFunction0(3, _c12))[node_r1.hostname] || \u0275\u0275pureFunction0(4, _c2));
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceClusterDetailsComponent, { className: "PlaceClusterDetailsComponent", filePath: "src/app/admin/cluster-details/cluster-details.component.ts", lineNumber: 83 });
})();
export {
  PlaceClusterDetailsComponent
};
//# sourceMappingURL=chunk-J4MSTYNR.js.map
