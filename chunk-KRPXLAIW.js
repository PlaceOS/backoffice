...
var ModuleAboutComponent = class _ModuleAboutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModuleAboutComponent, selectors: [["module-about"]], decls: 49, vars: 52, consts: [["edge_desc_template", ""], [1, "p-4"], [1, "flex", "flex-col", "space-y-2", "sm:flex-row", "sm:space-x-2", "sm:space-y-0"], [1, "flex-1", "sm:w-1/3"], [1, "grid", "flex-1", "gap-2", "rounded-sm", "border", "border-base-200", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "flex", "items-center"], ["matTooltipPosition", "right", 3, "matTooltip"], ["btn", "", "matRipple", "", 1, "col-span-2", "flex", "w-full", "items-center"], [1, "flex", "flex-1", "flex-col", "rounded-sm", "border", "border-base-200"], [1, "w-full", "rounded-sm", "bg-base-200", "px-4", "py-3", "text-lg", "font-medium"], [1, "flex", "flex-wrap", "items-center", "p-1"], ["btn", "", "matRipple", "", 1, "m-1", "min-w-36", "flex-1", 3, "click", "disabled"], [1, "text"], ["diameter", "32"], ["btn", "", "matRipple", "", 1, "inverse", "error", "m-1", "min-w-36", "flex-1", 3, "click", "disabled"], [1, "my-4"], [1, "m-auto", "flex", "flex-col", "items-center", "justify-center", "p-8"], [1, "mono"], [1, "bg-success", "text-base-100"], [1, "truncate", "underline", 3, "routerLink"], [1, "w-px", "flex-1"], ["icon", "", "customTooltip", "", "yPosition", "top", "xPosition", "center", 3, "hover", "backdrop", "content"], [1, "rounded-full", "border", "border-base-200"], [1, "pointer-events-none", "max-w-[24rem]", "rounded-sm", "border", "border-base-200", "bg-base-100", "p-2", "shadow-sm"], [1, "overflow-hidden", "rounded-xl", "bg-base-200", "p-2", "text-sm"], ["btn", "", "matRipple", "", 1, "col-span-2", "flex", "w-full", "items-center", 3, "click"], [3, "id", "merge", "settings", "merge_settings"], ["diameter", "48", 1, "mb-4"]], template: function ModuleAboutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-KRPXLAIW.js.map
