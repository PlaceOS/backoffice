...
var FunctionArgumentComponent = class _FunctionArgumentComponent extends AsyncHandler {
  ...
  ]), \u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 2, vars: 1, consts: [[1, "pl-8", 3, "formGroup"], [1, "flex", "items-center", "justify-center", "space-x-2", "p-4"], ["field", "", 1, "relative", "flex", "items-center", "space-x-2"], [1, "absolute", "left-0", "w-4", "-translate-x-full", "-translate-y-1/2", "transform", "border-b-2", "border-l-2", "border-base-200"], ["appearance", "outline", 1, "h-14", "w-1/2", "flex-1"], ["matInput", "", 3, "name", "formControlName", "placeholder"], [1, "w-16", "rounded", "px-2", "py-1", "text-center", "text-xs"], [1, "opacity-30"]], template: function FunctionArgumentComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var SelectMethodComponent = class _SelectMethodComponent extends AsyncHandler {
  ...
  method_list = combineLatest([this._system, this._module]).pipe(distinctUntilChanged(), tap(() => this.loading.set(true)), switchMap(([id, { module, index }]) => !!id && !!module ? Nc(id, module, index) : of({})), catchError(() => of({})), map((fn_mapping) => Object.keys(fn_mapping || {}).map((i) => __spreadValues({
    name: i
...
var SelectModuleComponent = class _SelectModuleComponent extends AsyncHandler {
  ...
  loading = signal(false, ...ngDevMode ? [{ debugName: "loading" }] : []);
  modules = combineLatest([this._system, this._change]).pipe(distinctUntilChanged(([id1, time1], [id2, time2]) => id1 === id2 && time1 === time2), tap(() => this.loading.set(true)), switchMap(([id]) => id ? Uu({
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SelectModuleComponent, selectors: [["select-system-module"]], inputs: { system: [1, "system"] }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
...
(() => {
  ...
  }], null, { system: [{ type: Input, args: [{ isSignal: true, alias: "system", required: false }] }] });
})();
(() => {
...
var ExecuteMethodFieldComponent = class _ExecuteMethodFieldComponent {
  ...
  writeValue(value) {
    ...
    this.module.set({ module: parts.join("_"), index: +index });
...
View Error?`, "View", () => this.viewDetails(err));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExecuteMethodFieldComponent, selectors: [["execute-method-field"]], inputs: { zone: [1, "zone"], system: [1, "system"], can_execute: [1, "can_execute"] }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => _ExecuteMethodFieldComponent),
      multi: true
    }
  ])], decls: 7, vars: 8, consts: [[1, "relative"], [3, "ngModelChange", "system", "ngModel"], [3, "system", "module", "ngModel"], [3, "method", "ngModel"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "absolute", "-inset-2", "flex", "flex-col", "items-center", "justify-center", "rounded"], [3, "ngModelChange", "system", "module", "ngModel"], [3, "valid", "ngModelChange", "method", "ngModel"], ["btn", "", 1, "inverse", "flex-1", 3, "click"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click", "disabled"], [1, "absolute", "inset-0", "bg-base-100", "opacity-60"], ["diameter", "32"]], template: function ExecuteMethodFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  ...
  }], null, { zone: [{ type: Input, args: [{ isSignal: true, alias: "zone", required: false }] }], system: [{ type: Input, args: [{ isSignal: true, alias: "system", required: false }] }], can_execute: [{ type: Input, args: [{ isSignal: true, alias: "can_execute", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExecuteMethodFieldComponent, { className: "ExecuteMethodFieldComponent", filePath: "src/app/ui/custom-fields/system-exec/execute-method-field.component.ts", lineNumber: 99 });
})();

export {
  ExecuteMethodFieldComponent
};
//# sourceMappingURL=chunk-IOPYUXF3.js.map
