...
function queryStorage(query_params = {}) {
  return O({ query_params, fn: process, path: PATH });
}
...
var StorageComponent = class _StorageComponent {
  ...
  async ngOnInit() {
    ...
    const domain_list = await lastValueFrom(xu().pipe(map((r) => r.data)));
...
//# sourceMappingURL=chunk-4N76E5JI.js.map
