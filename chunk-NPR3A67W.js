...
function queryStorage(query_params = {}) {
  return b({ query_params, fn: process, path: PATH });
}
...
function StorageComponent_ng_template_28_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function StorageComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, StorageComponent_ng_template_28_Conditional_3_Template, 2, 0, "span", 17);
...
function StorageComponent_ng_template_36_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 22)(1, "button", 23);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function StorageComponent_ng_template_36_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function StorageComponent_ng_template_36_Template_button_click_5_listener() {
      const row_r8 = \u0275\u0275restoreView(_r7).row;
      const ctx_r8 = \u0275\u0275nextContext();
...
var StorageComponent = class _StorageComponent {
  ...
  storage_list = computed(
    () => {
      ...
      return stores.map((store) => __spreadProps(__spreadValues({}, store), {
        domain: this.domain_list().find((d2) => d2.id === store.authority_id)
      }));
    },
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StorageComponent, selectors: [["app-storage"]], decls: 38, vars: 63, consts: [["name_template", ""], ["code_template", ""], ["date_from_template", ""], ["bool_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-12"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["icon", "", "default", "", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-176", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "flex", "flex-col", "px-4", "py-2"], [1, "opacity-30"], [1, "text-xs", "opacity-30"], [1, "p-4"], [1, "flex", "h-full", "w-full", "items-center", "justify-center"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function StorageComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(20, "mat-progress-bar", 14)(21, "simple-table", 15);
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275pipe(23, "translate");
      \u0275\u0275pipe(24, "translate");
      \u0275\u0275pipe(25, "translate");
      ...
      \u0275\u0275pipe(27, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(28, StorageComponent_ng_template_28_Template, 6, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(30, StorageComponent_ng_template_30_Template, 3, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(32, StorageComponent_ng_template_32_Template, 3, 3, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(34, StorageComponent_ng_template_34_Template, 4, 9, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(36, StorageComponent_ng_template_36_Template, 9, 6, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const name_template_r10 = \u0275\u0275reference(29);
      const code_template_r11 = \u0275\u0275reference(31);
      const date_from_template_r12 = \u0275\u0275reference(33);
      const bool_template_r13 = \u0275\u0275reference(35);
      const actions_template_r14 = \u0275\u0275reference(37);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 13, "ADMIN.STORAGE_HEADER"), " ");
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.domain);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 15, "ADMIN.ALL_DOMAINS"));
      \u0275\u0275control();
      \u0275\u0275advance(2);
      \u0275\u0275property("value", \u0275\u0275pureFunction0(36, _c0));
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(11, 17, "ADMIN.ALL_DOMAINS"));
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.domain_list());
      \u0275\u0275advance(2);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(15, 19, "ADMIN.STORAGE_ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(16, 21, "ADMIN.STORAGE_ADD"));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.storage_list())("columns", \u0275\u0275pureFunction6(54, _c7, \u0275\u0275pureFunction2(37, _c1, \u0275\u0275pipeBind1(22, 23, "DOMAINS.SINGULAR"), name_template_r10), \u0275\u0275pureFunction2(40, _c2, \u0275\u0275pipeBind1(23, 25, "ADMIN.STORAGE_FIELD_TYPE"), code_template_r11), \u0275\u0275pureFunction2(43, _c3, \u0275\u0275pipeBind1(24, 27, "ADMIN.STORAGE_FIELD_REGION"), code_template_r11), \u0275\u0275pureFunction2(46, _c4, \u0275\u0275pipeBind1(25, 29, "COMMON.UPDATED_AT"), date_from_template_r12), \u0275\u0275pureFunction2(49, _c5, \u0275\u0275pipeBind1(26, 31, "ADMIN.STORAGE_FIELD_DEFAULT"), bool_template_r13), \u0275\u0275pureFunction1(52, _c6, actions_template_r14)))("sortable", true)("empty_message", \u0275\u0275pipeBind2(27, 33, "ADMIN.STORAGE_LIST_EMPTY", \u0275\u0275pureFunction1(61, _c8, ctx.domain() ? "selected" : "any")));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StorageComponent, { className: "StorageComponent", filePath: "src/app/admin/storage/storage.component.ts", lineNumber: 187 });
})();
export {
  StorageComponent
};
//# sourceMappingURL=chunk-NPR3A67W.js.map
