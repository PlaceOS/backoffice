...
var ZoneAboutComponent = class _ZoneAboutComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZoneAboutComponent, selectors: [["zone-about"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 38, vars: 43, consts: [[1, "p-4"], [1, "mono", "mb-2", "w-full", "rounded-sm", "bg-warning", "p-2", "text-center", "text-xs", "text-warning-content"], [1, "mb-4", "flex", "space-x-2"], [1, "w-1/3", "flex-1"], [1, "grid", "gap-2", "rounded-sm", "border", "border-base-200", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "flex", "items-center"], ["matTooltipPosition", "right", 3, "matTooltip"], [1, "my-4"], [1, "flex", "flex-col", "items-center", "p-8"], [1, "mono", "text-sm", "underline", 3, "routerLink"], [1, "mono", "text-sm"], [1, "truncate", "underline", 3, "href"], ["for", "tags", 1, "flex", "items-center", "text-sm", "font-medium"], [1, "-mx-1", "flex", "flex-1", "flex-wrap"], [1, "mono", "m-1", "h-6", "rounded-sm", "bg-base-200", "px-2", "py-1", "text-[0.625rem]"], [1, "opacity-30"], [1, "flex", "flex-col", "rounded-sm", "border", "border-base-200"], [1, "w-full", "rounded-sm", "bg-base-200", "px-4", "py-3", "text-lg", "font-medium"], [1, "w-full", "p-2"], ["appearance", "outline", 1, "no-subscript", "mb-2", "w-full"], [3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "zone", "system"], [1, "my-4", "text-base-300"], [1, "w-full", "rounded-sm", "border", "border-base-200"], [1, "w-full", "rounded-sm", "bg-base-200", "p-4", "text-lg", "font-medium"], [1, "markdown", "w-full", "overflow-auto", "p-4", "text-sm", 3, "innerHTML"], [3, "merge", "id", "settings"], ["diameter", "48", 1, "mb-4"]], template: function ZoneAboutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-ZF3RGBMC.js.map
