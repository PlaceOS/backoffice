...
import {
  DomainStateService
} from "./chunk-RFTFOHDC.js";
import "./chunk-LAODODFO.js";
import {
  MatTab,
  MatTabGroup,
  MatTabsModule
...
var DomainAboutComponent = class _DomainAboutComponent extends AsyncHandler {
  ...
  ngOnInit() {
    this.subscription("item", this._service.item.subscribe(() => this.loadForm()));
  }
  ...
  async saveChanges() {
    ...
    const domain = new Js(__spreadProps(__spreadValues({}, this.item), {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DomainAboutComponent, { className: "DomainAboutComponent", filePath: "src/app/domains/domain-about.component.ts", lineNumber: 121 });
})();
export {
  DomainAboutComponent
};
//# sourceMappingURL=chunk-BS23TTP2.js.map
