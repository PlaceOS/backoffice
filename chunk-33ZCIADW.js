...
function DriverModulesComponent_ng_template_18_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 23)(1, "div", 25)(2, "div", 26);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function DriverModulesComponent_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8, "delete");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "mat-menu", null, 3)(11, "div", 21);
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, DriverModulesComponent_ng_template_18_Conditional_14_Template, 5, 4, "div", 22);
    \u0275\u0275repeaterCreate(15, DriverModulesComponent_ng_template_18_For_16_Template, 6, 5, "a", 23, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var DriverModulesComponent = class _DriverModulesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DriverModulesComponent, selectors: [["driver-devices"]], inputs: { filter: [1, "filter"] }, outputs: { filter: "filterChange" }, decls: 20, vars: 28, consts: [["state_template", ""], ["name_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "p-4"], [1, "mb-4", "flex", "items-center"], ["appearance", "outline", 1, "h-12", "flex-1"], ["matPrefix", "", 1, "prefix"], [1, "relative", "-left-0.5", "text-2xl"], ["matInput", "", 1, "rounded-none", 3, "ngModelChange", "ngModel", "placeholder"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-lg", "text-sm", 3, "data", "columns", "sortable", "empty_message"], ["binding", "", "bind", "connected", 3, "model", "sys", "mod"], [1, "mx-auto", "h-2", "w-2", "rounded-full"], ["binding", "", "bind", "connected", 3, "modelChange", "model", "sys", "mod"], [1, "flex", "flex-col", "items-start", "px-4", "py-2", "leading-snug"], [1, "truncate", "underline", 3, "routerLink"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip", "matMenuTriggerFor"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"], [1, "bg-base-200", "mx-1", "-mt-1", "mb-1", "min-w-64", "rounded-sm", "px-4", "py-2", "text-sm", "opacity-70"], [1, "flex", "items-center", "space-x-2", "p-2", "text-sm"], ["mat-menu-item", "", 1, "leading-tight", 3, "routerLink"], [3, "diameter"], [1, "flex", "h-full", "flex-col", "justify-center", "px-2", "leading-tight"], [1, "text-base"], [1, "text-xs", "opacity-30"]], template: function DriverModulesComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DriverModulesComponent, { className: "DriverModulesComponent", filePath: "src/app/drivers/driver-devices.component.ts", lineNumber: 213 });
})();
export {
  DriverModulesComponent
};
//# sourceMappingURL=chunk-33ZCIADW.js.map
