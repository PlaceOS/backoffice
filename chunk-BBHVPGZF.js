...
function SelectMethodComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SelectMethodComponent_Conditional_0_Conditional_0_Template, 5, 4, "mat-form-field", 1)(1, SelectMethodComponent_Conditional_0_Conditional_1_Template, 4, 3, "div", 0);
  }
  if (rf & 2) {
...
var SelectMethodComponent = class _SelectMethodComponent extends AsyncHandler {
  ...
  _method_list = toSignal(combineLatest([
    ...
    name: i
  }, fn_mapping[i]))), tap(() => this.loading.set(false)), shareReplay(1)), { initialValue: [] });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SelectMethodComponent, selectors: [["select-module-method"]], inputs: { system: [1, "system"], module: [1, "module"] }, features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, SelectMethodComponent_Conditional_0_Template, 2, 1)(1, SelectMethodComponent_Conditional_1_Template, 5, 3, "div", 0);
    }
    if (rf & 2) {
...
(() => {
  ...
  }], () => [], { system: [{ type: Input, args: [{ isSignal: true, alias: "system", required: false }] }], module: [{ type: Input, args: [{ isSignal: true, alias: "module", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SelectMethodComponent, { className: "SelectMethodComponent", filePath: "src/app/ui/custom-fields/system-exec/select-method.component.ts", lineNumber: 93 });
})();
...
//# sourceMappingURL=chunk-BBHVPGZF.js.map
