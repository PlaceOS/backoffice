...
function SignagePluginModalComponent_Conditional_2_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "mat-progress-bar", 19);
...
function SignagePluginModalComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div", 4)(33, "label", 10);
    \u0275\u0275text(34);
    \u0275\u0275pipe(35, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(39, "settings-toggle", 13);
    \u0275\u0275pipe(40, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 4)(42, "div", 14);
    \u0275\u0275text(43);
    \u0275\u0275pipe(44, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(45, SignagePluginModalComponent_Conditional_2_Conditional_45_Template, 5, 3, "div", 15);
    \u0275\u0275conditionalCreate(46, SignagePluginModalComponent_Conditional_2_Conditional_46_Template, 3, 3, "div", 16);
    \u0275\u0275conditionalCreate(47, SignagePluginModalComponent_Conditional_2_Conditional_47_Template, 3, 2, "div", 17);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 24, "COMMON.FIELD_NAME"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(9, 26, "COMMON.FIELD_NAME"))("formField", ctx_r0.form.name);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 28, "ADMIN.SIGNAGE_PLUGINS_NAME_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 30, "COMMON.FIELD_DESCRIPTION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(19, 32, "COMMON.FIELD_DESCRIPTION"))("formField", ctx_r0.form.description);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275classProp("error", ctx_r0.form.uri().invalid() && ctx_r0.form.uri().touched());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 34, "ADMIN.SIGNAGE_PLUGINS_FIELD_URI"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(28, 36, "ADMIN.SIGNAGE_PLUGINS_FIELD_URI"))("formField", ctx_r0.form.uri);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(31, 38, "ADMIN.SIGNAGE_PLUGINS_URI_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(35, 40, "ADMIN.SIGNAGE_PLUGINS_FIELD_PLAYBACK_TYPE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("value", ctx_r0.playback_type_name());
    \u0275\u0275advance(2);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(40, 42, "ADMIN.SIGNAGE_PLUGINS_FIELD_ENABLED"))("formField", ctx_r0.form.enabled);
    \u0275\u0275control();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(44, 44, "ADMIN.SIGNAGE_PLUGINS_FIELD_DEFAULTS"), " ");
    \u0275\u0275advance(2);
...
function SignagePluginModalComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 3)(1, "signage-plugin-embed", 21);
...
var SignagePluginModalComponent = class _SignagePluginModalComponent extends AsyncHandler {
  ...
  _loadPlugin(uri) {
    ...
    this.schema_error.set(false);
    this.embed_plugin.set(new Xi({ uri }));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePluginModalComponent, selectors: [["signage-plugin-modal"]], viewQuery: function SignagePluginModalComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(2, SignagePluginModalComponent_Conditional_2_Template, 49, 46, "form", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePluginModalComponent, { className: "SignagePluginModalComponent", filePath: "src/app/admin/signage-plugins/signage-plugin-modal.component.ts", lineNumber: 227 });
})();
...
var AdminSignagePluginsComponent = class _AdminSignagePluginsComponent extends AsyncHandler {
  ...
  editPlugin(item) {
    const ref = this._dialog.open(SignagePluginModalComponent, {
      data: {
        item,
        save: (updated) => mh(item.id, updated)
      }
    });
    this.subscription("modal_events", ref.afterClosed().subscribe((event) => {
      if (event?.reason !== "done")
  ...
  async deletePlugin(item) {
    ...
    const err = await yh(item.id).catch((_) => _);
    details.close();
    if (err)
  ...
  async loadPlugins() {
    ...
    try {
      const plugins = await ph().then((r) => r.data);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminSignagePluginsComponent, selectors: [["admin-signage-plugins"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 32, vars: 47, consts: [["mono_template", ""], ["description_template", ""], ["playback_type_template", ""], ["enabled_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 3, "click"], [1, "flex", "items-center"], [1, "text"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-6xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "max-w-[50vw]", "truncate", "p-4", "font-mono", "text-xs"], [1, "p-4", "text-xs"], [1, "opacity-30"], [1, "p-4", "text-xs", "uppercase"], [1, "bg-success", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "bg-error", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "text-success-content", "text-2xl"], [1, "text-error-content", "text-2xl"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AdminSignagePluginsComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      const description_template_r9 = \u0275\u0275reference(25);
      const playback_type_template_r10 = \u0275\u0275reference(27);
      const enabled_template_r11 = \u0275\u0275reference(29);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.plugins())("columns", \u0275\u0275pureFunction6(40, _c6, \u0275\u0275pureFunction1(24, _c04, \u0275\u0275pipeBind1(16, 12, "COMMON.FIELD_NAME")), \u0275\u0275pureFunction2(26, _c1, \u0275\u0275pipeBind1(17, 14, "COMMON.FIELD_DESCRIPTION"), description_template_r9), \u0275\u0275pureFunction2(29, _c2, \u0275\u0275pipeBind1(18, 16, "ADMIN.SIGNAGE_PLUGINS_FIELD_URI"), mono_template_r8), \u0275\u0275pureFunction2(32, _c3, \u0275\u0275pipeBind1(19, 18, "ADMIN.SIGNAGE_PLUGINS_FIELD_PLAYBACK_TYPE"), playback_type_template_r10), \u0275\u0275pureFunction2(35, _c4, \u0275\u0275pipeBind1(20, 20, "ADMIN.SIGNAGE_PLUGINS_FIELD_ENABLED"), enabled_template_r11), \u0275\u0275pureFunction1(38, _c5, actions_template_r12)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(21, 22, "ADMIN.SIGNAGE_PLUGINS_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminSignagePluginsComponent, { className: "AdminSignagePluginsComponent", filePath: "src/app/admin/signage-plugins/signage-plugins.component.ts", lineNumber: 180 });
})();
export {
  AdminSignagePluginsComponent
};
//# sourceMappingURL=chunk-J23UVVWY.js.map
