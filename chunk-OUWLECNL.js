...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-GZMI5WW7.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-TFGIKZBI.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-WOHNL527.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-2B4PFBAN.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
      ...
      {
        path: "upload-library",
        loadComponent: () => import("./chunk-GJJZMGQZ.js").then((m) => m.UploadLibraryComponent)
      },
      {
        path: "mailing-list",
        children: [
...
//# sourceMappingURL=chunk-OUWLECNL.js.map
