...
function queryBuildJobs(q = {}) {
  ...
  return ee(`/api/build/v1/monitor${query ? "?" + query : ""}`);
}
function cancelBuildJob(id, q = {}) {
  const query = toQueryString(q);
  return Be(`/api/build/v1/cancel/${id}${query ? "?" + query : ""}`);
}
var PlaceBuildListComponent = class _PlaceBuildListComponent {
  ...
  async loadJobList() {
    ...
    const { data } = await lastValueFrom(queryBuildJobs()).catch((_) => ({ data: [] }));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceBuildListComponent, selectors: [["", "admin-build-list", ""]], attrs: _c0, decls: 20, vars: 33, consts: [["repo_template", ""], ["driver_template", ""], ["description_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-5xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "flex", "flex-col", "px-4", "py-2"], [1, "text-xs", "opacity-30"], [1, "w-full", "select-text", "overflow-hidden", "px-4", "py-2", "text-xs"], [1, "opacity-30"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"]], template: function PlaceBuildListComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceBuildListComponent, { className: "PlaceBuildListComponent", filePath: "src/app/admin/build-list.component.ts", lineNumber: 139 });
})();
export {
  PlaceBuildListComponent
};
//# sourceMappingURL=chunk-POOFAWEC.js.map
