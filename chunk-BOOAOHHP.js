...
function ObjectListFieldComponent_Conditional_0_For_3_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("name", field_r6)("placeholder", field_r6)("disabled", ctx_r2.disabled());
...
function ObjectListFieldComponent_Conditional_0_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ObjectListFieldComponent_Conditional_0_For_3_For_2_Template, 3, 5, "div", 10, \u0275\u0275repeaterTrackByIdentity);
...
function ObjectListFieldComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, ObjectListFieldComponent_Conditional_0_For_3_Template, 6, 1, "div", 2, \u0275\u0275repeaterTrackByIdentity);
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.active_list().length ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.active_list());
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", ctx_r2.disabled());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 3, "COMMON.NEW_ITEM"), " ");
  }
}
var ObjectListFieldComponent = class _ObjectListFieldComponent extends AsyncHandler {
  ...
  ]), \u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [[1, "object-list"], [1, "header", "row", "h-6", "text-sm"], [1, "row"], [1, "row", "h-10", "text-center"], ["btn", "", "type", "button", 1, "w-full", 3, "click", "disabled"], [1, "contents"], [1, "text-2xl"], [1, "text"], [1, "field", "capitalize"], [1, "w-10"], [1, "field"], ["icon", "", "matRipple", "", 1, "border-error", "text-error", "h-12", "w-12", "rounded-sm", "border", 3, "click", "disabled"], ["appearance", "outline"], ["matInput", "", 3, "ngModelChange", "name", "placeholder", "disabled", "ngModel"]], template: function ObjectListFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, ObjectListFieldComponent_Conditional_0_Template, 12, 5, "div", 0);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ObjectListFieldComponent, { className: "ObjectListFieldComponent", filePath: "src/app/ui/custom-fields/object-list-field.component.ts", lineNumber: 135 });
})();

export {
  ObjectListFieldComponent
};
//# sourceMappingURL=chunk-BOOAOHHP.js.map
