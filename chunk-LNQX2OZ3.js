import {
  TriggerStateService
} from "./chunk-2KM2XQ4F.js";
import "./chunk-XOGFQX7U.js";
import "./chunk-7XUBFYQ7.js";
import {
  MarkdownPipe
...
function TriggerAboutComponent_ng_template_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 27)(1, "pre");
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "json");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "code", 28);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
...
function TriggerAboutComponent_ng_template_65_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "div")(2, "code");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
var TriggerAboutComponent = class _TriggerAboutComponent extends AsyncHandler {
  ...
  query_fn = (q) => Kc({ q }).then((resp) => resp.data);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TriggerAboutComponent, { className: "TriggerAboutComponent", filePath: "src/app/triggers/trigger-about.component.ts", lineNumber: 314 });
})();
export {
  TriggerAboutComponent
};
//# sourceMappingURL=chunk-LNQX2OZ3.js.map
