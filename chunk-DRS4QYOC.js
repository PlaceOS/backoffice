...
var EdgeModalComponent = class _EdgeModalComponent {
  ...
  async save() {
    ...
    const method = edge.id ? Fo(edge.id, edge) : Lo(edge);
...
var PlaceEdgeComponent = class _PlaceEdgeComponent {
  ...
  async token(edge) {
    const details = await Bo(edge.id);
  ...
  async remove(i) {
    ...
    const err = await jo(i.id).catch((_) => _);
    details.close();
    if (err)
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceEdgeComponent, { className: "PlaceEdgeComponent", filePath: "src/app/admin/edge.component.ts", lineNumber: 183 });
})();
export {
  PlaceEdgeComponent
};
//# sourceMappingURL=chunk-DRS4QYOC.js.map
