...
import {
  PlaceDebugService
} from "./chunk-QK3KO423.js";
import {
  CustomTooltipComponent,
  CustomTooltipData
} from "./chunk-4JYWFI3T.js";
import {
  HotkeysService
} from "./chunk-ESTK43HE.js";
import {
  AuthenticatedImageDirective
} from "./chunk-4SAGXWED.js";
import {
...
var DebugInfoComponent = class _DebugInfoComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DebugInfoComponent, selectors: [["debug-info"]], inputs: { compact: [1, "compact"] }, decls: 1, vars: 1, consts: [["menu", "matMenu"], [1, "m-2", "flex", "flex-col", "space-y-2", "rounded-xl", "border", "border-base-300", "p-2"], ["actions", "", 1, "flex", "items-center", "justify-center", "space-x-2"], ["matTooltipPosition", "right", 1, "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-sm", "bg-info", "text-info-content", 3, "matTooltip"], [1, "text-2xl"], ["matTooltipPosition", "right", 1, "relative", "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-sm", 3, "matTooltip"], [1, "absolute", "left-1/2", "top-1/2", "-translate-x-1/2", "-translate-y-1/2", "text-5xl", "opacity-10"], [1, "mono", "rounded-xl", "bg-info", "p-1", "text-center", "text-xs", "text-info-content"], [1, "p-1", "text-center", "text-xs"], ["icon", "", "matRipple", "", 1, "rounded-lg", "border", "border-base-300", "bg-base-100", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], ["icon", "", "matRipple", "", 1, "bg-base-200", 3, "click"], ["matTooltip", "Toggle Position"], ["matTooltip", "Clear Messages"], ["matTooltip", "Unbind Modules"], ["matTooltip", "Open Console"]], template: function DebugInfoComponent_Template(rf, ctx) {
    if (rf & 1) {
...
function UserAvatarComponent_Conditional_0_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("source", ctx_r0.user().photo || ctx_r0.user().image);
  }
}
function UserAvatarComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.user().photo && !ctx_r0.user().image ? 1 : 2);
  }
}
var UserAvatarComponent = class _UserAvatarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserAvatarComponent, selectors: [["a-user-avatar"]], inputs: { user: [1, "user"] }, decls: 1, vars: 1, consts: [[1, "flex", "items-center", "justify-center", "overflow-hidden", "rounded-full"], ["initials", "", 1, "uppercase", "text-base-content", "text-opacity-80"], ["auth", "", 1, "h-full", "w-full", "object-cover", 3, "source"]], template: function UserAvatarComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserAvatarComponent, { className: "UserAvatarComponent", filePath: "src/app/ui/user-avatar.component.ts", lineNumber: 47 });
})();
...
var UserMenuTooltipComponent = class _UserMenuTooltipComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserMenuTooltipComponent, selectors: [["user-menu-tooltip"]], decls: 33, vars: 24, consts: [["lang_menu", "matMenu"], [1, "m-2", "divide-y", "divide-base-200", "rounded-sm", "border", "border-base-300", "bg-base-100", "shadow-sm"], ["matRipple", "", "type", "button", "profile", "", 1, "space-x-2", 3, "routerLink"], ["dark-mode", "", 1, "flex", "w-[16rem]", "items-center", "p-4"], [1, "w-1/2", "flex-1"], [3, "ngModelChange", "ngModel"], ["matRipple", "", "type", "button", "logout", "", 1, "space-x-2", 3, "click"], ["matRipple", "", "type", "button", "uploads", "", 1, "space-x-2", 3, "click"], ["matRipple", "", "type", "button", 3, "matMenuTriggerFor"], ["xPosition", "after", "yPosition", "above"], ["mat-menu-item", "", 1, "w-60"], ["matRipple", "", "type", "button", "target", "_blank", "ref", "noopener noreferer", "report", "", 1, "space-x-2", 3, "href"], [3, "className"], [1, "flex-1", "text-left"], [1, "max-w-24", "truncate", "rounded-sm", "bg-base-200", "px-2", "py-1", "text-sm"], ["mat-menu-item", "", 1, "w-60", 3, "click"], [1, "flex", "w-full", "items-center", "justify-between", "space-x-4"]], template: function UserMenuTooltipComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
...
function SidebarMenuComponent_For_10_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275elementStart(2, "div", 15)(3, "icon", 16);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(12, _c13, link_r1.route))("matTooltip", ctx_r1.compact() ? \u0275\u0275pipeBind1(1, 8, link_r1.name) : "");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 10, link_r1.name), " ");
  }
}
function SidebarMenuComponent_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SidebarMenuComponent_For_10_Conditional_0_Template, 8, 14, "a", 14);
  }
  if (rf & 2) {
...
var SidebarMenuComponent = class _SidebarMenuComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarMenuComponent, selectors: [["sidebar-menu"]], inputs: { open: [1, "open"] }, outputs: { open: "openChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 26, vars: 29, consts: [["sidebar-menu", "", 1, "pointer-events-none", "absolute", "inset-0", "z-40", "hidden", "h-full", "flex-col", "justify-between", "bg-base-200", "sm:pointer-events-auto", "sm:relative", "sm:inset-auto", "sm:z-10", "sm:flex", 3, "click"], [1, "flex", "h-1/2", "flex-1", "flex-col", "items-center", "space-y-2"], [1, "font-heading", "ml-16", "mt-4", "text-4xl", "sm:mb-2", "sm:ml-0", 3, "routerLink"], [1, "font-heading", "text-primary"], ["src", "assets/icon/mstile-310x310.png", 1, "hidden", "h-12", "w-12"], [1, "w-full", "flex-1", "space-y-2", "overflow-auto", "pb-2"], ["icon", "", "matRipple", "", 1, "absolute", "left-1", "top-1", "sm:hidden", 3, "click"], [3, "compact"], ["matRipple", "", "customTooltip", "", "user", "", "yPosition", "bottom", "xPosition", "start", 1, "flex", "min-h-16", "items-center", "space-x-2", "border-t", "border-base-300", "p-2", "text-left", 3, "content"], ["matTooltipPosition", "right", 3, "user", "matTooltip"], [1, "flex", "w-1/2", "flex-1", "flex-col", "leading-tight"], [1, "w-full", "truncate"], [1, "w-full", "truncate", "text-xs", "opacity-30"], ["icon", "", "matRipple", "", 1, "absolute", "bottom-12", "right-0", "z-999", "hidden", "h-6", "w-6", "min-w-6", "translate-x-1/2", "rounded-full", "border", "border-base-200", "bg-base-100", "shadow-sm", "hover:bg-base-200", "sm:flex", 3, "click"], ["btn", "", "link", "", "matRipple", "", "routerLinkActive", "bg-secondary! text-secondary-content", "matTooltipPosition", "right", 1, "clear", "mx-auto", "w-[calc(100%-1rem)]", "text-left", "hover:bg-base-100", 3, "routerLink", "matTooltip"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "text-xl"]], template: function SidebarMenuComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarMenuComponent, { className: "SidebarMenuComponent", filePath: "src/app/ui/sidebar-menu.component.ts", lineNumber: 159 });
})();
...
//# sourceMappingURL=chunk-3MNUHFTU.js.map
