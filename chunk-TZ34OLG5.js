...
function ListComponent_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.validation_errors().length, " issue(s) ");
  }
}
...
function ListComponent_Conditional_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.duplicate_warnings().length, " warning(s) ");
  }
}
...
function ListComponent_Conditional_16_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.validation_errors().slice(0, 4));
  }
}
...
function ListComponent_Conditional_16_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.duplicate_warnings().slice(0, 4));
  }
}
function ListComponent_Conditional_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.validation_errors().length ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.duplicate_warnings().length ? 2 : -1);
  }
}
function ListComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function ListComponent_Conditional_19_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAllStartModules($event));
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.all_start_modules);
  }
}
function ListComponent_ng_template_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function ListComponent_ng_template_27_Template_input_ngModelChange_0_listener($event) {
      ...
      const id_r8 = ctx_r6.key;
      const index_r9 = ctx_r6.index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateItem(index_r9, id_r8, $event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const id_r8 = ctx.key;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("border-error", ctx_r1.isMissing(row_r10, id_r8));
    \u0275\u0275property("placeholder", name_r11)("ngModel", row_r10[id_r8]);
  }
}
function ListComponent_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ListComponent_ng_template_29_Template_input_click_1_listener($event) {
      ...
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateItem(index_r13, "start_modules", $event));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", row_r14["start_modules"]);
  }
}
...
var ListComponent = class _ListComponent {
  ...
  required_fields = input([], ...ngDevMode ? [{ debugName: "required_fields" }] : []);
  /** Validation errors to show for the reviewed list */
  validation_errors = input([], ...ngDevMode ? [{ debugName: "validation_errors" }] : []);
  /** Duplicate warnings to show for the reviewed list */
  duplicate_warnings = input([], ...ngDevMode ? [{ debugName: "duplicate_warnings" }] : []);
  ...
  _actions_tmpl = viewChild("actions", ...ngDevMode ? [{ debugName: "_actions_tmpl" }] : []);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListComponent, selectors: [["bulk-item-list"]], viewQuery: function ListComponent_Query(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275viewQuerySignal(ctx._actions_tmpl, _c2, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(3);
    }
...
function MatchFieldsComponent_For_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function MatchFieldsComponent_For_18_Template_mat_select_ngModelChange_6_listener($event) {
    ...
    \u0275\u0275text(8, "Skip field");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(9, MatchFieldsComponent_For_18_For_10_Template, 2, 2, "mat-option", 14, _forTrack02);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
var MatchFieldsComponent = class _MatchFieldsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MatchFieldsComponent, selectors: [["bulk-item-match-fields"]], inputs: { list: [1, "list"], field_list: [1, "field_list"], required_fields: [1, "required_fields"], mappings: [1, "mappings"] }, outputs: { mappings: "mappingsChange", mapping_done: "mapping_done", previous: "previous", new_mappings: "new_mappings" }, features: [\u0275\u0275NgOnChangesFeature], decls: 28, vars: 10, consts: [[1, "bg-base-100", "border-base-200", "mb-4", "grid", "gap-3", "rounded-sm", "border", "p-4", "text-sm", "md:grid-cols-3"], [1, "text-base-content/60", "tracking-wide", "uppercase"], [1, "text-lg", "font-medium"], [1, "-mx-2", "flex", "max-w-full", "flex-wrap", "px-2"], [1, "m-2", "flex", "min-w-[18rem]", "flex-1", "flex-col"], [1, "text-base-content/60", "px-2", "pt-2", "text-xs"], [1, "bg-base-100", "border-base-200", "fixed", "right-0", "bottom-0", "left-0", "z-20", "flex", "items-center", "justify-end", "space-x-4", "border-t", "px-4", "py-4", "shadow-lg"], ["btn", "", "matRipple", "", 1, "inverse", "w-36", 3, "click"], ["btn", "", "matRipple", "", 1, "w-36", 3, "click"], [1, "mb-1", "flex", "items-center", "justify-between", "text-xs", "tracking-wide", "uppercase", 3, "for"], [1, "text-error"], ["appearance", "outline", 1, "no-subscript"], ["placeholder", "Skip field", 3, "ngModelChange", "name", "ngModel"], ["value", ""], [3, "value"]], template: function MatchFieldsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(17, MatchFieldsComponent_For_18_Template, 11, 5, "div", 4, _forTrack02);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      let tmp_0_0;
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(((tmp_0_0 = ctx.list()) == null ? null : tmp_0_0.length) || 0);
      \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MatchFieldsComponent, { className: "MatchFieldsComponent", filePath: "src/app/overlays/bulk-item-modal/match-fields.component.ts", lineNumber: 104 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StatusListComponent, { className: "StatusListComponent", filePath: "src/app/overlays/bulk-item-modal/status-list.component.ts", lineNumber: 118 });
})();
...
var BulkItemModalComponent = class _BulkItemModalComponent {
  ...
  flow_step = signal("upload", ...ngDevMode ? [{ debugName: "flow_step" }] : []);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BulkItemModalComponent, selectors: [["app-bulk-item-modal"]], hostVars: 2, hostBindings: function BulkItemModalComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(9, BulkItemModalComponent_For_10_Template, 5, 8, "div", 5, _forTrack03);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      let tmp_6_0;
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 9, "COMMON.BULK_ADD", \u0275\u0275pureFunction1(12, _c03, ctx.type)), " ");
      \u0275\u0275advance(4);
      \u0275\u0275conditional(!ctx.loading ? 7 : -1);
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BulkItemModalComponent, { className: "BulkItemModalComponent", filePath: "src/app/overlays/bulk-item-modal/bulk-item-modal.component.ts", lineNumber: 164 });
})();
...
*/
//# sourceMappingURL=chunk-TZ34OLG5.js.map
