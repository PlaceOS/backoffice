...
import {
  ...
  MatMenuModule,
  MatMenuTrigger
} from "./chunk-U6LWNILH.js";
import {
  MatTabLink,
  MatTabNav,
  MatTabNavPanel,
  MatTabsModule
} from "./chunk-OTGRNH2B.js";
import {
  ActiveItemService
...
import {
  HotkeysService
} from "./chunk-75OXH2NR.js";
import {
  MatProgressSpinner,
  MatProgressSpinnerModule
} from "./chunk-I4CNNZYL.js";
import {
  notifyInfo
...
function ItemDetailsComponent_For_39_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classProp("text-error", item_r6.destructive);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(item_r6.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 5, item_r6.label), " ");
    \u0275\u0275advance(2);
...
var ItemDetailsComponent = class _ItemDetailsComponent {
  ...
  edit = output();
  delete = output();
  canMutate = (permission) => this._service.canMutate(permission);
  copyID = () => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemDetailsComponent, selectors: [["item-details"]], inputs: { type: [1, "type"], item: [1, "item"], can_edit: [1, "can_edit"], extra_actions: [1, "extra_actions"] }, outputs: { create: "create", edit: "edit", delete: "delete" }, decls: 41, vars: 28, consts: [["action_menu", "matMenu"], [1, "flex", "items-center", "justify-between", "px-4", "py-2"], [1, "flex", "flex-col", "space-y-2"], ["name", "", 1, "text-2xl", "select-text"], [1, "flex", "items-center", "space-x-2"], [1, "mono", "text-xs", "opacity-60", 3, "click"], [1, "bg-info", "text-info-content", "rounded-xl", "px-2", "py-1", "text-xs"], [1, "mono", "bg-info", "text-info-content", "rounded-xl", "px-2", "py-1", "text-xs"], [1, "bg-info", "text-info-content", "rounded-xl", "px-2", "py-1", "text-xs", "uppercase"], [1, "bg-error", "text-error-content", "rounded-xl", "px-2", "py-1", "text-xs", 3, "bg-success!", "text-success-content!"], [1, "bg-info", "text-info-content", "rounded-xl", "px-2", "py-1", "text-xs", 3, "matTooltip"], [1, "bg-success", "text-success-content", "flex", "items-center", "space-x-2", "rounded-xl", "px-2", "py-1", "text-xs"], ["icon", "", "default", "", "matRipple", "", 3, "matMenuTriggerFor"], [1, "min-w-88"], ["mat-menu-item", "", 1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", "disabled", "true", 1, "flex", "items-center", "space-x-2", 3, "click"], [1, "text-2xl"], ["mat-menu-item", "", 1, "flex", "items-center", "space-x-2", 3, "click"], [1, "bg-error", "text-error-content", "rounded-xl", "px-2", "py-1", "text-xs"], [1, "text"], [1, "flex-1"], [1, "keycap"], [1, "text-error", "text-2xl"]], template: function ItemDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(37, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275repeaterCreate(38, ItemDetailsComponent_For_39_Template, 7, 7, "button", 14, _forTrack0);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.can_edit() && ctx.canMutate(4) ? 19 : -1);
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.can_edit() && ctx.canMutate(8) ? 40 : -1);
    }
  }, dependencies: [
    IconComponent,
    MatMenuModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemDetailsComponent, { className: "ItemDetailsComponent", filePath: "src/app/ui/item-details.component.ts", lineNumber: 202 });
})();
...
function ItemSelectionComponent_Conditional_10_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-slide-toggle", 18);
    \u0275\u0275listener("change", function ItemSelectionComponent_Conditional_10_Conditional_9_Template_mat_slide_toggle_change_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.setIncludeDeleted($event.checked));
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("checked", ctx_r1.include_deleted());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, "USERS.INCLUDE_DELETED"), " ");
  }
}
function ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", item_r6.extra, " ");
  }
}
function ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 21);
    \u0275\u0275listener("click", function ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.close());
    });
    \u0275\u0275elementStart(1, "div", 22)(2, "p", 23);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Conditional_4_Template, 3, 3, "span", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Conditional_5_Template, 3, 1, "div", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("bg-base-content/5", idx_r7 % 2 === 1);
    \u0275\u0275property("routerLink", ctx_r1.subroute() ? \u0275\u0275pureFunction3(6, _c4, ctx_r1.route(), item_r6.id, ctx_r1.subroute()) : \u0275\u0275pureFunction2(10, _c5, ctx_r1.route(), item_r6.id));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", item_r6.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.route() === "users" && item_r6.deleted ? 4 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r6.extra ? 5 : -1);
  }
}
function ItemSelectionComponent_Conditional_10_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "virtual-scroll", 19);
    \u0275\u0275listener("scrolled", function ItemSelectionComponent_Conditional_10_Conditional_14_Template_virtual_scroll_scrolled_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Template, 6, 13, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const item_display_r8 = \u0275\u0275reference(5);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("item_size", 72)("items", ctx_r1.items())("item_template", item_display_r8);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 4, "COMMON.END_OF_LIST"), " ");
  }
}
function ItemSelectionComponent_Conditional_10_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSelectionComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, ItemSelectionComponent_Conditional_10_Conditional_9_Template, 3, 4, "mat-slide-toggle", 14);
    \u0275\u0275elementStart(10, "p", 15);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 16);
    \u0275\u0275conditionalCreate(14, ItemSelectionComponent_Conditional_10_Conditional_14_Template, 6, 6)(15, ItemSelectionComponent_Conditional_10_Conditional_15_Template, 4, 6, "div", 17);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(7, 6, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction1(13, _c2, ctx_r1.title())));
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.loading() ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.route() === "users" ? 9 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(12, 9, "COMMON.TOTAL_ITEMS", \u0275\u0275pureFunction1(15, _c3, ctx_r1.total()), ctx_r1.total()), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.items().length ? 14 : 15);
  }
}
var ItemSelectionComponent = class _ItemSelectionComponent extends AsyncHandler {
  ...
  include_deleted = this._service.include_deleted;
  setIncludeDeleted = (include) => this._service.setIncludeDeleted(include);
  last_total = 0;
  last_check = 0;
  search = "";
  ...
  _processItems(list) {
    for (const item of list) {
      if (item instanceof Is) {
        const detail = item.role === Nt.Service ? item.uri : item.role === Nt.Logic ? item.control_system_id : item.ip;
        item.display_name = item.custom_name || item.name || "<Unnamed>";
        item.extra = detail;
      } else if (item instanceof ur) {
  ...
  }, inputs: { show: [1, "show"], title: [1, "title"], route: [1, "route"] }, outputs: { show: "showChange" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], ngContentSelectors: _c1, decls: 11, vars: 7, consts: [["search_input", ""], ["item_display", ""], [1, "border-base-300", "flex", "w-full", "items-center", "justify-center", "border-b", "p-2"], [1, "border-base-300", "flex", "max-w-[calc(100vw-1rem)]", "flex-1", "items-center", "rounded-lg", "border", "sm:max-w-lg", "sm:flex-auto", 3, "click"], [1, "ml-2", "text-2xl"], [1, "w-1/2", "flex-1", "p-2", "text-left", "text-lg", "opacity-30"], [1, "keycap", "mr-2", "text-xs"], [1, "bg-base-100/80", "absolute", "inset-0"], [1, "bg-base-100/80", "absolute", "inset-0", 3, "click"], [1, "bg-base-100", "border-base-300", "absolute", "top-2", "left-1/2", "flex", "w-lg", "max-w-[calc(100vw-1rem)]", "-translate-x-1/2", "flex-col", "space-y-2", "overflow-hidden", "rounded-sm", "border", "shadow-sm", 3, "click"], [1, "border-base-300", "relative", "flex", "items-center", "border-b"], [1, "pointer-events-none", "absolute", "top-1/2", "left-2", "-translate-y-1/2", "text-2xl"], [1, "flex-1", "border-none", "bg-transparent", "py-4", "pr-4", "pl-10", 3, "ngModelChange", "ngModel", "placeholder"], ["diameter", "24", 1, "absolute", "top-1/2", "right-2", "mr-2", "-translate-y-1/2"], [1, "px-2", 3, "checked"], [1, "w-full", "px-4", "text-sm", "opacity-60", "text-left"], [1, "border-base-300", "flex", "h-1/2", "flex-1", "flex-col"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], [1, "px-2", 3, "change", "checked"], [1, "h-[768px]", "max-h-[75vh]", 3, "scrolled", "item_size", "items", "item_template"], [1, "bg-base-200", "p-2", "text-center", "text-sm", "opacity-30"], ["routerLinkActive", "active", 1, "m-2", "block", "max-w-[calc(100vw-2rem)]", "rounded-sm", "p-2", "text-left", 3, "click", "routerLink"], [1, "flex", "min-w-0", "items-center", "gap-2"], [1, "min-w-0", "flex-1", "truncate"], [1, "bg-error", "text-error-content", "shrink-0", "rounded-full", "px-2", "py-0.5", "text-xs"], [1, "inline-block", "w-full", "overflow-hidden"], ["extra", "", 1, "mono", "bg-base-content/10", "/5", "mt-1", "max-w-full", "truncate", "rounded-sm", "px-2", "py-1", "text-xs", "opacity-60"]], template: function ItemSelectionComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      ...
      \u0275\u0275text(9, "K");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(10, ItemSelectionComponent_Conditional_10_Template, 16, 17, "button", 7);
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSelectionComponent, { className: "ItemSelectionComponent", filePath: "src/app/ui/item-selection.component.ts", lineNumber: 202 });
})();
...
function ItemSidebarComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 8)(1, "button", 13)(2, "icon", 14);
    \u0275\u0275text(3, "filter_list");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "mat-form-field", 15)(5, "mat-select", 16);
    ...
    \u0275\u0275repeaterCreate(6, ItemSidebarComponent_Conditional_9_For_7_Template, 2, 2, "mat-option", 17, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
...
function ItemSidebarComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "settings-toggle", 18);
    \u0275\u0275listener("ngModelChange", function ItemSidebarComponent_Conditional_10_Template_settings_toggle_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setIncludeDeleted($event));
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("ngModel", ctx_r2.include_deleted());
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, "USERS.INCLUDE_DELETED"), " ");
  }
}
function ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_2_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r7);
      const node_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      ctx_r2.toggleGroup(node_r8.group.id);
  ...
  if (rf & 2) {
    const node_r8 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275attribute("aria-label", (ctx_r2.isGroupExpanded(node_r8.group.id) ? "Collapse group " : "Expand group ") + ctx_r2.displayName(node_r8.group));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r2.isGroupExpanded(node_r8.group.id) ? "expand_more" : "chevron_right", " ");
  }
}
function ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 26);
  }
}
function ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.childCount(node_r8.group), " ");
  }
}
function ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const node_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", node_r8.group.description, " ");
  }
}
function ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "cdk-tree-node", 23);
    \u0275\u0275element(1, "div", 24);
    \u0275\u0275conditionalCreate(2, ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_2_Template, 3, 2, "button", 25)(3, ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_3_Template, 1, 0, "div", 26);
    \u0275\u0275elementStart(4, "a", 27);
    \u0275\u0275listener("click", function ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Template_a_click_4_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.show.set(false));
    });
    \u0275\u0275elementStart(5, "div", 28)(6, "p", 29);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_8_Template, 2, 1, "span", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Conditional_9_Template, 2, 1, "p", 31);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const node_r8 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("active", ctx_r2.selected_id() === node_r8.group.id);
    \u0275\u0275property("cdkTreeNodePadding", node_r8.depth)("cdkTreeNodePaddingIndent", 8);
    \u0275\u0275advance();
    \u0275\u0275styleProp("width", 0.25 * node_r8.depth + "rem")("opacity", 0.1 * node_r8.depth);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.childCount(node_r8.group) > 0 ? 2 : 3);
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", ctx_r2.subroute() ? \u0275\u0275pureFunction3(13, _c32, ctx_r2.route(), node_r8.group.id, ctx_r2.subroute()) : \u0275\u0275pureFunction2(17, _c42, ctx_r2.route(), node_r8.group.id));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r2.displayName(node_r8.group), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.childCount(node_r8.group) > 0 ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(node_r8.group.description ? 9 : -1);
  }
}
function ItemSidebarComponent_Conditional_15_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19)(1, "cdk-tree", 20);
    \u0275\u0275template(2, ItemSidebarComponent_Conditional_15_Conditional_0_cdk_tree_node_2_Template, 10, 20, "cdk-tree-node", 21);
    \u0275\u0275elementEnd();
...
function ItemSidebarComponent_Conditional_15_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSidebarComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ItemSidebarComponent_Conditional_15_Conditional_0_Template, 6, 6, "div", 19)(1, ItemSidebarComponent_Conditional_15_Conditional_1_Template, 4, 6, "div", 12);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", item_r11.extra, " ");
  }
}
function ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "icon", 40);
    \u0275\u0275text(1, " new_releases ");
    \u0275\u0275elementEnd();
  }
}
function ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const item_r11 = \u0275\u0275nextContext().item;
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 1, item_r11.zone_issues === "system" ? "SYSTEMS.MISCONFIGURED" : "ZONES.MISCONFIGURED"));
  }
}
function ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSidebarComponent_Conditional_16_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 35);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ItemSidebarComponent_Conditional_16_ng_template_4_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.show.set(false));
    });
    \u0275\u0275elementStart(2, "div", 28)(3, "p", 36);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_5_Template, 3, 3, "span", 37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 38);
    \u0275\u0275conditionalCreate(7, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_7_Template, 2, 1, "div", 39);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_8_Template, 2, 0, "icon", 40);
    \u0275\u0275conditionalCreate(9, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_9_Template, 4, 3, "div", 41);
    \u0275\u0275conditionalCreate(10, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_10_Template, 4, 3, "div", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-base-200", idx_r12 % 2 === 1);
    \u0275\u0275property("routerLink", ctx_r2.subroute() ? \u0275\u0275pureFunction3(12, _c32, ctx_r2.route(), item_r11.id, ctx_r2.subroute()) : \u0275\u0275pureFunction2(16, _c42, ctx_r2.route(), item_r11.id))("matTooltip", item_r11.update_available && item_r11.commit !== item_r11.update_info.commit ? \u0275\u0275pipeBind1(1, 10, "COMMON.UPDATE_AVAILABLE") : "");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", item_r11.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.route() === "users" && item_r11.deleted ? 5 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(item_r11.extra ? 7 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r11.update_available && item_r11.commit !== item_r11.update_info.commit ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r11.zone_issues ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r11.has_runtime_error ? 10 : -1);
  }
}
function ItemSidebarComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "virtual-scroll", 34);
    \u0275\u0275listener("scrolled", function ItemSidebarComponent_Conditional_16_Template_virtual_scroll_scrolled_0_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, ItemSidebarComponent_Conditional_16_ng_template_4_Template, 11, 19, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const item_display_r13 = \u0275\u0275reference(5);
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("item_size", 72)("items", ctx_r2.items())("item_template", item_display_r13);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 4, "COMMON.END_OF_LIST"), " ");
  }
}
...
var ItemSidebarComponent = class _ItemSidebarComponent extends AsyncHandler {
  ...
  _processItems(list) {
    for (const item of list) {
      if (item instanceof Is) {
        ...
        const detail = item.role === Nt.Service ? item.uri : item.role === Nt.Logic ? name ? `${name} | ${item.control_system_id} ` : item.control_system_id : item.ip;
        item.display_name = item.custom_name || item.name || "<Unnamed>";
        item.extra = detail;
      } else if (item instanceof ur) {
        item.display_name = item.name || "<Unnamed>";
        item.extra = item.repo_type;
      } else if (item instanceof Rs) {
        item.display_name = item.display_name || item.name || "<Unnamed>";
        item.zone_issues = (item.email || item.map_id) && item.zones.length < 3 ? "system" : "";
      } else if (item instanceof Xt) {
        item.display_name = item.display_name || item.name || "<Unnamed>";
  ...
  }, inputs: { title: [1, "title"], route: [1, "route"], filter_options: [1, "filter_options"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 18, vars: 18, consts: [["search_input", ""], ["item_display", ""], [1, "border-base-200", "bg-base-100", "flex", "h-full", "w-[24rem]", "max-w-[25vw]", "min-w-64", "flex-col", "space-y-2", "overflow-hidden", "rounded-sm", "shadow-sm", "sm:border-r", 3, "click"], [1, "flex", "items-center", "gap-1", "px-1", "pt-1"], [1, "border-base-300", "relative", "flex", "flex-1", "items-center", "rounded-lg", "border", "shadow-sm"], [1, "pointer-events-none", "absolute", "top-1/2", "left-1", "-translate-y-1/2", "text-2xl"], [1, "w-full", "flex-1", "rounded-lg", "border-none", "bg-transparent", "py-2.5", "pr-4", "pl-9", 3, "ngModelChange", "ngModel", "placeholder"], ["diameter", "24", 1, "absolute", "top-1/2", "right-2", "mr-2", "-translate-y-1/2"], [1, "relative", "flex", "overflow-hidden"], [1, "px-1", 3, "ngModel"], [1, "w-full", "px-2", "text-sm", "opacity-60"], [1, "border-base-200", "flex", "h-1/2", "flex-1", "flex-col", "border-t"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], ["icon", "", "default", "", "matRipple", "", 1, "h-11", "w-11"], [1, "m-2", "text-2xl"], ["appearance", "outline", 1, "no-subscript", "absolute", "top-1/2", "-right-2", "-translate-y-1/2", "opacity-0"], ["multiple", "", 3, "ngModelChange", "ngModel"], [1, "capitalize", 3, "value"], [1, "px-1", 3, "ngModelChange", "ngModel"], [1, "h-full", "overflow-auto"], [1, "group-tree", 3, "dataSource", "levelAccessor", "trackBy"], ["cdkTreeNodePadding", "", "class", "border-base-200 bg-base-100 hover:bg-base-200 relative flex min-h-16 items-center gap-2 border-b pr-2 transition-colors", 3, "cdkTreeNodePadding", "cdkTreeNodePaddingIndent", "active", 4, "cdkTreeNodeDef"], [1, "bg-base-200", "p-2", "text-center", "text-sm", "opacity-30"], ["cdkTreeNodePadding", "", 1, "border-base-200", "bg-base-100", "hover:bg-base-200", "relative", "flex", "min-h-16", "items-center", "gap-2", "border-b", "pr-2", "transition-colors", 3, "cdkTreeNodePadding", "cdkTreeNodePaddingIndent"], [1, "bg-base-content", "absolute", "inset-y-1", "left-1", "rounded-sm"], ["type", "button", 1, "hover:bg-base-content/20", "ml-1", "flex", "h-7", "w-7", "shrink-0", "items-center", "justify-center", "rounded-lg", "transition-colors"], [1, "min-w-8"], [1, "flex", "min-w-0", "flex-1", "flex-col", "justify-center", "rounded-md", "py-3", "text-left", "no-underline", 3, "click", "routerLink"], [1, "flex", "min-w-0", "items-center", "gap-2"], [1, "min-w-0", "flex-1", "truncate", "font-medium"], [1, "bg-base-200/70", "rounded-full", "px-2", "py-0.5", "text-xs"], [1, "mt-0.5", "w-full", "truncate", "text-xs", "opacity-70"], ["type", "button", 1, "hover:bg-base-content/20", "ml-1", "flex", "h-7", "w-7", "shrink-0", "items-center", "justify-center", "rounded-lg", "transition-colors", 3, "click"], [1, "text-xl"], [3, "scrolled", "item_size", "items", "item_template"], ["routerLinkActive", "active", 1, "border-base-100", "hover:border-info", "relative", "m-1", "flex", "h-16", "w-92", "max-w-[calc(100%-0.5rem)]", "flex-col", "justify-center", "rounded-sm", "border", "px-2", "py-1", 3, "click", "routerLink", "matTooltip"], [1, "min-w-0", "flex-1", "truncate"], [1, "bg-error", "text-error-content", "shrink-0", "rounded-full", "px-2", "py-0.5", "text-xs"], [1, "flex", "w-full"], ["extra", "", 1, "mono", "border-base-300", "mt-1", "max-w-full", "truncate", "rounded-sm", "border", "p-1", "text-[0.625rem]", "opacity-60"], [1, "text-info", "absolute", "-top-1", "-right-1", "rotate-12", "text-2xl"], [1, "bg-warning", "text-warning-content", "absolute", "-top-1", "-right-1", "flex", "h-8", "w-8", "rotate-12", "items-center", "justify-center", "rounded-full", "text-2xl", 3, "matTooltip"], [1, "bg-error", "text-error-content", "absolute", "-top-1", "-right-1", "flex", "h-8", "w-8", "rotate-12", "items-center", "justify-center", "rounded-full", "text-2xl", 3, "matTooltip"]], template: function ItemSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 2);
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(10, ItemSidebarComponent_Conditional_10_Template, 3, 4, "settings-toggle", 9);
      \u0275\u0275elementStart(11, "p", 10);
      \u0275\u0275text(12);
      \u0275\u0275pipe(13, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "div", 11);
      \u0275\u0275conditionalCreate(15, ItemSidebarComponent_Conditional_15_Template, 2, 1)(16, ItemSidebarComponent_Conditional_16_Template, 6, 6)(17, ItemSidebarComponent_Conditional_17_Template, 4, 6, "div", 12);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
      \u0275\u0275twoWayProperty("ngModel", ctx.search);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(7, 7, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction1(14, _c12, ctx.title())));
      \u0275\u0275control();
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.route() === "users" ? 10 : -1);
      const t_r14 = ctx.total();
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(13, 10, "COMMON.TOTAL_ITEMS", \u0275\u0275pureFunction1(16, _c22, t_r14), t_r14), " ");
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.route() === "groups" && !ctx.search.trim() ? 15 : ctx.items().length ? 16 : 17);
    }
  }, dependencies: [
    CdkTreeModule,
    CdkTreeNodeDef,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSidebarComponent, { className: "ItemSidebarComponent", filePath: "src/app/ui/item-sidebar.component.ts", lineNumber: 375 });
})();
...
//# sourceMappingURL=chunk-BP4ELGVD.js.map
