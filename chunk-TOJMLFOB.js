...
import {
  ...
  MatMenuModule,
  MatMenuTrigger
} from "./chunk-5EAODZHO.js";
import {
  MatTabLink,
  MatTabNav,
  MatTabNavPanel,
  MatTabsModule
} from "./chunk-JQEXP6LA.js";
import {
  ActiveItemService
} from "./chunk-HVBHNHZ2.js";
import {
  HotkeysService
...
var ItemDetailsComponent = class _ItemDetailsComponent {
  ...
  newFromItem = () => this._service.create(true);
  get is_admin() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemDetailsComponent, selectors: [["item-details"]], inputs: { type: [1, "type"], item: [1, "item"], can_edit: [1, "can_edit"], extra_actions: [1, "extra_actions"] }, outputs: { create: "create", edit: "edit", delete: "delete" }, decls: 41, vars: 28, consts: [["action_menu", "matMenu"], [1, "flex", "items-center", "justify-between", "px-4", "py-2"], [1, "flex", "flex-col", "space-y-2"], ["name", "", 1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], [1, "mono", "text-xs", "opacity-60", 3, "click"], [1, "rounded-xl", "bg-info", "px-2", "py-1", "text-xs", "text-info-content"], [1, "mono", "rounded-xl", "bg-info", "px-2", "py-1", "text-xs", "text-info-content"], [1, "rounded-xl", "bg-info", "px-2", "py-1", "text-xs", "uppercase", "text-info-content"], [1, "rounded-xl", "bg-error", "px-2", "py-1", "text-xs", "text-error-content", 3, "bg-success!", "text-success-content!"], [1, "rounded-xl", "bg-info", "px-2", "py-1", "text-xs", "text-info-content", 3, "matTooltip"], [1, "flex", "items-center", "space-x-2", "rounded-xl", "bg-success", "px-2", "py-1", "text-xs", "text-success-content"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], [1, "min-w-88"], ["mat-menu-item", "", 1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", "disabled", "true", 1, "flex", "items-center", "space-x-2", 3, "click"], [1, "text-2xl"], ["mat-menu-item", "", 1, "flex", "items-center", "space-x-2", 3, "click"], [1, "rounded-xl", "bg-error", "px-2", "py-1", "text-xs", "text-error-content"], [1, "text"], [1, "flex-1"], [1, "keycap"], [1, "text-2xl", "text-error"]], template: function ItemDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function ItemDetailsComponent_Template_a_click_5_listener() {
        \u0275\u0275restoreView(_r1);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemDetailsComponent, { className: "ItemDetailsComponent", filePath: "src/app/ui/item-details.component.ts", lineNumber: 196 });
})();
...
var ItemDetailsSkeletonComponent = class _ItemDetailsSkeletonComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemDetailsSkeletonComponent, selectors: [["item-details-skeleton"]], decls: 19, vars: 0, consts: [[1, "flex", "flex-col", "animate-pulse"], [1, "flex", "items-center", "justify-between", "px-4", "py-2"], [1, "flex", "flex-col", "space-y-2"], [1, "h-8", "w-48", "rounded-sm", "bg-base-300"], [1, "flex", "items-center", "space-x-2"], [1, "h-4", "w-32", "rounded-sm", "bg-base-300"], [1, "h-6", "w-16", "rounded-xl", "bg-base-300"], [1, "h-10", "w-10", "rounded-sm", "bg-base-300"], [1, "h-12", "w-full", "border-b", "border-base-300"], [1, "flex", "h-full", "items-center", "space-x-4", "px-4"], [1, "h-8", "w-24", "rounded-sm", "bg-base-300"], [1, "h-8", "w-28", "rounded-sm", "bg-base-300"], [1, "h-8", "w-20", "rounded-sm", "bg-base-300"], [1, "space-y-4", "p-4"], [1, "h-4", "w-3/4", "rounded-sm", "bg-base-300"], [1, "h-4", "w-1/2", "rounded-sm", "bg-base-300"], [1, "h-4", "w-2/3", "rounded-sm", "bg-base-300"], [1, "mt-6", "h-32", "w-full", "rounded-sm", "bg-base-300"]], template: function ItemDetailsSkeletonComponent_Template(rf, ctx) {
    if (rf & 1) {
  ...
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ItemDetailsSkeletonComponent, [{
    ...
    args: [{ selector: "item-details-skeleton", template: `
        <div class="flex flex-col animate-pulse">
            ...
            <div class="flex items-center justify-between px-4 py-2">
                <div class="flex flex-col space-y-2">
                    <div class="h-8 w-48 rounded-sm bg-base-300"></div>
                    <div class="flex items-center space-x-2">
                        <div class="h-4 w-32 rounded-sm bg-base-300"></div>
                        <div class="h-6 w-16 rounded-xl bg-base-300"></div>
                    </div>
                </div>
                <div class="h-10 w-10 rounded-sm bg-base-300"></div>
            </div>

            <!-- Tab list skeleton -->
            <div class="h-12 w-full border-b border-base-300">
                <div class="flex h-full items-center space-x-4 px-4">
                    <div class="h-8 w-24 rounded-sm bg-base-300"></div>
                    <div class="h-8 w-28 rounded-sm bg-base-300"></div>
                    <div class="h-8 w-20 rounded-sm bg-base-300"></div>
                    <div class="h-8 w-24 rounded-sm bg-base-300"></div>
                </div>
            </div>
            ...
            <div class="space-y-4 p-4">
                <div class="h-4 w-3/4 rounded-sm bg-base-300"></div>
                <div class="h-4 w-1/2 rounded-sm bg-base-300"></div>
                <div class="h-4 w-2/3 rounded-sm bg-base-300"></div>
                <div class="mt-6 h-32 w-full rounded-sm bg-base-300"></div>
            </div>
        </div>
    ` }]
  }], null, null);
...
function ItemSelectionComponent_Conditional_10_Conditional_15_a_1_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSelectionComponent_Conditional_10_Conditional_15_a_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 19);
    \u0275\u0275listener("click", function ItemSelectionComponent_Conditional_10_Conditional_15_a_1_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r4);
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ItemSelectionComponent_Conditional_10_Conditional_15_a_1_Conditional_3_Template, 3, 1, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r5 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("routerLink", ctx_r1.subroute() ? \u0275\u0275pureFunction3(3, _c4, ctx_r1.route(), item_r5.id, ctx_r1.subroute()) : \u0275\u0275pureFunction2(7, _c5, ctx_r1.route(), item_r5.id));
    \u0275\u0275advance(2);
...
function ItemSelectionComponent_Conditional_10_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "cdk-virtual-scroll-viewport", 16);
    \u0275\u0275listener("scroll", function ItemSelectionComponent_Conditional_10_Conditional_15_Template_cdk_virtual_scroll_viewport_scroll_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.is_scrolled.set(true));
    })("scrolledIndexChange", function ItemSelectionComponent_Conditional_10_Conditional_15_Template_cdk_virtual_scroll_viewport_scrolledIndexChange_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.atBottom());
    });
    \u0275\u0275template(1, ItemSelectionComponent_Conditional_10_Conditional_15_a_1_Template, 4, 10, "a", 17);
    \u0275\u0275pipe(2, "async");
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("cdkVirtualForOf", \u0275\u0275pipeBind1(2, 3, ctx_r1.items))("cdkVirtualForTrackBy", ctx_r1.trackByFn);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 5, "COMMON.END_OF_LIST"), " ");
  }
}
function ItemSelectionComponent_Conditional_10_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSelectionComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6);
    \u0275\u0275listener("click", function ItemSelectionComponent_Conditional_10_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.show.set(false));
    })("keydown.esc", function ItemSelectionComponent_Conditional_10_Template_div_keydown_esc_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.show.set(false));
    }, \u0275\u0275resolveWindow);
    ...
    \u0275\u0275listener("click", function ItemSelectionComponent_Conditional_10_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 8)(3, "icon", 9);
    \u0275\u0275text(4, " search ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ItemSelectionComponent_Conditional_10_Conditional_8_Template, 1, 0, "mat-spinner", 11);
    \u0275\u0275pipe(9, "async");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(15, ItemSelectionComponent_Conditional_10_Conditional_15_Template, 6, 7, "cdk-virtual-scroll-viewport", 14);
    \u0275\u0275pipe(16, "async");
    \u0275\u0275conditionalBranchCreate(17, ItemSelectionComponent_Conditional_10_Conditional_17_Template, 4, 6, "div", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_6_0;
    ...
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(7, 5, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction1(17, _c2, ctx_r1.title())));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(9, 8, ctx_r1.loading) ? 8 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(13, 12, "COMMON.TOTAL_ITEMS", \u0275\u0275pureFunction1(19, _c3, \u0275\u0275pipeBind1(12, 10, ctx_r1.total))), " ");
    \u0275\u0275advance(4);
    \u0275\u0275conditional(((tmp_6_0 = \u0275\u0275pipeBind1(16, 15, ctx_r1.items)) == null ? null : tmp_6_0.length) ? 15 : 17);
  }
}
var ItemSelectionComponent = class _ItemSelectionComponent extends AsyncHandler {
  ...
  is_scrolled = signal(false, ...ngDevMode ? [{ debugName: "is_scrolled" }] : []);
  last_total = 0;
  last_check = 0;
  search = "";
  ...
  ngOnInit() {
    ...
    this.subscription("route.events", () => this._router.events.subscribe(() => {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275ItemSelectionComponent_BaseFactory;
    return function ItemSelectionComponent_Factory(__ngFactoryType__) {
      return (\u0275ItemSelectionComponent_BaseFactory || (\u0275ItemSelectionComponent_BaseFactory = \u0275\u0275getInheritedFactory(_ItemSelectionComponent)))(__ngFactoryType__ || _ItemSelectionComponent);
    };
  })();
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemSelectionComponent, selectors: [["item-selection"]], viewQuery: function ItemSelectionComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx.viewport, CdkVirtualScrollViewport, 5);
      \u0275\u0275viewQuerySignal(ctx._input, _c02, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(2);
    }
  }, inputs: { show: [1, "show"], title: [1, "title"], route: [1, "route"] }, outputs: { show: "showChange" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], ngContentSelectors: _c1, decls: 11, vars: 7, consts: [["search_input", ""], [1, "flex", "w-full", "items-center", "justify-center", "border-b", "border-base-200", "p-2"], [1, "flex", "max-w-[calc(100vw-1rem)]", "flex-1", "items-center", "rounded-lg", "border", "border-base-200", "sm:max-w-[512px]", "sm:flex-auto", 3, "click"], [1, "ml-2", "text-2xl"], [1, "w-1/2", "flex-1", "p-2", "text-left", "text-lg", "opacity-30"], [1, "keycap", "mr-2", "text-xs"], [1, "bg-base-100/80", "/30", "absolute", "inset-0", 3, "click", "keydown.esc"], [1, "absolute", "left-1/2", "top-2", "flex", "w-[512px]", "max-w-[calc(100vw-1rem)]", "-translate-x-1/2", "flex-col", "space-y-2", "overflow-hidden", "rounded-sm", "bg-base-100", "shadow-sm", 3, "click"], [1, "relative", "flex", "items-center", "border-b", "border-base-200"], [1, "pointer-events-none", "absolute", "left-2", "top-1/2", "-translate-y-1/2", "text-2xl"], [1, "bg-transparent", "flex-1", "border-none", "py-4", "pl-10", "pr-4", 3, "ngModelChange", "ngModel", "placeholder"], ["diameter", "24", 1, "absolute", "right-2", "top-1/2", "mr-2", "-translate-y-1/2"], [1, "w-full", "px-4", "text-sm", "opacity-60"], [1, "flex", "h-1/2", "flex-1", "flex-col"], ["itemSize", "48", 1, "h-[768px]", "max-h-[75vh]"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], ["itemSize", "48", 1, "h-[768px]", "max-h-[75vh]", 3, "scroll", "scrolledIndexChange"], ["routerLinkActive", "active", "class", "m-2 block max-w-[calc(100vw-2rem)] rounded-sm p-2", 3, "routerLink", "click", 4, "cdkVirtualFor", "cdkVirtualForOf", "cdkVirtualForTrackBy"], [1, "bg-base-200", "p-2", "text-center", "text-sm", "opacity-30"], ["routerLinkActive", "active", 1, "m-2", "block", "max-w-[calc(100vw-2rem)]", "rounded-sm", "p-2", 3, "click", "routerLink"], [1, "flex-1", "truncate"], [1, "inline-block", "w-full", "overflow-hidden"], ["extra", "", 1, "mono", "bg-base-content/10", "/5", "mt-1", "max-w-full", "truncate", "rounded-sm", "px-2", "py-1", "text-xs", "opacity-60"]], template: function ItemSelectionComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      ...
      \u0275\u0275text(9, "K");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(10, ItemSelectionComponent_Conditional_10_Template, 18, 21);
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ItemSelectionComponent, [{
    ...
    `, imports: [
      ...
      MatProgressSpinnerModule,
      FormsModule
    ], styles: ["/* angular:styles/component:css;ca5d06d480aec17e3e6cb2d83e77f82639fdfcf6dca76a8f4670c19af10f7466;/home/runner/work/backoffice/backoffice/src/app/ui/item-selection.component.ts */\na:nth-child(2n) {\n  background-color: rgba(0, 0, 0, 0.04);\n}\na:hover {\n  background-color: rgba(0, 0, 0, 0.2);\n}\na.active {\n  background-color: var(--secondary);\n  color: #fff;\n}\n/*# sourceMappingURL=item-selection.component.css.map */\n"] }]
  }], null, { show: [{ type: Input, args: [{ isSignal: true, alias: "show", required: false }] }, { type: Output, args: ["showChange"] }], title: [{ type: Input, args: [{ isSignal: true, alias: "title", required: false }] }], route: [{ type: Input, args: [{ isSignal: true, alias: "route", required: false }] }], viewport: [{ type: ViewChild, args: [forwardRef(() => CdkVirtualScrollViewport), { isSignal: true }] }], _input: [{ type: ViewChild, args: ["search_input", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSelectionComponent, { className: "ItemSelectionComponent", filePath: "src/app/ui/item-selection.component.ts", lineNumber: 178 });
})();

// src/app/ui/virtual-scroll.component.ts
var _c03 = ["scroll_container"];
var _c12 = ["*"];
...
function VirtualScrollComponent_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", ctx_r3.item_template())("ngTemplateOutletContext", \u0275\u0275pureFunction2(4, _c22, item_r2, ctx_r3.offset_start() + \u0275$index_5_r3));
  }
}
var VirtualScrollComponent = class _VirtualScrollComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VirtualScrollComponent, selectors: [["virtual-scroll"]], viewQuery: function VirtualScrollComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._scroll_container_el, _c03, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance();
    }
  }, inputs: { items: [1, "items"], item_size: [1, "item_size"], item_template: [1, "item_template"], buffer: [1, "buffer"] }, outputs: { scrolled: "scrolled" }, ngContentSelectors: _c12, decls: 7, vars: 6, consts: [["scroll_container", ""], [1, "relative", "h-full", "w-full", "overflow-auto", 3, "resize", "scroll"], ["scroll-fill", "", 1, "w-full"], [1, "absolute", "w-full", 3, "top"], [1, "absolute", "w-full"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"]], template: function VirtualScrollComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275projectionDef();
      \u0275\u0275elementStart(0, "div", 1, 0);
      \u0275\u0275listener("resize", function VirtualScrollComponent_Template_div_resize_0_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.updateContainer());
      }, \u0275\u0275resolveWindow)("scroll", function VirtualScrollComponent_Template_div_scroll_0_listener() {
        \u0275\u0275restoreView(_r1);
...
function ItemSidebarComponent_Conditional_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 1, ctx_r2.search ? "COMMON.SEARCH_EMPTY" : "COMMON.LIST_EMPTY", \u0275\u0275pureFunction1(4, _c13, ctx_r2.title())), " ");
  }
}
var ItemSidebarComponent = class _ItemSidebarComponent extends AsyncHandler {
  ...
  subroute = signal("", ...ngDevMode ? [{ debugName: "subroute" }] : []);
  ngOnInit() {
    this.subscription("route_change", this._router.events.subscribe((e) => {
  ...
  _processItems(list) {
    for (const item of list) {
      if (item instanceof Mr) {
        ...
        const detail = item.role === $t.Service ? item.uri : item.role === $t.Logic ? name ? `${name} | ${item.control_system_id} ` : item.control_system_id : item.ip;
        item.display_name = item.custom_name || item.name || "<Unnamed>";
        item.extra = detail;
      } else if (item instanceof Wo) {
        item.display_name = item.name || "<Unnamed>";
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275ItemSidebarComponent_BaseFactory;
    return function ItemSidebarComponent_Factory(__ngFactoryType__) {
      return (\u0275ItemSidebarComponent_BaseFactory || (\u0275ItemSidebarComponent_BaseFactory = \u0275\u0275getInheritedFactory(_ItemSidebarComponent)))(__ngFactoryType__ || _ItemSidebarComponent);
    };
  })();
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemSidebarComponent, selectors: [["item-sidebar"]], viewQuery: function ItemSidebarComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._input, _c04, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance();
    }
  }, inputs: { title: [1, "title"], route: [1, "route"], filter_options: [1, "filter_options"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 20, vars: 23, consts: [["search_input", ""], ["item_display", ""], [1, "flex", "h-full", "w-[24rem]", "min-w-64", "max-w-[25vw]", "flex-col", "space-y-2", "overflow-hidden", "rounded-sm", "border-base-200", "bg-base-100", "shadow-sm", "sm:border-r", 3, "click"], [1, "flex", "items-center", "space-x-2", "px-1", "pt-1"], [1, "relative", "flex", "flex-1", "items-center", "rounded-lg", "border", "border-base-300", "shadow-sm"], [1, "pointer-events-none", "absolute", "left-1", "top-1/2", "-translate-y-1/2", "text-2xl"], [1, "bg-transparent", "w-full", "flex-1", "rounded-lg", "border-none", "py-2.5", "pl-9", "pr-4", 3, "ngModelChange", "ngModel", "placeholder"], ["diameter", "24", 1, "absolute", "right-2", "top-1/2", "mr-2", "-translate-y-1/2"], [1, "relative", "flex", "overflow-hidden"], [1, "w-full", "px-2", "text-sm", "opacity-60"], [1, "flex", "h-1/2", "flex-1", "flex-col", "border-t", "border-base-200"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], ["icon", "", "matRipple", ""], [1, "text-2xl"], ["appearance", "outline", 1, "no-subscript", "absolute", "-right-2", "top-1/2", "-translate-y-1/2", "opacity-0"], ["multiple", "", 3, "ngModelChange", "ngModel"], [1, "capitalize", 3, "value"], [3, "scrolled", "item_size", "items", "item_template"], [1, "bg-base-200", "p-2", "text-center", "text-sm", "opacity-30"], ["routerLinkActive", "active", 1, "relative", "m-1", "flex", "h-16", "w-92", "max-w-[calc(100%-0.5rem)]", "flex-col", "justify-center", "rounded-sm", "border", "border-base-100", "px-2", "py-1", "hover:border-info", 3, "click", "routerLink", "matTooltip"], [1, "w-full", "truncate"], [1, "flex", "w-full"], ["extra", "", 1, "mono", "mt-1", "max-w-full", "truncate", "rounded-sm", "border", "border-base-300", "p-1", "text-[0.625rem]", "opacity-60"], [1, "absolute", "-right-1", "-top-1", "rotate-12", "text-2xl", "text-info"], [1, "absolute", "-right-1", "-top-1", "flex", "h-8", "w-8", "rotate-12", "items-center", "justify-center", "rounded-full", "bg-warning", "text-2xl", "text-warning-content", 3, "matTooltip"], [1, "absolute", "-right-1", "-top-1", "flex", "h-8", "w-8", "rotate-12", "items-center", "justify-center", "rounded-full", "bg-error", "text-2xl", "text-error-content", 3, "matTooltip"]], template: function ItemSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(7, 6, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction1(19, _c13, ctx.title())));
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(15, 13, "COMMON.TOTAL_ITEMS", \u0275\u0275pureFunction1(21, _c23, t_r10), t_r10), " ");
      \u0275\u0275advance(3);
...
(() => {
  ...
  }], null, { title: [{ type: Input, args: [{ isSignal: true, alias: "title", required: false }] }], route: [{ type: Input, args: [{ isSignal: true, alias: "route", required: false }] }], filter_options: [{ type: Input, args: [{ isSignal: true, alias: "filter_options", required: false }] }], _input: [{ type: ViewChild, args: ["search_input", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSidebarComponent, { className: "ItemSidebarComponent", filePath: "src/app/ui/item-sidebar.component.ts", lineNumber: 227 });
})();
...
function ItemTablistComponent_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", "/" + ctx_r2.base() + "/" + ctx_r2.item_id() + "/" + link_r1.id)("queryParams", link_r1.query || \u0275\u0275pureFunction0(6, _c05))("active", rla_r2.isActive);
    \u0275\u0275advance(2);
...
var ItemTablistComponent = class _ItemTablistComponent extends AsyncHandler {
  ...
  ngOnInit() {
    this.subscription("route.params", this._router.events.subscribe((event) => {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275ItemTablistComponent_BaseFactory;
    return function ItemTablistComponent_Factory(__ngFactoryType__) {
      return (\u0275ItemTablistComponent_BaseFactory || (\u0275ItemTablistComponent_BaseFactory = \u0275\u0275getInheritedFactory(_ItemTablistComponent)))(__ngFactoryType__ || _ItemTablistComponent);
    };
  })();
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemTablistComponent, selectors: [["item-tablist"]], inputs: { base: [1, "base"], item_id: [1, "item_id"], tabs: [1, "tabs"], scrolled: [1, "scrolled"] }, outputs: { item_id: "item_idChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 7, vars: 3, consts: [["tabPanel", ""], ["rla", "routerLinkActive"], [1, "h-12", "w-full", "border-b", "border-base-300"], [1, "h-14", "w-full", "overflow-hidden"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", "routerLinkActive", "", 1, "tab", 3, "routerLink", "queryParams", "active"], [1, "hidden"], [1, "text-xl", 3, "icon"], [1, "name"], [1, "mono", "flex", "h-5", "min-w-5", "items-center", "justify-center", "rounded-full", "bg-base-200", "px-1.5", "text-[0.625rem]"]], template: function ItemTablistComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "nav", 4);
      \u0275\u0275repeaterCreate(3, ItemTablistComponent_For_4_Template, 7, 7, "a", 5, _forTrack03);
      \u0275\u0275elementEnd()()();
...
(() => {
  ...
  }], null, { base: [{ type: Input, args: [{ isSignal: true, alias: "base", required: false }] }], item_id: [{ type: Input, args: [{ isSignal: true, alias: "item_id", required: false }] }, { type: Output, args: ["item_idChange"] }], tabs: [{ type: Input, args: [{ isSignal: true, alias: "tabs", required: false }] }], scrolled: [{ type: Input, args: [{ isSignal: true, alias: "scrolled", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemTablistComponent, { className: "ItemTablistComponent", filePath: "src/app/ui/item-tablist.component.ts", lineNumber: 59 });
})();
...
//# sourceMappingURL=chunk-TOJMLFOB.js.map
