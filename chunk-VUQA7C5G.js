...
function generateBrokerFormModel(broker = {}) {
  const auth_type = broker.auth_type ?? Ki.NoAuth;
  return {
    name: broker.name || "",
...
var applyBrokerFormSchema = (path) => {
  ...
  required(path.username, {
    when({ valueOf }) {
      return valueOf(path.auth_type) === Ki.UserPassword;
    }
  });
  ...
  required(path.certificate, {
    when({ valueOf }) {
      return valueOf(path.auth_type) === Ki.Certificate;
    }
  });
};
...
var BrokerFormComponent = class _BrokerFormComponent extends AsyncHandler {
  ...
  async submit() {
    await submit(this.form, async () => {
      ...
      const result = await (form_item.id ? Co(form_item.id, form_item) : wo(form_item)).catch(async (err) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BrokerFormComponent, { className: "BrokerFormComponent", filePath: "src/app/admin/broker-form.component.ts", lineNumber: 359 });
})();
...
function AdminBrokersComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminBrokersComponent_ng_template_24_Case_1_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminBrokersComponent_ng_template_24_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function AdminBrokersComponent_ng_template_24_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function AdminBrokersComponent_ng_template_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, AdminBrokersComponent_ng_template_24_Case_1_Template, 3, 3, "span")(2, AdminBrokersComponent_ng_template_24_Case_2_Template, 3, 3, "span")(3, AdminBrokersComponent_ng_template_24_Case_3_Template, 3, 3, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_7_0;
...
function AdminBrokersComponent_ng_template_26_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15)(1, "icon", 17);
    \u0275\u0275text(2, "lock");
    \u0275\u0275elementEnd()();
  }
}
function AdminBrokersComponent_ng_template_26_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminBrokersComponent_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, AdminBrokersComponent_ng_template_26_Conditional_0_Template, 3, 0, "div", 15);
    \u0275\u0275conditionalCreate(1, AdminBrokersComponent_ng_template_26_Conditional_1_Template, 3, 0, "div", 16);
  }
  if (rf & 2) {
...
function AdminBrokersComponent_ng_template_28_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminBrokersComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275conditionalCreate(1, AdminBrokersComponent_ng_template_28_Conditional_1_Template, 3, 3, "code");
    \u0275\u0275conditionalCreate(2, AdminBrokersComponent_ng_template_28_Conditional_2_Template, 3, 3, "span", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminBrokersComponent_ng_template_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function AdminBrokersComponent_ng_template_30_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function AdminBrokersComponent_ng_template_30_Template_button_click_5_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r6 = \u0275\u0275nextContext();
...
var AdminBrokersComponent = class _AdminBrokersComponent extends AsyncHandler {
  ...
  async deleteBroker(item) {
    if (item) {
      ...
      const err = await No(item.id).catch((_) => _);
      details.close();
      if (err)
  ...
  async loadBrokers() {
    ...
    const brokers = await Mo().then((r) => r.data);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminBrokersComponent, selectors: [["app-brokers"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 32, vars: 61, consts: [["mono_template", ""], ["auth_type_template", ""], ["tls_template", ""], ["filters_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["icon", "", "default", "", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-5xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "p-4", "font-mono", "text-sm"], [1, "p-4"], [1, "bg-success", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "bg-error", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "text-success-content", "text-xl"], [1, "text-error-content", "text-xl"], [1, "text-xs", "opacity-30"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AdminBrokersComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(21, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(22, AdminBrokersComponent_ng_template_22_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(24, AdminBrokersComponent_ng_template_24_Template, 4, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(26, AdminBrokersComponent_ng_template_26_Template, 2, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(28, AdminBrokersComponent_ng_template_28_Template, 3, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(30, AdminBrokersComponent_ng_template_30_Template, 9, 6, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const mono_template_r8 = \u0275\u0275reference(23);
      const auth_type_template_r9 = \u0275\u0275reference(25);
      const tls_template_r10 = \u0275\u0275reference(27);
      const filters_template_r11 = \u0275\u0275reference(29);
      const actions_template_r12 = \u0275\u0275reference(31);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 9, "ADMIN.BROKERS_HEADER"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(7, 11, "ADMIN.BROKERS_ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(8, 13, "ADMIN.BROKERS_ADD"));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.brokers())("columns", \u0275\u0275pureFunction8(52, _c8, \u0275\u0275pureFunction1(31, _c02, \u0275\u0275pipeBind1(14, 15, "COMMON.FIELD_NAME")), \u0275\u0275pureFunction2(33, _c1, \u0275\u0275pipeBind1(15, 17, "ADMIN.BROKERS_FIELD_AUTH_TYPE"), auth_type_template_r9), \u0275\u0275pureFunction1(36, _c2, \u0275\u0275pipeBind1(16, 19, "COMMON.FIELD_DESCRIPTION")), \u0275\u0275pureFunction2(38, _c3, \u0275\u0275pipeBind1(17, 21, "ADMIN.BROKERS_FIELD_HOST"), mono_template_r8), \u0275\u0275pureFunction2(41, _c4, \u0275\u0275pipeBind1(18, 23, "ADMIN.BROKERS_FIELD_PORT"), mono_template_r8), \u0275\u0275pureFunction2(44, _c5, \u0275\u0275pipeBind1(19, 25, "ADMIN.BROKERS_FIELD_TLS"), tls_template_r10), \u0275\u0275pureFunction2(47, _c6, \u0275\u0275pipeBind1(20, 27, "ADMIN.BROKERS_FIELD_FILTERS"), filters_template_r11), \u0275\u0275pureFunction1(50, _c7, actions_template_r12)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(21, 29, "ADMIN.BROKER_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminBrokersComponent, { className: "AdminBrokersComponent", filePath: "src/app/admin/brokers.component.ts", lineNumber: 195 });
})();
export {
  AdminBrokersComponent
};
//# sourceMappingURL=chunk-VUQA7C5G.js.map
