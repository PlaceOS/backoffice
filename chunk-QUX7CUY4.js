...
var ApplicationPickerTooltipComponent = class _ApplicationPickerTooltipComponent {
  ...
  total_pages = computed(() => Math.max(1, Math.ceil(this.applications().length / PAGE_SIZE)), ...ngDevMode ? [{ debugName: "total_pages" }] : []);
  ...
  async ngOnInit() {
    const active_authority = Dt();
    if (!active_authority?.id) {
      this.loading.set(false);
      return;
    }
    const response = await lastValueFrom(zu({ authority_id: active_authority.id })).catch(() => null);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ApplicationPickerTooltipComponent, [{
    ...
    `, imports: [CommonModule, MatRippleModule], styles: ["/* angular:styles/component:css;2c172394bef6e559507a4db92550c1c9265ffcb6660d2ee03e01d8ae03e8b930;/home/runner/work/backoffice/backoffice/src/app/ui/application-picker-tooltip.component.ts */\n[app-name] {\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  -webkit-line-clamp: 2;\n  overflow: hidden;\n  line-height: 1.25rem;\n  max-height: 2.5rem;\n  word-break: break-word;\n}\n/*# sourceMappingURL=application-picker-tooltip.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApplicationPickerTooltipComponent, { className: "ApplicationPickerTooltipComponent", filePath: "src/app/ui/application-picker-tooltip.component.ts", lineNumber: 121 });
})();
...
function SidebarMenuComponent_For_10_Conditional_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, SidebarMenuComponent_For_10_Conditional_0_Conditional_1_Conditional_8_Template, 1, 0, "span", 19);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const link_r1 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(17, _c13, link_r1.route))("matTooltip", ctx_r1.compact() ? \u0275\u0275pipeBind1(1, 13, link_r1.name) : "");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("sm:justify-center", ctx_r1.compact());
    \u0275\u0275advance();
    \u0275\u0275classProp("sm:text-2xl", ctx_r1.compact())("sm:mx-auto", ctx_r1.compact());
    ...
    \u0275\u0275classProp("sm:hidden", ctx_r1.compact());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 15, link_r1.name), " ");
    \u0275\u0275advance(2);
...
function SidebarMenuComponent_For_10_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SidebarMenuComponent_For_10_Conditional_0_Conditional_0_Template, 8, 16, "a", 15)(1, SidebarMenuComponent_For_10_Conditional_0_Conditional_1_Template, 9, 19, "a", 16);
  }
  if (rf & 2) {
...
var SidebarMenuComponent = class _SidebarMenuComponent extends AsyncHandler {
  ...
  show_application_picker = signal(false, ...ngDevMode ? [{ debugName: "show_application_picker" }] : []);
  ...
  get alerts_url() {
    return Dt()?.config?.backoffice?.alerts_url;
  }
  get metrics_url() {
    return Dt()?.config?.backoffice?.metrics_url;
  }
  close = () => this._tooltip?.close();
  toggleCompactMode() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarMenuComponent, selectors: [["sidebar-menu"]], inputs: { open: [1, "open"] }, outputs: { open: "openChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 27, vars: 30, consts: [["sidebar-menu", "", 1, "bg-base-200", "pointer-events-none", "absolute", "inset-0", "z-40", "hidden", "h-full", "flex-col", "justify-between", "sm:pointer-events-auto", "sm:relative", "sm:inset-auto", "sm:z-10", "sm:flex", 3, "click"], [1, "flex", "h-1/2", "flex-1", "flex-col", "items-center", "space-y-2"], [1, "font-heading", "mt-4", "ml-16", "text-4xl", "sm:mb-2", "sm:ml-0", 3, "routerLink"], [1, "font-heading", "text-primary"], ["src", "assets/icon/mstile-310x310.png", "alt", "PlaceOS logo", 1, "hidden", "h-12", "w-12"], [1, "w-full", "flex-1", "space-y-2", "overflow-auto", "pb-2"], ["icon", "", "matRipple", "", 1, "absolute", "top-1", "left-1", "sm:hidden", 3, "click"], ["btn", "", "link", "", "matRipple", "", "customTooltip", "", "matTooltipPosition", "right", "yPosition", "bottom", 1, "clear", "hover:bg-base-100", "mx-auto", "mb-2", "w-[calc(100%-1rem)]", "text-left", 3, "content", "matTooltip"], [3, "compact"], ["matRipple", "", "customTooltip", "", "user", "", "yPosition", "bottom", "xPosition", "start", 1, "border-base-300", "flex", "min-h-16", "items-center", "space-x-2", "border-t", "p-2", "text-left", 3, "content"], ["matTooltipPosition", "right", 3, "user", "matTooltip"], [1, "flex", "w-1/2", "flex-1", "flex-col", "leading-tight"], [1, "w-full", "truncate"], [1, "w-full", "truncate", "text-xs", "opacity-30"], ["icon", "", "matRipple", "", 1, "border-base-200", "bg-base-100", "hover:bg-base-200", "absolute", "right-0", "bottom-12", "z-999", "hidden", "h-6", "w-6", "min-w-6", "translate-x-1/2", "rounded-full", "border", "shadow-sm", "sm:flex", 3, "click"], ["btn", "", "link", "", "matRipple", "", "target", "_blank", "rel", "noopener noreferrer", "matTooltipPosition", "right", 1, "clear", "hover:bg-base-100", "mx-auto", "w-[calc(100%-1rem)]", "text-left", 3, "href", "matTooltip"], ["btn", "", "link", "", "matRipple", "", "routerLinkActive", "bg-secondary! text-secondary-content", "matTooltipPosition", "right", 1, "clear", "hover:bg-base-100", "relative", "mx-auto", "w-[calc(100%-1rem)]", "text-left", 3, "routerLink", "matTooltip"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "text-xl"], ["role", "status", "aria-label", "Loading page", 1, "ml-auto", "h-4", "w-4", "animate-spin", "rounded-full", "border-2", "border-current/30", "border-t-current", "sm:absolute", "sm:right-3", "sm:ml-0"]], template: function SidebarMenuComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 27, (ctx.user == null ? null : ctx.user.sys_admin) ? "COMMON.USER_ADMIN" : (ctx.user == null ? null : ctx.user.support) ? "COMMON.USER_SUPPORT" : "COMMON.USER_BASIC"), " ");
      \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarMenuComponent, { className: "SidebarMenuComponent", filePath: "src/app/ui/sidebar-menu.component.ts", lineNumber: 241 });
})();
...
//# sourceMappingURL=chunk-QUX7CUY4.js.map
