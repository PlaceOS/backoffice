...
function SystemTriggerFormComponent_Conditional_1_Conditional_4_For_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 16)(1, "div", 18)(2, "div", 19);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275listener("click", function SystemTriggerFormComponent_Conditional_1_Conditional_4_For_8_Template_button_click_6_listener() {
      const id_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.removePlaylist(id_r4));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r0.playlist_names()[id_r4] || id_r4, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", id_r4, " ");
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(7, 3, "SYSTEMS.PLAYLIST_REMOVE"));
  }
}
function SystemTriggerFormComponent_Conditional_1_Conditional_4_ForEmpty_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "SYSTEMS.PLAYLISTS_EMPTY"), " ");
  }
}
function SystemTriggerFormComponent_Conditional_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "item-search-field", 14);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275listener("ngModelChange", function SystemTriggerFormComponent_Conditional_1_Conditional_4_Template_item_search_field_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275repeaterCreate(7, SystemTriggerFormComponent_Conditional_1_Conditional_4_For_8_Template, 10, 5, "div", 16, \u0275\u0275repeaterTrackByIdentity, false, SystemTriggerFormComponent_Conditional_1_Conditional_4_ForEmpty_9_Template, 3, 3, "p", 17);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 8, "SYSTEMS.PLAYLISTS"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(5, 10, "SYSTEMS.PLAYLISTS_SEARCH"))("query_fn", ctx_r0.query_fn)("exclude", ctx_r0.exclude_fn)("clear_on_select", true)("ngModel", null)("ngModelOptions", \u0275\u0275pureFunction0(12, _c0));
    \u0275\u0275control();
    \u0275\u0275advance(3);
...
function SystemTriggerFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, SystemTriggerFormComponent_Conditional_1_Conditional_2_Template, 6, 4, "div", 3);
    \u0275\u0275conditionalCreate(3, SystemTriggerFormComponent_Conditional_1_Conditional_3_Template, 8, 14, "div", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, SystemTriggerFormComponent_Conditional_1_Conditional_4_Template, 10, 13, "div", 5);
    \u0275\u0275elementStart(5, "div", 6);
    \u0275\u0275element(6, "settings-toggle", 7);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275element(8, "settings-toggle", 7);
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275element(10, "settings-toggle", 7);
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
...
var SystemTriggerFormComponent = class _SystemTriggerFormComponent extends AsyncHandler {
  ...
  playlist_names = signal(
    {},
    ...ngDevMode ? [{ debugName: "playlist_names" }] : (
      /* istanbul ignore next */
      []
    )
  );
  query_fn = (q) => Gh({ q, limit: 20 }).then((resp) => resp.data);
  exclude_fn = (playlist) => this.formModel().playlists.includes(playlist.id);
  /** Add the selected playlist from the search field to the trigger */
  addPlaylist = (playlist) => {
    if (!playlist?.id)
      return;
    this.playlist_names.update((names) => __spreadProps(__spreadValues({}, names), {
      [playlist.id]: playlist.name
    }));
    this.formModel.update((model) => model.playlists.includes(playlist.id) ? model : __spreadProps(__spreadValues({}, model), { playlists: [...model.playlists, playlist.id] }));
  };
  removePlaylist = (id) => this.formModel.update((model) => __spreadProps(__spreadValues({}, model), {
  ...
  async _loadPlaylistNames() {
    const playlists = await Promise.all(this.formModel().playlists.map((id) => Bh(id).catch(() => null)));
    const names = {};
    for (const playlist of playlists) {
      if (playlist?.id)
        names[playlist.id] = playlist.name;
    }
    this.playlist_names.update((current) => __spreadValues(__spreadValues({}, names), current));
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SystemTriggerFormComponent, selectors: [["system-trigger-form"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 3, consts: [[3, "save", "heading", "loading"], ["system-trigger", "", 1, "flex", "flex-col"], [1, "mb-4", "flex", "space-x-4"], [1, "border-base-300", "relative", "flex", "flex-1", "items-center", "rounded-sm", "border", "p-4"], [1, "border-base-300", "relative", "flex-1", "rounded-sm", "border", "p-4"], [1, "mb-4", "flex", "flex-col"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], [1, "m-2", "max-w-[calc(50%-1rem)]", "min-w-[40%]", "flex-1", 3, "label", "formField"], [1, "truncation", "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "p-2", "text-xs"], [1, "text-xl"], [1, "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "p-2", "text-xs"], [1, "flex"], [1, "rounded-full", "px-4", "py-2", "text-sm"], ["for", "playlists"], ["name", "playlists", 3, "ngModelChange", "placeholder", "query_fn", "exclude", "clear_on_select", "ngModel", "ngModelOptions"], [1, "border-base-300", "divide-base-300", "divide-y", "rounded-sm", "border"], ["playlist", "", 1, "flex", "items-center", "gap-2", "py-1", "pr-1", "pl-4"], [1, "p-4", "text-center", "text-sm", "opacity-30"], [1, "min-w-0", "flex-1"], [1, "truncate"], [1, "truncate", "text-xs", "opacity-30"], ["icon", "", "matRipple", "", "type", "button", 3, "click"]], template: function SystemTriggerFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
      \u0275\u0275listener("save", function SystemTriggerFormComponent_Template_fullscreen_modal_shell_save_0_listener() {
        return ctx.submit();
      });
      \u0275\u0275conditionalCreate(1, SystemTriggerFormComponent_Conditional_1_Template, 12, 15, "form", 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemTriggerFormComponent, { className: "SystemTriggerFormComponent", filePath: "src/app/systems/system-trigger-form.component.ts", lineNumber: 193 });
})();
...
var SystemStateService = class _SystemStateService extends AsyncHandler {
  ...
  _associated_settings = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_associated_settings" } : (
    ...
    loader: async ({ params }) => {
      ...
      if (!(item instanceof Rs))
        return [];
      return isSubsystemUser() ? la({ parent_id: item.id }).then((response) => response.data).catch(() => []) : wa(item.id).catch(() => []);
    }
  }));
    ...
    loader: async ({ params }) => {
      ...
      try {
        const [triggers, metadata] = await Promise.all([
          Ma(item.id).then((response) => response.total).catch(() => 0),
          nc(item.id).then((response) => response.length).catch(() => 0)
        ]);
        return {
    ...
    loader: async ({ params }) => {
      ...
      try {
        const response = isSubsystemUser() ? {
          data: await Promise.all(item.zones.map((id) => ah(id)))
        } : await Ea(item.id).catch(() => ({
          data: []
        }));
  ...
  _triggers = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_triggers" } : (
    ...
    loader: async ({ params }) => {
      ...
      try {
        const response = await Ma(item.id).catch(() => ({
          data: []
        }));
  ...
  async startSystem() {
    ...
    const error = await xa(this.active_item.id).then(() => null).catch((err) => {
  ...
  async stopSystem() {
    ...
    const error = await qa(this.active_item.id).then(() => null).catch((err) => {
  ...
  async newModule() {
    const mod = await this._state.edit(new Is({
  ...
  async addModuleToSystem(device) {
    ...
    const ref = this._dialog.open(SelectItemModalComponent, {
      data: {
        ...
        query_fn: (_) => querySupportSystems({ q: _ }).then((resp) => resp.data.filter((_2) => _2.id !== item.id))
      }
    });
    ...
    if (!system)
      return ref.close();
    await Sa(system.id, device.id).catch((_e) => {
      ref.close();
  ...
  async selectTrigger() {
    const ref = this._dialog.open(SelectItemModalComponent, {
      data: {
        ...
        query_fn: (_) => Fa({ q: _ }).then((resp) => resp.data)
      }
    });
    const details = await Promise.race([
      waitForEvent(ref.componentInstance.event, (_) => _.reason === "action"),
  ...
  async addTrigger(trigger) {
    const t = await Oa(this.active_item.id, {
      control_system_id: this.active_item.id,
      enabled: true,
      important: false,
  ...
  async editTrigger(trigger) {
    if (this.item() && trigger) {
      ...
      const trig = await ce(url, details.metadata).catch((err) => {
  ...
  async removeTrigger(trigger) {
    ...
    if (!details?.reason)
      return;
    await Ca(this.active_item.id, trigger.id).catch((err) => {
      details.close();
  ...
  async reorderModules(fst, snd) {
    ...
    const resp = await $a(this.active_item.id, __spreadProps(__spreadValues({}, this.active_item), {
      modules: list
    })).catch((err) => {
  ...
  async removeModule(device) {
    ...
    if (!details?.reason)
      return;
    const system = await Aa(this.active_item.id, device.id).catch((err) => {
  ...
  async addZones(zone_list) {
    ...
    const system = await $a(this.active_item.id, __spreadProps(__spreadValues({}, this.active_item), {
      zones
    })).catch((err) => {
  ...
  async toggleModulePower(device) {
    const method = device.running ? gc : mc;
...
//# sourceMappingURL=chunk-LH4XCXDK.js.map
