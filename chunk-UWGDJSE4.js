...
async function querySignageAIProviders(params = {}) {
  const list = await f(`${PATH()}/providers${search(params)}`);
...
async function saveSignageAIProvider(item) {
  ...
  const result = id ? await te(`${PATH()}/providers/${encodeURIComponent(id)}`, body) : await v(`${PATH()}/providers`, body);
  return new SignageAIProvider(result);
}
function removeSignageAIProvider(id) {
  return V(`${PATH()}/providers/${encodeURIComponent(id)}`);
}
function testSignageAIProvider(id) {
  return v(`${PATH()}/providers/${encodeURIComponent(id)}/test`, {});
}
function signageAIUsage(params = {}) {
  return f(`${PATH()}/usage${search(params)}`);
}
...
function SignageAIComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageAIComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SignageAIComponent_ng_template_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "code");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function SignageAIComponent_ng_template_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "div", 25)(2, "icon", 8);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function SignageAIComponent_ng_template_52_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 26)(1, "button", 27);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function SignageAIComponent_ng_template_52_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function SignageAIComponent_ng_template_52_Template_button_click_5_listener() {
      const row_r8 = \u0275\u0275restoreView(_r7).row;
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("click", function SignageAIComponent_ng_template_52_Template_button_click_9_listener() {
      const row_r8 = \u0275\u0275restoreView(_r7).row;
      const ctx_r0 = \u0275\u0275nextContext();
...
var SignageAIComponent = class _SignageAIComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageAIComponent, selectors: [["app-signage-ai"]], decls: 54, vars: 108, consts: [["name_template", ""], ["code_template", ""], ["plain_template", ""], ["date_from_template", ""], ["bool_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "text-sm", "opacity-60"], [1, "flex", "items-center", "space-x-2"], ["icon", "", "default", "", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"], [1, "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "text-error/60", "bg-base-200", "w-full", "rounded-lg", "p-8", "text-center"], [1, "-mx-4", "overflow-x-auto", "px-4"], [1, "block", "w-max", "min-w-full", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "mt-8", "mb-2", "text-xl"], [1, "mb-2", "text-sm", "opacity-60"], [1, "-mx-4", "mb-8", "overflow-x-auto", "px-4"], [1, "block", "w-max", "min-w-full", "text-sm", 3, "data", "columns", "empty_message"], [1, "flex", "flex-col", "px-4", "py-2"], [1, "text-xs", "opacity-30"], [1, "p-4"], [1, "flex", "h-full", "w-full", "items-center", "justify-center"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function SignageAIComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(17, SignageAIComponent_Conditional_17_Template, 2, 1, "div", 14);
      \u0275\u0275elementStart(18, "div", 15);
      \u0275\u0275element(19, "simple-table", 16);
      \u0275\u0275pipe(20, "translate");
      \u0275\u0275pipe(21, "translate");
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275pipe(23, "translate");
      ...
      \u0275\u0275pipe(32, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(33, SignageAIComponent_Conditional_33_Template, 2, 1, "div", 14);
      \u0275\u0275elementStart(34, "div", 19);
      \u0275\u0275element(35, "simple-table", 20);
      \u0275\u0275pipe(36, "translate");
      \u0275\u0275pipe(37, "translate");
      \u0275\u0275pipe(38, "translate");
      \u0275\u0275pipe(39, "translate");
      ...
      \u0275\u0275pipe(41, "translate");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(42, SignageAIComponent_ng_template_42_Template, 5, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(44, SignageAIComponent_ng_template_44_Template, 3, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(46, SignageAIComponent_ng_template_46_Template, 2, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(48, SignageAIComponent_ng_template_48_Template, 3, 3, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(50, SignageAIComponent_ng_template_50_Template, 4, 9, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(52, SignageAIComponent_ng_template_52_Template, 13, 10, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const name_template_r9 = \u0275\u0275reference(43);
      const code_template_r10 = \u0275\u0275reference(45);
      const plain_template_r11 = \u0275\u0275reference(47);
      const date_from_template_r12 = \u0275\u0275reference(49);
      const bool_template_r13 = \u0275\u0275reference(51);
      const actions_template_r14 = \u0275\u0275reference(53);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 21, "ADMIN.AI_PROVIDERS_HEADER"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 23, "ADMIN.AI_PROVIDERS_SCOPE"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(11, 25, "ADMIN.AI_PROVIDER_ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(12, 27, "ADMIN.AI_PROVIDER_ADD"));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.provider_error() ? 17 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275classProp("hidden", ctx.provider_error());
      \u0275\u0275property("data", ctx.provider_list())("columns", \u0275\u0275pureFunction7(79, _c7, \u0275\u0275pureFunction2(59, _c0, \u0275\u0275pipeBind1(20, 29, "ADMIN.AI_PROVIDER_NAME"), name_template_r9), \u0275\u0275pureFunction2(62, _c1, \u0275\u0275pipeBind1(21, 31, "ADMIN.AI_PROVIDER_VENDOR"), code_template_r10), \u0275\u0275pureFunction2(65, _c2, \u0275\u0275pipeBind1(22, 33, "ADMIN.AI_PROVIDER_MODEL"), code_template_r10), \u0275\u0275pureFunction2(68, _c3, \u0275\u0275pipeBind1(23, 35, "COMMON.UPDATED_AT"), date_from_template_r12), \u0275\u0275pureFunction2(71, _c4, \u0275\u0275pipeBind1(24, 37, "ADMIN.AI_PROVIDER_ENABLED"), bool_template_r13), \u0275\u0275pureFunction2(74, _c5, \u0275\u0275pipeBind1(25, 39, "ADMIN.AI_PROVIDER_IS_DEFAULT"), bool_template_r13), \u0275\u0275pureFunction1(77, _c6, actions_template_r14)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(26, 41, "ADMIN.AI_PROVIDERS_EMPTY"));
      \u0275\u0275advance(9);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(29, 43, "ADMIN.AI_USAGE_HEADER"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(32, 45, "ADMIN.AI_USAGE_HINT"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.usage_error() ? 33 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275classProp("hidden", ctx.usage_error());
      \u0275\u0275property("data", ctx.usage())("columns", \u0275\u0275pureFunction5(102, _c13, \u0275\u0275pureFunction2(87, _c8, \u0275\u0275pipeBind1(36, 47, "ADMIN.AI_PROVIDER_VENDOR"), code_template_r10), \u0275\u0275pureFunction2(90, _c9, \u0275\u0275pipeBind1(37, 49, "ADMIN.AI_PROVIDER_MODEL"), code_template_r10), \u0275\u0275pureFunction2(93, _c10, \u0275\u0275pipeBind1(38, 51, "ADMIN.AI_USAGE_JOBS"), plain_template_r11), \u0275\u0275pureFunction2(96, _c11, \u0275\u0275pipeBind1(39, 53, "ADMIN.AI_USAGE_ASKED"), plain_template_r11), \u0275\u0275pureFunction2(99, _c12, \u0275\u0275pipeBind1(40, 55, "ADMIN.AI_USAGE_MADE"), plain_template_r11)))("empty_message", \u0275\u0275pipeBind1(41, 57, "ADMIN.AI_USAGE_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageAIComponent, { className: "SignageAIComponent", filePath: "src/app/admin/signage-ai/signage-ai.component.ts", lineNumber: 245 });
})();
export {
  SignageAIComponent
};
//# sourceMappingURL=chunk-UWGDJSE4.js.map
