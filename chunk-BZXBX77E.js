...
function SystemAboutComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("href", (tmp_3_0 = ctx_r0.item()) == null ? null : tmp_3_0.support_url, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
...
function SystemAboutComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, SystemAboutComponent_Conditional_8_For_5_Template, 2, 1, "span", 14, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function SystemAboutComponent_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("href", "mailto:" + ((tmp_3_0 = ctx_r0.item()) == null ? null : tmp_3_0.email), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
...
function SystemAboutComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.item()?.installed_ui_devices);
  }
}
...
function SystemAboutComponent_Conditional_44_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(7, 6, \u0275\u0275pipeBind1(6, 4, (tmp_3_0 = ctx_r0.item()) == null ? null : tmp_3_0.description)), \u0275\u0275sanitizeHtml);
  }
}
function SystemAboutComponent_Conditional_47_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("id", (tmp_2_0 = ctx_r0.item()) == null ? null : tmp_2_0.id)("merge", true)("settings", (tmp_4_0 = ctx_r0.item()) == null ? null : tmp_4_0.settings)("merge_settings", other_settings_value_r3 || \u0275\u0275pureFunction0(4, _c0));
  }
}
...
var SystemAboutComponent = class _SystemAboutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SystemAboutComponent, selectors: [["system-about"]], decls: 49, vars: 51, consts: [[1, "p-4"], [1, "flex", "flex-col", "gap-2"], [1, "border-base-200", "grid", "w-full", "gap-2", "rounded-sm", "border", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "flex", "items-center"], ["matTooltipPosition", "right", 3, "matTooltip"], [1, "border-base-200", "flex", "gap-2", "rounded-xl", "border", "p-2"], [1, "flex-1", "p-2", "text-lg", "font-medium"], ["icon", "", "default", "", "start", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "stop", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-base-300", "my-4"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8"], ["target", "_blank", 1, "truncate", "underline", "select-all", 3, "href"], [1, "flex", "flex-wrap", "gap-1"], [1, "bg-base-200", "rounded", "px-2", "py-1", "text-xs", "font-medium"], [1, "value", "mono"], [1, "border-base-200", "w-full", "rounded-sm", "border"], [1, "bg-base-200", "w-full", "rounded-sm", "p-4", "text-lg", "font-medium"], [1, "markdown", "w-full", "overflow-auto", "p-4", "text-sm", 3, "innerHTML"], [3, "id", "merge", "settings", "merge_settings"], [1, "mb-4", 3, "diameter"]], template: function SystemAboutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemAboutComponent, { className: "SystemAboutComponent", filePath: "src/app/systems/system-about.component.ts", lineNumber: 249 });
})();
export {
  SystemAboutComponent
};
//# sourceMappingURL=chunk-BZXBX77E.js.map
