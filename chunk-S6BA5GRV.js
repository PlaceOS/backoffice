...
var ResourceImportsComponent = class _ResourceImportsComponent {
  ...
  async ngOnInit() {
    const domain = Dt();
    const domain_list = await lastValueFrom(hc({ limit: 100 }).pipe(map((_) => _.data)));
  ...
  async importResource(resource, notify = true) {
    ...
    if (!domain)
      return;
    const system = await lastValueFrom(Hl({
  ...
  async loadResourceList() {
    ...
    const result = await lastValueFrom(k({
      path: "place",
    ...
    const { data } = await lastValueFrom(Ml({
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResourceImportsComponent, selectors: [["resource-imports"]], decls: 30, vars: 42, consts: [["email_template", ""], ["bool_template", ""], ["name_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-56"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click", "disabled"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "sticky", "left-0", "w-full"], [1, "mb-4", "block", "min-w-3xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [3, "value"], [1, "mono", "p-4", "text-xs"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", "text-white"], [1, "flex", "items-center", "justify-between", "space-x-2", "px-4", "py-2"], [1, "flex", "flex-1", "flex-col"], [1, "w-full", "truncate"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "matTooltip", "routerLink"]], template: function ResourceImportsComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ResourceImportsComponent, { className: "ResourceImportsComponent", filePath: "src/app/admin/resource-imports.component.ts", lineNumber: 195 });
})();
export {
  ResourceImportsComponent
};
//# sourceMappingURL=chunk-S6BA5GRV.js.map
