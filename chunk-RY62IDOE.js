...
var TriggersComponent = class _TriggersComponent extends AsyncHandler {
  ...
  async loadValues(item) {
    if (!item)
      return;
    this.instance_count = (await lastValueFrom($a(item.id))).length;
    this.updateTabList();
  }
...
//# sourceMappingURL=chunk-RY62IDOE.js.map
