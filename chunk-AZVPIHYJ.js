...
var TriggerAboutComponent = class _TriggerAboutComponent extends AsyncHandler {
  ...
  query_fn = (q) => na({ q }).pipe(map((resp) => resp.data));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TriggerAboutComponent, { className: "TriggerAboutComponent", filePath: "src/app/triggers/trigger-about.component.ts", lineNumber: 301 });
})();
export {
  TriggerAboutComponent
};
//# sourceMappingURL=chunk-AZVPIHYJ.js.map
