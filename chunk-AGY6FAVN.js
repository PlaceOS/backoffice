...
function UploadLibraryComponent_Conditional_22_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_22_div_28_Template_button_click_12_listener() {
    ...
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_22_div_28_Template_button_click_16_listener() {
      const upload_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_22_div_28_Template_button_click_20_listener() {
      const upload_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_22_div_28_Template_button_click_24_listener() {
      const upload_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function UploadLibraryComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "div", 17)(2, "button", 18);
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_22_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_22_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_22_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_22_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(28, UploadLibraryComponent_Conditional_22_div_28_Template, 28, 22, "div", 23);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function UploadLibraryComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
...
var UploadLibraryComponent = class _UploadLibraryComponent extends AsyncHandler {
  ...
  search_term = model("", ...ngDevMode ? [{ debugName: "search_term" }] : []);
  domain = model(null, ...ngDevMode ? [{ debugName: "domain" }] : []);
  ...
  domain_list = toSignal(hc({ limit: 100 }).pipe(map((r) => r.data), shareReplay(1)), { initialValue: [] });
  _uploads_list = combineLatest([
    toObservable(this.domain),
    toObservable(this.search_term),
    toObservable(this.refresh)
  ]).pipe(filter(([domain]) => !!domain), debounceTime(300), switchMap(([domain, search]) => k({
    path: "uploads",
    query_params: {
      limit: 1e3,
      file_search: search,
  ...
  }).pipe(catchError(() => of({ data: [] })))), map((r) => r.data.map((_) => __spreadProps(__spreadValues({}, _), { mime_type: getMimeType(_.file_name) })).sort((a, b) => a.file_name.localeCompare(b.file_name))), startWith([]), shareReplay(1));
  uploads_list = toSignal(this._uploads_list, {
    initialValue: []
  });
  async ngOnInit() {
    const domain = Dt();
    const domain_list = await nextValueFrom(hc({ limit: 100 }).pipe(map((r) => r.data)));
  ...
  async downloadUpload(upload) {
    const tkn = ee();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Gt()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=60;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UploadLibraryComponent, selectors: [["upload-library"]], inputs: { search_term: [1, "search_term"], domain: [1, "domain"] }, outputs: { search_term: "search_termChange", domain: "domainChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 24, vars: 14, consts: [[1, "flex", "h-full", "w-full", "flex-col"], [1, "mt-4", "mb-2", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-56"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "matRipple", "", 1, "relative", "h-12", "w-32"], ["type", "file", "multiple", "", 1, "pointer-events-auto", "absolute", "inset-0", "w-full", "opacity-0", 3, "change"], [1, "mb-4", "flex", "items-center", "justify-end", "space-x-2", "px-4"], ["appearance", "outline", 1, "no-subscript", "w-[20rem]", "max-w-full"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Search for file...", 3, "ngModelChange", "ngModel"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "sticky", "left-0", "w-full"], ["role", "table", 1, "mb-4", "block", "min-w-240", "overflow-hidden", "text-sm"], [1, "bg-base-200", "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "p-16"], ["header", "", 1, "divide-base-100", "border-base-300", "bg-base-200", "grid", "min-w-full", "grid-cols-5", "divide-x", "border"], [1, "flex", "items-center", "justify-between", "p-2", 3, "click"], [1, "p-2"], [1, "text-xl"], [1, "p-4"], ["itemSize", "48", 1, "min-h-[calc(100vh-13.25rem)]"], ["class", "divide-base-300 border-base-300 grid h-12 min-w-full grid-cols-5 divide-x overflow-hidden border-x border-b", 3, "grid-template-columns", 4, "cdkVirtualFor", "cdkVirtualForOf"], [1, "divide-base-300", "border-base-300", "grid", "h-12", "min-w-full", "grid-cols-5", "divide-x", "overflow-hidden", "border-x", "border-b"], [1, "flex", "h-full", "items-center", "p-4", "text-xs"], [1, "mono", "w-px", "flex-1", "truncate", 3, "matTooltip"], [1, "mono", "flex", "h-full", "items-center", "truncate", "p-4", "text-xs"], [1, "mono", "flex", "h-full", "w-full", "items-center", "justify-end", "p-4", "text-xs"], [1, "flex", "h-full", "items-center", "p-4"], [1, "flex", "w-full", "items-center", "justify-end", "space-x-2", "px-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-8xl", "opacity-30"], [1, "opacity-30"]], template: function UploadLibraryComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(9, UploadLibraryComponent_For_10_Template, 2, 2, "mat-option", 6, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(11, "button", 7)(12, "input", 8);
      \u0275\u0275listener("change", function UploadLibraryComponent_Template_input_change_12_listener($event) {
      ...
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(15, "div", 9)(16, "mat-form-field", 10)(17, "icon", 11);
      \u0275\u0275text(18, "search");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(19, "input", 12);
      \u0275\u0275twoWayListener("ngModelChange", function UploadLibraryComponent_Template_input_ngModelChange_19_listener($event) {
      ...
      \u0275\u0275conditionalCreate(22, UploadLibraryComponent_Conditional_22_Template, 29, 27, "div", 15)(23, UploadLibraryComponent_Conditional_23_Template, 6, 3, "div", 16);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      let tmp_7_0;
      ...
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 10, "ADMIN.SELECT_DOMAIN"));
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.domain_list());
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 12, "COMMON.UPLOAD_FILE"), " ");
      \u0275\u0275advance(6);
      \u0275\u0275twoWayProperty("ngModel", ctx.search_term);
      \u0275\u0275advance(2);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275conditional(((tmp_7_0 = ctx.uploads_list()) == null ? null : tmp_7_0.length) > 0 ? 22 : 23);
    }
  }, dependencies: [
    CommonModule,
    IconComponent,
...
(() => {
  ...
  }], null, { search_term: [{ type: Input, args: [{ isSignal: true, alias: "search_term", required: false }] }, { type: Output, args: ["search_termChange"] }], domain: [{ type: Input, args: [{ isSignal: true, alias: "domain", required: false }] }, { type: Output, args: ["domainChange"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UploadLibraryComponent, { className: "UploadLibraryComponent", filePath: "src/app/admin/upload-library.component.ts", lineNumber: 375 });
})();
export {
  UploadLibraryComponent
};
//# sourceMappingURL=chunk-AGY6FAVN.js.map
