...
var PlaceDetailsComponent = class _PlaceDetailsComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceDetailsComponent, selectors: [["app-engine-details"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 43, vars: 25, consts: [[1, "my-4", "flex", "items-center", "justify-between", "space-x-2"], [1, "text-2xl"], [1, "bg-base-200", "mb-4", "flex", "items-center", "space-x-2", "rounded-sm", "px-4", "py-2"], [1, "text-lg", "font-medium"], [1, "mono", "ml-2", "opacity-60"], [1, "flex-1"], [1, "p-2", "text-xs", "underline"], [1, "border-base-200", "mb-4", "inline-grid", "gap-2", "rounded-sm", "border", "p-4"], ["for", "version", 1, "flex", "items-center", "text-sm", "font-medium"], [1, "flex", "items-center", "space-x-2"], ["name", "version", 3, "click"], ["name", "tag", 1, "ml-2", 3, "click"], ["for", "hash", 1, "flex", "items-center", "text-sm", "font-medium"], ["name", "hash", 3, "click"], ["for", "build-time", 1, "flex", "items-center", "text-sm", "font-medium"], ["name", "build-time", 1, "text-sm", 3, "click"], [1, "bg-base-200", "flex", "items-center", "space-x-4", "rounded-sm", "px-4", "py-2"], [1, "bg-base-300"], [1, "-mx-2", "flex", "flex-wrap", "py-2"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "p-24"], [1, "p-2", "text-xs", "underline", 3, "click"], [1, "border-base-200", "bg-base-100", "m-2", "min-w-[40%]", "flex-1", "overflow-hidden", "rounded-sm", "border"], [1, "mono", "border-base-200", "w-full", "border-b", "px-4", "py-2"], [1, "inline-grid", "gap-2", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "text-sm"], [1, "border-base-300", "bg-base-200", "rounded-lg", "border", "p-4", "opacity-30"]], template: function PlaceDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceDetailsComponent, { className: "PlaceDetailsComponent", filePath: "src/app/admin/details.component.ts", lineNumber: 196 });
})();
export {
  PlaceDetailsComponent
};
//# sourceMappingURL=chunk-SDMFTINY.js.map
