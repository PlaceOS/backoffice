import {
  TriggerStateService
} from "./chunk-ROZGDBKB.js";
import "./chunk-VHAAVBBN.js";
import {
  d
...
import "./chunk-U24WBP3H.js";
import "./chunk-2N2QUKBU.js";
import "./chunk-OU3SSJTC.js";
...
var _c0 = () => [];
var _c1 = (a0, a1) => ({ key: "operator", name: a0, content: a1 });
var _c2 = (a0) => ({ key: "actions", name: " ", size: "6rem", sortable: false, content: a0 });
var _c3 = (a0, a1) => [a0, a1];
...
var TriggerAboutComponent = class _TriggerAboutComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TriggerAboutComponent, selectors: [["trigger-about"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 75, vars: 122, consts: [["time_dep_template", ""], ["comparison_template", ""], ["actions_template", ""], ["function_call_template", ""], ["email_call_template", ""], ["fn_actions_template", ""], [1, "mb-4", "flex", "space-x-2"], [1, "grid", "w-1/3", "flex-1", "gap-2", "rounded-sm", "border", "border-base-200", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "flex", "items-center"], ["matTooltipPosition", "right", 3, "matTooltip"], [1, "my-4"], [1, "flex", "flex-col"], ["for", "driver", 1, "max-w-[50%]", 3, "matTooltip"], [1, "w-full", 3, "ngModelChange", "placeholder", "query_fn", "ngModel"], [1, "my-4", "flex", "items-center"], [1, "flex-1", "text-lg", "font-medium"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click", "disabled"], [1, "text-2xl"], [1, "ml-2", "mr-4"], [1, "mb-4", "block", "w-full", "min-w-lg", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "block", "w-full", "min-w-lg", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "my-4", "flex", "items-center", "space-x-2"], [1, "mb-4", "block", "w-full", "min-w-lg", "text-sm", 3, "ondrop", "data", "columns", "can_reorder", "empty_message"], [1, "my-4", "text-base-300"], [1, "w-full", "rounded-sm", "border", "border-base-200"], [1, "w-full", "rounded-sm", "bg-base-200", "p-4", "text-lg", "font-medium"], [1, "markdown", "w-full", "overflow-auto", "p-4", "text-sm", 3, "innerHTML"], [1, "mono", "flex", "items-center", "space-x-2", "p-4", "text-sm"], [1, "mono", "flex", "items-center", "space-x-4", "p-4", "text-xs"], [1, "bg-success", "text-success-content"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 3, "click", "disabled"], ["icon", "", "matRipple", "", 3, "click"], [1, "text-error"], [1, "mono", "flex", "space-x-2", "p-4", "text-xs"], [1, "flex", "items-center", "space-x-2", "p-4"], [3, "matTooltip"]], template: function TriggerAboutComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275property("data", ctx.comparisons || \u0275\u0275pureFunction0(86, _c0))("columns", \u0275\u0275pureFunction2(92, _c3, \u0275\u0275pureFunction2(87, _c1, \u0275\u0275pipeBind1(41, 66, "TRIGGERS.FIELD_VAR_COMPARE"), comparison_template_r12), \u0275\u0275pureFunction1(90, _c2, actions_template_r13)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(42, 68, "TRIGGERS.CONDITION_COMPARE_EMPTY"));
      \u0275\u0275advance(3);
      \u0275\u0275property("data", ctx.time_dependents || \u0275\u0275pureFunction0(95, _c0))("columns", \u0275\u0275pureFunction2(101, _c3, \u0275\u0275pureFunction2(96, _c4, \u0275\u0275pipeBind1(44, 70, "TRIGGERS.FIELD_TIME_DEPS"), time_dep_template_r11), \u0275\u0275pureFunction1(99, _c2, actions_template_r13)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(45, 72, "TRIGGERS.CONDITION_TIME_EMPTY"));
      \u0275\u0275advance(11);
      ...
      \u0275\u0275advance(3);
      \u0275\u0275property("data", ctx.functions || \u0275\u0275pureFunction0(104, _c0))("columns", \u0275\u0275pureFunction2(110, _c3, \u0275\u0275pureFunction2(105, _c4, \u0275\u0275pipeBind1(64, 78, "TRIGGERS.FIELD_ACTION_FN_CALL"), function_call_template_r14), \u0275\u0275pureFunction1(108, _c2, fn_actions_template_r16)))("can_reorder", true)("empty_message", \u0275\u0275pipeBind1(65, 80, "TRIGGERS.ACTION_FN_EMPTY"));
      \u0275\u0275advance(3);
      \u0275\u0275property("data", ctx.mailers || \u0275\u0275pureFunction0(113, _c0))("columns", \u0275\u0275pureFunction2(119, _c3, \u0275\u0275pureFunction2(114, _c4, \u0275\u0275pipeBind1(67, 82, "TRIGGERS.FIELD_ACTION_EMAIL"), email_call_template_r15), \u0275\u0275pureFunction1(117, _c2, fn_actions_template_r16)))("can_reorder", true)("empty_message", \u0275\u0275pipeBind1(68, 84, "TRIGGERS.ACTION_EMAIL_EMPTY"));
    }
  }, dependencies: [
    CommonModule,
    IconComponent,
...
//# sourceMappingURL=chunk-34AQHHJN.js.map
