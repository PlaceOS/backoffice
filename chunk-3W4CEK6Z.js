import {
  UserPipe
} from "./chunk-SBAOVIPZ.js";
import {
  SettingsFieldComponent
} from "./chunk-GHXOIUC6.js";
import {
  DiffViewerComponent
} from "./chunk-LOO63BYG.js";
import {
  validateJSONString
...
function MetadataDisplayComponent_Conditional_9_For_2_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "settings-form-field", 26);
  }
  if (rf & 2) {
    const item_r2 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("schema", ctx_r2.schema_map()[item_r2.name])("readonly", false);
  }
}
function MetadataDisplayComponent_Conditional_9_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(35, MetadataDisplayComponent_Conditional_9_For_2_Conditional_35_Template, 1, 2, "settings-form-field", 26);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_17_0;
    ...
    \u0275\u0275property("id", "md-block-" + item_r2.name)("formGroup", ctx_r2.form_map()[item_r2.name]);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r2.names()[item_r2.name], " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.descriptions()[item_r2.name] ? 5 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", (tmp_17_0 = \u0275\u0275pipeBind1(9, 21, \u0275\u0275pipeBind1(8, 19, item_r2.modified_by_id))) == null ? null : tmp_17_0.name);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 23, item_r2.updated_at), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx_r2.edited()[item_r2.name])("matTooltip", \u0275\u0275pipeBind1(14, 25, "COMMON.SAVE"));
    \u0275\u0275advance(4);
...
function MetadataDisplayComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, MetadataDisplayComponent_Conditional_9_For_2_Template, 36, 33, "div", 9, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var MetadataDisplayComponent = class _MetadataDisplayComponent extends AsyncHandler {
  ...
  loading_list = signal(false, ...ngDevMode ? [{ debugName: "loading_list" }] : []);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MetadataDisplayComponent, selectors: [["metadata-display"]], inputs: { item: [1, "item"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 11, vars: 5, consts: [[1, "flex", "items-center", "justify-between", "space-x-2"], ["btn", "", 3, "click"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Search metadata blocks...", 3, "ngModelChange", "ngModel"], [1, "flex", "w-full", "items-center", "justify-center", "p-16"], [1, "mt-4", "space-y-2"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-8", "p-16", "opacity-30"], ["diameter", "32"], ["block", "", 1, "border-base-300", "rounded-sm", "border", 3, "id", "shadow", "opacity-30", "formGroup"], ["block", "", 1, "border-base-300", "rounded-sm", "border", 3, "id", "formGroup"], ["header", "", 1, "bg-base-200", "flex", "w-full", "items-center", "space-x-2", "px-2", "py-1", 3, "click"], [1, "min-w-0", "px-2", "text-left"], [1, "truncate", "font-mono", "text-sm"], [1, "text-base-content/60", "truncate", "text-[0.625rem]"], [1, "flex-1"], ["matTooltipPosition", "left", 1, "border-base-300", "rounded-sm", "border", "px-2", "py-1", "font-mono", "text-[0.625rem]", "whitespace-nowrap", 3, "matTooltip"], [1, "border-base-300", "bg-base-100", "flex", "items-center", "rounded-full", "border", 3, "click"], ["icon", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], [1, "text-xl"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"], ["icon", "", "matRipple", ""], [1, "text-2xl"], ["body", "", 1, "expandable"], [1, "border-base-300", "h-130", "border-t", "p-1"], ["formControlName", "details", "lang", "json", 3, "schema", "readonly"], [1, "text-8xl"]], template: function MetadataDisplayComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.loading_list() ? 8 : ((tmp_2_0 = ctx.metadata()) == null ? null : tmp_2_0.length) > 0 ? 9 : 10);
    }
  }, dependencies: [
    CommonModule,
    MatProgressSpinnerModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MetadataDisplayComponent, { className: "MetadataDisplayComponent", filePath: "src/app/ui/metadata-display.component.ts", lineNumber: 221 });
})();

export {
  MetadataDisplayComponent
};
//# sourceMappingURL=chunk-3W4CEK6Z.js.map
