...
var ModuleFormComponent = class _ModuleFormComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      const system_id = model2.system?.id || "";
      if (system_id !== model2.control_system_id) {
        this.formModel.update((value) => __spreadProps(__spreadValues({}, value), {
    ...
    effect(() => {
      const model2 = this.formModel();
      const driver = model2.driver;
      if (!driver?.id)
        return;
      const role = driver.role || At.Logic;
      const udp = driver.role === At.Service || driver.role === At.Websocket ? false : model2.udp;
      const system = driver.role === At.Logic ? model2.system : void 0;
      if (model2.driver_id === driver.id && model2.name === (driver.name || driver.module_name) && model2.uri === (driver.default_uri || "") && model2.port === (driver.default_port || 1) && model2.alert_level === (driver.alert_level || "medium") && model2.role === role && model2.udp === udp && model2.system === system) {
        return;
      }
      this.formModel.update((value) => __spreadProps(__spreadValues({}, value), {
        driver_id: driver.id,
...
function RepositoryFormComponent_Conditional_1_Conditional_10_For_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RepositoryFormComponent_Conditional_1_Conditional_10_For_14_Template_div_click_1_listener() {
      ...
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.base_commit.set(commit_r9));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", commit_r9.subject);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", commit_r9.subject, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 8, commit_r9.date, "medium"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(commit_r9.author ? 8 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind3(11, 11, commit_r9.hash, 0, 8));
  }
}
...
function RepositoryFormComponent_Conditional_1_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(12, "slice");
    \u0275\u0275elementEnd()()();
    \u0275\u0275repeaterCreate(13, RepositoryFormComponent_Conditional_1_Conditional_10_For_14_Template, 12, 15, "mat-option", 9, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RepositoryFormComponent, { className: "RepositoryFormComponent", filePath: "src/app/repositories/repository-form.component.ts", lineNumber: 410 });
})();
...
var SystemFormComponent = class _SystemFormComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    effect(() => {
      const model2 = this.formModel();
      const zone = model2.zone;
      if (zone?.id && (model2.zones.length !== 1 || model2.zones[0] !== zone.id)) {
        this.formModel.update((value) => __spreadProps(__spreadValues({}, value), {
          zones: [zone.id]
        }));
      }
  ...
  updateList() {
    ...
    this.timeout("update", async () => {
      ...
      const resp = await next().catch((err) => {
        log("Service", `Error loading ${type2} list.`, [err], "warn");
        return null;
      });
      if (!resp) {
        if (type2 === this._type) {
          ...
          notifyError(`Error loading ${type2} list.`);
        }
        return;
      }
      if (type2 === this._type) {
...
//# sourceMappingURL=chunk-ZP7RYZSS.js.map
