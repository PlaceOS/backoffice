...
var DashboardClockComponent = class _DashboardClockComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardClockComponent, selectors: [["clock"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 5, vars: 6, consts: [[1, "relative", "h-12", "w-12", "rounded-full", "border-2", "border-base-100"], [1, "hand", "absolute", "bottom-1/2", "left-1/2", "h-3", "w-1", "rounded-sm", "bg-base-100"], [1, "hand", "minute", "absolute", "bottom-1/2", "left-1/2", "h-4", "bg-base-100"], [1, "hand", "absolute", "bottom-1/2", "left-1/2", "h-5", "w-px", "bg-base-100"], [1, "absolute", "left-1/2", "top-1/2", "h-2", "w-2", "-translate-x-1/2", "-translate-y-1/2", "transform", "rounded-full", "bg-base-100"]], template: function DashboardClockComponent_Template(rf2, ctx) {
    if (rf2 & 1) {
...
mqtt/dist/mqtt.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-5UPOGFAE.js.map
