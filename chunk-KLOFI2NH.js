...
var GroupBulkAddModalComponent = class _GroupBulkAddModalComponent {
  ...
  selected_count = computed(() => this.selected().length, ...ngDevMode ? [{ debugName: "selected_count" }] : []);
  list_items = computed(() => {
  ...
  items = toSignal(toObservable(this.search).pipe(debounceTime(300), switchMap((search) => {
    this.loading.set(true);
    return this.query_fn(search.trim()).pipe(catchError(() => of([])));
  }), map((items) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GroupBulkAddModalComponent, { className: "GroupBulkAddModalComponent", filePath: "src/app/groups/group-bulk-add-modal.component.ts", lineNumber: 145 });
})();
...
var GroupPermissionsModalComponent = class _GroupPermissionsModalComponent {
  ...
  permissions = signal(+this._data.permissions || 0, ...ngDevMode ? [{ debugName: "permissions" }] : []);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GroupPermissionsModalComponent, { className: "GroupPermissionsModalComponent", filePath: "src/app/groups/group-permissions-modal.component.ts", lineNumber: 81 });
})();
...
//# sourceMappingURL=chunk-KLOFI2NH.js.map
