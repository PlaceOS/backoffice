...
function queryStorage(query_params = {}) {
  return A({ query_params, fn: process, path: PATH });
}
...
var StorageComponent = class _StorageComponent {
  ...
  async ngOnInit() {
    ...
    const domain_list = await lastValueFrom(ru().pipe(map((r) => r.data)));
...
//# sourceMappingURL=chunk-CXD3SDDA.js.map
