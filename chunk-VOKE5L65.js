...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-GCIY64JE.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-UZ77UQZT.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-HXNXBFIL.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "extensions",
        loadComponent: () => import("./chunk-5XPN6LZ6.js").then((m) => m.PlaceExtensionsComponent)
      },
      {
        path: "staff-api",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-6OA3JTL2.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
...
//# sourceMappingURL=chunk-VOKE5L65.js.map
