...
function PlaceDetailsComponent_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "code", 17);
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
...
function PlaceDetailsComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(0, "button", 20);
    \u0275\u0275domListener("click", function PlaceDetailsComponent_Conditional_39_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PlaceDetailsComponent_Conditional_41_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 21)(1, "h3", 22);
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(3, "div", 23)(4, "div", 24);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275domElementEnd();
    ...
    \u0275\u0275text(22);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(23, "div", 24);
    \u0275\u0275text(24);
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(26, "div", 25);
    \u0275\u0275text(27);
    \u0275\u0275pipe(28, "date");
    \u0275\u0275domElementEnd()()();
  }
...
function PlaceDetailsComponent_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, PlaceDetailsComponent_Conditional_41_For_1_Template, 29, 26, "div", 21, \u0275\u0275repeaterTrackByIndex);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PlaceDetailsComponent_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 19)(1, "div", 26);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275domElementEnd()();
  }
...
var PlaceDetailsComponent = class _PlaceDetailsComponent extends AsyncHandler {
  ...
  async loadApiDetails() {
    const details = await lastValueFrom(ee(`${ve()}/cluster/versions`)).catch((err) => notifyError(i18n("ADMIN.BACKEND_SERVICES_ERROR", {
  ...
  async loadPlatformDetails() {
    const { changelog, version } = await lastValueFrom(ee(`${ve()}/platform`)).catch((err) => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceDetailsComponent, selectors: [["app-engine-details"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 43, vars: 25, consts: [[1, "my-4", "flex", "items-center", "justify-between", "space-x-2"], [1, "text-2xl"], [1, "mb-4", "flex", "items-center", "space-x-2", "rounded-sm", "bg-base-200", "px-4", "py-2"], [1, "text-lg", "font-medium"], [1, "mono", "ml-2", "opacity-60"], [1, "flex-1"], [1, "p-2", "text-xs", "underline"], [1, "mb-4", "inline-grid", "gap-2", "rounded-sm", "border", "border-base-200", "p-4"], ["for", "version", 1, "flex", "items-center", "text-sm", "font-medium"], [1, "flex", "items-center", "space-x-2"], ["name", "version", 3, "click"], ["name", "tag", 1, "ml-2", 3, "click"], ["for", "hash", 1, "flex", "items-center", "text-sm", "font-medium"], ["name", "hash", 3, "click"], ["for", "build-time", 1, "flex", "items-center", "text-sm", "font-medium"], ["name", "build-time", 1, "text-sm", 3, "click"], [1, "flex", "items-center", "space-x-4", "rounded-sm", "bg-base-200", "px-4", "py-2"], [1, "bg-base-300"], [1, "-mx-2", "flex", "flex-wrap", "py-2"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "p-24"], [1, "p-2", "text-xs", "underline", 3, "click"], [1, "m-2", "min-w-[40%]", "flex-1", "overflow-hidden", "rounded-sm", "border", "border-base-200", "bg-base-100"], [1, "mono", "w-full", "border-b", "border-base-200", "px-4", "py-2"], [1, "inline-grid", "gap-2", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "text-sm"], [1, "rounded-lg", "border", "border-base-300", "bg-base-200", "p-4", "opacity-30"]], template: function PlaceDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(15, "div", 9)(16, "code", 10);
      \u0275\u0275domListener("click", function PlaceDetailsComponent_Template_code_click_16_listener() {
        return ctx.copy("version", ctx.backoffice_version);
      });
      \u0275\u0275text(17);
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(18, "code", 11);
      \u0275\u0275domListener("click", function PlaceDetailsComponent_Template_code_click_18_listener() {
      ...
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(23, "div")(24, "code", 13);
      \u0275\u0275domListener("click", function PlaceDetailsComponent_Template_code_click_24_listener() {
      ...
      \u0275\u0275domListener("click", function PlaceDetailsComponent_Template_div_click_29_listener() {
        return ctx.copy("build time", ctx.backoffice_build);
      });
      \u0275\u0275text(30);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(31, "div", 16)(32, "div", 3);
      \u0275\u0275text(33);
      \u0275\u0275pipe(34, "translate");
      \u0275\u0275domElementStart(35, "span", 4);
      \u0275\u0275text(36, "API");
      \u0275\u0275domElementEnd()();
      \u0275\u0275conditionalCreate(37, PlaceDetailsComponent_Conditional_37_Template, 2, 1, "code", 17);
      \u0275\u0275domElement(38, "div", 5);
      \u0275\u0275conditionalCreate(39, PlaceDetailsComponent_Conditional_39_Template, 3, 3, "button", 6);
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(40, "section", 18);
      \u0275\u0275conditionalCreate(41, PlaceDetailsComponent_Conditional_41_Template, 2, 0)(42, PlaceDetailsComponent_Conditional_42_Template, 4, 3, "div", 19);
      \u0275\u0275domElementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 19, "COMMON.GIT_COMMIT"), " ");
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", ctx.backoffice_hash, " ");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(28, 21, "ADMIN.BUILD"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", ctx.backoffice_build, " ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(34, 23, "ADMIN.BACKEND_SERVICES"), " ");
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.backend_version() ? 37 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.changelog_data() ? 39 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.api_details().length > 0 ? 41 : 42);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceDetailsComponent, { className: "PlaceDetailsComponent", filePath: "src/app/admin/details.component.ts", lineNumber: 194 });
})();
export {
  PlaceDetailsComponent
};
//# sourceMappingURL=chunk-ZCKTAEWQ.js.map
