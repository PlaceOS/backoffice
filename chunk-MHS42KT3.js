...
var LocaleService = class _LocaleService {
  ...
  async _loadLocale(locale) {
    ...
    if (!existing.expiry || existing.expiry < Date.now()) {
      ...
      const locale_override_data = this.zone_id ? await Sa(this.zone_id, `locale_${locale}`).toPromise() : { details: {} };
  ...
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _LocaleService, factory: _LocaleService.\u0275fac, providedIn: "root" });
};
(() => {
...
//# sourceMappingURL=chunk-MHS42KT3.js.map
