...
function ModuleRuntimeErrorsModalComponent_Conditional_8_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModel", ctx_r0.formatted_errors())("readonly", true)("fill", true);
    \u0275\u0275control();
  }
}
...
function ModuleRuntimeErrorsModalComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ModuleRuntimeErrorsModalComponent_Conditional_8_Conditional_1_Template, 1, 3, "settings-form-field", 6)(2, ModuleRuntimeErrorsModalComponent_Conditional_8_Conditional_2_Template, 3, 3, "div", 7);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var ModuleRuntimeErrorsModalComponent = class _ModuleRuntimeErrorsModalComponent {
  ...
  async _loadData() {
    ...
    try {
      const module = await dc(this._module_id);
      this.module.set(module);
      try {
        const errors = await kc(module.id);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModuleRuntimeErrorsModalComponent, selectors: [["module-runtime-errors-modal"]], decls: 10, vars: 6, consts: [[1, "border-base-100", "bg-base-200", "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "h-14", "w-[calc(100%-1rem)]", "max-w-full", "items-center", "justify-between", "rounded-sm", "border", "px-2"], [1, "flex", "items-center", "space-x-2", "px-2", "text-xl", "font-medium"], [1, "bg-base-100", "rounded", "px-2", "py-1", "font-mono", "text-xs"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "h-[calc(100vh-6rem)]", "w-[80vw]", "flex-col", "space-y-2", "overflow-auto", "p-4"], [1, "flex", "h-[calc(100vh-6rem)]", "w-[80vw]", "flex-col", "items-center", "justify-center"], ["lang", "json", 1, "min-h-0", "flex-1", 3, "ngModel", "readonly", "fill"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "opacity-30"], ["diameter", "32"], [1, "opacity-30"]], template: function ModuleRuntimeErrorsModalComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", ctx.module()?.custom_name || ctx.module()?.name, " ");
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModuleRuntimeErrorsModalComponent, { className: "ModuleRuntimeErrorsModalComponent", filePath: "src/app/ui/module-runtime-errors-modal.component.ts", lineNumber: 75 });
})();

export {
  ModuleRuntimeErrorsModalComponent
};
//# sourceMappingURL=chunk-44QHUPSB.js.map
