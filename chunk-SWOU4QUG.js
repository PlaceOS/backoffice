...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-DMBOFGLR.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-33K2TQGC.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-3SI2ZCMW.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "staff-api",
        loadComponent: () => import("./chunk-UGDEZZLJ.js").then((m) => m.PlaceStaffAPIComponent)
      },
      {
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-MCCXBXZD.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
...
//# sourceMappingURL=chunk-SWOU4QUG.js.map
