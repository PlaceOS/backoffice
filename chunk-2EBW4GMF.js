...
function SignagePluginImportModalComponent_For_12_Template(rf, ctx) {
  if (rf & 1) {
...
function SignagePluginImportModalComponent_For_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 11);
    \u0275\u0275listener("click", function SignagePluginImportModalComponent_For_16_Template_button_click_0_listener() {
...
function SignagePluginImportModalComponent_ForEmpty_17_Template(rf, ctx) {
  if (rf & 1) {
...
var SignagePluginImportModalComponent = class _SignagePluginImportModalComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePluginImportModalComponent, selectors: [["signage-plugin-import-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 18, vars: 12, consts: [[1, "bg-base-200", "mx-2", "mt-2", "flex", "items-center", "justify-between", "rounded-sm", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "h-[65vh]", "w-lg", "max-w-[calc(100vw-2rem)]", "flex-col", "px-4", "pt-4"], ["appearance", "outline", 1, "w-full"], [3, "valueChange", "placeholder", "value"], [3, "value"], [3, "mode", "value"], [1, "flex-1", "space-y-2", "overflow-auto", "py-2"], ["matRipple", "", 1, "border-base-300", "hover:bg-base-200", "flex", "w-full", "items-center", "gap-4", "rounded-sm", "border", "px-4", "py-2", "text-left"], [1, "bg-base-200", "rounded-sm", "p-8", "text-center", "text-sm", "opacity-60"], ["matRipple", "", 1, "border-base-300", "hover:bg-base-200", "flex", "w-full", "items-center", "gap-4", "rounded-sm", "border", "px-4", "py-2", "text-left", 3, "click"], [1, "min-w-0", "flex-1"], [1, "truncate", "font-medium"], [1, "truncate", "font-mono", "text-xs", "opacity-60"], [1, "text-xs", "uppercase", "opacity-60"], [1, "text-xl"]], template: function SignagePluginImportModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "close");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(7, "main", 3)(8, "mat-form-field", 4)(9, "mat-select", 5);
      \u0275\u0275pipe(10, "translate");
      ...
      \u0275\u0275repeaterCreate(11, SignagePluginImportModalComponent_For_12_Template, 2, 2, "mat-option", 6, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(13, "mat-progress-bar", 7);
      \u0275\u0275elementStart(14, "div", 8);
      \u0275\u0275repeaterCreate(15, SignagePluginImportModalComponent_For_16_Template, 10, 3, "button", 9, _forTrack1, false, SignagePluginImportModalComponent_ForEmpty_17_Template, 3, 3, "div", 10);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 8, "ADMIN.SIGNAGE_PLUGINS_IMPORT"), " ");
      \u0275\u0275advance(7);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(10, 10, "ADMIN.SIGNAGE_PLUGINS_IMPORT_REPOSITORY"))("value", ctx.repository_id());
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.repositories());
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePluginImportModalComponent, { className: "SignagePluginImportModalComponent", filePath: "src/app/admin/signage-plugins/signage-plugin-import-modal.component.ts", lineNumber: 117 });
})();
...
function SchemaFormComponent_Conditional_0_For_2_Case_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const field_r2 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngModel", ctx_r2.fieldValue(field_r2.key))("disabled", ctx_r2.disabled())("ngModelOptions", \u0275\u0275pureFunction0(5, _c02));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function SchemaFormComponent_Conditional_0_For_2_Case_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.fieldValue(field_r2.key))("disabled", ctx_r2.disabled())("ngModelOptions", \u0275\u0275pureFunction0(7, _c02));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function SchemaFormComponent_Conditional_0_For_2_Case_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(field_r2.description ? 4 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.fieldValue(field_r2.key))("disabled", ctx_r2.disabled())("ngModelOptions", \u0275\u0275pureFunction0(8, _c02))("placeholder", field_r2.label);
    \u0275\u0275control();
  }
}
...
//# sourceMappingURL=chunk-2EBW4GMF.js.map
