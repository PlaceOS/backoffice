...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NewTerminalComponent, [{
    ...
    `, providers: [SanitizePipe], imports: [
      ...
      SafePipe,
      TranslatePipe
    ], styles: ["/* angular:styles/component:css;6bdb6109b6070dfbef40c061336d5b71cd67b3b726c9cbe2b6c546961f29d5d5;/home/runner/work/backoffice/backoffice/src/app/ui/new-terminal.component.ts */\n:host {\n  display: block;\n  height: 1px;\n  flex-grow: 1;\n  width: 100%;\n}\n/*# sourceMappingURL=new-terminal.component.css.map */\n"] }]
...
function DebugOutputComponent_Conditional_0_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("@show", ctx_r1.is_shown() ? "show" : "hide");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(5, 16, "COMMON.MESSAGE_COUNT", \u0275\u0275pureFunction1(30, _c1, ctx_r1.event_count()), ctx_r1.event_count()), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("lines", ctx_r1.logs())("resize", ctx_r1.resize());
    \u0275\u0275advance(6);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(13, 20, "COMMON.DEBUG_DOWNLOAD_MESSAGES"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(17, 22, "COMMON.DEBUG_TOGGLE_POSITION"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.debug_position() === "side" ? "border_bottom" : "border_right");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(21, 24, "COMMON.DEBUG_CLEAR_MESSAGES"));
    \u0275\u0275advance(3);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(24, 26, "COMMON.DEBUG_UNBIND_MODULES"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(28, 28, "COMMON.DEBUG_CLOSE_CONSOLE"));
  }
}
function DebugOutputComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, DebugOutputComponent_Conditional_0_Conditional_0_Template, 31, 32, "div", 1);
  }
  if (rf & 2) {
...
var DebugOutputComponent = class _DebugOutputComponent extends AsyncHandler {
  ...
  }, inputs: { compact: [1, "compact"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["content", ""], [3, "class"], [3, "resize"], ["content", "", 1, "relative", "z-10", "flex", "flex-col", "overflow-hidden", "border", "border-base-200", "bg-[#212121]", "text-white", "shadow"], [1, "p-3", "text-sm"], [3, "lines", "resize"], ["ns-resize", "", 1, "absolute", "-top-2", "left-0", "right-0", "h-4", "select-none", 3, "mousedown", "touchstart"], ["ew-resize", "", 1, "absolute", "-left-2", "bottom-0", "top-0", "w-4", "select-none", 3, "mousedown", "touchstart"], ["nwse-resize", "", 1, "absolute", "-left-2", "-top-2", "h-4", "w-4", "select-none", 3, "mousedown", "touchstart"], ["actions", "", 1, "absolute", "bottom-2", "right-2", "flex", "items-center", "space-x-2"], ["icon", "", "matRipple", "", 1, "rounded-full", "bg-neutral-focus", "text-neutral-content", "shadow", 3, "click"], [3, "matTooltip"], ["icon", "", "matRipple", "", 1, "rounded-full", "bg-neutral-focus", "text-neutral-content", "shadow", 3, "click", "matTooltip"]], template: function DebugOutputComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DebugOutputComponent, [{
    ...
    `, animations: [ANIMATION_SHOW_CONTRACT_EXPAND_BIDIR], imports: [
      IconComponent,
      TranslatePipe,
      MatTooltipModule,
      MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DebugOutputComponent, { className: "DebugOutputComponent", filePath: "src/app/ui/debug-output.component.ts", lineNumber: 212 });
})();

export {
  DebugOutputComponent
};
//# sourceMappingURL=chunk-KUHIXTWR.js.map
