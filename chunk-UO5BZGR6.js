...
var DebugInfoComponent = class _DebugInfoComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DebugInfoComponent, selectors: [["debug-info"]], inputs: { compact: [1, "compact"] }, decls: 1, vars: 1, consts: [["menu", "matMenu"], [1, "m-2", "flex", "flex-col", "space-y-2", "rounded-xl", "border", "border-base-300", "p-2"], ["actions", "", 1, "flex", "items-center", "justify-center", "space-x-2"], ["matTooltipPosition", "right", 1, "flex", "h-10", "w-10", "items-center", "justify-center", "rounded", "bg-info", "text-info-content", 3, "matTooltip"], [1, "text-2xl"], ["matTooltipPosition", "right", 1, "relative", "flex", "h-10", "w-10", "items-center", "justify-center", "rounded", 3, "matTooltip"], [1, "absolute", "left-1/2", "top-1/2", "-translate-x-1/2", "-translate-y-1/2", "text-5xl", "opacity-10"], [1, "mono", "rounded-xl", "bg-info", "p-1", "text-center", "text-xs", "text-info-content"], [1, "p-1", "text-center", "text-xs"], ["icon", "", "matRipple", "", 1, "rounded-lg", "border", "border-base-300", "bg-base-100", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], ["icon", "", "matRipple", "", 1, "bg-base-200", 3, "click"], ["matTooltip", "Toggle Position"], ["matTooltip", "Clear Messages"], ["matTooltip", "Unbind Modules"], ["matTooltip", "Open Console"]], template: function DebugInfoComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var UserMenuTooltipComponent = class _UserMenuTooltipComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserMenuTooltipComponent, selectors: [["user-menu-tooltip"]], decls: 33, vars: 24, consts: [["lang_menu", "matMenu"], [1, "m-2", "divide-y", "divide-base-200", "rounded", "border", "border-base-300", "bg-base-100", "shadow"], ["matRipple", "", "type", "button", "profile", "", 1, "space-x-2", 3, "routerLink"], ["dark-mode", "", 1, "flex", "w-[16rem]", "items-center", "p-4"], [1, "w-1/2", "flex-1"], [3, "ngModelChange", "ngModel"], ["matRipple", "", "type", "button", "logout", "", 1, "space-x-2", 3, "click"], ["matRipple", "", "type", "button", "uploads", "", 1, "space-x-2", 3, "click"], ["matRipple", "", "type", "button", 3, "matMenuTriggerFor"], ["xPosition", "after", "yPosition", "above"], ["mat-menu-item", "", 1, "w-60"], ["matRipple", "", "type", "button", "target", "_blank", "ref", "noopener noreferer", "report", "", 1, "space-x-2", 3, "href"], [3, "className"], [1, "flex-1", "text-left"], [1, "max-w-24", "truncate", "rounded", "bg-base-200", "px-2", "py-1", "text-sm"], ["mat-menu-item", "", 1, "w-60", 3, "click"], [1, "flex", "w-full", "items-center", "justify-between", "space-x-4"]], template: function UserMenuTooltipComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
...
//# sourceMappingURL=chunk-UO5BZGR6.js.map
