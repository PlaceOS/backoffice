...
function RepositoryAboutComponent_Conditional_63_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, RepositoryAboutComponent_Conditional_63_Conditional_1_Template, 2, 3)(2, RepositoryAboutComponent_Conditional_63_Conditional_2_Template, 1, 0, "mat-spinner", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var RepositoryAboutComponent = class _RepositoryAboutComponent {
  ...
  local_url = computed(
    () => this.item()?.type === Ms.Interface ? `${location.origin}/${this.item()?.folder_name}/` : `${location.hash}`,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RepositoryAboutComponent, selectors: [["repository-about"]], decls: 65, vars: 73, consts: [[1, "mb-4", "flex", "space-x-2"], [1, "w-1/3", "flex-1"], [1, "border-base-200", "grid", "gap-4", "rounded-sm", "border", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "select-text"], [1, "select-all"], ["target", "_blank", 3, "href"], [1, "opacity-30"], [1, "flex", "items-center", "font-mono", "text-sm", "select-text"], [1, "flex", "items-center"], ["matTooltipPosition", "right", 1, "select-text", 3, "matTooltip"], [1, "border-base-200", "grid", "gap-4", "overflow-hidden", "rounded-sm", "border", "p-4"], [1, "overflow-hidden", "underline", "select-all"], ["target", "_blank", 1, "block", "w-full", "truncate", 3, "href"], [1, "flex", "items-center", "overflow-hidden"], [1, "inline-block", "max-w-full", "truncate", "text-xs", "select-text", 3, "matTooltip"], [1, "mono", "wrap-break-word", "select-text"], [1, "border-error", "bg-error/10", "text-error", "col-span-2", "flex", "items-start", "space-x-2", "rounded-sm", "border", "p-2", "text-xs"], ["btn", "", "matRipple", "", 1, "col-span-2", "w-full", 3, "disabled"], [1, "text-lg"], [1, "min-w-0", "flex-1"], [1, "mt-0.75", "font-medium"], [1, "mt-2", "font-mono", "text-[0.625rem]", "break-words", "select-text"], ["btn", "", "matRipple", "", 1, "col-span-2", "w-full", 3, "click", "disabled"], ["diameter", "32"], [1, "text-base-300", "my-4"], [1, "border-base-200", "w-full", "rounded-sm", "border"], [1, "bg-base-200", "w-full", "rounded-sm", "p-4", "text-lg", "font-medium"], [1, "markdown", "selectable", "w-full", "overflow-auto", "p-4", "text-sm", 3, "innerHTML"]], template: function RepositoryAboutComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(14);
      \u0275\u0275conditionalCreate(15, RepositoryAboutComponent_Conditional_15_Template, 3, 3, "span", 7);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(20);
      \u0275\u0275conditionalCreate(21, RepositoryAboutComponent_Conditional_21_Template, 2, 0, "span", 7);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(39, "dateFrom");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(40, "div", 1)(41, "div", 11)(42, "div", 3);
      \u0275\u0275text(43);
      \u0275\u0275pipe(44, "translate");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(51, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(52, "div", 14)(53, "code", 15);
      \u0275\u0275text(54);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275pipe(57, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "div", 14)(59, "code", 15);
      \u0275\u0275text(60);
      \u0275\u0275conditionalCreate(61, RepositoryAboutComponent_Conditional_61_Template, 2, 1, "span", 16);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(62, RepositoryAboutComponent_Conditional_62_Template, 9, 4, "div", 17);
      \u0275\u0275conditionalCreate(63, RepositoryAboutComponent_Conditional_63_Template, 3, 2, "button", 18);
      \u0275\u0275elementEnd()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RepositoryAboutComponent, { className: "RepositoryAboutComponent", filePath: "src/app/repositories/repository-about.component.ts", lineNumber: 227 });
})();
export {
  RepositoryAboutComponent
};
//# sourceMappingURL=chunk-ZPHAFGYZ.js.map
