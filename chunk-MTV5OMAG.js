...
import {
  openConfirmModal
} from "./chunk-UCNDKOJV.js";
import {
  SimpleTableComponent
} from "./chunk-DV6VICSN.js";
import {
  FullscreenModalShellComponent
} from "./chunk-4GAF3GQG.js";
...
var ActionFieldComponent = class _ActionFieldComponent {
  ...
  on_action = output({ alias: "onAction" });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ActionFieldComponent, selectors: [["an-action-field"]], inputs: { name: [1, "name"], disabled: [1, "disabled"] }, outputs: { on_action: "onAction" }, ngContentSelectors: _c0, decls: 5, vars: 2, consts: [["role", "button", "form-field", "", "tabindex", "0", 1, "border-gray-200", "flex", "items-center", "rounded-sm", "border", "px-4", "py-2.5", "hover:border-base-content", 3, "keydown.enter"], ["placeholder", "", 1, "w-0", "flex-1", "truncate", 3, "click"], [1, "-mr-2", "text-2xl", 3, "click"]], template: function ActionFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275listener("keydown.enter", function ActionFieldComponent_Template_div_keydown_enter_0_listener() {
...
(() => {
  ...
  }], null, { name: [{ type: Input, args: [{ isSignal: true, alias: "name", required: false }] }], disabled: [{ type: Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], on_action: [{ type: Output, args: ["onAction"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ActionFieldComponent, { className: "ActionFieldComponent", filePath: "src/app/ui/custom-fields/action-field.component.ts", lineNumber: 36 });
})();
...
function APIKeyModalComponent_For_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-option", 29);
    \u0275\u0275listener("click", function APIKeyModalComponent_For_40_Template_mat_option_click_0_listener() {
      const option_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.addScope({ input: {}, value: option_r6 }));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
...
function APIKeyModalComponent_For_58_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "code", 34);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
  }
...
function APIKeyModalComponent_For_58_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 30);
    \u0275\u0275listener("click", function APIKeyModalComponent_For_58_Template_button_click_0_listener() {
      const item_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      ctx_r3.form.patchValue({ user: item_r8, user_id: item_r8.id });
      return \u0275\u0275resetView(ctx_r3.setSearch(""));
    });
    \u0275\u0275elementStart(1, "div", 31)(2, "div", 32)(3, "div");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 33);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(7, APIKeyModalComponent_For_58_Conditional_7_Template, 3, 3, "code", 34);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const item_r8 = ctx.$implicit;
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275classProp("text-secondary", (ctx_r3.form.value.user == null ? null : ctx_r3.form.value.user.id) === item_r8.id);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(item_r8.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", item_r8.email, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r8.sys_admin || item_r8.support ? 7 : -1);
  }
}
function APIKeyModalComponent_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
...
var APIKeyModalComponent = class _APIKeyModalComponent extends AsyncHandler {
  ...
  loadUsers() {
    this.timeout("load_users", async () => {
      const users = await lastValueFrom(this.domain() ? Jc({
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _APIKeyModalComponent, selectors: [["api-key-modal"]], viewQuery: function APIKeyModalComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275pipe(36, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "mat-autocomplete", null, 1);
      \u0275\u0275repeaterCreate(39, APIKeyModalComponent_For_40_Template, 2, 1, "mat-option", null, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275pipe(41, "async");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(42, "div", 6)(43, "label", 15);
      \u0275\u0275text(44);
      \u0275\u0275pipe(45, "translate");
      \u0275\u0275elementStart(46, "span");
      \u0275\u0275text(47, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(48, "an-action-field", 16);
      \u0275\u0275listener("click", function APIKeyModalComponent_Template_an_action_field_click_48_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(50);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(51, "mat-menu", null, 2)(53, "mat-form-field", 17);
      \u0275\u0275listener("click", function APIKeyModalComponent_Template_mat_form_field_click_53_listener($event) {
        \u0275\u0275restoreView(_r1);
        $event.preventDefault();
        return \u0275\u0275resetView($event.stopPropagation());
      });
      \u0275\u0275elementStart(54, "input", 18, 3);
      \u0275\u0275pipe(56, "translate");
      \u0275\u0275twoWayListener("ngModelChange", function APIKeyModalComponent_Template_input_ngModelChange_54_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.search_term, $event) || (ctx.search_term = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("ngModelChange", function APIKeyModalComponent_Template_input_ngModelChange_54_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.setSearch($event));
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275repeaterCreate(57, APIKeyModalComponent_For_58_Template, 8, 5, "button", 19, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275pipe(59, "slice");
      \u0275\u0275conditionalCreate(60, APIKeyModalComponent_Conditional_60_Template, 2, 1, "button", 20);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(61, "div", 6)(62, "label", 21);
      \u0275\u0275text(63);
      \u0275\u0275pipe(64, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(65, "mat-form-field", 8)(66, "mat-select", 22)(67, "mat-option", 23);
      \u0275\u0275text(68);
      \u0275\u0275pipe(69, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(70, "mat-option", 24);
      \u0275\u0275text(71);
      \u0275\u0275pipe(72, "translate");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      const auto_r10 = \u0275\u0275reference(38);
      const menu_r11 = \u0275\u0275reference(52);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(36, 43, "ADMIN.APP_KEYS_SCOPES_REQUIRED"));
      \u0275\u0275advance(4);
      \u0275\u0275repeater(\u0275\u0275pipeBind1(41, 45, ctx.scopes));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(45, 47, "USERS.SINGULAR"));
      \u0275\u0275advance(4);
      ...
      \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(65, _c1))("placeholder", \u0275\u0275pipeBind1(56, 49, "USERS.SEARCH"));
      \u0275\u0275advance(3);
      \u0275\u0275repeater(\u0275\u0275pipeBind3(59, 51, ctx.users(), 0, 10));
      \u0275\u0275advance(3);
      \u0275\u0275conditional(!((tmp_28_0 = ctx.users()) == null ? null : tmp_28_0.length) ? 60 : -1);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(64, 55, "ADMIN.PERMISSIONS"));
      \u0275\u0275advance(4);
      \u0275\u0275property("value", null);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(69, 57, "ADMIN.PERMISSIONS_NONE"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(72, 59, "ADMIN.PERMISSIONS_USER"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(75, 61, "ADMIN.PERMISSIONS_SUPPORT"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(78, 63, "ADMIN.PERMISSIONS_ADMIN"));
    }
  }, dependencies: [
    CommonModule,
    FormsModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(APIKeyModalComponent, { className: "APIKeyModalComponent", filePath: "src/app/admin/api-keys/api-key-modal.component.ts", lineNumber: 245 });
})();
...
var APIKeyService = class _APIKeyService {
  ...
  available_domains = ru({ limit: 500 }).pipe(map((_) => _.data), shareReplay(1));
  available_scopes = ee("/api/engine/v2/scopes").pipe(map((_) => _), shareReplay(1));
  ...
  users = combineLatest([
    ...
    return domain ? Jc({ authority_id: domain.id, q }).pipe(map((_) => _.data)) : of([]);
  }), shareReplay(1));
  setDomain(domain) {
  ...
  async newKey() {
    ...
    const key = await lastValueFrom(M({
      query_params: {},
      fn: (d) => new PlaceAPIKeyDetails(d),
      path: "api_keys",
...
function AdminAPIKeysComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminAPIKeysComponent_Conditional_17_Template_div_click_9_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r3 = \u0275\u0275nextContext();
...
var AdminAPIKeysComponent = class _AdminAPIKeysComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminAPIKeysComponent, selectors: [["admin-api-keys"]], decls: 40, vars: 63, consts: [["scopes_template", ""], ["description_template", ""], ["access_template", ""], ["data_from_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-12"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click", "disabled"], [1, "mx-4", "mb-4", "flex", "w-[calc(100%-2rem)]", "items-start", "space-x-2"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-5xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "h-12", "w-full"], [1, "flex", "w-full", "flex-col", "rounded-sm", "border", "border-base-300", "shadow-sm"], [1, "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "border-b", "border-base-300", "bg-base-200"], [1, "px-4", "py-2", "text-lg", "font-medium"], [1, "mono", "rounded-sm", "bg-base-100", "px-2", "py-1", "text-xs", "opacity-60"], [1, "mono", "cursor-pointer", "select-all", "wrap-break-word", "px-4", "py-3", "opacity-60", 3, "click"], [1, "flex", "flex-wrap", "px-4", "py-2"], [1, "m-1", "text-xs"], [1, "p-4", "text-xs"], [1, "opacity-30"], [1, "p-4", "font-mono", "text-xs", "uppercase"], [1, "p-4"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-error"]], template: function AdminAPIKeysComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275property("disabled", !\u0275\u0275pipeBind1(14, 20, ctx.domain));
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminAPIKeysComponent, { className: "AdminAPIKeysComponent", filePath: "src/app/admin/api-keys/api-keys.component.ts", lineNumber: 198 });
})();
export {
  AdminAPIKeysComponent
};
//# sourceMappingURL=chunk-MTV5OMAG.js.map
