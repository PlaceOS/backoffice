...
var UploadLibraryComponent = class _UploadLibraryComponent extends AsyncHandler {
  ...
  async downloadUpload(upload) {
    const tkn = X();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Ht()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=60;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
...
//# sourceMappingURL=chunk-NMZ4K35N.js.map
