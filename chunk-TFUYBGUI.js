...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-QAORKZFW.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-CCEZXSLD.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-A7IY5Y34.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-KI6RAKCK.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-K5XNQTRK.js").then((m) => m.AdminSignagePluginsComponent)
      },
      {
        path: "build-jobs",
...
//# sourceMappingURL=chunk-TFUYBGUI.js.map
