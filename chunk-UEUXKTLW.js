...
var EdgeModalComponent = class _EdgeModalComponent {
  ...
  async save() {
    ...
    const method = edge.id ? Pc(edge.id, edge) : Ec(edge);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EdgeModalComponent, selectors: [["edge-modal"]], outputs: { event: "event" }, decls: 22, vars: 20, consts: [[3, "save", "heading", "loading"], [3, "formGroup"], [1, "flex", "flex-1", "flex-col"], ["for", "edge-name"], ["appearance", "outline"], ["id", "edge-name", "matInput", "", "formControlName", "name", 3, "placeholder"], ["for", "edge-description"], ["id", "edge-description", "matInput", "", "formControlName", "description", 3, "placeholder"]], template: function EdgeModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EdgeModalComponent, { className: "EdgeModalComponent", filePath: "src/app/admin/edge-modal.component.ts", lineNumber: 87 });
})();
...
var PlaceEdgeComponent = class _PlaceEdgeComponent {
  ...
  async token(edge) {
    const details = await lastValueFrom(Oc(edge.id));
  ...
  async remove(i) {
    ...
    const err = await lastValueFrom(Tc(i.id)).catch((_) => _);
    details.close();
    if (err)
  ...
  async loadEdges() {
    ...
    const { data } = await lastValueFrom(Ic());
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceEdgeComponent, selectors: [["", "admin-edge", ""]], attrs: _c0, decls: 27, vars: 40, consts: [["name_template", ""], ["time_template", ""], ["bool_template", ""], ["description_template", ""], ["actions_template", ""], ["matRipple", "", 1, "border-base-200", "bg-base-100", "absolute", "top-4", "right-4", "flex", "max-w-[calc(100%-11rem)]", "cursor-pointer", "items-center", "overflow-hidden", "rounded-sm", "border", "shadow-sm", 3, "matTooltip"], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["btn", "", 1, "w-40", 3, "click"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-5xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], ["matRipple", "", 1, "border-base-200", "bg-base-100", "absolute", "top-4", "right-4", "flex", "max-w-[calc(100%-11rem)]", "cursor-pointer", "items-center", "overflow-hidden", "rounded-sm", "border", "shadow-sm", 3, "click", "matTooltip"], [1, "border-base-200", "flex", "h-full", "w-1/2", "flex-1", "items-center", "border-r", "p-2"], [1, "flex-1", "truncate"], [1, "rounded-none"], [1, "flex", "flex-col", "px-4", "py-2"], [1, "text-xs", "opacity-30"], [1, "flex", "flex-col", "p-4"], ["matTooltipPosition", "right", 1, "flex", "h-full", "w-full", "items-center", "justify-center", 3, "matTooltip"], [1, "h-3", "w-3", "rounded-full"], [1, "w-full", "overflow-hidden", "px-4", "py-2", "text-xs", "select-text"], [1, "opacity-30"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"]], template: function PlaceEdgeComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-UEUXKTLW.js.map
