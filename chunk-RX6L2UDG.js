...
import {
  SystemStateService
} from "./chunk-LH4XCXDK.js";
import "./chunk-K6R3FLXT.js";
import {
  BindingDirective
} from "./chunk-UZERE5JX.js";
import "./chunk-GKSBSY6N.js";
import "./chunk-7ZXH46SC.js";
import "./chunk-XQMMIPUL.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
...
} from "./chunk-44QHUPSB.js";
import "./chunk-U7F6GIG4.js";
import {
  SettingsFieldComponent
} from "./chunk-YZU3SQA7.js";
import "./chunk-UVS4UHCY.js";
import "./chunk-NRGAP4VU.js";
...
} from "./chunk-L5VQ5BDJ.js";
import "./chunk-QT5RWFEG.js";
import "./chunk-6RLDP7DJ.js";
import "./chunk-PGB6GY3R.js";
import {
  MatCheckbox,
  MatCheckboxModule
} from "./chunk-CRKGZJW7.js";
import {
  MatTooltip,
  MatTooltipModule
...
function ViewModuleStateModalComponent_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 10, "SYSTEMS.SINGULAR"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.system?.display_name || ctx_r1.system?.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.system?.id);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(13, 12, "MODULES.SINGULAR"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.module?.custom_name || ctx_r1.module?.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.device_classes()[ctx_r1.module?.id], " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 14, "MODULES.STATE_UPDATE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r1.state())("readonly", true)("fill", true);
    \u0275\u0275control();
  }
}
...
var ViewModuleStateModalComponent = class _ViewModuleStateModalComponent extends AsyncHandler {
  ...
  closing = signal(
    false,
    ...ngDevMode ? [{ debugName: "closing" }] : (
      /* istanbul ignore next */
      []
    )
  );
  /** Mapping of devices to the module bindings */
  device_classes = signal(
    {},
    ...ngDevMode ? [{ debugName: "device_classes" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  generateModuleBindings() {
    ...
    for (const device of this.devices) {
      ...
      this.device_classes.update((classes) => __spreadProps(__spreadValues({}, classes), {
  ...
  async updateState() {
    ...
    try {
      const state = await Ta(this.system.id, class_parts.slice(0, class_parts.length - 1).join("_"), num);
      ...
      this.state.set(JSON.stringify(pre_state, void 0, 4));
    } catch (err) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewModuleStateModalComponent, selectors: [["view-module-state-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 4, consts: [[1, "bg-base-200", "mx-4", "mt-4", "mb-2", "flex", "items-center", "justify-between", "rounded-sm", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "h-[calc(100vh-6rem)]", "w-[80vw]", "flex-col", "space-y-2", "overflow-auto", "p-4"], [1, "flex", "h-[calc(100vh-6rem)]", "w-[80vw]", "flex-col", "items-center", "justify-center"], [1, "mb-2", "flex", "items-center", "space-x-2"], [1, "border-base-300", "relative", "min-w-48", "rounded-sm", "border", "px-4", "py-2"], [1, "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "px-2", "py-1", "text-xs"], [1, "truncate"], [1, "text-xs", "opacity-30"], [1, "w-px", "flex-1"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "flex", "min-h-0", "flex-1"], [1, "min-h-0", "flex-1", 3, "ngModel", "readonly", "fill"], ["diameter", "32"]], template: function ViewModuleStateModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "close");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(7, ViewModuleStateModalComponent_Conditional_7_Template, 25, 16, "main", 3)(8, ViewModuleStateModalComponent_Conditional_8_Template, 5, 3, "main", 4);
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ViewModuleStateModalComponent, { className: "ViewModuleStateModalComponent", filePath: "src/app/overlays/view-module-state.component.ts", lineNumber: 121 });
})();
...
var ContextMenuComponent = class _ContextMenuComponent extends AsyncHandler {
  ...
  menu = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? { debugName: "menu" } : (
    /* istanbul ignore next */
    {}
  )), { alias: "context-menu" }));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContextMenuComponent, selectors: [["", "context-menu", ""]], viewQuery: function ContextMenuComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx.container, _c0, 5)(ctx.trigger, MatMenuTrigger, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(2);
    }
  ...
  }, inputs: { menu: [1, "context-menu", "menu"], offset_x: [1, "offset_x"], offset_y: [1, "offset_y"] }, features: [\u0275\u0275InheritDefinitionFeature], ngContentSelectors: _c1, decls: 3, vars: 5, consts: [["container", ""], [1, "pointer-events-none", "fixed", "h-px", "w-px", 2, "opacity", "0", "height", "0", 3, "matMenuTriggerFor"]], template: function ContextMenuComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      \u0275\u0275projection(0);
      \u0275\u0275element(1, "div", 1, 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContextMenuComponent, { className: "ContextMenuComponent", filePath: "src/app/ui/context-menu.component.ts", lineNumber: 40 });
})();

// src/app/systems/system-modules.component.ts
var _c02 = (a0, a1) => ({ key: "state", name: a0, content: a1, size: "4rem" });
var _c12 = (a0, a1) => ({ key: "name", name: a0, content: a1, size: "15rem" });
var _c2 = (a0, a1) => ({ key: "type", name: a0, content: a1, size: "6.5rem" });
...
function SystemModulesComponent_Conditional_0_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 8)(1, "h3", 22);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "execute-method-field", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 3, "COMMON.EXECUTE_COMMAND"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("system", ctx_r1.item_signal())("refresh", ctx_r1.modules_refresh());
  }
}
function SystemModulesComponent_Conditional_0_Conditional_17_For_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 25);
    \u0275\u0275listener("click", function SystemModulesComponent_Conditional_0_Conditional_17_For_1_Template_button_click_0_listener() {
...
function SystemModulesComponent_Conditional_0_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, SystemModulesComponent_Conditional_0_Conditional_17_For_1_Template, 6, 5, "button", 24, \u0275\u0275repeaterTrackByIdentity);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SystemModulesComponent_Conditional_0_ng_template_29_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 30);
  }
}
function SystemModulesComponent_Conditional_0_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 29);
    \u0275\u0275twoWayListener("modelChange", function SystemModulesComponent_Conditional_0_ng_template_29_Template_button_modelChange_0_listener($event) {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      \u0275\u0275twoWayBindingSet(row_r6.connected, $event) || (row_r6.connected = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("click", function SystemModulesComponent_Conditional_0_ng_template_29_Template_button_click_0_listener() {
      const index_r7 = \u0275\u0275restoreView(_r5).index;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.setActive(index_r7));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(1, SystemModulesComponent_Conditional_0_ng_template_29_Conditional_1_Template, 1, 0, "mat-spinner", 30);
  }
  if (rf & 2) {
    const row_r6 = ctx.row;
    const index_r7 = ctx.index;
    \u0275\u0275nextContext();
    const context_menu_r8 = \u0275\u0275reference(16);
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275property("sys", ctx_r1.item.id)("mod", ctx_r1.bindings()[index_r7]);
    \u0275\u0275twoWayProperty("model", row_r6.connected);
    \u0275\u0275property("matMenuTriggerFor", context_menu_r8);
    \u0275\u0275advance();
    \u0275\u0275conditional(row_r6.running && row_r6.connected === void 0 ? 1 : -1);
  }
}
function SystemModulesComponent_Conditional_0_ng_template_31_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function SystemModulesComponent_Conditional_0_ng_template_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 32)(2, "a", 33);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 34);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(6, SystemModulesComponent_Conditional_0_ng_template_31_Conditional_6_Template, 2, 4, "a", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r9.driver?.name || row_r9.name, " ");
    \u0275\u0275advance(2);
...
function SystemModulesComponent_Conditional_0_ng_template_33_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.driver_type(row_r10.role || row_r10.driver?.role), " ");
  }
}
function SystemModulesComponent_Conditional_0_ng_template_35_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.bindings()[index_r11], " ");
  }
}
function SystemModulesComponent_Conditional_0_ng_template_37_Template(rf, ctx) {
  if (rf & 1) {
...
function SystemModulesComponent_Conditional_0_ng_template_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 41)(1, "mat-checkbox", 42);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("change", function SystemModulesComponent_Conditional_0_ng_template_39_Template_mat_checkbox_change_1_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("disabled", !row_r14.running)("checked", ctx_r1.debugging()[row_r14.id])("matTooltip", \u0275\u0275pipeBind1(2, 5, ctx_r1.debugging()[row_r14.id] ? "SYSTEMS.DEBUG_DISABLE" : "SYSTEMS.DEBUG_ENABLE"));
  }
}
function SystemModulesComponent_Conditional_0_ng_template_41_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 43)(1, "button", 44);
    \u0275\u0275listener("click", function SystemModulesComponent_Conditional_0_ng_template_41_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function SystemModulesComponent_Conditional_0_ng_template_41_Template_button_click_4_listener() {
...
function SystemModulesComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275conditionalCreate(0, SystemModulesComponent_Conditional_0_Conditional_0_Template, 5, 5, "section", 8);
    ...
    \u0275\u0275elementStart(15, "mat-menu", null, 0);
    \u0275\u0275conditionalCreate(17, SystemModulesComponent_Conditional_0_Conditional_17_Template, 2, 0);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 16)(19, "simple-table", 17);
    \u0275\u0275pipe(20, "translate");
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275pipe(23, "translate");
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275pipe(26, "translate");
    \u0275\u0275listener("enter_row", function SystemModulesComponent_Conditional_0_Template_simple_table_enter_row_19_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setActive($event));
    })("ondrop", function SystemModulesComponent_Conditional_0_Template_simple_table_ondrop_19_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(28, "div", 19);
    \u0275\u0275template(29, SystemModulesComponent_Conditional_0_ng_template_29_Template, 2, 13, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(31, SystemModulesComponent_Conditional_0_ng_template_31_Template, 7, 6, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(33, SystemModulesComponent_Conditional_0_ng_template_33_Template, 2, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(35, SystemModulesComponent_Conditional_0_ng_template_35_Template, 2, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(37, SystemModulesComponent_Conditional_0_ng_template_37_Template, 5, 4, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(39, SystemModulesComponent_Conditional_0_ng_template_39_Template, 3, 7, "ng-template", null, 6, \u0275\u0275templateRefExtractor)(41, SystemModulesComponent_Conditional_0_ng_template_41_Template, 7, 1, "ng-template", null, 7, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(43, "button", 20);
    \u0275\u0275pipe(44, "translate");
    \u0275\u0275listener("click", function SystemModulesComponent_Conditional_0_Template_button_click_43_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sortByType());
    });
    \u0275\u0275elementStart(45, "icon", 21);
    \u0275\u0275text(46, "sort");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const context_menu_r8 = \u0275\u0275reference(16);
    const state_template_r18 = \u0275\u0275reference(30);
    const name_template_r19 = \u0275\u0275reference(32);
    const type_template_r20 = \u0275\u0275reference(34);
    const class_template_r21 = \u0275\u0275reference(36);
    const url_template_r22 = \u0275\u0275reference(38);
    const debug_template_r23 = \u0275\u0275reference(40);
    const actions_template_r24 = \u0275\u0275reference(42);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r1.item.id && ctx_r1.item.modules && !ctx_r1.hide_exec ? 0 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 23, "SYSTEMS.MODULE_LIST"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(6, 25, "SYSTEMS.FIND_MODULE"))("query_fn", ctx_r1.query_fn)("exclude", ctx_r1.exclude_fn)("ngModel", null);
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r1.new_module());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 27, "COMMON.ADD_EXISTING"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 29, "COMMON.ADD_NEW"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("opacity-0", !ctx_r1.loading().modules);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.active_item() ? 17 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("pointer-events-none", ctx_r1.loading().modules)("opacity-60", ctx_r1.loading().modules);
    \u0275\u0275property("context-menu", context_menu_r8);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx_r1.modules)("columns", \u0275\u0275pureFunction7(67, _c7, \u0275\u0275pureFunction2(47, _c02, \u0275\u0275pipeBind1(20, 31, "SYSTEMS.MODULE_FIELD_STATE"), state_template_r18), \u0275\u0275pureFunction2(50, _c12, \u0275\u0275pipeBind1(21, 33, "SYSTEMS.MODULE_FIELD_NAME"), name_template_r19), \u0275\u0275pureFunction2(53, _c2, \u0275\u0275pipeBind1(22, 35, "SYSTEMS.MODULE_FIELD_TYPE"), type_template_r20), \u0275\u0275pureFunction2(56, _c3, \u0275\u0275pipeBind1(23, 37, "SYSTEMS.MODULE_FIELD_CLASS"), class_template_r21), \u0275\u0275pureFunction2(59, _c4, \u0275\u0275pipeBind1(24, 39, "SYSTEMS.MODULE_FIELD_ADDRESS"), url_template_r22), \u0275\u0275pureFunction2(62, _c5, \u0275\u0275pipeBind1(25, 41, "SYSTEMS.MODULE_FIELD_DEBUG"), debug_template_r23), \u0275\u0275pureFunction1(65, _c6, actions_template_r24)))("can_reorder", true)("color", ctx_r1.colors())("empty_message", \u0275\u0275pipeBind1(26, 43, "SYSTEMS.MODULE_LIST_EMPTY"));
    \u0275\u0275advance(24);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(44, 45, "SYSTEMS.SORT_MODULES_BY_CLASS_TOOLTIP"));
  }
}
var SystemModulesComponent = class _SystemModulesComponent extends AsyncHandler {
  ...
  new_module = signal(
    "",
    ...ngDevMode ? [{ debugName: "new_module" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  item_signal = computed(
    () => this._service.item(),
    ...ngDevMode ? [{ debugName: "item_signal" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  modules_refresh = computed(
    () => {
      this.modules();
      return Date.now();
    },
    ...ngDevMode ? [{ debugName: "modules_refresh" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  query_fn = (_) => lc({ q: _, no_logic: true }).then((resp) => resp.data.map((mod) => __spreadProps(__spreadValues({}, mod), {
    extra: mod.driver?.name
  })));
  /** Function for excluding modules already within this system */
  exclude_fn = (item, __) => item.control_system_id === this.item.id || item.role === Nt.Logic;
  newModule = () => this._service.newModule();
  removeModule = (d) => this._service.removeModule(d);
  editModule = (d) => this._service.editModule(d);
  joinModule = (id) => this._service.joinModule(id);
  toggleDebug = (d) => this._service.toggleModuleDebug(d);
  power = (d) => this._service.toggleModulePower(d);
  addToSystem = (d) => this._service.addModuleToSystem(d);
  sortByType = () => this._service.sortModulesByType();
  driver_type(role) {
    if (!role && role != 0)
      return "";
    switch (role) {
  ...
  async loadModule(device) {
    await $c(device.id).then(() => notifySuccess(`Successfully loaded module "${device.name || device.id}"`), (err) => notifyError(`Error loading module. Error: ${JSON.stringify(err.response || err.message || err)}`));
  }
  /**
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SystemModulesComponent, selectors: [["system-modules"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["context_menu", "matMenu"], ["state_template", ""], ["name_template", ""], ["type_template", ""], ["class_template", ""], ["url_template", ""], ["debug_template", ""], ["actions_template", ""], ["exec", "", 1, "p-4"], [1, "bg-base-200", "mx-auto", "mb-2", "w-[calc(100%-2rem)]", "rounded-sm", "p-4", "text-lg", "font-medium"], ["add-module", "", 1, "flex", "w-full", "flex-wrap", "space-x-2", "px-4"], ["label", "module", 1, "h-12", "w-full", "grow", "sm:w-auto", "sm:flex-1", 3, "ngModelChange", "placeholder", "query_fn", "exclude", "ngModel"], ["btn", "", "matRipple", "", 1, "h-11", "w-40", "flex-1", "sm:w-32", "sm:flex-none", 3, "click", "disabled"], ["btn", "", "matRipple", "", 1, "h-11", "w-40", "flex-1", "sm:w-32", "sm:flex-none", 3, "click"], ["device-list", "", 1, "min-h-[calc(100%-20rem)]", "overflow-y-auto", "p-4"], ["mode", "indeterminate", 1, "sticky", "left-0", "w-full"], [1, "flex", 3, "context-menu"], [1, "block", "min-w-312", "text-sm", 3, "enter_row", "ondrop", "data", "columns", "can_reorder", "color", "empty_message"], [1, "h-4", "w-4", "min-w-4"], [1, "h-16", "w-full"], ["fab", "", "matRipple", "", "matTooltipPosition", "left", 1, "bg-secondary", "text-secondary-content", "fixed", "right-4", "bottom-4", "z-50", "flex", "h-12", "w-12", "items-center", "justify-center", "rounded-lg", "shadow-lg", 3, "click", "matTooltip"], [1, "text-2xl"], [1, "bg-base-200", "mb-2", "w-full", "rounded-sm", "p-4", "text-lg", "font-medium"], [3, "system", "refresh"], ["mat-menu-item", "", 3, "disabled"], ["mat-menu-item", "", 3, "click", "disabled"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl", 3, "icon"], [1, "text"], ["dot", "", "binding", "", "bind", "connected", "aria-label", "Module connection status", 1, "mx-auto", "h-4", "w-4", "rounded-full", 3, "modelChange", "click", "sys", "mod", "model", "matMenuTriggerFor"], ["diameter", "32", 1, "pointer-events-none", "absolute", "top-1/2", "left-1/2", "-translate-x-1/2", "-translate-y-1/2"], [1, "flex", "w-full", "max-w-full", "items-center", "justify-between", "space-x-2", "px-4", "py-2"], [1, "flex", "max-w-full", "flex-1", "flex-col", "items-start", "overflow-hidden", "leading-snug"], [1, "max-w-full", "truncate", "underline", 3, "routerLink"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], ["icon", "", "matRipple", "", 1, "border-base-200", "bg-info", "text-info-content", "h-6", "w-6", "max-w-6", "min-w-6", "rounded-full", "border", "text-xs", 3, "matTooltip", "routerLink"], [1, "p-4"], [1, "p-4", "font-mono", "text-xs"], [1, "flex", "max-w-88", "items-center", "p-4"], [1, "text-xl"], ["target", "_blank", 1, "max-w-[20rem]", "truncate", "underline", 3, "href"], [1, "mx-auto"], ["matTooltipPosition", "left", 3, "change", "disabled", "checked", "matTooltip"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matMenuTriggerFor"]], template: function SystemModulesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, SystemModulesComponent_Conditional_0_Template, 47, 75);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemModulesComponent, { className: "SystemModulesComponent", filePath: "src/app/systems/system-modules.component.ts", lineNumber: 380 });
})();
export {
  SystemModulesComponent
};
//# sourceMappingURL=chunk-RX6L2UDG.js.map
