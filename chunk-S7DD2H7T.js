...
var RichTextInputComponent = class _RichTextInputComponent extends AsyncHandler {
  ...
  _setAuth() {
    const tkn = V();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Qe()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=30;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplateFormComponent, { className: "EmailTemplateFormComponent", filePath: "src/app/admin/mailing-lists/email-template-form.component.ts", lineNumber: 187 });
})();
export {
  EmailTemplateFormComponent,
  extractTextFromHTML
};
//# sourceMappingURL=chunk-S7DD2H7T.js.map
