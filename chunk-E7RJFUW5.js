import {
  startOfMinute
} from "./chunk-XOGFQX7U.js";
import {
  ExecuteMethodFieldComponent
} from "./chunk-7LD4UX4O.js";
import {
...
} from "./chunk-GKSBSY6N.js";
import {
  calculateModuleIndex
} from "./chunk-7ZXH46SC.js";
import {
  isBefore
} from "./chunk-74ZONB4W.js";
import {
  CustomTooltipComponent
} from "./chunk-JKQJDYPY.js";
import {
  ActiveItemService
} from "./chunk-NRGAP4VU.js";
import {
  openConfirmModal
} from "./chunk-TUGYSRNX.js";
import {
  moveItemInArray
} from "./chunk-7KQO4KVV.js";
import {
  addDays
...
import {
  ...
  MatChipRow,
  MatChipsModule
} from "./chunk-277XJOAN.js";
import {
  MatAutocomplete,
  MatAutocompleteModule,
  MatAutocompleteTrigger
} from "./chunk-QT5RWFEG.js";
import {
  SettingsToggleComponent
} from "./chunk-PGB6GY3R.js";
import {
  MatSelect,
  MatSelectModule,
  MatSelectTrigger
} from "./chunk-VMQJNUAC.js";
import {
  FormField,
  disabled,
  form,
  submit,
  validate
} from "./chunk-WUJNSD3X.js";
import {
  FullscreenModalShellComponent
} from "./chunk-UMUFHY24.js";
import {
  notifyError,
  notifySuccess
...
import {
  AsyncHandler
} from "./chunk-OOF3366H.js";
import {
  MatInput,
  MatInputModule
} from "./chunk-QUUJ3KQH.js";
import {
  MatError,
  MatFormField,
  MatFormFieldModule,
...
import {
  ...
  NgModel,
  ɵNgNoValidate
} from "./chunk-TUQY4L4B.js";
import {
  MAT_DIALOG_DATA,
  MatDialog,
  MatDialogRef
} from "./chunk-I3KJAEKD.js";
import {
  MatOption,
  MatRippleModule
} from "./chunk-NALZHFC6.js";
import {
  TranslatePipe,
  i18n
} from "./chunk-4EBHF2Z4.js";
import {
  IconComponent
} from "./chunk-LNMJVTUY.js";
import {
  COMMA,
  ENTER,
  SPACE
} from "./chunk-L2M3MNUF.js";
import {
  numberToPosition,
  padLength
...
function TriggerActionModalComponent_Conditional_2_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 2, "TRIGGERS.ACTION_FIELD_TYPE"), ": ");
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form.action_type);
    \u0275\u0275control();
    \u0275\u0275advance();
...
function TriggerActionModalComponent_Conditional_2_Case_2_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275classProp("error", ctx_r1.form.emails().touched() && ctx_r1.form.emails().invalid());
    \u0275\u0275advance();
...
function TriggerActionModalComponent_Conditional_2_Case_2_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 2, "TRIGGERS.ACTION_EMAIL_BODY"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form.content);
    \u0275\u0275control();
  }
}
function TriggerActionModalComponent_Conditional_2_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, TriggerActionModalComponent_Conditional_2_Case_2_Conditional_1_Template, 6, 4, "div", 3);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(ctx_r1.form.emails ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.content ? 1 : -1);
  }
}
function TriggerActionModalComponent_Conditional_2_Case_3_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 4, "TRIGGERS.ACTION_EXECUTE_SELECT"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r1.form.method_call)("system", ctx_r1.system)("can_execute", false);
    \u0275\u0275control();
  }
}
function TriggerActionModalComponent_Conditional_2_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, TriggerActionModalComponent_Conditional_2_Case_3_Conditional_0_Template, 5, 6, "div", 3);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(ctx_r1.form.method_call ? 0 : -1);
  }
}
function TriggerActionModalComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form", 2);
    \u0275\u0275conditionalCreate(1, TriggerActionModalComponent_Conditional_2_Conditional_1_Template, 8, 4, "div", 3);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.action_type ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_2_0 = ctx_r1.formModel().action_type) === "emails" ? 2 : 3);
  }
}
var TriggerActionModalComponent = class _TriggerActionModalComponent extends AsyncHandler {
  ...
  form = form(this.formModel, applyTriggerActionFormSchema);
  ...
  action_types = signal(
    [],
    ...ngDevMode ? [{ debugName: "action_types" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  addEmail(email) {
    ...
    this.formModel.update((model2) => __spreadProps(__spreadValues({}, model2), { emails: email_list }));
  ...
  async save() {
    ...
    await ja(this.trigger.id, __spreadProps(__spreadValues({}, this.trigger), {
  ...
  }, outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 3, vars: 5, consts: [["chipList", ""], [3, "save", "heading", "loading"], ["trigger-action", "", 1, "flex", "w-full", "max-w-[calc(100vw-2rem)]", "flex-col"], [1, "field"], ["for", "type"], ["appearance", "outline"], [3, "formField"], [3, "value"], ["for", "description"], ["appearance", "outline", 1, "w-full"], [3, "aria-label"], [3, "ngModelChange", "matChipInputTokenEnd", "ngModel", "ngModelOptions", "placeholder", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [3, "removed"], [1, "max-w-md", "truncate"], ["type", "button", "matChipRemove", ""], ["for", "content"], ["matInput", "", "placeholder", "Email body contents...", 3, "formField"], [3, "formField", "system", "can_execute"]], template: function TriggerActionModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(2, TriggerActionModalComponent_Conditional_2_Template, 4, 2, "form", 2);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TriggerActionModalComponent, { className: "TriggerActionModalComponent", filePath: "src/app/ui/forms/trigger-action-modal.component.ts", lineNumber: 213 });
})();
...
function TriggerConditionComparisonFormComponent_Conditional_0_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 3, "TRIGGERS.COMPARE_OP"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form().operator)("placeholder", \u0275\u0275pipeBind1(6, 5, "TRIGGERS.COMPARE_OP_SELECT"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
...
function TriggerConditionComparisonFormComponent_Conditional_0_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function TriggerConditionComparisonFormComponent_Conditional_0_Conditional_4_Template_mat_select_ngModelChange_5_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.formModel().update((model2) => __spreadProps(__spreadValues({}, model2), { right: "" })));
    });
...
function TriggerConditionComparisonFormComponent_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 6)(5, "input", 12);
    \u0275\u0275listener("ngModelChange", function TriggerConditionComparisonFormComponent_Conditional_0_Conditional_5_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.formModel().update((model2) => __spreadProps(__spreadValues({}, model2), { right: $event })));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 4, "TRIGGERS.COMPARE_TO"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r1.formModel()().right)("ngModelOptions", \u0275\u0275pureFunction0(8, _c12));
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 6, "TRIGGERS.COMPARE_JSON_REQUIRED"));
  }
}
...
function TriggerConditionComparisonFormComponent_Conditional_0_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275nextContext(2);
    const status_variable_form_r6 = \u0275\u0275reference(2);
    \u0275\u0275property("ngTemplateOutlet", status_variable_form_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction0(2, _c22));
  }
}
function TriggerConditionComparisonFormComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(3, TriggerConditionComparisonFormComponent_Conditional_0_Conditional_3_Template, 9, 7, "div", 4);
    \u0275\u0275conditionalCreate(4, TriggerConditionComparisonFormComponent_Conditional_0_Conditional_4_Template, 8, 6, "div", 4);
    \u0275\u0275conditionalCreate(5, TriggerConditionComparisonFormComponent_Conditional_0_Conditional_5_Template, 9, 9, "div", 4)(6, TriggerConditionComparisonFormComponent_Conditional_0_Conditional_6_Template, 1, 3, "ng-container");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    const status_variable_form_r6 = \u0275\u0275reference(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", status_variable_form_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction0(6, _c02));
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form().left().touched() && ctx_r1.form().left().invalid() ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form().operator ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form().operator ? 4 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.rhs_type() === "constant" ? 5 : 6);
  }
}
function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_1_For_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const mod_r9 = ctx.$implicit;
    \u0275\u0275property("value", mod_r9.name);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", mod_r9.name, " ");
  }
}
function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_1_Template_mat_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r7);
      const side_r8 = \u0275\u0275nextContext().side;
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1[side_r8 + "_side"].mod, $event) || (ctx_r1[side_r8 + "_side"].mod = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_1_Template_mat_select_ngModelChange_5_listener($event) {
      ...
      const side_r8 = \u0275\u0275nextContext().side;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.loadSystemStatusVariables($event, side_r8));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1[side_r8 + "_side"].mod);
...
function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_2_For_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", mod_r11.name);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", mod_r11.name, " ");
  }
}
function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_2_Template_mat_select_ngModelChange_5_listener($event) {
      ...
      const side_r8 = \u0275\u0275nextContext().side;
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1[side_r8 + "_side"].status, $event) || (ctx_r1[side_r8 + "_side"].status = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_2_Template_mat_select_ngModelChange_5_listener() {
      ...
      const side_r8 = \u0275\u0275nextContext().side;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateFormForSide(side_r8));
    });
...
function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function TriggerConditionComparisonFormComponent_ng_template_1_Conditional_3_Template_input_ngModelChange_5_listener($event) {
      ...
      const side_r8 = \u0275\u0275nextContext().side;
      const ctx_r1 = \u0275\u0275nextContext();
      ctx_r1[side_r8 + "_side"].keys = $event.split(",");
      return \u0275\u0275resetView(ctx_r1.updateFormForSide(side_r8));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("for", side_r8 + "-subkeys");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 5, "TRIGGERS.COMPARE_SUBKEYS"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r1[side_r8 + "_keys"])("name", side_r8 + "-subkeys")("placeholder", \u0275\u0275pipeBind1(6, 7, "TRIGGERS.COMPARE_SUBKEYS_PLACEHOLDER"));
    \u0275\u0275control();
  }
}
function TriggerConditionComparisonFormComponent_ng_template_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const side_r8 = ctx.side;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1[side_r8 + "_side"] ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1[side_r8 + "_status_variables"]?.length ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1[side_r8 + "_status_variables"] && ctx_r1[side_r8 + "_status_variables"].length ? 3 : -1);
  }
}
var TriggerConditionComparisonFormComponent = class _TriggerConditionComparisonFormComponent {
  ...
  module_list = signal(
    [],
    ...ngDevMode ? [{ debugName: "module_list" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  right_var_type = signal(
    [],
    ...ngDevMode ? [{ debugName: "right_var_type" }] : (
      /* istanbul ignore next */
      []
    )
  );
  /** Allowed comparison operators */
  compare_types = signal(
    [],
    ...ngDevMode ? [{ debugName: "compare_types" }] : (
      /* istanbul ignore next */
      []
    )
  );
   ...
   */
  async loadSystemStatusVariables(mod_name, side) {
    const name = (mod_name || "").split("_");
    if (!name[0]?.length)
      return;
    await Ta(this.system().id, name.length > 1 ? name.slice(0, name.length - 1).join("_") : name[0], +name[name.length - 1] || 1).then((var_map) => {
    ...
    }).catch(() => notifyError(i18n("TRIGGERS.COMPARE_VARIABLE_LOAD_ERROR", {
  ...
  async loadSystemModules() {
    ...
    this.module_list.set(this.modules.map((mod) => {
  ...
  addExistingModules() {
    ...
    if (form2.left && model2.left) {
      const module = model2.left.mod;
      ...
      this.left_side = model2.left;
    }
    if (form2.right && model2.right && model2.right.mod) {
      this.rhs_type.set("status_var");
      const module = model2.right.mod;
      if (!this.module_list().find((mod) => mod.name === module)) {
        this.module_list.update((list) => [
          {
            id: "old_right_value",
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TriggerConditionComparisonFormComponent, selectors: [["trigger-condition-comparison-form"]], inputs: { form: [1, "form"], formModel: [1, "formModel"], system: [1, "system"] }, features: [\u0275\u0275NgOnChangesFeature], decls: 3, vars: 1, consts: [["status_variable_form", ""], [1, "trigger-condition", "form", "comparison"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "error"], [1, "field"], ["for", "operator", "hidden", ""], ["appearance", "outline"], [3, "formField", "placeholder"], [3, "value"], ["for", "compared-to", "hidden", ""], ["name", "compared-to", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "constant", "hidden", ""], ["matInput", "", "placeholder", "true/false, 'string', 123.456", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "fieldset"], ["for", "type"], ["name", "type", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "for"], [3, "ngModelChange", "name", "ngModel", "ngModelOptions", "placeholder"], ["matInput", "", 3, "ngModelChange", "ngModel", "name", "placeholder"]], template: function TriggerConditionComparisonFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, TriggerConditionComparisonFormComponent_Conditional_0_Template, 7, 7, "div", 1);
...
(() => {
  ...
  }], null, { form: [{ type: Input, args: [{ isSignal: true, alias: "form", required: false }] }], formModel: [{ type: Input, args: [{ isSignal: true, alias: "formModel", required: false }] }], system: [{ type: Input, args: [{ isSignal: true, alias: "system", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TriggerConditionComparisonFormComponent, { className: "TriggerConditionComparisonFormComponent", filePath: "src/app/ui/forms/trigger-condition-form/comparison-form.component.ts", lineNumber: 225 });
})();
...
var CronInputFieldComponent = class _CronInputFieldComponent {
  ...
  form = form(this.formModel, (path) => {
    for (const field of [
      ...
      disabled(field, { when: () => this.disabled() });
    }
    this.validatePattern(path.minute, listPattern("(?:\\*(?:/\\d{1,2})?|[0-5]?\\d(?:-[0-5]?\\d)?(?:/\\d{1,2})?)"));
    this.validatePattern(path.hour, listPattern("(?:\\*(?:/\\d{1,2})?|(?:[01]?\\d|2[0-3])(?:-(?:[01]?\\d|2[0-3]))?(?:/\\d{1,2})?)"));
    this.validatePattern(path.day, listPattern("(?:\\*(?:/\\d{1,2})?|(?:[1-9]|[12]\\d|3[01])(?:-(?:[1-9]|[12]d|3[01]))?(?:/\\d{1,2})?)"));
    this.validatePattern(path.month, listPattern("(?:\\*(?:/\\d{1,2})?|(?:[1-9]|1[0-2])(?:-(?:[1-9]|1[0-2]))?(?:/\\d{1,2})?)"));
    this.validatePattern(path.day_of_week, listPattern("(?:\\*(?:/\\d{1,2})?|[0-6](?:-[0-6])?(?:/\\d{1,2})?)"));
  });
  ...
  validatePattern(path, pattern) {
    const regex = new RegExp(`^${pattern}$`);
    validate(path, ({ value }) => regex.test(String(value() || "")) ? void 0 : { kind: "pattern", message: "Invalid CRON segment" });
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CronInputFieldComponent, selectors: [["cron-input-field"]], features: [\u0275\u0275ProvidersFeature([
  ...
  ])], decls: 8, vars: 7, consts: [[1, "border-base-300", "focus-within:border-base-content", "focus-within:outline-base-content", "mb-1", "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "border", "focus-within:outline-4", 3, "focusout"], ["placeholder", "*", 1, "w-px", "flex-1", "border-none", "bg-none", "p-2", "text-base", "outline-hidden", 3, "keydown", "formField"], ["placeholder", "*", 1, "w-px", "flex-1", "border-none", "bg-none", "p-2", "text-base", "outline-hidden", 3, "formField"], [1, "text-error", "text-xs"]], template: function CronInputFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275listener("focusout", function CronInputFieldComponent_Template_div_focusout_0_listener() {
    ...
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("formField", ctx.form.minute);
      \u0275\u0275control();
      \u0275\u0275advance();
      \u0275\u0275property("formField", ctx.form.hour);
      \u0275\u0275control();
      \u0275\u0275advance();
      \u0275\u0275property("formField", ctx.form.day);
      \u0275\u0275control();
      \u0275\u0275advance();
      \u0275\u0275property("formField", ctx.form.month);
      \u0275\u0275control();
      \u0275\u0275advance();
      \u0275\u0275property("formField", ctx.form.day_of_week);
      \u0275\u0275control();
      \u0275\u0275advance();
      \u0275\u0275classProp("opacity-0", !ctx.form().invalid());
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CronInputFieldComponent, { className: "CronInputFieldComponent", filePath: "src/app/ui/custom-fields/cron-input-field.component.ts", lineNumber: 88 });
})();
...
function DateCalendarComponent_For_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("disabled", ctx_r3.disabled() || day_r3.id < ctx_r3.from() || day_r3.id > ctx_r3.to());
    \u0275\u0275advance();
...
var DateCalendarComponent = class _DateCalendarComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DateCalendarComponent, selectors: [["date-calendar"]], inputs: { from: [1, "from"], to: [1, "to"], offset_weekday: [1, "offset_weekday"] }, features: [\u0275\u0275ProvidersFeature([
  ...
  ]), \u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 19, vars: 10, consts: [[1, "p-2"], [1, "flex", "items-center", "justify-between"], [1, "pr-2", "pl-1.5", "font-medium"], [1, "flex", "items-center"], ["icon", "", "matRipple", "", "name", "schedule-next-month", 3, "click", "disabled"], ["icon", "", "matRipple", "", "name", "schedule-previous-month", 3, "click", "disabled"], [1, "border-base-200", "mb-2", "flex", "items-center", "border-b", "pb-2", "text-sm"], [1, "flex-1", "text-center", "opacity-60"], [1, "flex", "flex-wrap", "items-center", "justify-between"], ["icon", "", "name", "schedule-set-date", 1, "relative", "my-0.5", "h-9", "w-9", "min-w-[14%]", "overflow-visible", 3, "hover:bg-base-100", "text-base-300!", "text-secondary-content", "text-base-content", "bg-secondary", "font-normal", "disabled"], ["icon", "", "name", "schedule-set-date", 1, "relative", "my-0.5", "h-9", "w-9", "min-w-[14%]", "overflow-visible", 3, "click", "disabled"], ["matRipple", "", 1, "border-secondary", "absolute", "-inset-[2px]", "overflow-hidden", "rounded-full", "border"], ["matRipple", "", 1, "absolute", "inset-0", "overflow-hidden", "rounded-full"]], template: function DateCalendarComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 3, ctx.date_list()[6]?.id || ctx.date(), "LLLL YYYY"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("disabled", ctx.disabled() || ctx.date_list()[0]?.id < ctx.from());
      \u0275\u0275advance(3);
      \u0275\u0275property("disabled", ctx.disabled() || ctx.date_list()[34]?.id > ctx.to());
      \u0275\u0275advance(4);
      \u0275\u0275repeater(\u0275\u0275pipeBind3(15, 6, ctx.date_list(), 0, 7));
      \u0275\u0275advance(4);
      \u0275\u0275repeater(ctx.date_list());
    }
  }, dependencies: [IconComponent, DatePipe, SlicePipe], encapsulation: 2 });
};
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DateCalendarComponent, { className: "DateCalendarComponent", filePath: "src/app/ui/custom-fields/date-calendar.component.ts", lineNumber: 123 });
})();
...
function DateFieldComponent_ng_template_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r0.date() || ctx_r0.now)("from", ctx_r0.fromDate)("to", ctx_r0.until)("offset_weekday", ctx_r0.week_start());
    \u0275\u0275control();
  }
}
...
var DateFieldComponent = class _DateFieldComponent extends AsyncHandler {
  ...
  get fromDate() {
    ...
    return (isNaN(date.getTime()) ? startOfDay(/* @__PURE__ */ new Date()) : date).valueOf();
  }
  /** Current date value */
  get until() {
    const date = new Date(this.to());
    return (isNaN(date.getTime()) ? addYears(endOfDay(/* @__PURE__ */ new Date()), 1) : date).valueOf();
  }
  ngOnInit() {
  ...
  }, inputs: { from: [1, "from"], to: [1, "to"], week_start: [1, "week_start"], use_24hr: [1, "use_24hr"], disabled: [1, "disabled"], short: [1, "short"], timezone: [1, "timezone"], range: [1, "range"] }, outputs: { disabled: "disabledChange" }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => _DateFieldComponent),
      multi: true
    }
  ]), \u0275\u0275InheritDefinitionFeature], ngContentSelectors: _c03, decls: 13, vars: 7, consts: [["calendar_picker", ""], ["customTooltip", "", "yPosition", "top", "matRipple", "", 1, "border-neutral", "flex", "h-12", "w-full", "items-center", "justify-between", "rounded-sm", "border", 3, "content", "disabled"], [1, "flex", "w-1/2", "flex-1", "flex-col", "truncate", "px-4", "py-2", "text-left", "leading-tight"], [1, "text-base", "font-normal"], [1, "opacity-30"], [1, "truncate", "text-xs", "opacity-30"], [1, "flex", "h-10", "w-10", "items-center", "justify-center", "text-2xl"], [1, "error", "text-error", "h-5", "p-1", "text-xs"], [1, "bg-base-100", "relative", "w-[18rem]", "rounded-sm", "px-2", "py-4"], [3, "ngModelChange", "ngModel", "from", "to", "offset_weekday"]], template: function DateFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
(() => {
  ...
  }], null, { from: [{ type: Input, args: [{ isSignal: true, alias: "from", required: false }] }], to: [{ type: Input, args: [{ isSignal: true, alias: "to", required: false }] }], week_start: [{ type: Input, args: [{ isSignal: true, alias: "week_start", required: false }] }], use_24hr: [{ type: Input, args: [{ isSignal: true, alias: "use_24hr", required: false }] }], disabled: [{ type: Input, args: [{ isSignal: true, alias: "disabled", required: false }] }, { type: Output, args: ["disabledChange"] }], short: [{ type: Input, args: [{ isSignal: true, alias: "short", required: false }] }], timezone: [{ type: Input, args: [{ isSignal: true, alias: "timezone", required: false }] }], range: [{ type: Input, args: [{ isSignal: true, alias: "range", required: false }] }], _tooltip: [{ type: ViewChild, args: [forwardRef(() => CustomTooltipComponent), { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DateFieldComponent, { className: "DateFieldComponent", filePath: "src/app/ui/custom-fields/date-field.component.ts", lineNumber: 109 });
})();
...
var TimeFieldComponent = class _TimeFieldComponent extends AsyncHandler {
  ...
  select_field = viewChild(
    "select",
    ...ngDevMode ? [{ debugName: "select_field" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  ]), \u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], ngContentSelectors: _c13, decls: 8, vars: 5, consts: [["select", ""], ["appearance", "outline", 3, "keydown.enter"], ["matInput", "", "type", "time", 3, "ngModelChange", "disabled", "ngModel"], ["btn", "", "icon", "", "matSuffix", "", 1, "relative", "top-1", "-right-1", 3, "click"], [1, "text-base-content", "text-opacity-50", "text-2xl"], ["appearance", "outline"], [3, "valueChange", "value", "disabled"], [3, "value"]], template: function TimeFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TimeFieldComponent, { className: "TimeFieldComponent", filePath: "src/app/ui/custom-fields/time-field.component.ts", lineNumber: 105 });
})();
...
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275listener("input", function TriggerConditionTimeFormComponent_Conditional_0_Conditional_4_Template_input_input_7_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.updateTimezoneList($event.target.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const auto_r5 = \u0275\u0275reference(10);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 5, "COMMON.TIMEZONE"));
    \u0275\u0275advance(5);
    \u0275\u0275property("formField", ctx_r1.form().timezone)("placeholder", \u0275\u0275pipeBind1(8, 7, "COMMON.TIMEZONE"))("matAutocomplete", auto_r5);
    \u0275\u0275control();
    \u0275\u0275advance(4);
...
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_5_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(3, 2, "TRIGGERS.TIME_FIELD_DATE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r1.form().time);
    \u0275\u0275control();
  }
}
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_5_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(3, 2, "TRIGGERS.TIME_FIELD_TIME"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r1.form().time);
    \u0275\u0275control();
  }
...
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5);
    \u0275\u0275conditionalCreate(1, TriggerConditionTimeFormComponent_Conditional_0_Conditional_5_Conditional_1_Template, 5, 4, "div", 4);
    \u0275\u0275conditionalCreate(2, TriggerConditionTimeFormComponent_Conditional_0_Conditional_5_Conditional_2_Template, 5, 4, "div", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form().time ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form().time ? 2 : -1);
  }
}
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_6_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", period_r7.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", period_r7.name, " ");
  }
}
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_6_Conditional_8_Conditional_1_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const \u0275$index_85_r10 = ctx.$index;
    \u0275\u0275property("value", \u0275$index_85_r10 + 1);
    \u0275\u0275advance();
...
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_6_Conditional_8_Conditional_2_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", period_r12.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", period_r12.name, " ");
  }
}
...
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_6_Conditional_8_Conditional_3_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const \u0275$index_115_r15 = ctx.$index;
    \u0275\u0275property("value", \u0275$index_115_r15);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", weekday_r14, " ");
  }
}
...
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_6_Conditional_8_Conditional_5_For_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", +hour_r17);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.pad(hour_r17), ":");
  }
}
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_6_Conditional_8_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" cron_hour() ", ctx_r1.pad(ctx_r1.cron_hour), ":");
    \u0275\u0275advance(3);
...
function TriggerConditionTimeFormComponent_Conditional_0_Conditional_6_Conditional_8_Conditional_6_For_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const minute_r19 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(5);
    \u0275\u0275property("value", +minute_r19);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.pad(ctx_r1.cron_hour()));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(":", ctx_r1.pad(minute_r19), " ");
  }
}
...
function TriggerConditionTimeFormComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, TriggerConditionTimeFormComponent_Conditional_0_Conditional_4_Template, 14, 9, "div", 4);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(3, 5, "TRIGGERS.TIME_SCHEDULE"));
...
var TriggerConditionTimeFormComponent = class _TriggerConditionTimeFormComponent extends AsyncHandler {
  ...
  repeat_period = signal(
    [],
    ...ngDevMode ? [{ debugName: "repeat_period" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  cron_period = signal(
    "minute",
    ...ngDevMode ? [{ debugName: "cron_period" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  days_of_week = signal(
    [],
    ...ngDevMode ? [{ debugName: "days_of_week" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  months_of_year = signal(
    [],
    ...ngDevMode ? [{ debugName: "months_of_year" }] : (
      /* istanbul ignore next */
      []
    )
  );
  cron_string = signal(
    "",
    ...ngDevMode ? [{ debugName: "cron_string" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  cron_minute = signal(
    0,
    ...ngDevMode ? [{ debugName: "cron_minute" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  cron_month = signal(
    1,
    ...ngDevMode ? [{ debugName: "cron_month" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  ngOnInit() {
    ...
    this.days_of_week.set(new Array(7).fill(0).map((_, index) => i18n(`COMMON.${format(setDay(Date.now(), index), "EEEE").toUpperCase()}`)));
    this.months_of_year.set(Array(12).fill(0).map((_, index) => i18n(`COMMON.${format(setMonth(Date.now(), index), "MMMM").toUpperCase()}`)));
  }
  ngOnChanges(changes) {
    const form2 = this.form();
  ...
  updateTimezoneList(tz) {
    ...
    this.timezones.set(TIMEZONES_IANA.filter((_) => _.toLowerCase().includes(tz_lower)));
  }
  toggleCRON(is_cron) {
    this.formModel().update((model2) => __spreadProps(__spreadValues({}, model2), {
      cron: "",
      time_type: is_cron ? hr.CRON : hr.AT
    }));
    this.updateCronString();
  }
  saveCRON(cron_str) {
    this.timeout("save_cron", () => this.formModel().update((model2) => __spreadProps(__spreadValues({}, model2), {
      cron: cron_str
    })), 1e3);
  }
  /**
  ...
  updateCronString() {
    ...
    if (form2 && form2.cron) {
      ...
      this.formModel().update((model2) => __spreadProps(__spreadValues({}, model2), { cron: cron_str }));
    }
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TriggerConditionTimeFormComponent, selectors: [["trigger-condition-time-form"]], inputs: { form: [1, "form"], formModel: [1, "formModel"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 1, vars: 1, consts: [["auto", "matAutocomplete"], [1, "trigger-condition", "form", "time"], [1, "field", "mb-4"], [3, "ngModelChange", "label", "ngModel", "ngModelOptions"], [1, "field"], [1, "flex", "space-x-4"], ["for", "timezone"], ["appearance", "outline"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", 3, "input", "formField", "placeholder", "matAutocomplete"], [3, "value"], [3, "disabled"], ["for", "type"], [3, "formField"], ["name", "type", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "ngModel", "ngModelOptions"], [1, "field", "w-2/5", "flex-1"], [1, "flex", "items-center", "space-x-4"], ["for", "month"], ["name", "month", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "day"], ["name", "day", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "weekday"], ["name", "weekday", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "hour"], ["name", "hour", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "opacity-30"], ["for", "minute"], ["name", "minute", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "ngModelChange", "ngModel", "ngModelOptions"]], template: function TriggerConditionTimeFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, TriggerConditionTimeFormComponent_Conditional_0_Template, 7, 8, "div", 1);
    }
    if (rf & 2) {
      \u0275\u0275conditional(ctx.form() ? 0 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TriggerConditionTimeFormComponent, { className: "TriggerConditionTimeFormComponent", filePath: "src/app/ui/forms/trigger-condition-form/time-form.component.ts", lineNumber: 316 });
})();
...
function TriggerConditionModalComponent_Conditional_2_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 2, "TRIGGERS.CONDITION_FIELD_TYPE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form.condition_type);
    \u0275\u0275control();
    \u0275\u0275advance();
...
function TriggerConditionModalComponent_Conditional_2_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("form", ctx_r1.form)("formModel", ctx_r1.formModel)("system", ctx_r1.system);
  }
}
function TriggerConditionModalComponent_Conditional_2_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("form", ctx_r1.form)("formModel", ctx_r1.formModel);
  }
}
function TriggerConditionModalComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form", 1);
    \u0275\u0275conditionalCreate(1, TriggerConditionModalComponent_Conditional_2_Conditional_1_Template, 8, 4, "div", 2);
    \u0275\u0275conditionalCreate(2, TriggerConditionModalComponent_Conditional_2_Conditional_2_Template, 1, 3, "trigger-condition-comparison-form", 3)(3, TriggerConditionModalComponent_Conditional_2_Conditional_3_Template, 1, 2, "trigger-condition-time-form", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.condition_type ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.formModel().condition_type === "compare" ? 2 : 3);
  }
}
var TriggerConditionModalComponent = class _TriggerConditionModalComponent extends AsyncHandler {
  ...
  form = form(this.formModel, applyTriggerConditionFormSchema);
  ...
  async save() {
    ...
    void (this.formModel().condition_type === "compare" ? this.updateComparisons() : this.updateTimeDependents());
    const item = await ja(this.trigger.id, __spreadProps(__spreadValues({}, this.trigger), {
      conditions: this.conditions
    })).catch((err) => notifyError(i18n("TRIGGERS.CONDITION_SAVE_ERROR", {
  ...
  updateComparisons() {
    ...
    const new_value = {
      left: typeof this.formModel().left === "string" ? JSON.parse(this.formModel().left) : this.formModel().left,
      operator: this.formModel().operator,
      right: typeof this.formModel().right === "string" ? JSON.parse(this.formModel().right) : this.formModel().right
    };
  ...
  updateTimeDependents() {
    ...
    const new_value = {
      ...
      time: +(this.formModel().time / 1e3).toFixed(0),
      cron: this.formModel().cron,
      timezone: this.formModel().timezone
    };
    if (new_value.type === hr.CRON) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TriggerConditionModalComponent, selectors: [["trigger-condition-modal"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 3, vars: 5, consts: [[3, "save", "heading", "loading"], ["trigger-condition", "", 1, "flex", "flex-col"], [1, "field"], [3, "form", "formModel", "system"], [3, "form", "formModel"], ["for", "type"], ["appearance", "outline"], [3, "formField"], [3, "value"]], template: function TriggerConditionModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(2, TriggerConditionModalComponent_Conditional_2_Template, 4, 2, "form", 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TriggerConditionModalComponent, { className: "TriggerConditionModalComponent", filePath: "src/app/ui/forms/trigger-condition-modal.component.ts", lineNumber: 100 });
})();
...
var TriggerStateService = class _TriggerStateService {
  ...
  _instances = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_instances" } : (
    /* istanbul ignore next */
    {}
  )), {
    ...
    loader: async ({ params }) => {
      const { item } = params;
      if (!(item instanceof pe))
        return [];
      this._loading.set(true);
      try {
        return Wa(item.id).catch(() => []);
      } finally {
  ...
  async editCondition(condition = null, template) {
    ...
    const result = await Promise.race([
      waitForEvent(ref.componentInstance.event, (event) => event.reason === "done"),
      waitForEvent(ref.afterClosed())
    ]);
    if (!result?.reason || !result.metadata?.trigger)
      return;
  ...
  async reorderAction(type, fst, snd) {
    ...
    const resp = await ja(this.active_item.id, __spreadProps(__spreadValues({}, this.active_item.toJSON()), {
      actions
    })).catch((_) => _);
    if (!(resp instanceof pe)) {
      const error = resp;
      return notifyError(i18n("TRIGGERS.REORDER_CONFIRM_ERROR", {
        error: JSON.stringify(error.response || error.message || resp)
      }));
    }
  ...
  async removeCondition(condition) {
    ...
    list.splice(index, 1);
    const resp = await ja(item.id, __spreadProps(__spreadValues({}, item.toJSON()), {
      conditions
    })).catch((err) => err);
    details.close();
    if (!(resp instanceof pe)) {
  ...
  async removeTriggerFromParent(instance) {
    ...
    const method = type === "zone" ? Ca : Ca;
    let err = await method(instance.control_system_id, instance?.id || this.active_item.id).catch((_) => ({ error: _ }));
    details.close();
    if (err?.error) {
      err = err.error;
  ...
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineService({ token: _TriggerStateService, factory: _TriggerStateService.\u0275fac });
};
(() => {
...
//# sourceMappingURL=chunk-E7RJFUW5.js.map
