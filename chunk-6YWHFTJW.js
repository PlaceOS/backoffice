...
import {
  ...
  addChipItem,
  removeChipItem
} from "./chunk-TDW2O7RD.js";
import {
  AuthenticatedImageDirective
} from "./chunk-5BG3YZTE.js";
import {
  DateFromPipe
} from "./chunk-CF2NOKQL.js";
import {
  Clipboard
} from "./chunk-PWRYQANA.js";
import {
  HotkeysService
...
} from "./chunk-SBQHH5ML.js";
import {
  UploadsService
} from "./chunk-3Y76NEPO.js";
import {
...
function generateSystemsFormFields(system) {
  const fields = {
    ...
    camera_snapshot_url: new FormControl(system.camera_snapshot_url || system.camera_snapshot_urls[0] || null),
...
var ItemCreateUpdateModalComponent = class _ItemCreateUpdateModalComponent extends AsyncHandler {
  ...
  submit() {
    ...
    const form_item = this.item.id ? ds(__spreadValues(__spreadValues({}, item_json), this.form.value), this.item_type === "user" ? [void 0, null, ""] : [void 0]) : __spreadValues(__spreadValues({}, item_json), this.form.value);
    if (this._data.external_save) {
      this.event.emit({ reason: "action", metadata: form_item });
      return;
    }
    this._data.save(form_item).subscribe((_item) => {
      this.result = _item;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemCreateUpdateModalComponent, { className: "ItemCreateUpdateModalComponent", filePath: "src/app/overlays/item-modal.component.ts", lineNumber: 146 });
})();
...
*/
//# sourceMappingURL=chunk-6YWHFTJW.js.map
