...
function ExtensionModalComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 7)(1, "span", 14);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ExtensionModalComponent_For_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "mat-form-field", 5)(3, "input", 15);
    \u0275\u0275pipe(4, "translate");
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(5, "div", 3)(6, "mat-form-field", 5)(7, "mat-select", 16);
    \u0275\u0275pipe(8, "translate");
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 3)(12, "mat-form-field", 5)(13, "input", 17);
    \u0275\u0275pipe(14, "translate");
...
var ExtensionModalComponent = class _ExtensionModalComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExtensionModalComponent, selectors: [["extension-modal"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 45, vars: 30, consts: [[3, "save", "heading", "loading"], [3, "formGroup"], [1, "fieldset"], [1, "field"], ["for", "type"], ["appearance", "outline"], ["formControlName", "type"], [3, "value"], ["for", "name"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["for", "url"], ["matInput", "", "name", "url", "formControlName", "url", 3, "placeholder"], [1, "w-full"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "capitalize"], ["matInput", "", "name", "condition-field", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["matInput", "", "name", "value", 3, "ngModelChange", "disabled", "ngModel", "ngModelOptions", "placeholder"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", "border", "border-error", "text-error", 3, "click"]], template: function ExtensionModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(39, ExtensionModalComponent_Conditional_39_Template, 3, 3, "label");
...
var PlaceExtensionsComponent = class _PlaceExtensionsComponent {
  ...
  editExtension(item) {
    ...
    ref.componentInstance.event.pipe(first((_) => _.reason === "done")).subscribe(async (event) => {
  ...
  async updateDomain(extension_list) {
    ...
    const updated = new Co(__spreadProps(__spreadValues({}, domain), {
    ...
    const new_domain = await ou(domain.id, updated).toPromise();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceExtensionsComponent, selectors: [["", "app-extensions", ""]], attrs: _c02, decls: 34, vars: 48, consts: [["type_template", ""], ["url_template", ""], ["conditions_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-12"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "matRipple", "", 3, "click"], [1, "mx-4", "mb-4", "flex", "items-center", "space-x-4", "rounded-sm", "bg-info", "p-4", "text-sm", "text-info-content", "shadow-sm"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "p-4", "font-mono", "text-xs", "uppercase"], [1, "truncate", "p-4", "underline", 3, "href"], [1, "p-4"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-error"]], template: function PlaceExtensionsComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-XEWZTEYT.js.map
