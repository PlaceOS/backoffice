...
var GroupFormComponent = class _GroupFormComponent extends AsyncHandler {
  ...
  query_parent_groups = (_) => Tu({ q: _, limit: 20 }).then(({ data }) => data);
  ...
  async submit() {
    await submit(this.form, async () => {
      ...
      try {
        const _item = await (form_item.id ? Eu(form_item.id, form_item) : Uu(form_item));
...
//# sourceMappingURL=chunk-IJETO5NF.js.map
