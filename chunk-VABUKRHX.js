...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-B5ILEX2R.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-PZNC4NIP.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-563PTIJB.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-344XJHN3.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
        loadComponent: () => import("./chunk-QI7JB3CY.js").then((m) => m.AdminAPIKeysComponent)
      },
      {
        path: "upload-storage",
...
//# sourceMappingURL=chunk-VABUKRHX.js.map
