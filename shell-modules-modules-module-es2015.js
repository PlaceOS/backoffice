...
class ModuleSystemsComponent extends _shared_globals_base_directive__WEBPACK_IMPORTED_MODULE_4__["BaseDirective"] {
    ...
    loadSystems(offset = 0) {
        ...
        Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["querySystems"])({ module_id: this.item.id, offset }).subscribe(list => {
            this.system_list = list;
        }, () => null);
    }
}
ModuleSystemsComponent.ɵfac = function ModuleSystemsComponent_Factory(t) { return new (t || ModuleSystemsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_app_service__WEBPACK_IMPORTED_MODULE_5__["ApplicationService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ModuleSystemsComponent, [{
    ...
    }], function () { return [{ type: _services_app_service__WEBPACK_IMPORTED_MODULE_5__["ApplicationService"] }]; }, { item: [{
...
class ModulesComponent extends _shared_components_base_root_component__WEBPACK_IMPORTED_MODULE_2__["BaseRootComponent"] {
    constructor(_service, _route, _router, _dialog) {
        ...
        this.save_fn = (item) => item.id ? Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["updateModule"])(item.id, item) : Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["addModule"])(item);
        /** Function to query domains */
        this.query_fn = (q) => Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["queryModules"])(q);
        /** Function to query domains */
        this.show_fn = (id, q) => Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["showModule"])(id, q);
    }
    ngOnInit() {
        super.ngOnInit();
    ...
    loadValues() {
        ...
        // Get system count
        Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["querySystems"])(query).subscribe((list) => {
            this.system_count = Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["lastRequestTotal"])('systems') || list.length || 0;
        });
    }
    /**
    ...
    newItem(copy = false) {
        ...
        this.modal_ref = this._dialog.open(src_app_overlays_item_modal_item_modal_component__WEBPACK_IMPORTED_MODULE_3__["ItemCreateUpdateModalComponent"], {
            ...
            data: {
                item: copy ? new _placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["PlaceModule"](Object.assign(Object.assign({}, this.item), { id: '', name: `${this.item.name} (1)` })) : new _placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["PlaceModule"](),
                name: 'Module',
                save: this.save_fn,
            }
        });
        ...
        if (this.item && !this.modal_ref) {
            ...
            this.subscription('delete_confirm', this.modal_ref.componentInstance.event.subscribe((event) => {
                if (event.reason === 'done') {
                    ...
                    Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["removeModule"])(this.item.id).subscribe(() => {
...
ModulesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ModulesComponent, selectors: [["app-modules"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 8, vars: 21, consts: [[1, "container"], [1, "sidebar"], ["heading", "Modules", "name", "modules", 3, "query_fn", "close", "queryParams", "event"], [1, "toggle"], ["labelPosition", "before", 3, "ngModel", "ngModelChange"], [3, "click"], ["name", "module", "route", "modules", 3, "save", "item", "tabs", "event"]], template: function ModulesComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ModulesComponent_Template_main_click_6_listener() { return ctx.show_sidebar = false; });
