...
var ResourceImportsComponent = class _ResourceImportsComponent {
  ...
  async ngOnInit() {
    const domain = St();
    const domain_list = await xo({ limit: 100 }).then((_2) => _2.data);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ResourceImportsComponent, { className: "ResourceImportsComponent", filePath: "src/app/admin/resource-imports.component.ts", lineNumber: 188 });
})();
export {
  ResourceImportsComponent
};
//# sourceMappingURL=chunk-DXH4HFG5.js.map
