...
function ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Conditional_3_Template, 3, 1, "div", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", ctx_r1.subroute() ? \u0275\u0275pureFunction3(5, _c4, ctx_r1.route(), item_r6.id, ctx_r1.subroute()) : \u0275\u0275pureFunction2(9, _c5, ctx_r1.route(), item_r6.id));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", item_r6.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r6.extra ? 3 : -1);
  }
}
function ItemSelectionComponent_Conditional_10_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, ItemSelectionComponent_Conditional_10_Conditional_14_ng_template_4_Template, 4, 12, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSelectionComponent, { className: "ItemSelectionComponent", filePath: "src/app/ui/item-selection.component.ts", lineNumber: 193 });
})();
...
function ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSidebarComponent_Conditional_16_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_5_Template, 2, 1, "div", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_6_Template, 2, 0, "icon", 39);
    \u0275\u0275conditionalCreate(7, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_7_Template, 4, 3, "div", 40);
    \u0275\u0275conditionalCreate(8, ItemSidebarComponent_Conditional_16_ng_template_4_Conditional_8_Template, 4, 3, "div", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", ctx_r2.subroute() ? \u0275\u0275pureFunction3(11, _c32, ctx_r2.route(), item_r11.id, ctx_r2.subroute()) : \u0275\u0275pureFunction2(15, _c42, ctx_r2.route(), item_r11.id))("matTooltip", item_r11.update_available && item_r11.commit !== item_r11.update_info.commit ? \u0275\u0275pipeBind1(1, 9, "COMMON.UPDATE_AVAILABLE") : "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", item_r11.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(item_r11.extra ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r11.update_available && item_r11.commit !== item_r11.update_info.commit ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r11.zone_issues ? 7 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r11.has_runtime_error ? 8 : -1);
  }
}
function ItemSidebarComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, ItemSidebarComponent_Conditional_16_ng_template_4_Template, 9, 18, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSidebarComponent, { className: "ItemSidebarComponent", filePath: "src/app/ui/item-sidebar.component.ts", lineNumber: 366 });
})();
...
//# sourceMappingURL=chunk-VKKSEGAL.js.map
