...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-ODARLCMU.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-3NTHY3CR.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-ZVDV3CCY.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-TJLTV6RJ.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-RVVX7F25.js").then((m) => m.AdminSignagePluginsComponent)
      },
      {
        path: "build-jobs",
...
//# sourceMappingURL=chunk-3TSTDN65.js.map
