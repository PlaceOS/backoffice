...
var ModuleFormComponent = class _ModuleFormComponent extends AsyncHandler {
  ...
  ngOnInit() {
    ...
    if (control_system_id && !system) {
      ta(control_system_id).then((sys) => this.formModel.update((v) => __spreadProps(__spreadValues({}, v), { system: sys })), () => null);
    }
  }
  constructor() {
    super();
    ...
    effect(() => {
      ...
      if (model2.system && model2.system.id !== model2.control_system_id) {
        this.formModel.update((value) => __spreadProps(__spreadValues({}, value), {
          control_system_id: model2.system.id
        }));
      }
    });
    effect(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModuleFormComponent, { className: "ModuleFormComponent", filePath: "src/app/modules/module-form.component.ts", lineNumber: 342 });
})();
...
//# sourceMappingURL=chunk-YFCEERVD.js.map
