...
function ModuleRuntimeErrorsModalComponent_Conditional_8_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.errors().join("\n"), " ");
  }
}
...
function ModuleRuntimeErrorsModalComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ModuleRuntimeErrorsModalComponent_Conditional_8_Conditional_1_Template, 2, 1, "code")(2, ModuleRuntimeErrorsModalComponent_Conditional_8_Conditional_2_Template, 3, 3, "div", 6);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var ModuleRuntimeErrorsModalComponent = class _ModuleRuntimeErrorsModalComponent {
  ...
  async _loadData() {
    ...
    try {
      const module = await firstValueFrom(sc(this._module_id));
      this.module.set(module);
      try {
        const errors = await firstValueFrom(_c(module.id));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModuleRuntimeErrorsModalComponent, selectors: [["module-runtime-errors-modal"]], decls: 10, vars: 6, consts: [[1, "border-base-100", "bg-base-200", "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "h-14", "w-[calc(100%-1rem)]", "max-w-full", "items-center", "justify-between", "rounded-sm", "border", "px-2"], [1, "flex", "items-center", "space-x-2", "px-2", "text-xl", "font-medium"], [1, "bg-base-100", "rounded", "px-2", "py-1", "font-mono", "text-xs"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "max-h-[65vh]", "overflow-auto", "p-4"], [1, "flex", "h-64", "w-[24rem]", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "flex", "h-64", "w-md", "flex-col", "items-center", "justify-center", "space-y-2", "opacity-30"], ["diameter", "32"], [1, "opacity-30"]], template: function ModuleRuntimeErrorsModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModuleRuntimeErrorsModalComponent, { className: "ModuleRuntimeErrorsModalComponent", filePath: "src/app/ui/module-runtime-errors-modal.component.ts", lineNumber: 71 });
})();

export {
  ModuleRuntimeErrorsModalComponent
};
//# sourceMappingURL=chunk-BPUQE7CU.js.map
