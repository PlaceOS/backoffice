...
var ExtensionModalComponent = class _ExtensionModalComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExtensionModalComponent, selectors: [["extension-modal"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 45, vars: 32, consts: [[3, "save", "heading", "loading"], [1, "fieldset"], [1, "field"], ["for", "type"], ["appearance", "outline"], [3, "formField"], [3, "value"], ["for", "name"], ["matInput", "", 3, "placeholder", "formField"], ["for", "url"], [1, "w-full"], [1, "label"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "capitalize"], ["matInput", "", "name", "condition-field", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["matInput", "", "name", "value", 3, "ngModelChange", "disabled", "ngModel", "ngModelOptions", "placeholder"], ["icon", "", "matRipple", "", 1, "border-error", "text-error", "h-12", "w-12", "rounded-sm", "border", 3, "click"]], template: function ExtensionModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExtensionModalComponent, { className: "ExtensionModalComponent", filePath: "src/app/admin/extension-modal/extension-modal.component.ts", lineNumber: 195 });
})();
...
var PlaceExtensionsComponent = class _PlaceExtensionsComponent {
  ...
  async ngOnInit() {
    ...
    const domain_list = await xo().then((r) => r.data);
  ...
  async updateDomain(extension_list) {
    ...
    const updated = new Di(__spreadProps(__spreadValues({}, domain), {
    ...
    const new_domain = await qo(domain.id, updated);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceExtensionsComponent, { className: "PlaceExtensionsComponent", filePath: "src/app/admin/extensions.component.ts", lineNumber: 190 });
})();
export {
  PlaceExtensionsComponent
};
//# sourceMappingURL=chunk-ECITIWMS.js.map
