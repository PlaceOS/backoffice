...
var PlaceExtensionsComponent = class _PlaceExtensionsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceExtensionsComponent, selectors: [["", "app-extensions", ""]], decls: 34, vars: 48, consts: [["type_template", ""], ["url_template", ""], ["conditions_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-12"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "matRipple", "", 3, "click"], [1, "bg-info", "text-info-content", "mx-4", "mb-4", "flex", "items-center", "space-x-4", "rounded-sm", "p-4", "text-sm", "shadow-sm"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "p-4", "font-mono", "text-xs", "uppercase"], [1, "truncate", "p-4", "underline", 3, "href"], [1, "p-4"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function PlaceExtensionsComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.extensions())("columns", \u0275\u0275pureFunction5(42, _c5, \u0275\u0275pureFunction2(29, _c02, \u0275\u0275pipeBind1(21, 19, "ADMIN.EXTENSIONS_FIELD_TYPE"), type_template_r9), \u0275\u0275pureFunction1(32, _c1, \u0275\u0275pipeBind1(22, 21, "ADMIN.EXTENSIONS_FIELD_TAB")), \u0275\u0275pureFunction2(34, _c2, \u0275\u0275pipeBind1(23, 23, "ADMIN.EXTENSIONS_FIELD_URL"), url_template_r10), \u0275\u0275pureFunction2(37, _c3, \u0275\u0275pipeBind1(24, 25, "ADMIN.EXTENSIONS_FIELD_CHECKS"), conditions_template_r11), \u0275\u0275pureFunction1(40, _c4, actions_template_r12)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(25, 27, "ADMIN.EXTENSIONS_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceExtensionsComponent, { className: "PlaceExtensionsComponent", filePath: "src/app/admin/extensions.component.ts", lineNumber: 186 });
})();
export {
  PlaceExtensionsComponent
};
//# sourceMappingURL=chunk-HFFDBSTW.js.map
