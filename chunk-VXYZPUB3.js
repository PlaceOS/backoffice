...
var ObjectListFieldComponent = class _ObjectListFieldComponent extends AsyncHandler {
  ...
  ]), \u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [[1, "object-list"], [1, "header", "row", "h-6", "text-sm"], [1, "row"], [1, "row", "h-10", "text-center"], ["btn", "", "type", "button", 1, "w-full", 3, "click"], [1, "contents"], [1, "text-2xl"], [1, "text"], [1, "field", "capitalize"], [1, "w-10"], [1, "field"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-error", "text-error", 3, "click"], ["appearance", "outline"], ["matInput", "", 3, "ngModelChange", "name", "placeholder", "ngModel"]], template: function ObjectListFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-VXYZPUB3.js.map
