...
function queryStorage(query_params = {}) {
  return k({ query_params, fn: process, path: PATH });
}
...
var StorageProviderModalComponent = class _StorageProviderModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StorageProviderModalComponent, selectors: [["storage-provider-modal"]], decls: 82, vars: 64, consts: [[3, "save", "heading", "loading"], [1, "w-full", 3, "formGroup"], [1, "flex", "flex-col"], ["for", "storage-type"], ["appearance", "outline"], ["name", "storage-type", "formControlName", "storage_type", "placeholder", "None"], ["value", "s3"], ["value", "azure"], [1, "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col"], ["for", "bucket-name"], ["matInput", "", "name", "bucket-name", "formControlName", "bucket_name", 3, "placeholder"], ["for", "region"], ["matInput", "", "name", "region", "formControlName", "region", 3, "placeholder"], ["for", "access-key"], ["matInput", "", "name", "access-key", "formControlName", "access_key", 3, "placeholder"], ["for", "access-secret"], ["matInput", "", "name", "access-secret", "formControlName", "access_secret", 3, "placeholder"], ["for", "endpoint"], ["matInput", "", "name", "endpoint", "formControlName", "endpoint", 3, "placeholder"], ["for", "extensions"], ["name", "extensions", "formControlName", "ext_filter", 3, "placeholder", "multiple"], [3, "value"], ["for", "mime-types"], ["name", "mime-types", "formControlName", "mime_filter", 3, "placeholder", "multiple"], ["formControlName", "is_default"]], template: function StorageProviderModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(32, "translate");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(33, "div", 8)(34, "div", 9)(35, "label", 14);
      \u0275\u0275text(36);
      \u0275\u0275pipe(37, "translate");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(43, "translate");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(44, "div", 9)(45, "label", 16);
      \u0275\u0275text(46);
      \u0275\u0275pipe(47, "translate");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(53, "translate");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(54, "div", 2)(55, "label", 18);
      \u0275\u0275text(56);
      \u0275\u0275pipe(57, "translate");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(60, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(61, "div", 2)(62, "label", 20);
      \u0275\u0275text(63);
      \u0275\u0275pipe(64, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(65, "mat-form-field", 4)(66, "mat-select", 21);
      \u0275\u0275pipe(67, "translate");
      \u0275\u0275repeaterCreate(68, StorageProviderModalComponent_For_69_Template, 2, 2, "mat-option", 22, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(70, "div", 2)(71, "label", 23);
      \u0275\u0275text(72);
      \u0275\u0275pipe(73, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(74, "mat-form-field", 4)(75, "mat-select", 24);
      \u0275\u0275pipe(76, "translate");
      \u0275\u0275repeaterCreate(77, StorageProviderModalComponent_For_78_Template, 2, 2, "mat-option", 22, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(79, "settings-toggle", 25);
      \u0275\u0275text(80);
      \u0275\u0275pipe(81, "translate");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 24, (ctx.storage == null ? null : ctx.storage.id) ? "ADMIN.STORAGE_EDIT" : "ADMIN.STORAGE_NEW"))("loading", ctx.loading());
      \u0275\u0275advance(2);
      \u0275\u0275property("formGroup", ctx.form);
      \u0275\u0275advance(13);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 26, "ADMIN.STORAGE_BUCKET_NAME_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(19, 28, "ADMIN.STORAGE_BUCKET_NAME_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(22, 30, "ADMIN.STORAGE_BUCKET_NAME_REQUIRED"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 32, "ADMIN.STORAGE_REGION_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(29, 34, "ADMIN.STORAGE_REGION_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(32, 36, "ADMIN.STORAGE_REGION_REQUIRED"));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 38, "ADMIN.STORAGE_ACCESS_KEY_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(40, 40, "ADMIN.STORAGE_ACCESS_KEY_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 42, "ADMIN.STORAGE_ACCESS_KEY_REQUIRED"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 44, "ADMIN.STORAGE_SECRET_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(50, 46, "ADMIN.STORAGE_SECRET_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(53, 48, "ADMIN.STORAGE_ACCESS_KEY_REQUIRED"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(57, 50, "ADMIN.STORAGE_ENDPOINT_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(60, 52, "ADMIN.STORAGE_ENDPOINT_LABEL"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(64, 54, "ADMIN.STORAGE_ALLOWED_EXTENSIONS_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(67, 56, "ADMIN.STORAGE_ALLOW_ALL_EXTENSIONS"))("multiple", true);
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.ALLOWED_FILE_EXTENSIONS);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(73, 58, "ADMIN.STORAGE_ALLOWED_MIME_LABEL"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(76, 60, "ADMIN.STORAGE_ALLOW_ALL_MIME"))("multiple", true);
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.ALLOWED_MIME_TYPES);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(81, 62, "ADMIN.STORAGE_IS_DEFAULT_LABEL"));
    }
  }, dependencies: [
    FullscreenModalShellComponent,
    SettingsToggleComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StorageProviderModalComponent, { className: "StorageProviderModalComponent", filePath: "src/app/admin/storage/storage-provider-modal.component.ts", lineNumber: 198 });
})();
...
function StorageComponent_ng_template_26_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", (row_r3.domain == null ? null : row_r3.domain.name) || row_r3.authority_id, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(!(row_r3.domain == null ? null : row_r3.domain.name) && !row_r3.authority_id ? 3 : -1);
    \u0275\u0275advance(2);
...
var StorageComponent = class _StorageComponent {
  ...
  loading = signal("", ...ngDevMode ? [{ debugName: "loading" }] : []);
  store_list = signal([], ...ngDevMode ? [{ debugName: "store_list" }] : []);
  ...
  async ngOnInit() {
    ...
    const domain_list = await lastValueFrom(hc().pipe(map((r) => r.data)));
  ...
  async loadStorage() {
    ...
    const { data } = await lastValueFrom(queryStorage({ auth_id: this.domain()?.id })).catch(() => ({ data: [] }));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StorageComponent, selectors: [["app-storage"]], decls: 36, vars: 60, consts: [["name_template", ""], ["code_template", ""], ["date_from_template", ""], ["bool_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-12"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-176", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "flex", "flex-col", "px-4", "py-2"], [1, "opacity-30"], [1, "text-xs", "opacity-30"], [1, "p-4"], [1, "flex", "h-full", "w-full", "items-center", "justify-center"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-error"]], template: function StorageComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("ngModelChange", function StorageComponent_Template_mat_select_ngModelChange_7_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.loadStorage());
      });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StorageComponent, { className: "StorageComponent", filePath: "src/app/admin/storage/storage.component.ts", lineNumber: 180 });
})();
export {
  StorageComponent
};
//# sourceMappingURL=chunk-FCI52YZ3.js.map
