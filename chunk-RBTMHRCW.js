...
var TriggerAboutComponent = class _TriggerAboutComponent extends AsyncHandler {
  ...
  query_fn = (q) => Zc({ q }).pipe(map((resp) => resp.data));
...
//# sourceMappingURL=chunk-RBTMHRCW.js.map
