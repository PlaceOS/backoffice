...
var APIKeyModalComponent = class _APIKeyModalComponent extends AsyncHandler {
  ...
  selectUser(user) {
    this.formModel.update((value) => __spreadProps(__spreadValues({}, value), { user, user_id: user.id }));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(APIKeyModalComponent, { className: "APIKeyModalComponent", filePath: "src/app/admin/api-keys/api-key-modal.component.ts", lineNumber: 277 });
})();
...
var APIKeyService = class _APIKeyService {
  ...
  _available_domains = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_available_domains" } : (
    /* istanbul ignore next */
    {}
  )), { loader: async () => (await xo({ limit: 500 })).data }));
  available_domains = computed(
    () => this._available_domains.value() || [],
    ...ngDevMode ? [{ debugName: "available_domains" }] : (
      /* istanbul ignore next */
      []
    )
  );
...
var AdminAPIKeysComponent = class _AdminAPIKeysComponent extends AsyncHandler {
  _service = inject(APIKeyService);
  ...
  ngOnInit() {
    ...
    const match = domain_list.find((d2) => d2.id === domain.id);
    if (match)
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminAPIKeysComponent, { className: "AdminAPIKeysComponent", filePath: "src/app/admin/api-keys/api-keys.component.ts", lineNumber: 204 });
})();
export {
  AdminAPIKeysComponent
};
//# sourceMappingURL=chunk-EJ6M2NTP.js.map
