...
var ModuleFormComponent = class _ModuleFormComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      const udp = driver.role === Ct.Service || driver.role === Ct.Websocket ? false : model.udp;
      const system = driver.role === Ct.Logic ? model.system : void 0;
...
//# sourceMappingURL=chunk-IHEKDJBO.js.map
