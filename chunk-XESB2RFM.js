...
function saveStorage(item) {
  const data = hs(item, ["", void 0, null]);
...
function removeStorage(id, query_params = {}) {
  return E({ id, query_params, path: PATH });
}
...
var StorageComponent = class _StorageComponent {
  ...
  async ngOnInit() {
    ...
    const domain_list = await lastValueFrom(Ou().pipe(map((r) => r.data)));
...
//# sourceMappingURL=chunk-XESB2RFM.js.map
