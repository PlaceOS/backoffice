...
var SystemAboutComponent = class _SystemAboutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SystemAboutComponent, selectors: [["system-about"]], decls: 48, vars: 49, consts: [[1, "p-4"], [1, "flex", "flex-col", "space-y-2", "sm:flex-row", "sm:space-y-0", "sm:space-x-2"], [1, "flex-1"], [1, "border-base-200", "grid", "w-full", "gap-2", "rounded-sm", "border", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "flex", "items-center"], ["matTooltipPosition", "right", 3, "matTooltip"], [1, "border-base-200", "flex", "flex-col", "rounded-sm", "border"], [1, "bg-base-200", "w-full", "rounded-sm", "px-4", "py-3", "text-lg", "font-medium"], [1, "flex", "flex-wrap", "items-center", "p-1"], ["btn", "", "start", "", "matRipple", "", 1, "m-1", "min-w-36", "flex-1", 3, "click"], ["btn", "", "stop", "", "matRipple", "", 1, "inverse", "error", "m-1", "min-w-36", "flex-1", 3, "click"], [1, "text-base-300", "my-4"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8"], ["target", "_blank", 1, "truncate", "underline", "select-all", 3, "href"], [1, "value", "mono"], [1, "border-base-200", "w-full", "rounded-sm", "border"], [1, "bg-base-200", "w-full", "rounded-sm", "p-4", "text-lg", "font-medium"], [1, "markdown", "w-full", "overflow-auto", "p-4", "text-sm", 3, "innerHTML"], [3, "id", "merge", "settings", "merge_settings"], [1, "mb-4", 3, "diameter"]], template: function SystemAboutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemAboutComponent, { className: "SystemAboutComponent", filePath: "src/app/systems/system-about.component.ts", lineNumber: 238 });
})();
export {
  SystemAboutComponent
};
//# sourceMappingURL=chunk-MKKGCKYB.js.map
