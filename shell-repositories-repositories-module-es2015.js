...
function RepositoryAboutComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function RepositoryAboutComponent_div_0_Template_button_tapped_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.pullLatestCommit(); });
...
class RepositoryAboutComponent extends _shared_globals_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    ...
    pullLatestCommit() {
        ...
        this._service.Repositories.pullCommit(this.item.id)
            ...
            this.item = new _placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["EngineRepository"](Object.assign(Object.assign({}, this.item), resp));
        }, err => {
            this.pulling = false;
...
class RepositoryDriversComponent extends _shared_globals_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    ...
    load(offset = 0) {
        ...
        this.loading = true;
        this._service.Repositories.listDrivers(this.item.id, { offset }).then(list => {
            this.loading = false;
...
RepositoryDriversComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RepositoryDriversComponent, selectors: [["repository-drivers"]], inputs: { item: "item" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 3, vars: 1, consts: [["class", "container", 4, "ngIf"], ["load_state", ""], [1, "container"], ["class", "settings", 4, "ngIf", "ngIfElse"], [1, "settings"], [4, "ngIf"], ["class", "info-block", 4, "ngIf"], [1, "flex"], [4, "ngFor", "ngForOf"], [3, "innerHTML"], [1, "small"], ["mat-icon-button", "", 3, "tapped"], [3, "icon"], [1, "info-block"], [1, "text"], [1, "info-block", "center"], [1, "icon"], ["diameter", "48"]], template: function RepositoryDriversComponent_Template(rf, ctx) { if (rf & 1) {
...
class RepositoriesComponent extends _shared_components_base_root_component__WEBPACK_IMPORTED_MODULE_3__["BaseRootComponent"] {
    ...
    loadValues() {
        ...
        if (this.item.type === _placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["EngineRepositoryType"].Driver) {
            ...
            this._service.Repositories.listDrivers(this.item.id, query).then(list => (this.driver_count = list.length));
        }
        else {
            this.driver_count = -1;
        }
...
RepositoriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: RepositoriesComponent, selectors: [["app-repositories"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 5, vars: 22, consts: [[1, "container"], [1, "sidebar"], ["heading", "Repositories", 3, "module", "close", "event"], [3, "touchrelease"], ["name", "repository", "route", "repositories", 3, "item", "loading", "tabs", "event"]], template: function RepositoriesComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("touchrelease", function RepositoriesComponent_Template_main_touchrelease_3_listener() { return ctx.show_sidebar = false; });
