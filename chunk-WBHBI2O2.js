...
var AdminInterfacesComponent = class _AdminInterfacesComponent {
  ...
  async loadInterfaces() {
    ...
    const mapping = await lastValueFrom(rc());
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminInterfacesComponent, selectors: [["app-interfaces"]], decls: 11, vars: 17, consts: [["name_template", ""], [1, "px-4"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2"], [1, "text-2xl"], ["mode", "indeterminate", 1, "w-full"], ["empty_message", "No interfaces", 1, "block", "min-w-[36rem]", "text-sm", 3, "data", "columns", "sortable"], [1, "h-12", "w-full"], [1, "p-4"], [1, "font-mono"], [1, "text-xs", "opacity-30"]], template: function AdminInterfacesComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-WBHBI2O2.js.map
