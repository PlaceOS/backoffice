...
var StaffTenantModalComponent = class _StaffTenantModalComponent {
  ...
  async save() {
    ...
    const data = Js(__spreadValues(__spreadValues({}, this.tenant || {}), value), ["", null, void 0]);
    const call = this.tenant?.id ? ce(`/api/staff/v1/tenants/${this.tenant.id}`, data) : S("/api/staff/v1/tenants", data);
...
//# sourceMappingURL=chunk-AT6BH35O.js.map
