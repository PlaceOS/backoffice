...
var SettingsHistoryViewComponent = class _SettingsHistoryViewComponent {
  ...
  settings = toSignal(this._service.item.pipe(switchMap((i) => !i ? of({ data: [] }) : Vc({ parent_id: i.id })), map((_) => _.data)), { initialValue: [] });
  history = toSignal(toObservable(this.active_setting).pipe(debounceTime(300), switchMap((_) => !_ ? of([]) : Kc(_.id))), { initialValue: [] });
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-5KPFEWDD.js.map
