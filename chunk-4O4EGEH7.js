...
var MetadataHistoryModalComponent = class _MetadataHistoryModalComponent {
  ...
  second_details = "";
  async ngOnInit() {
    const history = await tc(this._data.id, {
      name: this._data.name,
      limit: 5e3
    }).toPromise();
...
function MetadataDisplayComponent_Conditional_8_For_2_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
...
function MetadataDisplayComponent_Conditional_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MetadataDisplayComponent_Conditional_8_For_2_Template_button_click_10_listener($event) {
      \u0275\u0275restoreView(_r2);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(11, "button", 17);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275listener("click", function MetadataDisplayComponent_Conditional_8_For_2_Template_button_click_11_listener() {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.saveMetadata(item_r3));
    });
    \u0275\u0275elementStart(13, "icon", 18);
    \u0275\u0275text(14, "save");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "button", 19);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275listener("click", function MetadataDisplayComponent_Conditional_8_For_2_Template_button_click_15_listener() {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.editMetadataDetails(item_r3));
    });
    \u0275\u0275elementStart(17, "icon", 18);
    \u0275\u0275text(18, "edit");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "button", 19);
    \u0275\u0275pipe(20, "translate");
    \u0275\u0275listener("click", function MetadataDisplayComponent_Conditional_8_For_2_Template_button_click_19_listener() {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.viewMetadataHistory(item_r3));
    });
    \u0275\u0275elementStart(21, "icon", 18);
    \u0275\u0275text(22, "history");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "button", 20);
    \u0275\u0275pipe(24, "translate");
    \u0275\u0275listener("click", function MetadataDisplayComponent_Conditional_8_For_2_Template_button_click_23_listener() {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.deleteMetadata(item_r3.name));
    });
    \u0275\u0275elementStart(25, "icon", 18);
    \u0275\u0275text(26, "delete");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(27, "button", 21)(28, "icon", 22);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(30, "div", 23)(31, "div")(32, "div", 24);
    \u0275\u0275conditionalCreate(33, MetadataDisplayComponent_Conditional_8_For_2_Conditional_33_Template, 1, 2, "settings-form-field", 25);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const item_r3 = ctx.$implicit;
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 18, item_r3.updated_at), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx_r3.edited[item_r3.name])("matTooltip", \u0275\u0275pipeBind1(12, 20, "COMMON.SAVE"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(16, 22, "COMMON.METADATA_EDIT"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(20, 24, "COMMON.METADATA_HISTORY"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(24, 26, "COMMON.METADATA_REMOVE"));
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r3.show_view() === item_r3.name ? 33 : -1);
  }
}
function MetadataDisplayComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6);
    \u0275\u0275repeaterCreate(1, MetadataDisplayComponent_Conditional_8_For_2_Template, 34, 28, "div", 8, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
var MetadataDisplayComponent = class _MetadataDisplayComponent extends AsyncHandler {
  ...
  async deleteMetadata(field) {
    ...
    if (result.reason !== "done")
      return;
    await lastValueFrom(sc(this.item().id, { name: field })).catch((err) => {
  ...
  saveMetadata(field) {
    ...
    rc(this.item().id, __spreadProps(__spreadValues({}, value), {
      ...
      next: (item) => {
        ...
        if (field.name !== value.name) {
          lastValueFrom(sc(this.item().id, { name: field.name })).catch((err) => notifyError(`Error removing old "${field.name}" metadata. Error: ${JSON.stringify(err.response || err.message || err)}`));
        }
        if (index >= 0) {
          this.metadata.update((l) => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MetadataDisplayComponent, selectors: [["metadata-display"]], inputs: { item: [1, "item"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 12, vars: 5, consts: [["load_state", ""], [1, "flex", "items-center", "justify-between", "space-x-2"], ["btn", "", 3, "click"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Search metadata blocks...", 3, "ngModelChange", "ngModel"], [1, "mt-4", "space-y-2"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-8", "p-16", "opacity-30"], ["block", "", 1, "border-base-300", "rounded-sm", "border", 3, "id", "shadow", "opacity-30", "formGroup"], ["block", "", 1, "border-base-300", "rounded-sm", "border", 3, "id", "formGroup"], ["header", "", 1, "bg-base-200", "flex", "w-full", "items-center", "space-x-2", "px-2", "py-1", 3, "click"], [1, "min-w-0", "px-2", "text-left"], [1, "truncate", "font-mono", "text-sm"], [1, "text-base-content/60", "truncate", "text-[0.625rem]"], [1, "flex-1"], [1, "border-base-300", "rounded-sm", "border", "px-2", "py-1", "font-mono", "text-[0.625rem]", "whitespace-nowrap"], [1, "border-base-300", "bg-base-100", "flex", "items-center", "rounded-full", "border", 3, "click"], ["icon", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], [1, "text-xl"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"], ["icon", "", "matRipple", ""], [1, "text-2xl"], ["body", "", 1, "expandable"], [1, "border-base-300", "h-130", "border-t", "p-1"], ["formControlName", "details", "lang", "json", 3, "schema", "readonly"], [1, "text-8xl"], ["diameter", "32"]], template: function MetadataDisplayComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MetadataDisplayComponent, { className: "MetadataDisplayComponent", filePath: "src/app/ui/metadata-display.component.ts", lineNumber: 212 });
})();

export {
  MetadataDisplayComponent
};
//# sourceMappingURL=chunk-4O4EGEH7.js.map
