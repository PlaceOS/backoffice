...
var PlaceExtensionsComponent = class _PlaceExtensionsComponent {
  ...
  async updateDomain(extension_list) {
    ...
    const updated = new Ao(__spreadProps(__spreadValues({}, domain), {
    ...
    const new_domain = await pc(domain.id, updated).toPromise();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceExtensionsComponent, { className: "PlaceExtensionsComponent", filePath: "src/app/admin/extensions.component.ts", lineNumber: 191 });
})();
export {
  PlaceExtensionsComponent
};
//# sourceMappingURL=chunk-J5UUUNTO.js.map
