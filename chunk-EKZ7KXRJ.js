import {
  EmailStateService
} from "./chunk-3NP5XGRR.js";
import "./chunk-7KVQPNRA.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
...
var RichTextInputComponent = class _RichTextInputComponent extends AsyncHandler {
  ...
  _setAuth() {
    const tkn = V();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Je()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=30;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
  }
...
//# sourceMappingURL=chunk-EKZ7KXRJ.js.map
