...
var ModuleRuntimeErrorsModalComponent = class _ModuleRuntimeErrorsModalComponent {
  ...
  async _loadData() {
    ...
    try {
      const module = await firstValueFrom(Ta(this._module_id));
      this.module.set(module);
      try {
        const errors = await firstValueFrom(Fa(module.id));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModuleRuntimeErrorsModalComponent, { className: "ModuleRuntimeErrorsModalComponent", filePath: "src/app/ui/module-runtime-errors-modal.component.ts", lineNumber: 76 });
})();

export {
  ModuleRuntimeErrorsModalComponent
};
//# sourceMappingURL=chunk-JJ3BDYC4.js.map
