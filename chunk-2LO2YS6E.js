...
var AdminInterfacesComponent = class _AdminInterfacesComponent {
  ...
  interfaces = signal(
    [],
    ...ngDevMode ? [{ debugName: "interfaces" }] : (
      /* istanbul ignore next */
      []
    )
  );
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminInterfacesComponent, { className: "AdminInterfacesComponent", filePath: "src/app/admin/interfaces.component.ts", lineNumber: 60 });
})();
export {
  AdminInterfacesComponent
};
//# sourceMappingURL=chunk-2LO2YS6E.js.map
