...
function ApplicationFormComponent_Conditional_1_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(6, 7, "DOMAINS.APP_CLIENT_PLACEHOLDER"))("disabled", true)("ngModel", \u0275\u0275pipeBind1(7, 9, ctx_r0.client_id))("ngModelOptions", \u0275\u0275pureFunction0(11, _c03));
  }
}
function ApplicationFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(10, ApplicationFormComponent_Conditional_1_Conditional_10_Template, 8, 12, "div", 3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var ApplicationFormComponent = class _ApplicationFormComponent extends AsyncHandler {
  ...
  ngOnInit() {
    ...
    this.subscription("form.redirect_uri", this.form.get("redirect_uri").valueChanges.subscribe((value) => {
      if (this.form.value.preserve_client_id)
        return;
      this.client_id.next(value ? h.hashStr(value) : "");
      this.form.patchValue({ redirect_uri: value?.trim() }, { emitEvent: false });
    }));
    this.subscription("form.preserve_client_id", this.form.get("preserve_client_id").valueChanges.subscribe((preserve) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApplicationFormComponent, { className: "ApplicationFormComponent", filePath: "src/app/domains/application-form.component.ts", lineNumber: 162 });
})();
...
//# sourceMappingURL=chunk-ITBU6PYZ.js.map
