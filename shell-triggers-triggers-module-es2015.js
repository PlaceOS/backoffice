...
/* harmony import */ var _shared_pipes_date_from_pipe__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../shared/pipes/date-from.pipe */ "./src/app/shared/pipes/date-from.pipe.ts");
/* harmony import */ var _shared_pipes_format_list_pipe__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../shared/pipes/format-list.pipe */ "./src/app/shared/pipes/format-list.pipe.ts");
...
class TriggerAboutComponent extends _shared_globals_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    constructor(_service, _dialog) {
        ...
        this.query_fn = _ => Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["querySystems"])({ q: _ }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(resp => resp.data));
    }
    ngOnInit() {
