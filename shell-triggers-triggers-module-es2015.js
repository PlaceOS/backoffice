...
/* harmony import */ var src_app_overlays_trigger_action_modal_trigger_action_modal_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/overlays/trigger-action-modal/trigger-action-modal.component */ "./src/app/overlays/trigger-action-modal/trigger-action-modal.component.ts");
/* harmony import */ var src_app_overlays_trigger_condition_modal_trigger_condition_modal_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/overlays/trigger-condition-modal/trigger-condition-modal.component */ "./src/app/overlays/trigger-condition-modal/trigger-condition-modal.component.ts");
...
function TriggerAboutComponent_div_0_div_18_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TriggerAboutComponent_div_0_div_18_div_8_Template_button_click_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17); const time_r15 = ctx.$implicit; const ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r18.confirmRemoveCondition(time_r15); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](7, "app-icon", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function TriggerAboutComponent_div_0_div_26_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "button", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TriggerAboutComponent_div_0_div_26_div_4_Template_button_click_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24); const action_r21 = ctx.$implicit; const ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r23.editAction(action_r21); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](7, "app-icon", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "button", 23);
...
function TriggerAboutComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TriggerAboutComponent_div_0_Template_button_click_13_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r35); const ctx_r36 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r36.addCondition(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TriggerAboutComponent_div_0_Template_button_click_21_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r35); const ctx_r37 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r37.addAction(); });
...
class TriggerAboutComponent extends _shared_globals_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    constructor(_service, _dialog) {
        ...
        this.query_fn = _ => Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["querySystems"])({ q: _ });
    }
    ngOnInit() {
    ...
    confirmRemoveCondition(condition) {
        this.confirm_ref = this._dialog.open(src_app_overlays_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmModalComponent"], Object.assign(Object.assign({}, src_app_overlays_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_5__["CONFIRM_METADATA"]), { data: {
    ...
    removeCondition(condition) {
        ...
        Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["updateTrigger"])(this.item.id, Object.assign(Object.assign({}, this.item.toJSON()), { conditions })).subscribe(() => this._service.notifySuccess('Successfully removed trigger condition.'), err => this._service.notifyError(`Error removing trigger condition. Error: ${JSON.stringify(err.response || err.message || err)}`));
    }
    /**
    ...
    removeAction(action) {
        ...
        Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["updateTrigger"])(this.item.id, Object.assign(Object.assign({}, this.item.toJSON()), { actions })).subscribe(() => this._service.notifySuccess('Successfully removed trigger action.'), err => this._service.notifyError(`Error removing trigger action. Error: ${JSON.stringify(err.response || err.message || err)}`));
    }
    /**
    ...
    reorderAction(type, event) {
        ...
        Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__["updateTrigger"])(this.item.id, Object.assign(Object.assign({}, this.item.toJSON()), { actions })).subscribe(() => this._service.notifySuccess(`Successfully re-ordered trigger ${type} action.`), err => this._service.notifyError(`Error re-ordered trigger ${type} action. Error: ${JSON.stringify(err.response || err.message || err)}`));
    }
}
...
class TriggerSystemsComponent extends _shared_globals_base_directive__WEBPACK_IMPORTED_MODULE_3__["BaseDirective"] {
    constructor(_service, _dialog) {
        super();
        this._service = _service;
        this._dialog = _dialog;
    ...
    loadSystemTriggers(offset = 0) {
        Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["querySystems"])({
            ...
            offset
        }).subscribe(list => this.system_trigger_list = list || [], () => null);
    }
    /**
...
TriggerSystemsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: TriggerSystemsComponent, selectors: [["trigger-systems"]], inputs: { item: "item" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵNgOnChangesFeature"]], decls: 3, vars: 1, consts: [["class", "container", 4, "ngIf"], ["empty_state", ""], [1, "container"], [1, "settings"], [4, "ngIf", "ngIfElse"], [1, "small"], [1, "flex"], [4, "ngFor", "ngForOf"], [1, "state"], [3, "routerLink", "matTooltip", 4, "ngIf"], ["mat-icon-button", "", 3, "click"], [3, "icon"], [3, "routerLink", "matTooltip"], [1, "info-block"], [1, "text"]], template: function TriggerSystemsComponent_Template(rf, ctx) { if (rf & 1) {
...
class TriggersComponent extends _shared_components_base_root_component__WEBPACK_IMPORTED_MODULE_3__["BaseRootComponent"] {
    constructor(_service, _route, _router, _dialog) {
        ...
        this.save_fn = (item) => item.id ? Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["updateTrigger"])(item.id, item) : Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["addTrigger"])(item);
        /** Function to query domains */
        this.query_fn = (q) => Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["queryTriggers"])(q);
        /** Function to query domains */
        this.show_fn = (id, q) => Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["showTrigger"])(id, q);
    }
    ngOnInit() {
        super.ngOnInit();
    ...
    loadValues() {
        ...
        // Get trigger count
        Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["querySystems"])(query).subscribe((list) => (this.system_count = Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["lastRequestTotal"])('systems') || list.length || 0));
    }
    /**
    ...
    newItem(copy = false) {
        ...
        this.modal_ref = this._dialog.open(src_app_overlays_item_modal_item_modal_component__WEBPACK_IMPORTED_MODULE_5__["ItemCreateUpdateModalComponent"], {
            ...
            data: {
                item: copy
                    ? new _placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["PlaceTrigger"](Object.assign(Object.assign({}, this.item), { id: '', name: `${this.item.name} (1)` }))
        ...
        if (this.item && !this.modal_ref) {
            ...
            this.subscription('modal_events', this.modal_ref.componentInstance.event.subscribe((event) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                if (event.reason === 'done') {
                    ...
                    yield Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["removeTrigger"])(this.item.id)
                        .toPromise()
                        .catch((err) => {
...
TriggersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: TriggersComponent, selectors: [["app-triggers"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 5, vars: 18, consts: [[1, "container"], [1, "sidebar"], ["heading", "Triggers", "name", "triggers", 3, "query_fn", "close", "event"], [3, "click"], ["name", "trigger", "route", "triggers", 3, "save", "item", "loading", "tabs", "event"]], template: function TriggersComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function TriggersComponent_Template_main_click_3_listener() { return ctx.show_sidebar = false; });
