...
var ActionFieldComponent = class _ActionFieldComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ActionFieldComponent, selectors: [["an-action-field"]], inputs: { name: [1, "name"], disabled: [1, "disabled"] }, outputs: { performedAction: "performedAction" }, ngContentSelectors: _c0, decls: 5, vars: 2, consts: [["form-field", "", 1, "hover:border-base-content", "flex", "w-full", "items-center", "rounded-sm", "border", "border-gray-200", "px-4", "py-2.5", 3, "click", "keydown.enter"], ["placeholder", "", 1, "w-0", "flex-1", "truncate", "text-left"], [1, "-mr-2", "text-2xl"]], template: function ActionFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
function APIKeyModalComponent_For_59_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 33)(2, "div", 34)(3, "div");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 35);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(7, APIKeyModalComponent_For_59_Conditional_7_Template, 3, 3, "code", 36);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var APIKeyModalComponent = class _APIKeyModalComponent extends AsyncHandler {
  ...
  loadUsers() {
    this.timeout("load_users", async () => {
      const users = await lastValueFrom(this.domain() ? Ta({
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _APIKeyModalComponent, selectors: [["api-key-modal"]], viewQuery: function APIKeyModalComponent_Query(rf, ctx) {
  ...
  }, outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 80, vars: 66, consts: [["chipList", ""], ["chip_input", ""], ["auto", "matAutocomplete"], ["menu", "matMenu"], ["input", ""], [3, "save", "heading", "loading"], [1, "w-full", 3, "formGroup"], [1, "flex", "flex-col"], ["for", "name"], ["appearance", "outline"], ["name", "name", "formControlName", "name", "matInput", "", 3, "placeholder"], ["name", "description", "formControlName", "description", "matInput", "", 3, "placeholder"], ["for", "scope"], ["aria-label", "Scopes"], [3, "removable"], ["matInput", "", "placeholder", "Scopes...", 3, "matChipInputTokenEnd", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur", "matAutocomplete"], ["for", "user"], ["yPosition", "below", 1, "mb-8", "w-full", 3, "click", "matMenuTriggerFor"], [1, "min-w-80", "overflow-x-hidden"], ["appearance", "outline", 1, "no-subscript", "w-full", "px-2", 3, "click"], ["matInput", "", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["mat-menu-item", "", 1, "min-w-80", "overflow-hidden", 3, "text-secondary"], ["mat-menu-item", "", 1, "min-w-[20rem]", "text-center", 3, "disabled"], ["for", "permissions"], ["name", "permissions", "formControlName", "permissions", "placeholder", "None"], [3, "value"], ["value", "user"], ["value", "support"], ["value", "admin"], [3, "removed", "removable"], ["matChipRemove", ""], [3, "click"], ["mat-menu-item", "", 1, "min-w-80", "overflow-hidden", 3, "click"], [1, "flex", "w-full", "items-center", "space-x-4"], [1, "flex-1", "leading-tight"], [1, "text-xs", "opacity-30"], [1, "px-2"]], template: function APIKeyModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275repeaterCreate(58, APIKeyModalComponent_For_59_Template, 8, 5, "button", 21, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275pipe(60, "slice");
      \u0275\u0275conditionalCreate(61, APIKeyModalComponent_Conditional_61_Template, 2, 1, "button", 22);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(62, "div", 7)(63, "label", 23);
      \u0275\u0275text(64);
      \u0275\u0275pipe(65, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(66, "mat-form-field", 9)(67, "mat-select", 24)(68, "mat-option", 25);
      \u0275\u0275text(69);
      \u0275\u0275pipe(70, "translate");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 29, ctx.editing ? "ADMIN.APP_KEYS_EDIT" : "ADMIN.APP_KEYS_NEW"))("loading", ctx.loading());
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(APIKeyModalComponent, { className: "APIKeyModalComponent", filePath: "src/app/admin/api-keys/api-key-modal.component.ts", lineNumber: 264 });
})();
...
var APIKeyService = class _APIKeyService {
  ...
  available_domains = Tu({ limit: 500 }).pipe(map((_) => _.data), shareReplay(1));
  ...
  users = combineLatest([
    ...
    return domain ? Ta({ authority_id: domain.id, q }).pipe(map((_) => _.data)) : of([]);
  }), shareReplay(1));
  setDomain(domain) {
  ...
  async newKey() {
    ...
    const key = await lastValueFrom(E({
      query_params: {},
      fn: (d) => new PlaceAPIKeyDetails(d),
      path: "api_keys",
  ...
  async editKey(key) {
    ...
    const domain = this._domain.getValue();
    const updated_key = await lastValueFrom(I({
      id: key.id,
      query_params: {},
      fn: (d) => new PlaceAPIKeyDetails(d),
      path: "api_keys",
...
//# sourceMappingURL=chunk-M4TIHUUG.js.map
