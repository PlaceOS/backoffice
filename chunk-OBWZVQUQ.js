...
var RepositoryAboutComponent = class _RepositoryAboutComponent {
  ...
  local_url = computed(
    () => this.item()?.type === Us.Interface ? `${location.origin}/${this.item()?.folder_name}/` : `${location.hash}`,
...
//# sourceMappingURL=chunk-OBWZVQUQ.js.map
