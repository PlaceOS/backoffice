...
var BookingLimitsModalComponent = class _BookingLimitsModalComponent {
  ...
  async save() {
    await submit(this.form, async () => {
      ...
      const call = v(`/api/staff/v1/tenants/${this.tenant.id}/limits`, booking_limits);
...
function StaffTenantModalComponent_Conditional_74_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "label", 26);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
...
function StaffTenantModalComponent_For_79_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, StaffTenantModalComponent_For_79_Case_5_Template, 1, 5, "input", 30)(6, StaffTenantModalComponent_For_79_Case_6_Template, 1, 5, "textarea", 30);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(9, 7, "ADMIN.TENANT_ITEM_REQUIRED", \u0275\u0275pureFunction1(10, _c13, item_r3.key)), " ");
  }
}
function StaffTenantModalComponent_Conditional_80_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 20)(1, "settings-toggle", 32);
    \u0275\u0275pipe(2, "translate");
...
function StaffTenantModalComponent_Conditional_81_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "mat-form-field", 5)(6, "input", 31);
    \u0275\u0275pipe(7, "translate");
...
function StaffTenantModalComponent_Conditional_95_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "ADMIN.TENANTS_BOOKING_RANGE_ERROR"), " ");
  }
}
...
var StaffTenantModalComponent = class _StaffTenantModalComponent {
  ...
  form = form(this.formModel, (path) => {
    ...
    validate(path.booking_range, ({ value }) => {
      ...
      return ranges.some(({ days }, index) => !types[index] || days == null || `${days}`.trim() === "" || !Number.isInteger(+days) || +days < 0 || +days > 4294967295) || new Set(types).size !== types.length ? { kind: "booking_range" } : void 0;
    });
  });
  ...
  updateBookingRange(booking_range) {
    this.formModel.update((model2) => __spreadProps(__spreadValues({}, model2), {
  ...
  async save() {
    ...
    const value = __spreadProps(__spreadValues({}, model2), {
      ...
      booking_limits,
      booking_range: Object.fromEntries(model2.booking_range.map(({ type, days }) => [
        type.trim(),
        +days
      ]))
    });
    ...
    const data = oi(__spreadValues(__spreadValues({}, this.tenant || {}), value), ["", null, void 0]);
    const call = this.tenant?.id ? ce(`/api/staff/v1/tenants/${this.tenant.id}`, data) : v("/api/staff/v1/tenants", data);
  ...
  generateFormModel() {
    ...
    return {
      ...
      booking_range: Object.entries(this.tenant?.booking_range || {}).map(([type, days]) => ({ type, days })),
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffTenantModalComponent, selectors: [["staff-tenant-modal"]], inputs: { show_outlook: [1, "show_outlook"] }, outputs: { event: "event", show_outlook: "show_outlookChange" }, decls: 96, vars: 119, consts: [[3, "save", "heading", "loading"], [1, "mb-16"], [1, "flex", "flex-wrap", "items-center", "space-x-0", "sm:space-x-2"], [1, "flex", "flex-1", "flex-col"], ["for", "tenant-name"], ["appearance", "outline"], ["id", "tenant-name", "matInput", "", 3, "formField", "placeholder"], ["for", "tenant-platform"], ["id", "tenant-platform", 3, "formField"], ["value", "google"], ["value", "office365"], ["for", "tenant-email-domain"], ["id", "tenant-email-domain", "matInput", "", 3, "formField", "placeholder"], [1, "flex", "flex-col", "space-y-2"], ["for", "tenant-early-checkin"], ["id", "tenant-early-checkin", "placeholder", "Select time", 3, "formField"], [3, "value"], [1, "mb-6", "flex", "items-center"], [1, "w-1/2", 3, "label", "formField"], [1, "flex", "flex-col", 3, "hidden"], [1, "mb-4", "flex", "items-center"], [1, "label"], [3, "ngModelChange", "ngModel", "ngModelOptions", "fields"], [1, "mt-6", "flex", "flex-col", "space-y-2"], [1, "text-sm", "opacity-60"], [1, "text-error", "text-sm"], ["for", "tenant-service-account"], ["id", "tenant-service-account", "matInput", "", 3, "formField", "placeholder"], [1, "flex", "flex-col"], [1, "capitalize", 3, "for"], ["matInput", "", 3, "id", "ngModel", "ngModelOptions", "placeholder"], ["matInput", "", 3, "ngModelChange", "id", "ngModel", "ngModelOptions", "placeholder"], [1, "w-1/2", 3, "ngModelChange", "label", "ngModel", "ngModelOptions"], [3, "for"]], template: function StaffTenantModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
      \u0275\u0275pipe(1, "translate");
      ...
      \u0275\u0275controlCreate();
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(87, "div", 23)(88, "span", 21);
      \u0275\u0275text(89);
      \u0275\u0275pipe(90, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(91, "p", 24);
      \u0275\u0275text(92);
      \u0275\u0275pipe(93, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(94, "object-list-field", 22);
      \u0275\u0275listener("ngModelChange", function StaffTenantModalComponent_Template_object_list_field_ngModelChange_94_listener($event) {
        return ctx.updateBookingRange($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275controlCreate();
      \u0275\u0275conditionalCreate(95, StaffTenantModalComponent_Conditional_95_Template, 3, 3, "p", 25);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 49, ctx.tenant ? "ADMIN.TENANTS_EDIT" : "ADMIN.TENANTS_NEW"))("loading", ctx.loading());
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 51, "COMMON.FIELD_NAME"));
      \u0275\u0275advance(5);
      \u0275\u0275property("formField", ctx.form.name)("placeholder", \u0275\u0275pipeBind1(12, 53, "ADMIN.TENANTS_FIELD_NAME"));
      \u0275\u0275control();
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(15, 55, "ADMIN.TENANTS_NAME_ERROR"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 57, "ADMIN.TENANTS_PLATFORM"), " ");
      \u0275\u0275advance(5);
      \u0275\u0275property("formField", ctx.form.platform);
      \u0275\u0275control();
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 59, "ADMIN.TENANTS_EMAIL_DOMAIN"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("formField", ctx.form.email_domain)("placeholder", \u0275\u0275pipeBind1(34, 61, "ADMIN.TENANTS_EMAIL_PLACEHOLDER"));
      \u0275\u0275control();
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 63, "ADMIN.TENANTS_EMAIL_ERROR"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(41, 65, "ADMIN.TENANTS_EARLY_CHECKIN"));
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(46, 67, "ADMIN.TENANTS_MINUTES", \u0275\u0275pureFunction0(105, _c02)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 30 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(49, 70, "ADMIN.TENANTS_MINUTES", \u0275\u0275pureFunction0(106, _c1)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 45 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(52, 73, "ADMIN.TENANTS_MINUTES", \u0275\u0275pureFunction0(107, _c2)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 60 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(55, 76, "ADMIN.TENANTS_HOURS", \u0275\u0275pureFunction0(108, _c3)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 1.5 * 60 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(58, 79, "ADMIN.TENANTS_MINUTES_HOURS", \u0275\u0275pureFunction0(109, _c4)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 2 * 60 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(61, 82, "ADMIN.TENANTS_HOURS", \u0275\u0275pureFunction0(110, _c5)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 2.5 * 60 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(64, 85, "ADMIN.TENANTS_MINUTES_HOURS", \u0275\u0275pureFunction0(111, _c6)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 3 * 60 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(67, 88, "ADMIN.TENANTS_HOURS", \u0275\u0275pureFunction0(112, _c7)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 3.5 * 60 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(70, 91, "ADMIN.TENANTS_MINUTES_HOURS", \u0275\u0275pureFunction0(113, _c8)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("value", 4 * 60 * 60);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(73, 94, "ADMIN.TENANTS_HOURS", \u0275\u0275pureFunction0(114, _c9)), " ");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.formModel().platform !== "google" && !ctx.formModel().delegated ? 74 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(77, 97, "ADMIN.TENANTS_DELEGATED"))("formField", ctx.form.delegated);
      \u0275\u0275control();
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(85, 99, "ADMIN.TENANTS_BOOKING_LIMITS"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngModel", ctx.formModel().booking_limits)("ngModelOptions", \u0275\u0275pureFunction0(115, _c10))("fields", \u0275\u0275pureFunction0(116, _c11));
      \u0275\u0275control();
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(90, 101, "ADMIN.TENANTS_BOOKING_RANGE"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(93, 103, "ADMIN.TENANTS_BOOKING_RANGE_HINT"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("ngModel", ctx.formModel().booking_range)("ngModelOptions", \u0275\u0275pureFunction0(117, _c10))("fields", \u0275\u0275pureFunction0(118, _c12));
      \u0275\u0275control();
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.form.booking_range().invalid() ? 95 : -1);
    }
  }, dependencies: [
    FullscreenModalShellComponent,
    ObjectListFieldComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffTenantModalComponent, { className: "StaffTenantModalComponent", filePath: "src/app/admin/staff-tenant-modal.component.ts", lineNumber: 423 });
})();

// src/app/admin/staff-api.component.ts
var _c03 = (a0) => ({ key: "name", name: a0 });
var _c14 = (a0) => ({ key: "platform", name: a0 });
...
function PlaceStaffAPIComponent_ng_template_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "button", 16);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function PlaceStaffAPIComponent_ng_template_25_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function PlaceStaffAPIComponent_ng_template_25_Template_button_click_5_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("click", function PlaceStaffAPIComponent_ng_template_25_Template_button_click_9_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r3 = \u0275\u0275nextContext();
...
var PlaceStaffAPIComponent = class _PlaceStaffAPIComponent {
  ...
  async removeTenant(tenant) {
    ...
    const system = await V(`/api/staff/v1/tenants/${tenant.id}`).catch((err) => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceStaffAPIComponent, selectors: [["staff-api"]], decls: 27, vars: 41, consts: [["expires_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-56"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["icon", "", "default", "", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-3xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "px-2"], [1, "rounded-2xl", "px-3", "py-1", "text-xs"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function PlaceStaffAPIComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(23, PlaceStaffAPIComponent_ng_template_23_Template, 5, 23, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(25, PlaceStaffAPIComponent_ng_template_25_Template, 13, 9, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const expires_template_r7 = \u0275\u0275reference(24);
      const actions_template_r8 = \u0275\u0275reference(26);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 11, "ADMIN.TENANTS_HEADER"), " ");
      \u0275\u0275advance(4);
      \u0275\u0275property("ngModel", ctx.domain())("placeholder", \u0275\u0275pipeBind1(8, 13, "ADMIN.SELECT_DOMAIN"));
      \u0275\u0275control();
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.domain_list());
      \u0275\u0275advance(2);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(12, 15, "ADMIN.TENANTS_ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 17, "ADMIN.TENANTS_ADD"));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.tenants())("columns", \u0275\u0275pureFunction4(36, _c42, \u0275\u0275pureFunction1(27, _c03, \u0275\u0275pipeBind1(19, 19, "COMMON.FIELD_NAME")), \u0275\u0275pureFunction1(29, _c14, \u0275\u0275pipeBind1(20, 21, "ADMIN.TENANTS_PLATFORM")), \u0275\u0275pureFunction2(31, _c22, \u0275\u0275pipeBind1(21, 23, "ADMIN.TENANTS_SECRET_EXPIRY"), expires_template_r7), \u0275\u0275pureFunction1(34, _c32, actions_template_r8)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(22, 25, "ADMIN.TENANTS_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
//# sourceMappingURL=chunk-VVLYEPHC.js.map
