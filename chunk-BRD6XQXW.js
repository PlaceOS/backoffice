...
function AdminSignagePluginsComponent_ng_template_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AdminSignagePluginsComponent_ng_template_23_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminSignagePluginsComponent_ng_template_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, AdminSignagePluginsComponent_ng_template_23_Conditional_2_Template, 3, 3, "span", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminSignagePluginsComponent_ng_template_27_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminSignagePluginsComponent_ng_template_27_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminSignagePluginsComponent_ng_template_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, AdminSignagePluginsComponent_ng_template_27_Conditional_0_Template, 3, 0, "div", 17);
    \u0275\u0275conditionalCreate(1, AdminSignagePluginsComponent_ng_template_27_Conditional_1_Template, 3, 0, "div", 18);
  }
  if (rf & 2) {
...
function AdminSignagePluginsComponent_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function AdminSignagePluginsComponent_ng_template_29_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function AdminSignagePluginsComponent_ng_template_29_Template_button_click_5_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r6 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("click", function AdminSignagePluginsComponent_ng_template_29_Template_button_click_9_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r6 = \u0275\u0275nextContext();
...
var AdminSignagePluginsComponent = class _AdminSignagePluginsComponent extends AsyncHandler {
  ...
  editPlugin(item) {
    const ref = this._dialog.open(SignagePluginModalComponent, {
      data: {
        item,
        save: (updated) => ol(item.id, updated)
      }
    });
    this.subscription("modal_events", ref.afterClosed().subscribe((event) => {
      if (event?.reason !== "done")
  ...
  async deletePlugin(item) {
    ...
    const err = await cl(item.id).catch((_) => _);
    details.close();
    if (err)
  ...
  async loadPlugins() {
    ...
    try {
      const plugins = await il().then((r) => r.data);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminSignagePluginsComponent, selectors: [["admin-signage-plugins"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 31, vars: 56, consts: [["mono_template", ""], ["description_template", ""], ["type_template", ""], ["enabled_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["icon", "", "default", "", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-6xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "max-w-[50vw]", "truncate", "p-4", "font-mono", "text-xs"], [1, "p-4", "text-xs"], [1, "opacity-30"], [1, "p-4", "text-xs", "uppercase"], [1, "bg-success", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "bg-error", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "text-success-content", "text-2xl"], [1, "text-error-content", "text-2xl"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AdminSignagePluginsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(12, "mat-progress-bar", 11)(13, "simple-table", 12);
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275pipe(15, "translate");
      \u0275\u0275pipe(16, "translate");
      \u0275\u0275pipe(17, "translate");
      ...
      \u0275\u0275pipe(20, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(21, AdminSignagePluginsComponent_ng_template_21_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(23, AdminSignagePluginsComponent_ng_template_23_Template, 3, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(25, AdminSignagePluginsComponent_ng_template_25_Template, 2, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(27, AdminSignagePluginsComponent_ng_template_27_Template, 2, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(29, AdminSignagePluginsComponent_ng_template_29_Template, 13, 9, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const mono_template_r8 = \u0275\u0275reference(22);
      const description_template_r9 = \u0275\u0275reference(24);
      const type_template_r10 = \u0275\u0275reference(26);
      const enabled_template_r11 = \u0275\u0275reference(28);
      const actions_template_r12 = \u0275\u0275reference(30);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 9, "ADMIN.SIGNAGE_PLUGINS_HEADER"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(7, 11, "ADMIN.SIGNAGE_PLUGINS_ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(8, 13, "ADMIN.SIGNAGE_PLUGINS_ADD"));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.plugins())("columns", \u0275\u0275pureFunction7(48, _c7, \u0275\u0275pureFunction1(29, _c04, \u0275\u0275pipeBind1(14, 15, "COMMON.FIELD_NAME")), \u0275\u0275pureFunction2(31, _c1, \u0275\u0275pipeBind1(15, 17, "COMMON.FIELD_DESCRIPTION"), description_template_r9), \u0275\u0275pureFunction2(34, _c2, \u0275\u0275pipeBind1(16, 19, "ADMIN.SIGNAGE_PLUGINS_FIELD_TYPE"), type_template_r10), \u0275\u0275pureFunction2(37, _c3, \u0275\u0275pipeBind1(17, 21, "ADMIN.SIGNAGE_PLUGINS_FIELD_URI"), mono_template_r8), \u0275\u0275pureFunction2(40, _c4, \u0275\u0275pipeBind1(18, 23, "ADMIN.SIGNAGE_PLUGINS_FIELD_PLAYBACK_TYPE"), type_template_r10), \u0275\u0275pureFunction2(43, _c5, \u0275\u0275pipeBind1(19, 25, "ADMIN.SIGNAGE_PLUGINS_FIELD_ENABLED"), enabled_template_r11), \u0275\u0275pureFunction1(46, _c6, actions_template_r12)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(20, 27, "ADMIN.SIGNAGE_PLUGINS_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminSignagePluginsComponent, { className: "AdminSignagePluginsComponent", filePath: "src/app/admin/signage-plugins/signage-plugins.component.ts", lineNumber: 192 });
})();
export {
  AdminSignagePluginsComponent
};
//# sourceMappingURL=chunk-BRD6XQXW.js.map
