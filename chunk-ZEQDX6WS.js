...
var UserAboutComponent = class _UserAboutComponent {
  ...
  domain = this._service.item.pipe(distinctUntilChanged(), debounceTime(300), filter((_) => !!_ && typeof _.authority_id === "string"), switchMap((i) => Eu(i.authority_id)), shareReplay(1));
  get item() {
...
//# sourceMappingURL=chunk-ZEQDX6WS.js.map
