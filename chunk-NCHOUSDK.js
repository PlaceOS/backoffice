...
import {
  ...
  addChipItem,
  removeChipItem
} from "./chunk-VVGC3NQA.js";
import {
  AuthenticatedImageDirective
} from "./chunk-7WWQ44LU.js";
import {
  DateFromPipe
} from "./chunk-2CWN74E4.js";
import {
  Clipboard
} from "./chunk-AXMNVT7F.js";
import {
  HotkeysService
} from "./chunk-7OB6FJ2M.js";
import {
  FullscreenModalShellComponent
} from "./chunk-CV4QBZZQ.js";
import {
  MatProgressSpinner,
...
import {
  UploadsService
} from "./chunk-LQAAVYTX.js";
import {
  SettingsToggleComponent
} from "./chunk-66T35HGZ.js";
import {
  MatInput,
  MatInputModule
...
function generateBrokerFormFields(broker) {
  const auth_type = broker.auth_type ?? Ks.NoAuth;
  const fields = {
    ...
    username: new FormControl(broker.username, auth_type === Ks.UserPassword ? [Validators.required] : []),
    password: new FormControl(broker.password, auth_type === Ks.UserPassword ? [Validators.required] : []),
    certificate: new FormControl(broker.certificate, auth_type === Ks.Certificate ? [Validators.required] : []),
...
function includeLegacyCameraSnapshotUrl(updated_at) {
...
function normaliseCameraSnapshotUrls(system) {
  const snapshot_urls = Array.isArray(system?.camera_snapshot_urls) ? system.camera_snapshot_urls : [];
  const legacy_snapshot_urls = includeLegacyCameraSnapshotUrl(system?.updated_at) && system?.camera_snapshot_url ? [system.camera_snapshot_url] : [];
...
function generateSystemsFormFields(system) {
  const fields = {
    ...
    camera_snapshot_url: new FormControl(system.camera_snapshot_url || system.camera_snapshot_urls[0] || ""),
...
var BrokerFormComponent = class _BrokerFormComponent {
  ...
  ngOnInit() {
    this.auth_types = [
      ...
      { id: Ks.NoAuth, name: i18n("ADMIN.BROKERS_AUTH_TYPE_NONE") },
      {
        id: Ks.UserPassword,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DomainFormComponent, { className: "DomainFormComponent", filePath: "src/app/ui/forms/domain-form.component.ts", lineNumber: 227 });
})();
...
function DriverFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, DriverFormComponent_Conditional_1_Conditional_6_Template, 4, 6, "div", 6);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function DriverFormComponent_Conditional_3_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "label", 27);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 9)(5, "mat-select", 28);
    \u0275\u0275repeaterCreate(6, DriverFormComponent_Conditional_3_Conditional_13_For_7_Template, 3, 4, "mat-option", 26, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DriverFormComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "label", 7);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    ...
    \u0275\u0275conditionalCreate(13, DriverFormComponent_Conditional_3_Conditional_13_Template, 8, 3, "div", 12);
    ...
    \u0275\u0275text(19, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "mat-form-field", 9);
    ...
    \u0275\u0275pipe(28, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "mat-form-field", 9);
    \u0275\u0275element(30, "textarea", 16);
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "label", 17);
    \u0275\u0275text(33);
    \u0275\u0275pipe(34, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "mat-form-field", 9);
    \u0275\u0275element(36, "input", 18);
    \u0275\u0275pipe(37, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 19)(39, "div", 12)(40, "label", 20);
    \u0275\u0275text(41);
    \u0275\u0275pipe(42, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(48, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(49, "div", 12);
    \u0275\u0275element(50, "div", 22)(51, "settings-toggle", 23);
    \u0275\u0275pipe(52, "translate");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(55, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "mat-form-field", 9)(57, "mat-select", 25);
    \u0275\u0275repeaterCreate(58, DriverFormComponent_Conditional_3_For_59_Template, 3, 4, "mat-option", 26, _forTrack02);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var DriverFormComponent = class _DriverFormComponent extends AsyncHandler {
  ...
  commit_list = combineLatest([this.repo, this.driver]).pipe(filter(([repo, driver]) => !!repo?.id && !!driver?.id), distinctUntilChanged(([prev_repo, prev_driver], [curr_repo, curr_driver]) => prev_repo?.id === curr_repo?.id && prev_driver?.id === curr_driver?.id), tap(() => this.loading_type.update((types) => [...types, "commits"])), switchMap(([{ id }, driver]) => Fc(id, { driver: driver.id, limit: 1e3 }).pipe(catchError(() => of([])))), map((list) => list.map((item) => ({
    id: item.commit,
    name: `${item.subject}`,
...
(() => {
  ...
  }], null, { form: [{ type: Input, args: [{ isSignal: true, alias: "form", required: false }] }], waitingChange: [{ type: Output, args: ["waitingChange"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DriverFormComponent, { className: "DriverFormComponent", filePath: "src/app/ui/forms/driver-form.component.ts", lineNumber: 251 });
})();
...
function ModuleFormComponent_Conditional_0_Conditional_2_Conditional_10_For_7_Template(rf, ctx) {
  if (rf & 1) {
...
function ModuleFormComponent_Conditional_0_Conditional_2_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 15)(5, "mat-select", 22);
    \u0275\u0275repeaterCreate(6, ModuleFormComponent_Conditional_0_Conditional_2_Conditional_10_For_7_Template, 3, 4, "mat-option", 23, _forTrack03);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function ModuleFormComponent_Conditional_0_Conditional_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "label", 24);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
...
function ModuleFormComponent_Conditional_0_Conditional_2_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "label", 26);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 15);
...
function ModuleFormComponent_Conditional_0_Conditional_2_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "label", 2);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "item-search-field", 28);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ModuleFormComponent_Conditional_0_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(10, ModuleFormComponent_Conditional_0_Conditional_2_Conditional_10_Template, 8, 3, "div", 1);
    \u0275\u0275conditionalCreate(11, ModuleFormComponent_Conditional_0_Conditional_2_Conditional_11_Template, 7, 6, "div", 1);
    \u0275\u0275conditionalCreate(12, ModuleFormComponent_Conditional_0_Conditional_2_Conditional_12_Template, 7, 6, "div", 1);
    \u0275\u0275conditionalCreate(13, ModuleFormComponent_Conditional_0_Conditional_2_Conditional_13_Template, 6, 7, "div", 1);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function ModuleFormComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, ModuleFormComponent_Conditional_0_Conditional_2_Template, 14, 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModuleFormComponent, { className: "ModuleFormComponent", filePath: "src/app/ui/forms/module-form.component.ts", lineNumber: 310 });
})();
...
function RepositoryFormComponent_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "mat-form-field", 4)(7, "input", 12);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275listener("blur", function RepositoryFormComponent_Conditional_0_Conditional_5_Template_input_blur_7_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function RepositoryFormComponent_Conditional_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 4)(5, "input", 14);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("blur", function RepositoryFormComponent_Conditional_0_Conditional_7_Template_input_blur_5_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.credentials_blur$.next());
    });
...
function RepositoryFormComponent_Conditional_0_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 4)(5, "input", 16);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("blur", function RepositoryFormComponent_Conditional_0_Conditional_8_Template_input_blur_5_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.credentials_blur$.next());
    });
    ...
    \u0275\u0275listener("click", function RepositoryFormComponent_Conditional_0_Conditional_8_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function RepositoryFormComponent_Conditional_0_Conditional_9_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19);
...
function RepositoryFormComponent_Conditional_0_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(11, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, RepositoryFormComponent_Conditional_0_Conditional_9_Conditional_12_Template, 2, 0, "div", 19);
...
function RepositoryFormComponent_Conditional_0_Conditional_10_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "mat-option", 8)(1, "div", 28);
    ...
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(8, RepositoryFormComponent_Conditional_0_Conditional_10_For_15_Conditional_8_Template, 2, 1, "code", 32);
    \u0275\u0275elementStart(9, "code", 32);
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "slice");
    \u0275\u0275elementEnd()()();
  }
...
function RepositoryFormComponent_Conditional_0_Conditional_10_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19);
    \u0275\u0275element(1, "mat-spinner", 20);
    \u0275\u0275elementEnd();
...
function RepositoryFormComponent_Conditional_0_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 4)(5, "mat-select", 23);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementStart(7, "mat-select-trigger")(8, "div", 24)(9, "div", 25);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(16, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(17, RepositoryFormComponent_Conditional_0_Conditional_10_Conditional_17_Template, 2, 0, "div", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 1)(19, "settings-toggle", 27);
    \u0275\u0275listener("ngModelChange", function RepositoryFormComponent_Conditional_0_Conditional_10_Template_settings_toggle_ngModelChange_19_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function RepositoryFormComponent_Conditional_0_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "label", 35);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 4);
...
function RepositoryFormComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(8, RepositoryFormComponent_Conditional_0_Conditional_8_Template, 10, 7, "div", 1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, RepositoryFormComponent_Conditional_0_Conditional_9_Template, 16, 15, "div", 1);
    \u0275\u0275conditionalCreate(10, RepositoryFormComponent_Conditional_0_Conditional_10_Template, 20, 18);
...
var RepositoryFormComponent = class _RepositoryFormComponent extends AsyncHandler {
  ...
  ngOnChanges(changes) {
    ...
    if (changes.form && form) {
      ...
      const uri_valid$ = form.get("uri").valueChanges.pipe(debounceTime(1e3), filter((uri) => isValidUrl(uri) && uri.startsWith("http")), distinctUntilChanged());
      ...
      this.commit_list = merge(timer(300), this.credentials_blur$, uri_valid$, form.get("branch").valueChanges).pipe(debounceTime(300), tap(() => this.loading_commits.set(true)), switchMap(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RepositoryFormComponent, { className: "RepositoryFormComponent", filePath: "src/app/ui/forms/repository-form.component.ts", lineNumber: 387 });
})();
...
var ImageListFieldComponent = class _ImageListFieldComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ImageListFieldComponent, selectors: [["image-list-field"]], viewQuery: function ImageListFieldComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(11, ImageListFieldComponent_For_12_Template, 4, 6, "button", 8, _forTrack04);
      \u0275\u0275pipe(13, "async");
...
function SystemFormComponent_Conditional_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(7, SystemFormComponent_Conditional_0_Conditional_1_Conditional_7_Template, 3, 3, "div", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function SystemFormComponent_Conditional_0_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "label", 25);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 12);
...
function SystemFormComponent_Conditional_0_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 38)(5, "mat-chip-grid", 39, 1);
...
function SystemFormComponent_Conditional_0_Conditional_40_For_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 41);
    \u0275\u0275listener("removed", function SystemFormComponent_Conditional_0_Conditional_40_For_8_Template_mat_chip_row_removed_0_listener() {
      const item_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
...
function SystemFormComponent_Conditional_0_Conditional_40_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function SystemFormComponent_Conditional_0_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 4)(1, "label", 52);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 38)(5, "mat-chip-grid", 53, 2);
    \u0275\u0275repeaterCreate(7, SystemFormComponent_Conditional_0_Conditional_40_For_8_Template, 7, 7, "mat-chip-row", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "input", 54);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("matChipInputTokenEnd", function SystemFormComponent_Conditional_0_Conditional_40_Template_input_matChipInputTokenEnd_9_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.addCameraSnapshotUrl($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, SystemFormComponent_Conditional_0_Conditional_40_Conditional_11_Template, 3, 3, "mat-error");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function SystemFormComponent_Conditional_0_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "label", 55);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 12);
...
function SystemFormComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, SystemFormComponent_Conditional_0_Conditional_1_Template, 8, 7, "div", 4);
    \u0275\u0275elementStart(2, "div", 5);
    \u0275\u0275conditionalCreate(3, SystemFormComponent_Conditional_0_Conditional_3_Template, 9, 6, "div", 4);
    \u0275\u0275conditionalCreate(4, SystemFormComponent_Conditional_0_Conditional_4_Template, 8, 9, "div", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 5);
    \u0275\u0275conditionalCreate(6, SystemFormComponent_Conditional_0_Conditional_6_Template, 7, 6, "div", 4);
    \u0275\u0275conditionalCreate(7, SystemFormComponent_Conditional_0_Conditional_7_Template, 7, 6, "div", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, SystemFormComponent_Conditional_0_Conditional_8_Template, 10, 11, "div", 4);
    \u0275\u0275elementStart(9, "div", 6);
    \u0275\u0275conditionalCreate(10, SystemFormComponent_Conditional_0_Conditional_10_Template, 5, 7, "div", 4);
    \u0275\u0275conditionalCreate(11, SystemFormComponent_Conditional_0_Conditional_11_Template, 5, 7, "div", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 7);
    \u0275\u0275element(13, "settings-toggle", 8);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275element(15, "settings-toggle", 9);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275element(17, "settings-toggle", 10);
    \u0275\u0275pipe(18, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(19, SystemFormComponent_Conditional_0_Conditional_19_Template, 7, 6, "div", 4);
    \u0275\u0275conditionalCreate(20, SystemFormComponent_Conditional_0_Conditional_20_Template, 11, 11, "div", 4);
    \u0275\u0275conditionalCreate(21, SystemFormComponent_Conditional_0_Conditional_21_Template, 6, 3, "div", 4);
    \u0275\u0275elementStart(22, "div", 4)(23, "label", 11);
    \u0275\u0275text(24);
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "mat-form-field", 12)(27, "div", 13)(28, "icon", 14);
    \u0275\u0275text(29, " search ");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275repeaterCreate(34, SystemFormComponent_Conditional_0_For_35_Template, 2, 2, "mat-option", 16, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(36, SystemFormComponent_Conditional_0_Conditional_36_Template, 3, 4, "mat-option", 17);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(37, SystemFormComponent_Conditional_0_Conditional_37_Template, 5, 3, "div", 4);
    \u0275\u0275conditionalCreate(38, SystemFormComponent_Conditional_0_Conditional_38_Template, 10, 11, "div", 4);
    \u0275\u0275conditionalCreate(39, SystemFormComponent_Conditional_0_Conditional_39_Template, 10, 11, "div", 4);
    \u0275\u0275conditionalCreate(40, SystemFormComponent_Conditional_0_Conditional_40_Template, 12, 12, "div", 4);
    \u0275\u0275conditionalCreate(41, SystemFormComponent_Conditional_0_Conditional_41_Template, 10, 11, "div", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemFormComponent, { className: "SystemFormComponent", filePath: "src/app/ui/forms/system-form.component.ts", lineNumber: 511 });
})();
...
function SystemTriggerFormComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 16)(5, "mat-chip-grid", 17, 0);
    \u0275\u0275repeaterCreate(7, SystemTriggerFormComponent_Conditional_4_For_8_Template, 4, 2, "mat-chip", 18, _forTrack05);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemTriggerFormComponent, { className: "SystemTriggerFormComponent", filePath: "src/app/ui/forms/system-trigger-form.component.ts", lineNumber: 126 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserFormComponent, { className: "UserFormComponent", filePath: "src/app/ui/forms/user-form.component.ts", lineNumber: 343 });
})();
...
function ZoneFormComponent_Conditional_0_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3)(1, "label", 38);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 6);
...
function ZoneFormComponent_Conditional_0_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3)(1, "label", 40);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneFormComponent, { className: "ZoneFormComponent", filePath: "src/app/ui/forms/zone-form.component.ts", lineNumber: 305 });
})();
...
function ItemCreateUpdateModalComponent_Case_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("waitingChange", function ItemCreateUpdateModalComponent_Case_9_Template_driver_form_waitingChange_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
var ItemCreateUpdateModalComponent = class _ItemCreateUpdateModalComponent extends AsyncHandler {
  ...
  get item_type() {
    if (this.item instanceof Qr) {
      return "system";
    } else if (this.item instanceof Gr) {
      return "module";
    } else if (this.item instanceof Dn) {
      return "zone";
    } else if (this.item instanceof Br) {
      return "driver";
    } else if (this.item instanceof fo) {
      return "user";
    } else if (this.item instanceof to) {
      return "domain";
    } else if (this.item instanceof Ys) {
      return "application";
    } else if (this.item instanceof me && this._data.external_save) {
      return "system-trigger";
    } else if (this.item instanceof me) {
      return "trigger";
    } else if (this.item instanceof uo) {
      return "repository";
    } else if (this.item instanceof Zs) {
      return "broker";
    }
  }
  /**
  ...
  submit() {
    ...
    const item_json = this.item.toJSON ? this.item.toJSON() : this.item;
    const form_item = this.item.id ? ds(__spreadValues(__spreadValues({}, item_json), this.form.value), this.item_type === "user" ? [void 0, null, ""] : [void 0, null]) : __spreadValues(__spreadValues({}, item_json), this.form.value);
    const item = this.normaliseItemPayload(form_item);
    if (this._data.external_save) {
      this.event.emit({ reason: "action", metadata: item });
      return;
    }
    this._data.save(item).subscribe((_item) => {
      this.result = _item;
   ...
   */
  normaliseItemPayload(item) {
    if (this.item_type !== "system") {
      return item;
    }
    const _a = item, { camera_snapshot_url, camera_snapshot_urls } = _a, system_item = __objRest(_a, ["camera_snapshot_url", "camera_snapshot_urls"]);
    return __spreadProps(__spreadValues({}, system_item), {
      camera_snapshot_urls: normaliseCameraSnapshotUrls(__spreadProps(__spreadValues({}, system_item), {
        camera_snapshot_url,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemCreateUpdateModalComponent, { className: "ItemCreateUpdateModalComponent", filePath: "src/app/overlays/item-modal.component.ts", lineNumber: 150 });
})();
...
*/
//# sourceMappingURL=chunk-NCHOUSDK.js.map
