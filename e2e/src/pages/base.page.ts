...
export abstract class BasePage {
    ...
    async waitForLoad(): Promise<void> {
        ...
        await this.page.waitForSelector('sidebar-menu, item-sidebar', { timeout: 30000 }).catch(() => {});
    ...
    get searchInput(): Locator {
        return this.page.locator('item-sidebar input[placeholder*="earch"], input[placeholder*="earch"]').first();
    }
    ...
    get sidebarItems(): Locator {
        ...
        return this.page.locator('item-sidebar a, virtual-scroll a, scroll-item a');
    }
    ...
    get addButton(): Locator {
        ...
        return this.page.locator('button:has(icon i:text("add")), button:has(icon:has-text("add"))').first();
    }
    ...
    get actionMenuButton(): Locator {
        return this.page.locator('item-details button:has(icon:has-text("more_vert"))').first();
    }
    ...
    async openActionMenu(): Promise<void> {
        ...
        await this.page.waitForSelector('.mat-mdc-menu-panel, .cdk-overlay-pane:has(button[mat-menu-item])', { timeout: 5000 });
    }
    ...
    get editButton(): Locator {
        return this.page.locator('button[mat-menu-item]:has(icon:has-text("edit"))').first();
    }
    ...
    get deleteButton(): Locator {
        return this.page.locator('button[mat-menu-item]:has(icon:has-text("delete"))').first();
    }
    ...
    get bulkAddButton(): Locator {
        return this.page.locator('button:has(icon:has-text("playlist_add"))').first();
    }
     ...
     */
    get dialog(): Locator {
        return this.page.locator('fullscreen-modal-shell, mat-dialog-container, [mat-dialog-container]').first();
    }
    ...
    get saveButton(): Locator {
        return this.page.locator('fullscreen-modal-shell footer button[btn], mat-dialog-container button:has-text("Save"), mat-dialog-container button:has-text("Create")').first();
    }
    ...
    get cancelButton(): Locator {
        return this.page.locator('fullscreen-modal-shell button[mat-dialog-close], mat-dialog-container button:has-text("Cancel")').first();
    }
    ...
    get confirmButton(): Locator {
        return this.page.locator('mat-dialog-container button:has-text("Ok"), mat-dialog-container button:has-text("Confirm"), mat-dialog-container button:has-text("Yes"), confirm-modal button:has-text("Ok")').first();
    }
    ...
    async selectItem(name: string): Promise<void> {
        await this.page.locator(`item-sidebar a:has-text("${name}"), virtual-scroll a:has-text("${name}")`).first().click();
        await this.page.waitForTimeout(500);
    }
    ...
    async navigateToTab(tabName: string): Promise<void> {
        await this.page.locator(`item-tablist a:has-text("${tabName}"), [role="tab"]:has-text("${tabName}")`).first().click();
        await this.page.waitForTimeout(500);
    }
    ...
    async selectDropdown(label: string, option: string): Promise<void> {
        const select = this.page.locator(`mat-form-field:has(mat-label:text("${label}")) mat-select, mat-select[placeholder*="${label}" i]`).first();
        await select.click();
        await this.page.locator(`mat-option:has-text("${option}")`).first().click();
    }
    ...
    async toggleCheckbox(label: string): Promise<void> {
        await this.page.locator(`mat-checkbox:has-text("${label}"), mat-slide-toggle:has-text("${label}")`).first().click();
    }
    ...
    async expectNotification(text: string): Promise<void> {
        await expect(this.page.locator(`mat-snack-bar-container:has-text("${text}")`)).toBeVisible({ timeout: 5000 });
    }
    ...
    get mainContent(): Locator {
        ...
        return this.page.locator('item-details, new-systems-view > div, new-zones-view > div, new-users-view > div, new-domains-view > div').first();
    }
    ...
    async expectNoErrors(): Promise<void> {
        const error = await this.page.locator('.error-state, [class*="error"]:has-text("Error")').isVisible().catch(() => false);
    ...
    async waitForItemDetails(): Promise<void> {
        await this.page.locator('item-details [name]').waitFor({ timeout: 10000 });
    }
}
