...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-SL6HVDEE.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-WBY666NX.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-CJDMP54R.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "brokers",
        loadComponent: () => import("./chunk-S2XUSEG2.js").then((m) => m.AdminBrokersComponent)
      },
      {
        path: "edge",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-AJ3HZANB.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
      ...
      {
        path: "upload-library",
        loadComponent: () => import("./chunk-GRUM2Y4E.js").then((m) => m.UploadLibraryComponent)
      },
      {
        path: "mailing-list",
        children: [
...
//# sourceMappingURL=chunk-XZM4QNOD.js.map
