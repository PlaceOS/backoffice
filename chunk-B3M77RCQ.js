...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-PWIZJWYT.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-YCN2UNOR.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-KFRM6IFI.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-JJFYPDQM.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
        loadComponent: () => import("./chunk-CTWUEOGI.js").then((m) => m.AdminAPIKeysComponent)
      },
      {
        path: "upload-storage",
...
//# sourceMappingURL=chunk-B3M77RCQ.js.map
