...
function ApplicationPickerTooltipComponent_Conditional_6_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("href", app_r4.redirect_uri, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
...
var ApplicationPickerTooltipComponent = class _ApplicationPickerTooltipComponent {
  ...
  async ngOnInit() {
    const active_authority = Ut();
    if (!active_authority?.id) {
      this.loading.set(false);
      return;
    }
    const response = await lastValueFrom(_u({ authority_id: active_authority.id })).catch(() => null);
...
//# sourceMappingURL=chunk-EWM67A4K.js.map
