...
// src/app/alert-dashboard/clock.component.ts
var DashboardClockComponent = class _DashboardClockComponent extends AsyncHandler {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275DashboardClockComponent_BaseFactory;
    return function DashboardClockComponent_Factory(__ngFactoryType__) {
      return (\u0275DashboardClockComponent_BaseFactory || (\u0275DashboardClockComponent_BaseFactory = \u0275\u0275getInheritedFactory(_DashboardClockComponent)))(__ngFactoryType__ || _DashboardClockComponent);
    };
  })();
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardClockComponent, selectors: [["clock"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 5, vars: 6, consts: [[1, "relative", "h-12", "w-12", "rounded-full", "border-2", "border-base-100"], [1, "hand", "absolute", "bottom-1/2", "left-1/2", "h-3", "w-1", "rounded", "bg-base-100"], [1, "hand", "minute", "absolute", "bottom-1/2", "left-1/2", "h-4", "bg-base-100"], [1, "hand", "absolute", "bottom-1/2", "left-1/2", "h-5", "w-px", "bg-base-100"], [1, "absolute", "left-1/2", "top-1/2", "h-2", "w-2", "-translate-x-1/2", "-translate-y-1/2", "transform", "rounded-full", "bg-base-100"]], template: function DashboardClockComponent_Template(rf2, ctx) {
    if (rf2 & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DashboardClockComponent, [{
    type: Component,
    args: [{ selector: "clock", template: `
        <div class="relative h-12 w-12 rounded-full border-2 border-base-100">
            ...
            ></div>
            <div
                class="hand minute absolute bottom-1/2 left-1/2 h-4 bg-base-100"
                [style.transform]="
                    'translateX(-50%) rotate(' + minute_angle + 'deg)'
                "
            ></div>
            <div
                class="hand absolute bottom-1/2 left-1/2 h-5 w-px bg-base-100"
                [style.transform]="
                    'translateX(-50%) rotate(' + second_angle + 'deg)'
                "
            ></div>
            <div
                class="absolute left-1/2 top-1/2 h-2 w-2 -translate-x-1/2 -translate-y-1/2 transform rounded-full bg-base-100"
            ></div>
        </div>
    `, imports: [], styles: ["/* angular:styles/component:css;ad89ac6d32c78caabe18fd68c2a3e134ffc604c58e28366bffed4961ac099e7b;/home/runner/work/backoffice/backoffice/src/app/alert-dashboard/clock.component.ts */\n.hand {\n  transform-origin: 50% 100%;\n}\n.minute {\n  width: 2px;\n  border-radius: 1px;\n}\n/*# sourceMappingURL=clock.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardClockComponent, { className: "DashboardClockComponent", filePath: "src/app/alert-dashboard/clock.component.ts", lineNumber: 45 });
})();
...
function If() {
  ...
  o.prototype.readUintLE = o.prototype.readUIntLE = function(u, l, S) {
    u = u >>> 0, l = l >>> 0, S || Y2(u, l, this.length);
    ...
    return u = u >>> 0, l || Y2(u, 1, this.length), this[u];
  }, o.prototype.readUint16LE = o.prototype.readUInt16LE = function(u, l) {
    return u = u >>> 0, l || Y2(u, 2, this.length), this[u] | this[u + 1] << 8;
  }, o.prototype.readUint16BE = o.prototype.readUInt16BE = function(u, l) {
    return u = u >>> 0, l || Y2(u, 2, this.length), this[u] << 8 | this[u + 1];
  }, o.prototype.readUint32LE = o.prototype.readUInt32LE = function(u, l) {
    return u = u >>> 0, l || Y2(u, 4, this.length), (this[u] | this[u + 1] << 8 | this[u + 2] << 16) + this[u + 3] * 16777216;
  }, o.prototype.readUint32BE = o.prototype.readUInt32BE = function(u, l) {
    return u = u >>> 0, l || Y2(u, 4, this.length), this[u] * 16777216 + (this[u + 1] << 16 | this[u + 2] << 8 | this[u + 3]);
    ...
    return u = u >>> 0, l || Y2(u, 1, this.length), this[u] & 128 ? (255 - this[u] + 1) * -1 : this[u];
  }, o.prototype.readInt16LE = function(u, l) {
    u = u >>> 0, l || Y2(u, 2, this.length);
    ...
    return u = u >>> 0, l || Y2(u, 4, this.length), this[u] | this[u + 1] << 8 | this[u + 2] << 16 | this[u + 3] << 24;
  }, o.prototype.readInt32BE = function(u, l) {
    return u = u >>> 0, l || Y2(u, 4, this.length), this[u] << 24 | this[u + 1] << 16 | this[u + 2] << 8 | this[u + 3];
    ...
    return u = u >>> 0, l || Y2(u, 4, this.length), e.read(this, u, true, 23, 4);
  }, o.prototype.readFloatBE = function(u, l) {
    return u = u >>> 0, l || Y2(u, 4, this.length), e.read(this, u, false, 23, 4);
  }, o.prototype.readDoubleLE = function(u, l) {
    return u = u >>> 0, l || Y2(u, 8, this.length), e.read(this, u, true, 52, 8);
  }, o.prototype.readDoubleBE = function(u, l) {
    return u = u >>> 0, l || Y2(u, 8, this.length), e.read(this, u, false, 52, 8);
  };
...
function JA() {
  ...
  let T = (H) => String.fromCodePoint(...H), g = function(H) {
    ...
    te < 0 && (te = 0);
    for (let Y2 = 0; Y2 < te; ++Y2) H.charCodeAt(Y2) >= 128 && b("not-basic"), G.push(H.charCodeAt(Y2));
    for (let Y2 = te > 0 ? te + 1 : 0; Y2 < K; ) {
      let ee = X;
      for (let Z = 1, ne = e; ; ne += e) {
        Y2 >= K && b("invalid-input");
        let fe = g(H.charCodeAt(Y2++));
    ...
    let te = G.length, Y2 = te;
    for (te && G.push(c); Y2 < K; ) {
      let ee = t;
      ...
      for (let Z of H) if (Z < X && ++Q > t && b("overflow"), Z === X) {
        ...
        G.push(E(O(ne, 0))), V = _(Q, pe, Y2 === te), Q = 0, ++Y2;
      }
      ++Q, ++X;
    }
    return G.join("");
...
function Wr() {
  ...
  var T = function Q(V) {
    ...
    if (V === "%AsyncFunction%") te = f("async function () {}");
      ...
      var Y2 = Q("%AsyncGeneratorFunction%");
      Y2 && (te = Y2.prototype);
    ...
    var te = J(V, 0, 1), Y2 = J(V, -1);
    if (te === "%" && Y2 !== "%") throw new s("invalid intrinsic syntax, expected closing `%`");
    if (Y2 === "%" && te !== "%") throw new s("invalid intrinsic syntax, expected opening `%`");
    var ee = [];
    ...
    var Y2 = V, ee;
    if (_(g, Y2) && (ee = g[Y2], Y2 = "%" + ee[0] + "%"), _(v, Y2)) {
      var pe = v[Y2];
      if (pe === b && (pe = T(Y2)), typeof pe > "u" && !te) throw new o("intrinsic " + V + " exists, but is not available. Please file an issue!");
      return { alias: ee, name: Y2, value: pe };
    }
  ...
  return ol = function(V, te) {
    ...
    var Y2 = K(V), ee = Y2.length > 0 ? Y2[0] : "", pe = X("%" + ee + "%", te), Z = pe.name, ne = pe.value, fe = false, ge = pe.alias;
    ge && (ee = ge[0], $(Y2, q([0, 1], ge)));
    for (var ye = 1, Ae = true; ye < Y2.length; ye += 1) {
      var _e = Y2[ye], ve = J(_e, 0, 1), Oe = J(_e, -1);
...
function Px() {
  ...
  var te = Tx, Y2 = te.custom, ee = Oe(Y2) ? Y2 : null;
...
function Rx() {
  ...
  var t = Ox(), e = vb(), r = Cl(), n = Object.prototype.hasOwnProperty, i = { brackets: function(b) {
    ...
    for (var V = b, te = Q, Y2 = 0, ee = false; (te = te.get(w)) !== void 0 && !ee; ) {
      var pe = te.get(b);
      if (Y2 += 1, typeof pe < "u") {
        if (pe === Y2) throw new RangeError("Cyclic object value");
        ee = true;
      }
      typeof te.get(w) > "u" && (Y2 = 0);
    }
...
`, "	"], o = ["{", "}", "|", "\\", "^", "`"].concat(s), a = ["'"].concat(o), c = ["%", "/", "?", ";", "#"].concat(a), f = ["/", "?", "#"], h = 255, d = /^[+a-z0-9A-Z_-]{0,63}$/, w = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, y = { javascript: true, "javascript:": true }, P = { javascript: true, "javascript:": true }, E = { http: true, https: true, ftp: true, gopher: true, file: true, "http:": true, "https:": true, "ftp:": true, "gopher:": true, "file:": true }, b = Cx();
  ...
  e.prototype.parse = function(g, O, _) {
    ...
    if (!P[G] && (X || G && !E[G])) {
      ...
      var Y2, ee;
      Q === -1 ? ee = W.lastIndexOf("@") : ee = W.lastIndexOf("@", Q), ee !== -1 && (Y2 = W.slice(0, ee), W = W.slice(ee + 1), this.auth = decodeURIComponent(Y2)), Q = -1;
  ...
  return e.prototype.resolveObject = function(g) {
    ...
    var te = _.pathname && _.pathname.charAt(0) === "/", Y2 = g.host || g.pathname && g.pathname.charAt(0) === "/", ee = Y2 || te || _.host && g.pathname, pe = ee, Z = _.pathname && _.pathname.split("/") || [], ne = g.pathname && g.pathname.split("/") || [], fe = _.protocol && !E[_.protocol];
    if (fe && (_.hostname = "", _.port = null, _.host && (Z[0] === "" ? Z[0] = _.host : Z.unshift(_.host)), _.host = "", g.protocol && (g.hostname = null, g.port = null, g.host && (ne[0] === "" ? ne[0] = g.host : ne.unshift(g.host)), g.host = null), ee = ee && (ne[0] === "" || Z[0] === "")), Y2) _.host = g.host || g.host === "" ? g.host : _.host, _.hostname = g.hostname || g.hostname === "" ? g.hostname : _.hostname, _.search = g.search, _.query = g.query, Z = ne;
...
var Wl = D((Si) => {
  ...
  function _T(t) {
    ...
    if (n !== void 0) {
      ...
      return (0, qb.connect)(__spreadProps(__spreadValues({}, i), { socket: s }));
    }
...
// src/app/alert-dashboard/dashboard-state.service.ts
var MqttDashboardStateService = class _MqttDashboardStateService {
  _client;
  ...
  topic = this.filters.valueChanges.pipe(map(() => {
  ...
  constructor() {
    $s().pipe(first((_) => _)).subscribe(() => this._init());
    this.filters.enable();
  }
  async _init() {
    const secure = location.protocol.includes("https");
    this._client = mqtt_esm_default.connect(`ws${secure ? "s" : ""}://${location.host}/api/mqtt/`, {
      username: Y(),
      password: Y()
    });
  ...
  query(topic) {
    if (!this._client)
      throw new Error("MQTT connection not setup.");
    if (!this._connected)
      throw new Error("MQTT connection is pending.");
  ...
  findMatchingTopic(topic) {
    ...
    for (const key of topic_list) {
      ...
      if (i === topic_tokens.length)
        return key;
    }
    return "";
  }
  static \u0275fac = function MqttDashboardStateService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MqttDashboardStateService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _MqttDashboardStateService, factory: _MqttDashboardStateService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MqttDashboardStateService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/alert-dashboard/dashboard.component.ts
var _forTrack0 = ($index, $item) => $item.id;
function MqttDashboardComponent_For_15_For_5_Template(rf2, ctx) {
  if (rf2 & 1) {
    ...
    \u0275\u0275pipe(11, "dateFrom");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "button", 14)(13, "icon", 9);
    \u0275\u0275text(14, "done");
    \u0275\u0275elementEnd()()();
  }
  if (rf2 & 2) {
    const ev_r1 = ctx.$implicit;
    \u0275\u0275classProp("bg-error", !ev_r1.value)("bg-teal-800", ev_r1.value);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ev_r1.mod);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ev_r1.driver_id);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ev_r1.ip);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ev_r1.value ? "Connected" : "Disconnected", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 9, ev_r1.timestamp * 1e3), " ");
  }
}
function MqttDashboardComponent_For_15_Template(rf2, ctx) {
  if (rf2 & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 8)(2, "h2", 9);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(4, MqttDashboardComponent_For_15_For_5_Template, 15, 11, "div", 10, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf2 & 2) {
    const sys_r2 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", sys_r2.display_name || sys_r2.name, " (", sys_r2.id, ") ");
    \u0275\u0275advance();
    \u0275\u0275repeater(sys_r2.events);
  }
}
var SYSTEMS = {};
var MqttDashboardComponent = class _MqttDashboardComponent {
  _state = inject(MqttDashboardStateService);
  systems = new BehaviorSubject([]);
  get time() {
    return startOfMinute(Date.now());
  }
  constructor() {
    this._state.connected.pipe(first((_) => _)).subscribe(() => this._state.query("placeos/+/state/+/+/+/+/+/+/+/connected").subscribe((d) => this._processQuery(d)));
  }
  async _processQuery(data) {
    const details = data.map(([_, d]) => __spreadProps(__spreadValues({}, d), {
      id: `event-${randomInt(999999999999)}`,
      sys_id: _[6],
      driver_id: _[7],
      mod: `${_[8]}_${_[9]}`
    }));
    ...
    for (const id of system_ids) {
      const sys = SYSTEMS[id] || await wc(id).toPromise();
      systems.push(__spreadProps(__spreadValues({
        id
      }, sys), {
  ...
  static \u0275fac = function MqttDashboardComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MqttDashboardComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MqttDashboardComponent, selectors: [["mqtt-dashboard"]], decls: 17, vars: 10, consts: [[1, "[#424242]", "flex", "h-full", "w-full", "flex-col", "bg-base-100"], [1, "flex", "w-full", "items-center", "justify-between", "bg-secondary", "px-4", "py-2", "text-base-100"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "flex-col", "items-center", "justify-center", "text-right"], [1, ""], [1, "h-1/2", "w-full", "flex-1", "space-y-4", "overflow-auto", "p-4"], [1, "divide-base-100/50", "border-base-100/50", "divide-y", "border"], [1, "bg-[#212121]", "p-2", "text-base-100"], [1, "text-xl"], [1, "flex", "items-center", "px-2", "text-base-100", 3, "bg-error", "bg-teal-800"], [1, "flex", "items-center", "px-2", "text-base-100"], [1, "w-1/6"], [1, "flex-1"], ["icon", "", "matRipple", ""]], template: function MqttDashboardComponent_Template(rf2, ctx) {
    if (rf2 & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3, "PlaceOS Alerts");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275repeaterCreate(14, MqttDashboardComponent_For_15_Template, 6, 2, "div", 7, _forTrack0);
      \u0275\u0275pipe(16, "async");
      \u0275\u0275elementEnd()();
    }
    if (rf2 & 2) {
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(9, 2, ctx.time, "shortTime"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(12, 5, ctx.time, "EEE, MMM d"));
      \u0275\u0275advance(3);
      \u0275\u0275repeater(\u0275\u0275pipeBind1(16, 8, ctx.systems));
    }
  }, dependencies: [
    CommonModule,
    IconComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MqttDashboardComponent, [{
    type: Component,
    args: [{ selector: "mqtt-dashboard", template: `
    ...
    `, imports: [
      ...
      DateFromPipe,
      DashboardClockComponent
    ], styles: ["/* angular:styles/component:css;897f3038bc171a01a3115e12043e1097ca47c3c1965f84153c2dad27f4deb3b7;/home/runner/work/backoffice/backoffice/src/app/alert-dashboard/dashboard.component.ts */\n:host > div {\n  z-index: 9999;\n}\n/*# sourceMappingURL=dashboard.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MqttDashboardComponent, { className: "MqttDashboardComponent", filePath: "src/app/alert-dashboard/dashboard.component.ts", lineNumber: 90 });
})();

// src/app/alert-dashboard/dashboard.module.ts
var ROUTES = [
  { component: MqttDashboardComponent, path: "" },
  { path: "**", redirectTo: "" }
];
var MqttDashboardModule = class _MqttDashboardModule {
  static \u0275fac = function MqttDashboardModule_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MqttDashboardModule)();
  };
  static \u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _MqttDashboardModule });
  static \u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forChild(ROUTES)] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MqttDashboardModule, [{
    type: NgModule,
    args: [{
      declarations: [],
...
mqtt/dist/mqtt.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-HPAE6W3G.js.map
