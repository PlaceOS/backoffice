...
var UserAboutComponent = class _UserAboutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserAboutComponent, selectors: [["user-about"]], decls: 41, vars: 57, consts: [[1, "mb-4", "flex", "items-center", "space-x-2"], [1, "flex", "items-center", "space-x-2", "rounded-3xl", "border", "border-base-300", "p-2"], [1, "px-2"], [1, "rounded-2xl", "px-2", "py-1", "text-xs"], [1, "mb-4", "flex", "space-x-2"], [1, "grid", "w-1/3", "flex-1", "gap-2", "rounded-sm", "border", "border-base-200", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "mono", "truncate", "text-sm", "underline", 3, "href"], ["for", "groups", 1, "flex", "items-center", "text-sm", "font-medium"], [1, "-mx-1", "flex", "flex-wrap"], [1, "opacity-30"], [1, "flex", "items-center"], ["matTooltipPosition", "right", 3, "matTooltip"], [1, "mono", "text-sm"], [1, "underline", 3, "routerLink"], ["matRipple", "", 1, "mono", "m-1", "rounded-sm", "bg-base-200", "px-2", "py-1", "text-[0.625rem]"], ["matRipple", "", 1, "mono", "m-1", "rounded-sm", "bg-base-200", "px-2", "py-1", "text-[0.625rem]", 3, "click"]], template: function UserAboutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-4XR2L5XS.js.map
