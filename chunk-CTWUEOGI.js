...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(APIKeyModalComponent, { className: "APIKeyModalComponent", filePath: "src/app/admin/api-keys/api-key-modal.component.ts", lineNumber: 279 });
})();
...
function AdminAPIKeysComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminAPIKeysComponent_Conditional_17_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
...
function AdminAPIKeysComponent_ng_template_28_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminAPIKeysComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275repeaterCreate(1, AdminAPIKeysComponent_ng_template_28_For_2_Template, 2, 1, "code", 25, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminAPIKeysComponent_ng_template_30_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminAPIKeysComponent_ng_template_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, AdminAPIKeysComponent_ng_template_30_Conditional_2_Template, 3, 3, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminAPIKeysComponent_ng_template_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, AdminAPIKeysComponent_ng_template_32_Conditional_2_Template, 3, 3, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminAPIKeysComponent_ng_template_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function AdminAPIKeysComponent_ng_template_36_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function AdminAPIKeysComponent_ng_template_36_Template_button_click_5_listener() {
      const row_r10 = \u0275\u0275restoreView(_r9).row;
      const ctx_r2 = \u0275\u0275nextContext();
...
var AdminAPIKeysComponent = class _AdminAPIKeysComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminAPIKeysComponent, selectors: [["admin-api-keys"]], decls: 38, vars: 57, consts: [["scopes_template", ""], ["description_template", ""], ["access_template", ""], ["data_from_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-12"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click", "disabled"], ["btn", "", "matRipple", "", 1, "w-36", 3, "click", "disabled"], [1, "mx-4", "mb-4", "flex", "w-[calc(100%-2rem)]", "items-start", "space-x-2"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-5xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "h-12", "w-full"], [1, "border-base-300", "flex", "w-full", "flex-col", "rounded-sm", "border", "shadow-sm"], [1, "border-base-300", "bg-base-200", "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "border-b"], [1, "px-4", "py-2", "text-lg", "font-medium"], [1, "mono", "bg-base-100", "rounded-sm", "px-2", "py-1", "text-xs", "opacity-60"], ["matRipple", "", 1, "mono", "rounded", "px-4", "py-3", "wrap-break-word", "opacity-60", "select-all", 3, "click"], [1, "flex", "flex-wrap", "px-4", "py-2"], [1, "m-1", "text-xs"], [1, "p-4", "text-xs"], [1, "opacity-30"], [1, "p-4", "font-mono", "text-xs", "uppercase"], [1, "p-4"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AdminAPIKeysComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function AdminAPIKeysComponent_Template_button_click_14_listener() {
        return ctx.quickCreateKey();
      });
      \u0275\u0275text(15);
      \u0275\u0275pipe(16, "translate");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(17, AdminAPIKeysComponent_Conditional_17_Template, 10, 5, "div", 14);
      \u0275\u0275elementStart(18, "div", 15);
      \u0275\u0275element(19, "mat-progress-bar", 16)(20, "simple-table", 17);
      \u0275\u0275pipe(21, "translate");
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275pipe(23, "translate");
      \u0275\u0275pipe(24, "translate");
      ...
      \u0275\u0275element(27, "div", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(28, AdminAPIKeysComponent_ng_template_28_Template, 3, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(30, AdminAPIKeysComponent_ng_template_30_Template, 3, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(32, AdminAPIKeysComponent_ng_template_32_Template, 3, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(34, AdminAPIKeysComponent_ng_template_34_Template, 3, 3, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(36, AdminAPIKeysComponent_ng_template_36_Template, 9, 6, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const scopes_template_r11 = \u0275\u0275reference(29);
      const description_template_r12 = \u0275\u0275reference(31);
      const access_template_r13 = \u0275\u0275reference(33);
      const data_from_template_r14 = \u0275\u0275reference(35);
      const actions_template_r15 = \u0275\u0275reference(37);
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(13, 18, "ADMIN.APP_KEYS_ADD"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", ctx.domain() === null || ctx.loading() === true);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 20, "ADMIN.APP_KEYS_QUICK_CREATE"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.last_key() ? 17 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275classProp("opacity-0", ctx.loading() !== true);
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.key_list)("columns", \u0275\u0275pureFunction6(50, _c6, \u0275\u0275pureFunction1(34, _c02, \u0275\u0275pipeBind1(21, 22, "COMMON.FIELD_NAME")), \u0275\u0275pureFunction2(36, _c1, \u0275\u0275pipeBind1(22, 24, "COMMON.FIELD_DESCRIPTION"), description_template_r12), \u0275\u0275pureFunction2(39, _c2, \u0275\u0275pipeBind1(23, 26, "ADMIN.APP_KEYS_FIELD_SCOPES"), scopes_template_r11), \u0275\u0275pureFunction2(42, _c3, \u0275\u0275pipeBind1(24, 28, "ADMIN.APP_KEYS_FIELD_PERMISSIONS"), access_template_r13), \u0275\u0275pureFunction2(45, _c4, \u0275\u0275pipeBind1(25, 30, "COMMON.CREATED_AT"), data_from_template_r14), \u0275\u0275pureFunction1(48, _c5, actions_template_r15)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(26, 32, "ADMIN.APP_KEYS_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminAPIKeysComponent, { className: "AdminAPIKeysComponent", filePath: "src/app/admin/api-keys/api-keys.component.ts", lineNumber: 210 });
})();
export {
  AdminAPIKeysComponent
};
//# sourceMappingURL=chunk-CTWUEOGI.js.map
