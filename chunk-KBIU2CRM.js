...
import {
  DomainStateService
} from "./chunk-OIVPAGIB.js";
import "./chunk-4QY7QHFC.js";
import {
  MatTab,
  MatTabGroup,
  MatTabsModule
...
var DomainAboutComponent = class _DomainAboutComponent extends AsyncHandler {
  ...
  async saveChanges() {
    ...
    const domain = new Di(__spreadProps(__spreadValues({}, this.item), {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DomainAboutComponent, { className: "DomainAboutComponent", filePath: "src/app/domains/domain-about.component.ts", lineNumber: 126 });
})();
export {
  DomainAboutComponent
};
//# sourceMappingURL=chunk-KBIU2CRM.js.map
