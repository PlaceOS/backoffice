...
var SelectMethodComponent = class _SelectMethodComponent extends AsyncHandler {
  ...
  _method_list = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_method_list" } : (
    ...
    loader: async ({ params }) => {
      ...
      try {
        const fn_mapping = await Ia(id, module.module, module.index).catch(() => ({}));
  ...
  ]), \u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 2, vars: 1, consts: [["method_search", ""], [1, "flex", "items-center", "justify-center", "space-x-2", "p-4"], ["appearance", "outline", 1, "h-14", "w-full"], [3, "ngModelChange", "openedChange", "placeholder", "disabled", "ngModel"], [1, "hover:bg-base-100!", "sticky", "-top-2"], ["name", "method-search", 1, "method-search-input", "pointer-event-auto", "focus:bg-info/10", "absolute", "inset-1", "h-auto", "w-[calc(100%-0.5rem)]", "cursor-text", "rounded-sm", "p-4", 3, "ngModelChange", "mousedown", "click", "keydown", "ngModel", "placeholder"], [3, "value"], [1, "opacity-30"], ["diameter", "32"]], template: function SelectMethodComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SelectMethodComponent, { className: "SelectMethodComponent", filePath: "src/app/ui/custom-fields/system-exec/select-method.component.ts", lineNumber: 118 });
})();
...
//# sourceMappingURL=chunk-7LD4UX4O.js.map
