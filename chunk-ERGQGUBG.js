...
var RichTextInputComponent = class _RichTextInputComponent extends AsyncHandler {
  ...
  _setAuth() {
    const tkn = ee();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Gt()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=30;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
  }
...
var EmailTemplateFormComponent = class _EmailTemplateFormComponent extends AsyncHandler {
  ...
  template = signal(null, ...ngDevMode ? [{ debugName: "template" }] : []);
  ...
  active_trigger_id = toSignal(this.form.controls.trigger.valueChanges.pipe(startWith(this.form.controls.trigger.value)), { initialValue: this.form.controls.trigger.value });
  active_trigger = computed(() => this.definition_list().find((_) => _.id === this.active_trigger_id()), ...ngDevMode ? [{ debugName: "active_trigger" }] : []);
  _template_id = toSignal(this._route.paramMap.pipe(map((params) => params.get("id"))), { initialValue: null });
  constructor() {
    super();
    effect(() => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplateFormComponent, selectors: [["email-template-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 47, vars: 10, consts: [["tracking_menu", "matMenu"], ["load_state", ""], [1, "bg-base-100", "absolute", "inset-0", "overflow-auto", "p-4"], [1, "mx-auto", "min-h-full", "w-3xl", "max-w-full", "pt-4", 3, "formGroup"], [1, "mb-8", "flex", "items-center", "space-x-2"], [1, "text-2xl", "font-medium"], [1, "flex", "items-center", "space-x-4"], [1, "w-1/4", "flex-1", "space-y-2"], ["for", "trigger"], ["appearance", "outline", 1, "w-full"], ["name", "trigger", "placeholder", "Select Trigger", "formControlName", "trigger"], ["value", ""], [3, "value"], ["btn", "", "matRipple", "", "matTooltip", "Values that get replaced in the email template when sent", 1, "my-4", "w-1/4", "flex-1", 3, "disabled", "matMenuTriggerFor"], [1, "max-h-96"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "disabled"], ["appearance", "outline", 1, "flex-1"], ["matInput", "", "placeholder", "Reply to address", "formControlName", "reply_to"], ["matInput", "", "placeholder", "From address", "formControlName", "from"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Template Subject", "formControlName", "subject"], ["formControlName", "html", "placeholder", "Body of the email template", 1, "block", "min-h-[calc(100vh-28rem)]", 3, "images_allowed"], [1, "bg-base-100", "sticky", "bottom-0", "flex", "items-center", "justify-end", "space-x-2"], ["btn", "", "matRipple", "", 1, "inverse", "w-32", 3, "routerLink"], ["btn", "", "matRipple", "", "type", "button", 1, "w-48", 3, "click"], [1, "my-2", "flex", "flex-col-reverse", "leading-tight"], [1, "text-xs", "opacity-30"], [1, "text-sm"], [1, "opacity-0"], ["mat-menu-item", "", 3, "click"], [1, "flex", "flex-col", "leading-tight"], [1, "font-mono", "text-sm"], [1, "bg-base-100", "absolute", "inset-0"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function EmailTemplateFormComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      let tmp_7_0;
      let tmp_8_0;
      const tracking_menu_r6 = \u0275\u0275reference(20);
      \u0275\u0275advance();
      \u0275\u0275property("formGroup", ctx.form);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", ((tmp_3_0 = ctx.template()) == null ? null : tmp_3_0.id) ? "Edit" : "New", " Email Template ");
      \u0275\u0275advance(9);
      \u0275\u0275repeater(ctx.definition_list());
      \u0275\u0275advance(4);
      \u0275\u0275property("disabled", !ctx.form.value.trigger)("matMenuTriggerFor", tracking_menu_r6);
      \u0275\u0275advance(4);
      \u0275\u0275repeater(((tmp_7_0 = ctx.active_trigger()) == null ? null : tmp_7_0.fields) || \u0275\u0275pureFunction0(7, _c02));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(!(((tmp_8_0 = ctx.active_trigger()) == null ? null : tmp_8_0.fields) || \u0275\u0275pureFunction0(8, _c02)).length ? 23 : -1);
      \u0275\u0275advance(16);
      \u0275\u0275property("images_allowed", true);
      \u0275\u0275advance(2);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(9, _c12));
    }
  }, dependencies: [
    CommonModule,
    MatProgressSpinnerModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplateFormComponent, { className: "EmailTemplateFormComponent", filePath: "src/app/admin/mailing-lists/email-template-form.component.ts", lineNumber: 196 });
})();
export {
  EmailTemplateFormComponent,
  extractTextFromHTML
};
//# sourceMappingURL=chunk-ERGQGUBG.js.map
