...
function SettingsFormComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(3, SettingsFormComponent_Conditional_4_Conditional_3_Template, 2, 0, "icon")(4, SettingsFormComponent_Conditional_4_Conditional_4_Template, 1, 0, "mat-spinner", 6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(7, SettingsFormComponent_Conditional_4_Conditional_7_Template, 2, 0, "icon")(8, SettingsFormComponent_Conditional_4_Conditional_8_Template, 1, 0, "mat-spinner", 6);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SettingsFormComponent_Conditional_5_For_5_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "settings-form-field", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, SettingsFormComponent_Conditional_5_For_5_Conditional_0_Conditional_2_Template, 2, 1, "div", 11);
    \u0275\u0275conditionalCreate(3, SettingsFormComponent_Conditional_5_For_5_Conditional_0_Conditional_3_Template, 10, 15, "div", 12);
  }
  if (rf & 2) {
    let tmp_14_0;
    let tmp_18_0;
...
function SettingsFormComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "form", 4)(1, "mat-tab-group", 8);
    ...
    \u0275\u0275repeaterCreate(2, SettingsFormComponent_Conditional_5_For_3_Template, 1, 1, "mat-tab", 9, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
...
var SettingsFormComponent = class _SettingsFormComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsFormComponent, selectors: [["a-settings-form"]], inputs: { id: [1, "id"], settings: [1, "settings"], merge: [1, "merge"], merge_settings: [1, "merge_settings"] }, outputs: { settings: "settingsChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 8, vars: 5, consts: [["spinner", ""], [1, "bg-base-200", "mb-2", "flex", "h-14", "w-full", "items-center", "justify-between", "rounded-sm", "p-2", "text-lg", "font-medium"], [1, "px-2"], [1, "flex", "items-center", "space-x-2", "text-base"], [3, "formGroup"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], ["diameter", "32"], ["icon", "", "default", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], [1, "border-base-300", "border-x", "border-t", 3, "selectedIndexChange", "selectedIndex"], [3, "label"], [3, "decorations", "formControlName", "readonly"], [1, "error-display"], [1, "border-base-300", "mb-4", "flex", "items-center", "justify-between", "space-x-2", "border-x", "border-b", "border-gray-300", "p-1"], [1, "pl-2", "text-xs"], [1, "text-xs", 3, "matTooltip"]], template: function SettingsFormComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsFormComponent, { className: "SettingsFormComponent", filePath: "src/app/ui/forms/settings-form.component.ts", lineNumber: 235 });
})();
var MAPPING_CLASS = [
  "external-setting",
  "encryption-none",
...
//# sourceMappingURL=chunk-P5TAMD2W.js.map
