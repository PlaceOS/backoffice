...
var ZoneTriggersComponent = class _ZoneTriggersComponent {
  ...
  _triggers = this._state.triggers;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneTriggersComponent, { className: "ZoneTriggersComponent", filePath: "src/app/zones/zone-triggers.component.ts", lineNumber: 128 });
})();
export {
  ZoneTriggersComponent
};
//# sourceMappingURL=chunk-B7ZLVWVC.js.map
