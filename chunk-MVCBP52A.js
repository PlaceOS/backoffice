import {
  EmailStateService
} from "./chunk-T37LLXIW.js";
import "./chunk-ASYDRY76.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
...
var selectMenu_default = {
  ...
  initEvent: function(pluginName, forms) {
    const form2 = forms.querySelector(".se-select-list");
    ...
    form2.addEventListener("mousedown", this.plugins.selectMenu.onMousedown_list);
    form2.addEventListener("mousemove", this.plugins.selectMenu.onMouseMove_list.bind(this, context));
    form2.addEventListener("click", this.plugins.selectMenu.onClick_list.bind(this, context));
  },
  ...
  open: function(listContext, positionHandler) {
    const form2 = listContext.form;
    form2.style.visibility = "hidden";
    form2.style.display = "block";
    positionHandler(form2);
    form2.style.visibility = "";
  },
...
var RichTextInputComponent = class _RichTextInputComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RichTextInputComponent, selectors: [["rich-text-input"]], viewQuery: function RichTextInputComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._container_el, _c0, 5)(ctx._editor_el, _c1, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(2);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RichTextInputComponent, { className: "RichTextInputComponent", filePath: "src/app/ui/custom-fields/rich-text-input.component.ts", lineNumber: 47 });
})();
...
function EmailTemplateFormComponent_For_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", template_r1.name_details[0], " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", template_r1.name_details[1], " ");
  }
}
function EmailTemplateFormComponent_For_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 30);
    \u0275\u0275listener("click", function EmailTemplateFormComponent_For_22_Template_button_click_0_listener() {
      const field_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.copyField(field_r3.name));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", field_r3.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", field_r3.description, " ");
  }
}
function EmailTemplateFormComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateFormComponent_ng_template_45_Template(rf, ctx) {
  if (rf & 1) {
...
var EmailTemplateFormComponent = class _EmailTemplateFormComponent extends AsyncHandler {
  ...
  definition_list = toSignal(this.definitions, {
    initialValue: []
  });
  formModel = signal(
    {
  ...
  active_trigger_id = computed(
    () => this.formModel().trigger,
    ...ngDevMode ? [{ debugName: "active_trigger_id" }] : (
      /* istanbul ignore next */
      []
    )
  );
  active_trigger = computed(
  ...
  _route_params = toSignal(this._route.paramMap, {
    initialValue: null
  });
  _template_id = computed(
  ...
  async loadTemplate(template_id) {
    ...
    if (!template) {
      ...
      this.formModel.update((value) => __spreadValues(__spreadValues({}, value), template));
    }
  }
  static \u0275fac = function EmailTemplateFormComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EmailTemplateFormComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplateFormComponent, selectors: [["email-template-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 47, vars: 14, consts: [["tracking_menu", "matMenu"], ["load_state", ""], [1, "bg-base-100", "absolute", "inset-0", "overflow-auto", "p-4"], [1, "mx-auto", "min-h-full", "w-3xl", "max-w-full", "pt-4"], [1, "mb-8", "flex", "items-center", "space-x-2"], [1, "text-2xl", "font-medium"], [1, "flex", "items-center", "space-x-4"], [1, "w-1/4", "flex-1", "space-y-2"], ["for", "trigger"], ["appearance", "outline", 1, "w-full"], ["placeholder", "Select Trigger", 3, "formField"], ["value", ""], [3, "value"], ["type", "button", "btn", "", "matRipple", "", "matTooltip", "Values that get replaced in the email template when sent", 1, "my-4", "w-1/4", "flex-1", 3, "disabled", "matMenuTriggerFor"], [1, "max-h-96"], ["type", "button", "mat-menu-item", ""], ["type", "button", "mat-menu-item", "", 3, "disabled"], ["appearance", "outline", 1, "flex-1"], ["matInput", "", "placeholder", "Reply to address", 3, "formField"], ["matInput", "", "placeholder", "From address", 3, "formField"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Template Subject", 3, "formField"], ["placeholder", "Body of the email template", 1, "block", "min-h-[calc(100vh-28rem)]", 3, "formField", "images_allowed"], [1, "bg-base-100", "sticky", "bottom-0", "flex", "items-center", "justify-end", "space-x-2"], ["btn", "", "matRipple", "", 1, "inverse", "w-32", 3, "routerLink"], ["btn", "", "matRipple", "", "type", "button", 1, "w-48", 3, "click"], [1, "my-2", "flex", "flex-col-reverse", "leading-tight"], [1, "text-xs", "opacity-30"], [1, "text-sm"], [1, "opacity-0"], ["type", "button", "mat-menu-item", "", 3, "click"], [1, "flex", "flex-col", "leading-tight"], [1, "font-mono", "text-sm"], [1, "bg-base-100", "absolute", "inset-0"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function EmailTemplateFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(16, "A trigger is required");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(17, "button", 13);
      \u0275\u0275text(18, " Placeholders ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(19, "mat-menu", 14, 0);
      \u0275\u0275repeaterCreate(21, EmailTemplateFormComponent_For_22_Template, 6, 2, "button", 15, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275conditionalCreate(23, EmailTemplateFormComponent_Conditional_23_Template, 2, 1, "button", 16);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "div", 6)(25, "mat-form-field", 17);
      \u0275\u0275element(26, "input", 18);
      \u0275\u0275controlCreate();
      \u0275\u0275elementStart(27, "mat-error");
      \u0275\u0275text(28, "A reply address is required");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(29, "mat-form-field", 17);
      \u0275\u0275element(30, "input", 19);
      \u0275\u0275controlCreate();
      \u0275\u0275elementStart(31, "mat-error");
      \u0275\u0275text(32, "A from address is required");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(33, "mat-form-field", 9)(34, "icon", 20);
      \u0275\u0275text(35, " description ");
      \u0275\u0275elementEnd();
      \u0275\u0275element(36, "input", 21);
      \u0275\u0275controlCreate();
      \u0275\u0275elementStart(37, "mat-error");
      \u0275\u0275text(38, "A title for the template is required");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(39, "rich-text-input", 22);
      \u0275\u0275controlCreate();
      \u0275\u0275elementStart(40, "div", 23)(41, "a", 24);
      \u0275\u0275text(42, " Cancel ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(43, "button", 25);
      \u0275\u0275listener("click", function EmailTemplateFormComponent_Template_button_click_43_listener() {
        return ctx.save();
      });
      \u0275\u0275text(44, " Save Template ");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(45, EmailTemplateFormComponent_ng_template_45_Template, 5, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const tracking_menu_r5 = \u0275\u0275reference(20);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", ctx.template()?.id ? "Edit" : "New", " Email Template ");
      \u0275\u0275advance(6);
      \u0275\u0275property("formField", ctx.form.trigger);
      \u0275\u0275control();
      \u0275\u0275advance(3);
      \u0275\u0275repeater(ctx.definition_list());
      \u0275\u0275advance(4);
      \u0275\u0275property("disabled", !ctx.formModel().trigger)("matMenuTriggerFor", tracking_menu_r5);
      \u0275\u0275advance(4);
      \u0275\u0275repeater(ctx.active_trigger()?.fields || \u0275\u0275pureFunction0(11, _c02));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(!(ctx.active_trigger()?.fields || \u0275\u0275pureFunction0(12, _c02)).length ? 23 : -1);
      \u0275\u0275advance(3);
      \u0275\u0275property("formField", ctx.form.reply_to);
      \u0275\u0275control();
      \u0275\u0275advance(4);
      \u0275\u0275property("formField", ctx.form.from);
      \u0275\u0275control();
      \u0275\u0275advance(6);
      \u0275\u0275property("formField", ctx.form.subject);
      \u0275\u0275control();
      \u0275\u0275advance(3);
      \u0275\u0275property("formField", ctx.form.html)("images_allowed", true);
      \u0275\u0275control();
      \u0275\u0275advance(2);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(13, _c12));
    }
  }, dependencies: [
    MatProgressSpinnerModule,
    MatProgressSpinner,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplateFormComponent, { className: "EmailTemplateFormComponent", filePath: "src/app/admin/mailing-lists/email-template-form.component.ts", lineNumber: 191 });
})();
export {
  EmailTemplateFormComponent,
  extractTextFromHTML
};
//# sourceMappingURL=chunk-MVCBP52A.js.map
