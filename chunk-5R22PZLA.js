...
var ModuleRuntimeErrorsModalComponent = class _ModuleRuntimeErrorsModalComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModuleRuntimeErrorsModalComponent, selectors: [["module-runtime-errors-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 10, consts: [[1, "border-base-100", "bg-base-200", "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "max-w-full", "items-center", "justify-between", "rounded-sm", "border", "px-4", "py-2"], [1, "px-2"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "max-h-[65vh]", "overflow-auto", "p-4"], [1, "flex", "h-64", "w-[24rem]", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "flex", "h-64", "w-[24rem]", "flex-col", "items-center", "justify-center", "space-y-2", "opacity-30"], ["diameter", "32"], [1, "opacity-30"]], template: function ModuleRuntimeErrorsModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModuleRuntimeErrorsModalComponent, { className: "ModuleRuntimeErrorsModalComponent", filePath: "src/app/ui/module-runtime-errors-modal.component.ts", lineNumber: 69 });
})();

export {
  ModuleRuntimeErrorsModalComponent
};
//# sourceMappingURL=chunk-5R22PZLA.js.map
