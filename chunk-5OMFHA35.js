...
var ClockComponent = class _ClockComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClockComponent, selectors: [["clock"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 5, vars: 6, consts: [[1, "relative", "h-12", "w-12", "rounded-full", "border-2", "border-base-content"], [1, "hand", "absolute", "bottom-1/2", "left-1/2", "h-3", "w-1", "rounded", "bg-base-content"], [1, "hand", "minute", "absolute", "bottom-1/2", "left-1/2", "h-4", "bg-base-content"], [1, "hand", "absolute", "bottom-1/2", "left-1/2", "h-5", "w-px", "bg-base-content"], [1, "absolute", "left-1/2", "top-1/2", "h-2", "w-2", "-translate-x-1/2", "-translate-y-1/2", "transform", "rounded-full", "bg-base-content"]], template: function ClockComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var AppMetricsModule = class _AppMetricsModule {
  static \u0275fac = function AppMetricsModule_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppMetricsModule)();
  };
  static \u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _AppMetricsModule });
  static \u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [MetricsComponent, RouterModule.forChild(ROUTES)] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppMetricsModule, [{
    type: NgModule,
    args: [{
      declarations: [],
...
//# sourceMappingURL=chunk-5OMFHA35.js.map
