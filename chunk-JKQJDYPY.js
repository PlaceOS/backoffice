...
var CustomTooltipComponent = class _CustomTooltipComponent extends AsyncHandler {
  ...
  _updateType() {
    ...
    this.type.set(typeof content === "string" ? "html" : content instanceof TemplateRef ? "template" : "component");
  }
  _updateInjector() {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomTooltipComponent, { className: "CustomTooltipComponent", filePath: "src/app/ui/custom-tooltip.component.ts", lineNumber: 60 });
})();
...
//# sourceMappingURL=chunk-JKQJDYPY.js.map
