...
var NewTerminalComponent = class _NewTerminalComponent extends AsyncHandler {
  ...
  search_count = computed(() => this._filtered_events().length, ...ngDevMode ? [{ debugName: "search_count" }] : []);
  ...
  _scroll_viewport = viewChild(VirtualScrollComponent, ...ngDevMode ? [{ debugName: "_scroll_viewport" }] : []);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewTerminalComponent, selectors: [["new-terminal"]], viewQuery: function NewTerminalComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._scroll_viewport, VirtualScrollComponent, 5);
      \u0275\u0275viewQuerySignal(ctx._container_el, _c0, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(2);
    }
  }, inputs: { lines: [1, "lines"], search: [1, "search"], resize: [1, "resize"] }, outputs: { search: "searchChange" }, features: [\u0275\u0275ProvidersFeature([SanitizePipe]), \u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 12, vars: 9, consts: [["line_template", ""], ["container", ""], [1, "relative", "flex", "h-full", "w-full", "items-end", "border-t", "border-[hsl(0,0%,40%)]", "bg-[hsl(0,0%,15%)]", "text-xs", "text-white"], [1, "max-h-full", "w-full", 3, "scrolled", "items", "item_size", "item_template"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "text-base", "select-none"], [1, "absolute", "-top-11", "right-0", "flex", "items-center", "space-x-2", "p-2"], [1, "absolute", "top-1/2", "left-3", "-translate-y-1/2", "text-xl"], ["placeholder", "Filter output", 1, "mono", "rounded-lg", "border-none", "bg-[hsl(0,0%,30%)]", "px-8", "py-1", "pr-1", "text-sm", "text-white", 3, "ngModelChange", "ngModel"], [1, "mono", "p-1", "hover:bg-white/10", 3, "innerHTML"], [1, "opacity-60"]], template: function NewTerminalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("scrolled", function NewTerminalComponent_Template_virtual_scroll_scrolled_4_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onScrolled($event));
      });
      \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewTerminalComponent, { className: "NewTerminalComponent", filePath: "src/app/ui/new-terminal.component.ts", lineNumber: 87 });
})();
...
var DebugOutputComponent = class _DebugOutputComponent extends AsyncHandler {
  ...
  }, inputs: { compact: [1, "compact"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["content", ""], [3, "class"], [3, "resize"], ["content", "", 1, "animate-fade-in", "relative", "z-10", "flex", "flex-col", "overflow-hidden", "border", "bg-[hsl(0,0%,15%)]", "text-white", "shadow-sm"], [1, "p-3", "text-sm"], [1, "h-1/2", "w-full", "flex-1", 3, "lines", "resize"], ["ns-resize", "", 1, "absolute", "-top-2", "right-0", "left-0", "h-4", "select-none", 3, "mousedown", "touchstart"], ["ew-resize", "", 1, "absolute", "top-0", "bottom-0", "-left-2", "w-4", "select-none", 3, "mousedown", "touchstart"], ["nwse-resize", "", 1, "absolute", "-top-2", "-left-2", "h-4", "w-4", "select-none", 3, "mousedown", "touchstart"], ["actions", "", 1, "absolute", "right-2", "bottom-2", "flex", "items-center", "space-x-2"], ["icon", "", "matRipple", "", 1, "rounded-full", "bg-[hsl(0,0%,30%)]", "text-white", "shadow-sm", 3, "click"], [3, "matTooltip"], ["icon", "", "matRipple", "", 1, "rounded-full", "bg-[hsl(0,0%,30%)]", "text-white", "shadow-sm", 3, "click", "matTooltip"]], template: function DebugOutputComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DebugOutputComponent, { className: "DebugOutputComponent", filePath: "src/app/ui/debug-output.component.ts", lineNumber: 210 });
})();

export {
  DebugOutputComponent
};
//# sourceMappingURL=chunk-OMHZFXJ6.js.map
