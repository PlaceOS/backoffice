...
var SettingsToggleComponent = class _SettingsToggleComponent {
  ...
  ])], ngContentSelectors: _c0, decls: 8, vars: 12, consts: [["type", "button", "matRipple", "", 1, "relative", "flex", "min-h-12", "flex-1", "items-center", "space-x-2", "overflow-hidden", "rounded-sm", "border", "px-2", 3, "click", "disabled"], [1, "bg-info", "absolute", "inset-0", "m-0!", "opacity-10"], [1, "ml-2", "flex", "flex-1", "items-center", "space-x-2", "text-left"], [3, "matTooltip"], [1, "pointer-events-none", 3, "ngModelChange", "ngModel", "disabled"]], template: function SettingsToggleComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsToggleComponent, { className: "SettingsToggleComponent", filePath: "src/app/ui/settings-toggle.component.ts", lineNumber: 63 });
})();

export {
  SettingsToggleComponent
};
//# sourceMappingURL=chunk-PGB6GY3R.js.map
