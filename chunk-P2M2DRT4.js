...
var SettingsFieldComponent = class _SettingsFieldComponent extends AsyncHandler {
  ...
  ]), \u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 2, vars: 0, consts: [["editor", ""], ["editor", "", 1, "relative", "h-128", "w-full", "border", "border-base-300", 3, "resize"]], template: function SettingsFieldComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SettingsFieldComponent, [{
    ...
    args: [{ selector: "settings-form-field,[settings-field]", template: `
        <div
            class="relative h-128 w-full border border-base-300"
            editor
...
//# sourceMappingURL=chunk-P2M2DRT4.js.map
