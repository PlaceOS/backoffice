...
var ChangelogModalComponent = class _ChangelogModalComponent extends AsyncHandler {
  ...
  loading;
  changelog = this._data.changelog;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChangelogModalComponent, selectors: [["changelog-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 5, consts: [[3, "heading", "hide_confirm"], [1, "markdown", "changelog", "items-start", 3, "innerHTML"], [1, "flex", "h-[50vh]", "w-full", "flex-col", "items-center", "justify-center", "space-y-4"], [1, "text-7xl"], [1, "text"]], template: function ChangelogModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(1, "translate");
      \u0275\u0275conditionalCreate(2, ChangelogModalComponent_Conditional_2_Template, 3, 5, "div", 1)(3, ChangelogModalComponent_Conditional_3_Template, 6, 3, "div", 2);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChangelogModalComponent, { className: "ChangelogModalComponent", filePath: "src/app/overlays/changelog-modal.component.ts", lineNumber: 49 });
})();
...
var PlaceDetailsComponent = class _PlaceDetailsComponent extends AsyncHandler {
  ...
  api_details = signal(
    [],
    ...ngDevMode ? [{ debugName: "api_details" }] : (
      /* istanbul ignore next */
      []
    )
  );
  changelog_data = signal(
    "",
    ...ngDevMode ? [{ debugName: "changelog_data" }] : (
      /* istanbul ignore next */
      []
    )
  );
  backend_version = signal(
    "",
    ...ngDevMode ? [{ debugName: "backend_version" }] : (
      /* istanbul ignore next */
      []
    )
  );
  backoffice_logs = signal(
    "",
    ...ngDevMode ? [{ debugName: "backoffice_logs" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  async loadApiDetails() {
    const details = await f(`${u()}/cluster/versions`).catch((err) => notifyError(i18n("ADMIN.BACKEND_SERVICES_ERROR", {
      error: JSON.stringify(err.response || err.message || err)
    })));
    this.api_details.set(details || []);
  }
  async loadPlatformDetails() {
    const { changelog, version } = await f(`${u()}/platform`).catch((err) => {
  ...
  }, dependencies: [TranslatePipe, DatePipe, SlicePipe], styles: ["\n[_nghost-%COMP%] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  padding: 1rem;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n}\n/*# sourceMappingURL=details.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PlaceDetailsComponent, [{
    ...
    `, imports: [TranslatePipe, DatePipe, SlicePipe], styles: ["/* angular:styles/component:css;a9c9b54ac1150998ce0ae85eb89bb6d8fd79aeab8edd84be4a671d3bf76cdf8a;/home/runner/work/backoffice/backoffice/src/app/admin/details.component.ts */\n:host {\n  position: absolute;\n  top: 0;\n  left: 0;\n  padding: 1rem;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n}\n/*# sourceMappingURL=details.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceDetailsComponent, { className: "PlaceDetailsComponent", filePath: "src/app/admin/details.component.ts", lineNumber: 199 });
})();
export {
  PlaceDetailsComponent
};
//# sourceMappingURL=chunk-LOIPGD67.js.map
