...
var removingLabel = (resource2) => i18n(REMOVING_KEY[resource2.type], { name: resource2.name });
var emptyPlan = () => ({
  scope: [],
  summary: [],
  warnings: [],
...
async function zoneSubtreeIds(zone_id) {
  ...
  while (level.length) {
    ...
    const children = await collectPages(ja({ parent_id: level.join(","), limit: PAGE_SIZE }));
    level = [];
...
async function splitZoneSystems(zone_ids) {
  ...
  const pages = await mapLimit(zone_ids, READ_CONCURRENCY, (zone_id) => collectPages(Xc({ zone_id, limit: PAGE_SIZE })));
  ...
  const confirmed = await mapLimit(candidates, READ_CONCURRENCY, (system) => ta(system.id).catch(() => null));
  const orphaned = [];
...
async function domainTenants(domain) {
  if (!domain)
    return [];
  const tenants = await d("/api/staff/v1/tenants");
...
async function planDomainCascade(domain) {
  ...
  const [applications, tenants, all_domains] = await Promise.all([
    collectPages(io({ authority_id: domain.id, limit: PAGE_SIZE })),
    domainTenants(domain.domain),
    org_zone_id ? collectPages(Uo({ limit: PAGE_SIZE })) : Promise.resolve([])
  ]);
  ...
  if (tenants.length) {
    ...
    plan.steps.push(...tenants.map((tenant) => ({
      ...
      run: () => X(`/api/staff/v1/tenants/${tenant.id}`)
    })));
  }
  if (!org_zone_id) {
  ...
  const org_zone = await Ba(org_zone_id).catch(() => null);
  if (!org_zone) {
...
var _c05 = ["branch_search"];
var _c13 = ["commit_search"];
...
function RepositoryFormComponent_Conditional_1_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r0.branch_filter())("ngModelOptions", \u0275\u0275pureFunction0(21, _c22))("placeholder", \u0275\u0275pipeBind2(11, 13, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction0(22, _c3)));
...
function RepositoryFormComponent_Conditional_1_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r0.commit_filter())("ngModelOptions", \u0275\u0275pureFunction0(23, _c22))("placeholder", \u0275\u0275pipeBind2(16, 17, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction0(24, _c4)));
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r0.follow_latest())("ngModelOptions", \u0275\u0275pureFunction0(26, _c22));
    \u0275\u0275control();
  }
}
...
var RepositoryFormComponent = class _RepositoryFormComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RepositoryFormComponent, selectors: [["repository-form"]], viewQuery: function RepositoryFormComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._branch_search_el, _c05, 5)(ctx._commit_search_el, _c13, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(2);
    }
...
var receiptItems = (resources) => resources.map((resource2) => ({
  type: i18n(`CASCADE.TYPE_${resource2.type.toUpperCase()}`),
  id: resource2.id,
  name: resource2.name
}));
var ActiveItemService = class _ActiveItemService extends AsyncHandler {
  ...
  async delete() {
    ...
    waitForEvent(ref.componentInstance.event, (e) => e.reason === "done").then(async (event) => {
      ...
      await actions.remove(item).then(() => {
        this._active_item.set(null);
...
//# sourceMappingURL=chunk-T2HEYUL2.js.map
