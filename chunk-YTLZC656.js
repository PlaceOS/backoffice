...
var _c0 = (a0, a1) => ({ key: "repo", name: a0, content: a1 });
var _c1 = (a0, a1) => ({ key: "driver", name: a0, content: a1 });
var _c2 = (a0, a1) => ({ key: "message", name: a0, size: "32rem", content: a1 });
var _c3 = (a0) => ({ key: "actions", name: " ", content: a0, size: "3.5rem", sortable: false });
...
function queryBuildJobs(q = {}) {
  ...
  return f(`/api/build/v1/monitor${query ? "?" + query : ""}`);
}
function cancelBuildJob(id, q = {}) {
  const query = toQueryString(q);
  return V(`/api/build/v1/cancel/${id}${query ? "?" + query : ""}`);
}
var PlaceBuildListComponent = class _PlaceBuildListComponent {
  ...
  async loadJobList() {
    ...
    const { data } = await queryBuildJobs().catch(() => ({ data: [] }));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceBuildListComponent, selectors: [["", "admin-build-list", ""]], decls: 20, vars: 33, consts: [["repo_template", ""], ["driver_template", ""], ["description_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-5xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "flex", "flex-col", "px-4", "py-2"], [1, "text-xs", "opacity-30"], [1, "w-full", "overflow-hidden", "px-4", "py-2", "text-xs", "select-text"], [1, "opacity-30"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"]], template: function PlaceBuildListComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.jobs())("columns", \u0275\u0275pureFunction4(28, _c4, \u0275\u0275pureFunction2(17, _c0, \u0275\u0275pipeBind1(8, 9, "REPOS.SINGULAR"), repo_template_r7), \u0275\u0275pureFunction2(20, _c1, \u0275\u0275pipeBind1(9, 11, "DRIVERS.SINGULAR"), driver_template_r8), \u0275\u0275pureFunction2(23, _c2, \u0275\u0275pipeBind1(10, 13, "COMMON.FIELD_DESCRIPTION"), description_template_r9), \u0275\u0275pureFunction1(26, _c3, actions_template_r10)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(11, 15, "ADMIN.BUILD_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceBuildListComponent, { className: "PlaceBuildListComponent", filePath: "src/app/admin/build-list.component.ts", lineNumber: 142 });
})();
export {
  PlaceBuildListComponent
};
//# sourceMappingURL=chunk-YTLZC656.js.map
