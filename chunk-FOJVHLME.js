...
var TriggerAboutComponent = class _TriggerAboutComponent extends AsyncHandler {
  ...
  query_fn = (q) => Gc({ q }).pipe(map((resp) => resp.data));
...
//# sourceMappingURL=chunk-FOJVHLME.js.map
