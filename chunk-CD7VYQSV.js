import {
  UserAvatarComponent
} from "./chunk-3D7O6VCF.js";
import {
  PlaceDebugService
} from "./chunk-XQMMIPUL.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
...
var ApplicationPickerTooltipComponent = class _ApplicationPickerTooltipComponent {
  ...
  async ngOnInit() {
    const active_authority = Mt();
    if (!active_authority?.id) {
      this.loading.set(false);
      return;
    }
    const response = await ko({
...
// src/app/ui/support-group-picker.component.ts
var _forTrack02 = ($index, $item) => $item.group.id;
function SupportGroupPickerComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-current", !ctx_r2.selected_id() ? "true" : null);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(!ctx_r2.selected_id() ? "check" : "public");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 4, "GROUPS.ALL_GROUPS"), " ");
  }
}
function SupportGroupPickerComponent_For_13_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function SupportGroupPickerComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "button", 6)(1, "icon");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, SupportGroupPickerComponent_For_13_Conditional_6_Template, 2, 1, "span", 12);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_15_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("mat-dialog-close", item_r4.group.id);
    \u0275\u0275attribute("aria-current", ctx_r2.selected_id() === item_r4.group.id ? "true" : null);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.selected_id() === item_r4.group.id ? "check" : "groups");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r4.group.name);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_15_0 = ctx_r2.parentName(item_r4.group.parent_id)) ? 6 : -1, tmp_15_0);
  }
}
function SupportGroupPickerComponent_ForEmpty_14_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "GROUPS.NO_MATCHING_GROUPS"), " ");
  }
}
var SupportGroupPickerComponent = class _SupportGroupPickerComponent {
  search = signal(
    "",
  ...
  selected_id = selected_support_group_id;
  show_all = hasSupportRole;
  groups = computed(
    () => {
      const search = this.search().trim().toLowerCase();
      return support_groups().filter(({ group }) => `${group.name} ${this.parentName(group.parent_id)}`.toLowerCase().includes(search));
    },
  ...
  parentName(id) {
    return support_groups().find(({ group }) => group.id === id)?.group.name || "";
  }
  static \u0275fac = function SupportGroupPickerComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SupportGroupPickerComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SupportGroupPickerComponent, selectors: [["app-support-group-picker"]], decls: 19, vars: 12, consts: [["search_input", ""], ["mat-dialog-title", ""], [1, "w-96", "max-w-full"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "cdkFocusInitial", "", 3, "input"], [1, "flex", "flex-col", "gap-1"], [1, "hover:bg-base-200", "flex", "items-center", "gap-2", "rounded", "p-3", "text-left", 3, "mat-dialog-close"], [1, "p-3", "opacity-60"], ["align", "end"], [1, "rounded", "px-4", "py-2", 3, "mat-dialog-close"], [1, "min-w-0"], [1, "block"], [1, "block", "text-xs", "opacity-60"]], template: function SupportGroupPickerComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275listener("input", function SupportGroupPickerComponent_Template_input_input_8_listener() {
        \u0275\u0275restoreView(_r1);
        const search_input_r2 = \u0275\u0275reference(9);
        return \u0275\u0275resetView(ctx.search.set(search_input_r2.value));
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "div", 5);
      \u0275\u0275conditionalCreate(11, SupportGroupPickerComponent_Conditional_11_Template, 5, 6, "button", 6);
      \u0275\u0275repeaterCreate(12, SupportGroupPickerComponent_For_13_Template, 7, 5, "button", 6, _forTrack02, false, SupportGroupPickerComponent_ForEmpty_14_Template, 3, 3, "p", 7);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(15, "mat-dialog-actions", 8)(16, "button", 9);
      \u0275\u0275text(17);
      \u0275\u0275pipe(18, "translate");
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 6, "GROUPS.SWITCH_GROUP"));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 8, "GROUPS.SEARCH_GROUPS"));
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.show_all() && !ctx.search() ? 11 : -1);
      \u0275\u0275advance();
      \u0275\u0275repeater(ctx.groups());
      \u0275\u0275advance(4);
      \u0275\u0275property("mat-dialog-close", void 0);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(18, 10, "COMMON.CANCEL"), " ");
    }
  }, dependencies: [
    MatDialogModule,
    MatDialogClose,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SupportGroupPickerComponent, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SupportGroupPickerComponent, { className: "SupportGroupPickerComponent", filePath: "src/app/ui/support-group-picker.component.ts", lineNumber: 79 });
})();
...
function SidebarMenuComponent_For_10_Conditional_0_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275elementStart(2, "div", 18)(3, "icon", 19);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6);
...
function SidebarMenuComponent_For_10_Conditional_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275elementStart(2, "div", 18)(3, "icon", 20);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, SidebarMenuComponent_For_10_Conditional_0_Conditional_1_Conditional_8_Template, 1, 8, "span", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const link_r1 = \u0275\u0275nextContext(2).$implicit;
...
function SidebarMenuComponent_For_10_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SidebarMenuComponent_For_10_Conditional_0_Conditional_0_Template, 8, 16, "a", 16)(1, SidebarMenuComponent_For_10_Conditional_0_Conditional_1_Template, 9, 21, "a", 17);
  }
  if (rf & 2) {
...
function SidebarMenuComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "button", 7)(1, "div", 18)(2, "icon", 19);
    \u0275\u0275text(3, "apps");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p");
...
function SidebarMenuComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 23);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function SidebarMenuComponent_Conditional_15_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.switchGroup());
    });
    \u0275\u0275elementStart(3, "icon", 24);
    \u0275\u0275text(4, "groups");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(9, "unfold_more");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("justify-center", ctx_r1.compact());
    \u0275\u0275property("matTooltip", ctx_r1.selected_group()?.group.name || \u0275\u0275pipeBind1(1, 9, "GROUPS.ALL_GROUPS"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 11, "GROUPS.SWITCH_GROUP"));
    \u0275\u0275advance(5);
    \u0275\u0275classProp("sm:hidden", ctx_r1.compact());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.selected_group()?.group.name || \u0275\u0275pipeBind1(7, 13, "GROUPS.ALL_GROUPS"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("sm:hidden", ctx_r1.compact());
  }
}
var SidebarMenuComponent = class _SidebarMenuComponent extends AsyncHandler {
  ...
  _items = inject(ActiveItemService);
  support_groups = support_groups;
  selected_group = selected_support_group;
  open = model(
    true,
  ...
  get alerts_url() {
    return Mt()?.config?.backoffice?.alerts_url;
  }
  get metrics_url() {
    return Mt()?.config?.backoffice?.metrics_url;
  }
  close = () => this._tooltip?.close();
  switchGroup() {
    this._dialog.open(SupportGroupPickerComponent, {
      maxWidth: "calc(100vw - 2rem)"
    }).afterClosed().subscribe((id) => {
      if (id !== void 0)
        this._items.switchGroup(id);
    });
  }
  toggleCompactMode() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarMenuComponent, selectors: [["sidebar-menu"]], inputs: { open: [1, "open"] }, outputs: { open: "openChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 28, vars: 31, consts: [["sidebar-menu", "", 1, "bg-base-200", "pointer-events-none", "absolute", "inset-0", "z-40", "hidden", "h-full", "flex-col", "justify-between", "sm:pointer-events-auto", "sm:relative", "sm:inset-auto", "sm:z-10", "sm:flex", 3, "click"], [1, "flex", "h-1/2", "flex-1", "flex-col", "items-center", "space-y-2"], [1, "font-heading", "mt-4", "ml-16", "text-4xl", "sm:mb-2", "sm:ml-0", 3, "routerLink"], [1, "font-heading", "text-primary"], ["src", "assets/icon/mstile-310x310.png", "alt", "PlaceOS logo", 1, "hidden", "h-12", "w-12"], [1, "w-full", "flex-1", "space-y-2", "overflow-auto", "pb-2"], ["icon", "", "matRipple", "", 1, "absolute", "top-1", "left-1", "sm:hidden", 3, "click"], ["btn", "", "link", "", "matRipple", "", "customTooltip", "", "matTooltipPosition", "right", "yPosition", "bottom", 1, "clear", "hover:bg-base-100", "mx-auto", "mb-2", "w-[calc(100%-1rem)]", "text-left", 3, "content", "matTooltip"], ["matRipple", "", "type", "button", "matTooltipPosition", "right", 1, "hover:bg-base-100", "flex", "min-h-14", "items-center", "gap-2", "border-t", "border-base-300", "p-3", "text-left", 3, "justify-center", "matTooltip"], [3, "compact"], ["matRipple", "", "customTooltip", "", "user", "", "yPosition", "bottom", "xPosition", "start", 1, "border-base-300", "flex", "min-h-16", "items-center", "space-x-2", "border-t", "p-2", "text-left", 3, "content"], ["matTooltipPosition", "right", 3, "user", "matTooltip"], [1, "flex", "w-1/2", "flex-1", "flex-col", "leading-tight"], [1, "w-full", "truncate"], [1, "w-full", "truncate", "text-xs", "opacity-30"], ["icon", "", "matRipple", "", 1, "border-base-200", "bg-base-100", "hover:bg-base-200", "absolute", "right-0", "bottom-12", "z-999", "hidden", "h-6", "w-6", "min-w-6", "translate-x-1/2", "rounded-full", "border", "shadow-sm", "sm:flex", 3, "click"], ["btn", "", "link", "", "matRipple", "", "target", "_blank", "rel", "noopener noreferrer", "matTooltipPosition", "right", 1, "clear", "hover:bg-base-100", "mx-auto", "w-[calc(100%-1rem)]", "text-left", 3, "href", "matTooltip"], ["btn", "", "link", "", "matRipple", "", "routerLinkActive", "bg-secondary! text-secondary-content", "matTooltipPosition", "right", 1, "clear", "hover:bg-base-100", "relative", "mx-auto", "w-[calc(100%-1rem)]", "text-left", 3, "routerLink", "matTooltip"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "text-xl"], [1, "text-xl", "transition-opacity"], ["role", "status", "aria-label", "Loading page", 1, "ml-auto", "h-4", "w-4", "animate-spin", "rounded-full", "border-2", "border-current/30", "border-t-current", "sm:absolute", "sm:top-1/2", "sm:ml-0", "sm:-translate-y-1/2", 3, "sm:left-1/2", "sm:right-3", "sm:right-auto", "sm:-translate-x-1/2"], ["role", "status", "aria-label", "Loading page", 1, "ml-auto", "h-4", "w-4", "animate-spin", "rounded-full", "border-2", "border-current/30", "border-t-current", "sm:absolute", "sm:top-1/2", "sm:ml-0", "sm:-translate-y-1/2"], ["matRipple", "", "type", "button", "matTooltipPosition", "right", 1, "hover:bg-base-100", "flex", "min-h-14", "items-center", "gap-2", "border-t", "border-base-300", "p-3", "text-left", 3, "click", "matTooltip"], [1, "text-2xl"], [1, "min-w-0", "flex-1", "truncate"]], template: function SidebarMenuComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(15, SidebarMenuComponent_Conditional_15_Template, 10, 15, "button", 8);
      \u0275\u0275element(16, "debug-info", 9);
      \u0275\u0275elementStart(17, "button", 10);
      \u0275\u0275element(18, "a-user-avatar", 11);
      ...
      \u0275\u0275listener("click", function SidebarMenuComponent_Template_button_click_25_listener() {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(30, _c04));
      \u0275\u0275advance();
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.support_groups().length ? 15 : -1);
      \u0275\u0275advance();
      ...
      \u0275\u0275property("user", ctx.user)("matTooltip", ctx.compact() ? ctx.user?.name : "");
      \u0275\u0275advance();
      \u0275\u0275classProp("sm:hidden", ctx.compact());
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.user?.name);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(24, 28, ctx.user?.sys_admin ? "COMMON.USER_ADMIN" : ctx.user?.support ? "COMMON.USER_SUPPORT" : "COMMON.USER_BASIC"), " ");
      \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarMenuComponent, { className: "SidebarMenuComponent", filePath: "src/app/ui/sidebar-menu.component.ts", lineNumber: 273 });
})();
...
var VirtualScrollComponent = class _VirtualScrollComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VirtualScrollComponent, selectors: [["virtual-scroll"]], viewQuery: function VirtualScrollComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275element(2, "div", 2);
      \u0275\u0275repeaterCreate(3, VirtualScrollComponent_For_4_Template, 2, 7, "div", 3, _forTrack03, true);
      \u0275\u0275pipe(5, "slice");
      \u0275\u0275projection(6);
      \u0275\u0275elementEnd();
    }
...
//# sourceMappingURL=chunk-CD7VYQSV.js.map
