...
var SettingsToggleComponent = class _SettingsToggleComponent {
  ...
  ])], ngContentSelectors: _c0, decls: 8, vars: 8, consts: [["matRipple", "", 1, "relative", "flex", "min-h-12", "flex-1", "items-center", "space-x-2", "overflow-hidden", "rounded-sm", "border", "px-2", 3, "click"], [1, "absolute", "inset-0", "bg-info", "opacity-10"], [1, "ml-2", "flex", "flex-1", "items-center", "space-x-2", "text-left"], [3, "matTooltip"], [1, "pointer-events-none", 3, "ngModelChange", "ngModel"]], template: function SettingsToggleComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
//# sourceMappingURL=chunk-KWUQFCBO.js.map
