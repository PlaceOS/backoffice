...
var UserAboutComponent = class _UserAboutComponent {
  ...
  domain = this._service.item.pipe(distinctUntilChanged(), debounceTime(300), filter((_) => !!_ && typeof _.authority_id === "string"), switchMap((i) => qu(i.authority_id)), shareReplay(1));
  get item() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserAboutComponent, selectors: [["user-about"]], decls: 41, vars: 57, consts: [[1, "mb-4", "flex", "items-center", "space-x-2"], [1, "border-base-300", "flex", "items-center", "space-x-2", "rounded-3xl", "border", "p-2"], [1, "px-2"], [1, "rounded-2xl", "px-2", "py-1", "text-xs"], [1, "mb-4", "flex", "space-x-2"], [1, "border-base-200", "grid", "w-1/3", "flex-1", "gap-2", "rounded-sm", "border", "p-4"], [1, "flex", "items-center", "text-sm", "font-medium"], [1, "mono", "truncate", "text-sm", "underline", 3, "href"], ["for", "groups", 1, "flex", "items-center", "text-sm", "font-medium"], [1, "-mx-1", "flex", "flex-wrap"], [1, "opacity-30"], [1, "flex", "items-center"], ["matTooltipPosition", "right", 3, "matTooltip"], [1, "mono", "text-sm"], [1, "underline", 3, "routerLink"], ["matRipple", "", 1, "mono", "bg-base-200", "m-1", "rounded-sm", "px-2", "py-1", "text-[0.625rem]"], ["matRipple", "", 1, "mono", "bg-base-200", "m-1", "rounded-sm", "px-2", "py-1", "text-[0.625rem]", 3, "click"]], template: function UserAboutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserAboutComponent, { className: "UserAboutComponent", filePath: "src/app/users/user-about.component.ts", lineNumber: 174 });
})();
export {
  UserAboutComponent
};
//# sourceMappingURL=chunk-WID5JSYN.js.map
