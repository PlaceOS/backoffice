import {
  UsersStateService
} from "./chunk-3EUG2QCM.js";
import "./chunk-DCRZ6QOP.js";
import {
  extensionsForItem
...
function UsersComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("can_edit", true)("extra_actions", ctx_r2.userActions())("item", ctx_r2.item())("type", \u0275\u0275pipeBind1(1, 7, "USERS.SINGULAR"));
    \u0275\u0275advance(2);
...
var UsersComponent = class _UsersComponent extends AsyncHandler {
  ...
  userActions() {
    ...
    return [
      ...item instanceof Cn && item.deleted && this._service.canMutate(4) ? [
        {
          label: "USERS.REVIVE",
  ...
  canCreate = () => this._service.canMutate(2);
  ...
  tab_list = computed(
    ...
    ].concat(extensionsForItem(this.item(), this.name)).filter((tab) => !isSubsystemUser() || !["groups", "history"].includes(tab.id)),
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UsersComponent, selectors: [["new-users-view"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 21, vars: 18, consts: [["el", ""], [1, "divide-base-200", "bg-base-100", "absolute", "inset-0", "flex", "items-center", "divide-y", "sm:divide-x", "sm:divide-y-0"], [1, "sm:h-full", 3, "openChange", "open"], [1, "hidden", "sm:block", 3, "route", "title"], [1, "relative", "z-0", "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "z-20", "sm:hidden", 3, "route", "title"], ["btn", "", "icon", "", 1, "mr-2", "sm:hidden", 3, "click"], [1, "flex", "h-1/2", "flex-1", "flex-col"], ["matTooltipPosition", "right", "matRipple", "", 1, "border-base-200", "bg-secondary", "text-secondary-content", "absolute", "bottom-2", "left-2", "z-30", "flex", "h-12", "w-12", "items-center", "justify-center", "rounded-lg", "border", "shadow-sm", "sm:-left-9", 3, "click", "matTooltip", "disabled"], [1, "text-3xl"], ["matTooltipPosition", "right", "matRipple", "", 1, "border-base-200", "bg-secondary", "text-secondary-content", "absolute", "bottom-16", "left-2", "z-30", "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-lg", "border", "shadow-sm", "sm:-left-8", 3, "click", "matTooltip", "disabled"], [1, "text-2xl"], [3, "can_edit", "extra_actions", "item", "type"], [1, "z-10", 3, "base", "tabs", "scrolled"], [1, "relative", "z-0", "h-1/2", "w-full", "flex-1", "overflow-auto", 3, "scroll"]], template: function UsersComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(11, UsersComponent_Conditional_11_Template, 1, 0, "item-details-skeleton")(12, UsersComponent_Conditional_12_Template, 6, 9);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("route", ctx.name)("title", \u0275\u0275pipeBind1(3, 10, "USERS.PLURAL"));
      \u0275\u0275advance(3);
      \u0275\u0275property("route", ctx.name)("title", \u0275\u0275pipeBind1(6, 12, "USERS.PLURAL"));
      \u0275\u0275advance(6);
      \u0275\u0275conditional(ctx.loading() ? 11 : ctx.item()?.id ? 12 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(14, 14, "USERS.NEW"))("disabled", !ctx.canCreate());
      \u0275\u0275advance(4);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(18, 16, "USERS.BULK"))("disabled", !ctx.canCreate());
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UsersComponent, { className: "UsersComponent", filePath: "src/app/users/users.component.ts", lineNumber: 112 });
})();
export {
  UsersComponent
};
//# sourceMappingURL=chunk-ISOWPFJF.js.map
