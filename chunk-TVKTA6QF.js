...
} from "./chunk-UKPYILA6.js";
import {
  SettingsService
} from "./chunk-JZVO25QW.js";
import {
  AsyncHandler
...
var ItemSelectionComponent = class _ItemSelectionComponent extends AsyncHandler {
  ...
  }, inputs: { show: [1, "show"], title: [1, "title"], route: [1, "route"] }, outputs: { show: "showChange" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], ngContentSelectors: _c1, decls: 11, vars: 7, consts: [["search_input", ""], [1, "border-base-200", "flex", "w-full", "items-center", "justify-center", "border-b", "p-2"], [1, "border-base-200", "flex", "max-w-[calc(100vw-1rem)]", "flex-1", "items-center", "rounded-lg", "border", "sm:max-w-[512px]", "sm:flex-auto", 3, "click"], [1, "ml-2", "text-2xl"], [1, "w-1/2", "flex-1", "p-2", "text-left", "text-lg", "opacity-30"], [1, "keycap", "mr-2", "text-xs"], [1, "bg-base-100/80", "/30", "absolute", "inset-0", 3, "click", "keydown.esc"], [1, "bg-base-100", "absolute", "top-2", "left-1/2", "flex", "w-[512px]", "max-w-[calc(100vw-1rem)]", "-translate-x-1/2", "flex-col", "space-y-2", "overflow-hidden", "rounded-sm", "shadow-sm", 3, "click"], [1, "border-base-200", "relative", "flex", "items-center", "border-b"], [1, "pointer-events-none", "absolute", "top-1/2", "left-2", "-translate-y-1/2", "text-2xl"], [1, "flex-1", "border-none", "bg-transparent", "py-4", "pr-4", "pl-10", 3, "ngModelChange", "ngModel", "placeholder"], ["diameter", "24", 1, "absolute", "top-1/2", "right-2", "mr-2", "-translate-y-1/2"], [1, "w-full", "px-4", "text-sm", "opacity-60"], [1, "flex", "h-1/2", "flex-1", "flex-col"], ["itemSize", "48", 1, "h-[768px]", "max-h-[75vh]"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], ["itemSize", "48", 1, "h-[768px]", "max-h-[75vh]", 3, "scroll", "scrolledIndexChange"], ["routerLinkActive", "active", "class", "m-2 block max-w-[calc(100vw-2rem)] rounded-sm p-2", 3, "routerLink", "click", 4, "cdkVirtualFor", "cdkVirtualForOf", "cdkVirtualForTrackBy"], [1, "bg-base-200", "p-2", "text-center", "text-sm", "opacity-30"], ["routerLinkActive", "active", 1, "m-2", "block", "max-w-[calc(100vw-2rem)]", "rounded-sm", "p-2", 3, "click", "routerLink"], [1, "flex-1", "truncate"], [1, "inline-block", "w-full", "overflow-hidden"], ["extra", "", 1, "mono", "bg-base-content/10", "/5", "mt-1", "max-w-full", "truncate", "rounded-sm", "px-2", "py-1", "text-xs", "opacity-60"]], template: function ItemSelectionComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
//# sourceMappingURL=chunk-TVKTA6QF.js.map
