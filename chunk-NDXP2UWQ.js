...
var SettingsFormComponent = class _SettingsFormComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsFormComponent, selectors: [["a-settings-form"]], inputs: { id: [1, "id"], settings: [1, "settings"], merge: [1, "merge"], merge_settings: [1, "merge_settings"] }, outputs: { settings: "settingsChange" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 8, vars: 5, consts: [["spinner", ""], [1, "mb-2", "flex", "h-16", "w-full", "items-center", "justify-between", "rounded-sm", "bg-base-200", "px-2", "text-lg", "font-medium"], [1, "px-2"], [1, "flex", "items-center", "space-x-2"], [3, "formGroup"], ["icon", "", "matRipple", "", 1, "rounded-sm", "border", "border-secondary", "bg-base-100", "text-secondary", 3, "click", "disabled", "matTooltip"], [1, "text-2xl"], ["diameter", "32"], ["icon", "", "matRipple", "", 1, "rounded-sm", "bg-secondary", "text-secondary-content", 3, "click", "disabled", "matTooltip"], [1, "border-x", "border-t", "border-base-300", 3, "selectedIndexChange", "selectedIndex"], [3, "label"], [3, "decorations", "formControlName", "readonly"], [1, "error-display"], [1, "border-gray-300", "mb-4", "flex", "items-center", "justify-between", "space-x-2", "border-x", "border-b", "border-base-300", "p-1"], [1, "pl-2", "text-xs"], [1, "text-xs", 3, "matTooltip"]], template: function SettingsFormComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SettingsFormComponent, [{
    ...
    `, imports: [
      ...
      IconComponent,
      UserPipe
    ], styles: ["/* angular:styles/component:css;45ddeb504199a154286499dbc995b4569c19aca7940b5069fec6a5d6fcc29ca1;/home/runner/work/backoffice/backoffice/src/app/ui/forms/settings-form.component.ts */\n.settings {\n  position: relative;\n  width: calc(100vw - 29em);\n  height: calc(100vh - 32em);\n}\n@media screen and (max-width: 640px) {\n  .settings {\n    width: calc(100vw - 3em);\n  }\n}\n.error-border {\n  border: 2px solid var(--error);\n}\n.error-display {\n  color: #fff;\n  background-color: var(--error);\n  white-space: pre-wrap;\n  margin: 0 0.5em 0.5em;\n  padding: 0.5em;\n  border-radius: 0 0 4px 4px;\n  font-family: var(--mono-font);\n  box-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);\n}\n.actions {\n  display: flex;\n  align-items: center;\n  justify-content: end;\n  padding: 0.5em 0;\n  margin-top: -2em;\n  height: 3em;\n}\n@media screen and (max-width: 640px) {\n  .actions {\n    margin-left: 4.5em;\n  }\n}\n@media screen and (max-width: 640px) {\n  .actions button {\n    font-size: 0.8em;\n  }\n}\n.off-screen {\n  position: absolute;\n  left: 110vw;\n}\n/*# sourceMappingURL=settings-form.component.css.map */\n"] }]
...
//# sourceMappingURL=chunk-NDXP2UWQ.js.map
