...
var UploadLibraryComponent = class _UploadLibraryComponent extends AsyncHandler {
  ...
  async downloadUpload(upload) {
    const tkn = V();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Je()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=60;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
...
//# sourceMappingURL=chunk-G6XQK2KA.js.map
