...
import {
  BindingDirective
} from "./chunk-AM3QKLWC.js";
import {
  SystemStateService
} from "./chunk-LDHEM6VP.js";
import "./chunk-FCZYPQEO.js";
import {
  ModuleRuntimeErrorsModalComponent
} from "./chunk-IKQ7LWGE.js";
import {
  MatProgressBar,
  MatProgressBarModule
} from "./chunk-3EHCOJYI.js";
import "./chunk-QGHCXUIL.js";
import {
  SettingsFieldComponent
} from "./chunk-VTGSFWBC.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
...
import "./chunk-Y6QJOBJU.js";
import "./chunk-FNEEONA6.js";
import "./chunk-USUWSEFT.js";
import {
...
import "./chunk-E6ENTTIL.js";
import "./chunk-HD2OHXTZ.js";
...
var ViewModuleStateModalComponent = class _ViewModuleStateModalComponent extends AsyncHandler {
  ...
  updateState() {
    ...
    oa(this.system.id, class_parts.slice(0, class_parts.length - 1).join("_"), num).subscribe((state) => {
...
var SystemModulesComponent = class _SystemModulesComponent extends AsyncHandler {
  ...
  query_fn = (_) => ic({ q: _, no_logic: true }).pipe(map((resp) => resp.data.map((mod) => __spreadProps(__spreadValues({}, mod), {
   ...
   */
  async reload(device) {
    const item = await sc(device.id).toPromise();
    for (const k in item) {
      if (k in item)
        device[k] = item[k];
    }
  ...
  loadModule(device) {
    dc(device.id).toPromise().then(() => notifySuccess(`Successfully loaded module "${device.name || device.id}"`), (err) => notifyError(`Error loading module. Error: ${JSON.stringify(err.response || err.message || err)}`));
  }
  /**
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemModulesComponent, { className: "SystemModulesComponent", filePath: "src/app/systems/system-modules.component.ts", lineNumber: 358 });
})();
export {
  SystemModulesComponent
};
//# sourceMappingURL=chunk-QGQJIJQ6.js.map
