...
var PlaceDatabaseDetailsComponent = class _PlaceDatabaseDetailsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceDatabaseDetailsComponent, selectors: [["app-database-details"]], decls: 18, vars: 10, consts: [[1, "mb-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "w-full", "space-x-4", "p-4"], [1, "flex", "w-1/3", "flex-1", "flex-col", "space-y-2", "rounded", "border", "border-base-200", "p-2"], [1, "mx-auto", "max-w-64", "p-2", "text-center"], ["btn", "", "matRipple", "", 1, "w-[calc(100%-0.5rem)]", 3, "click", "disabled"], [1, "my-1", "flex", "w-full", "justify-center"], ["diameter", "32"]], template: function PlaceDatabaseDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-T6D4HOHU.js.map
