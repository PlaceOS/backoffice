...
var DiffViewerComponent = class _DiffViewerComponent extends AsyncHandler {
  ...
  }, inputs: { original: [1, "original"], modified: [1, "modified"], lang: [1, "lang"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 2, vars: 0, consts: [["editor", ""], ["editor", "", 1, "border-gray-300", "select-initial", "relative", "h-128", "w-full", "border", 3, "resize"]], template: function DiffViewerComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-TXDWXKP7.js.map
