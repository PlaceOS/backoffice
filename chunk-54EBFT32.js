...
function SimpleTableComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("grid-area", ctx_r1.gridSquare(1, 1));
  }
}
function SimpleTableComponent_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275styleProp("grid-area", ctx_r1.gridSquare(1, 1 + (ctx_r1.can_reorder() ? 1 : 0)));
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r1.selected().length === ctx_r1.data_length())("indeterminate", ctx_r1.selected().length > 0 && ctx_r1.selected().length < ctx_r1.data_length());
  }
}
function SimpleTableComponent_For_4_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ((tmp_13_0 = ctx_r1.sort()) == null ? null : tmp_13_0.key) === column_r5.key && ((tmp_13_0 = ctx_r1.sort()) == null ? null : tmp_13_0.reverse) ? "arrow_upward" : "arrow_downward", " ");
  }
}
function SimpleTableComponent_For_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SimpleTableComponent_For_4_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setSort(column_r5.key));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275styleProp("grid-area", ctx_r1.gridSquare(1, 1 + \u0275$index_11_r6 + (ctx_r1.selectable() ? 1 : 0) + (ctx_r1.can_reorder() ? 1 : 0)));
    \u0275\u0275classProp("pointer-events-none", !ctx_r1.can_sort() || column_r5.sortable === false)("active", ((tmp_14_0 = ctx_r1.sort()) == null ? null : tmp_14_0.key) === column_r5.key)("border-r", \u0275$index_11_r6 !== ctx_r1.active_columns().length - 1)("width", column_r5.size);
    \u0275\u0275property("id", "column-" + column_r5.key);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", column_r5.name || column_r5.key, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.can_sort() && column_r5.sortable !== false ? 3 : -1);
  }
}
function SimpleTableComponent_For_6_Conditional_0_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const \u0275$index_21_r7 = \u0275\u0275nextContext(2).$index;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275styleProp("grid-area", \u0275$index_21_r7 + 2 + "/1/" + (\u0275$index_21_r7 + 2) + "/" + ctx_r1.column_count());
  }
}
...
function SimpleTableComponent_For_6_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const \u0275$index_21_r7 = ctx_r7.$index;
    const ctx_r1 = \u0275\u0275nextContext();
    const row_template_r10 = \u0275\u0275reference(9);
    \u0275\u0275styleProp("grid-area", \u0275$index_21_r7 + 2 + "/1/" + (\u0275$index_21_r7 + 2) + "/-1")("grid-template-columns", ctx_r1.column_template());
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("grid-area", ctx_r1.gridSquare(2 + \u0275$index_21_r7, 1))("background", ctx_r1.color()[\u0275$index_21_r7]);
    \u0275\u0275classProp("border-b", \u0275$index_21_r7 !== ctx_r1.data_length() - 1);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngTemplateOutlet", row_template_r10)("ngTemplateOutletContext", \u0275\u0275pureFunction2(12, _c0, row_r9, \u0275$index_21_r7));
  }
}
...
function SimpleTableComponent_For_6_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275nextContext();
    const row_template_r10 = \u0275\u0275reference(9);
    \u0275\u0275property("ngTemplateOutlet", row_template_r10)("ngTemplateOutletContext", \u0275\u0275pureFunction2(2, _c0, row_r9, \u0275$index_21_r7));
  }
}
function SimpleTableComponent_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r1.can_reorder() ? 0 : 1);
  }
}
...
function SimpleTableComponent_ng_template_8_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("mouseenter", function SimpleTableComponent_ng_template_8_Conditional_0_Template_div_mouseenter_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.enter_row.emit(i_r12));
    ...
    \u0275\u0275listener("change", function SimpleTableComponent_ng_template_8_Conditional_0_Template_mat_checkbox_change_1_listener($event) {
      ...
      const i_r12 = \u0275\u0275nextContext().index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.select(i_r12, $event.checked));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const i_r12 = \u0275\u0275nextContext().index;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275styleProp("grid-area", ctx_r1.gridSquare(2 + i_r12, 1 + (ctx_r1.can_reorder() ? 1 : 0)))("background", ctx_r1.color()[i_r12]);
    \u0275\u0275classProp("border-b", i_r12 !== ctx_r1.data_length() - 1);
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r1.selected().includes(i_r12));
  }
}
function SimpleTableComponent_ng_template_8_For_2_Case_1_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function SimpleTableComponent_ng_template_8_For_2_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SimpleTableComponent_ng_template_8_For_2_Case_1_ng_container_0_Template, 1, 0, "ng-container", 16);
  }
  if (rf & 2) {
    const column_r14 = \u0275\u0275nextContext().$implicit;
    const ctx_r14 = \u0275\u0275nextContext();
    const row_r16 = ctx_r14.row;
    const i_r12 = ctx_r14.index;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngTemplateOutlet", ctx_r1.template(column_r14))("ngTemplateOutletContext", \u0275\u0275pureFunction7(2, _c1, i_r12 === 0, i_r12 === ctx_r1.data_length() - 1, i_r12, row_r16[column_r14.key], row_r16, column_r14.key, column_r14.name || column_r14.key));
  }
}
function SimpleTableComponent_ng_template_8_For_2_Case_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function SimpleTableComponent_ng_template_8_For_2_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, SimpleTableComponent_ng_template_8_For_2_Case_2_Conditional_2_Template, 2, 0, "span", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const column_r14 = \u0275\u0275nextContext().$implicit;
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r16[column_r14.key], " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(row_r16[column_r14.key] === null || row_r16[column_r14.key] === void 0 ? 2 : -1);
  }
}
function SimpleTableComponent_ng_template_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, SimpleTableComponent_ng_template_8_For_2_Case_1_Template, 1, 10, "ng-container")(2, SimpleTableComponent_ng_template_8_For_2_Case_2_Template, 3, 2, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_20_0;
    const column_r14 = ctx.$implicit;
    const \u0275$index_56_r17 = ctx.$index;
    const i_r12 = \u0275\u0275nextContext().index;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275styleProp("grid-area", ctx_r1.gridSquare(2 + i_r12, 1 + \u0275$index_56_r17 + (ctx_r1.selectable() ? 1 : 0) + (ctx_r1.can_reorder() ? 1 : 0)))("background", ctx_r1.color()[i_r12]);
    \u0275\u0275classProp("border-b", i_r12 !== ctx_r1.data_length() - 1)("border-r", \u0275$index_56_r17 !== ctx_r1.active_columns().length - 1)("width", column_r14.size);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_20_0 = ctx_r1.columnType(column_r14)) === "template" ? 1 : 2);
  }
}
...
var SimpleTableComponent = class _SimpleTableComponent {
  ...
  can_reorder = input(false, ...ngDevMode ? [{ debugName: "can_reorder" }] : []);
  page_size = input(0, ...ngDevMode ? [{ debugName: "page_size" }] : []);
  color = input({}, ...ngDevMode ? [{ debugName: "color" }] : []);
  empty_message = input("No data to list", ...ngDevMode ? [{ debugName: "empty_message" }] : []);
  filter_on = input([], ...ngDevMode ? [{ debugName: "filter_on" }] : []);
  ...
  total_count = signal(0, ...ngDevMode ? [{ debugName: "total_count" }] : []);
  total_pages = signal(0, ...ngDevMode ? [{ debugName: "total_pages" }] : []);
  active_columns = signal([], ...ngDevMode ? [{ debugName: "active_columns" }] : []);
  ...
  data_length = computed(() => this._data().length, ...ngDevMode ? [{ debugName: "data_length" }] : []);
  template(column) {
  ...
  can_sort = computed(() => !this.can_reorder() && this.sortable(), ...ngDevMode ? [{ debugName: "can_sort" }] : []);
  column(key) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SimpleTableComponent, selectors: [["simple-table"]], inputs: { selected: [1, "selected"], data: [1, "data"], columns: [1, "columns"], selectable: [1, "selectable"], filter: [1, "filter"], sortable: [1, "sortable"], can_reorder: [1, "can_reorder"], page_size: [1, "page_size"], color: [1, "color"], empty_message: [1, "empty_message"], filter_on: [1, "filter_on"] }, outputs: { selected: "selectedChange", selectedChange: "selectedChange", enter_row: "enter_row", onclick: "onclick", oncontext: "oncontext", ondrop: "ondrop" }, decls: 10, vars: 5, consts: [["row_template", ""], ["role", "table", "cdkDropList", "", 1, "grid", "overflow-visible", "border", "border-base-200", 3, "click", "cdkDropListDropped"], [1, "sticky", "top-0", "z-10", "flex", "min-h-full", "items-center", "justify-between", "border-r", "border-base-200", "bg-base-300", "px-2", 3, "gridArea"], ["header", "", "matRipple", "", 1, "sticky", "top-0", "z-10", "flex", "min-h-full", "items-center", "justify-between", "border-base-200", "bg-base-300", "p-4", 3, "id", "gridArea", "pointer-events-none", "active", "border-r", "width"], [1, "flex", "items-center", "justify-center", "p-4", "opacity-30", 3, "gridArea"], [1, "sticky", "top-0", "z-10", "flex", "min-h-full", "items-center", "justify-between", "border-r", "border-base-200", "bg-base-300", "px-2"], [3, "change", "checked", "indeterminate"], ["header", "", "matRipple", "", 1, "sticky", "top-0", "z-10", "flex", "min-h-full", "items-center", "justify-between", "border-base-200", "bg-base-300", "p-4", 3, "click", "id"], [1, "font-medium"], [1, "text-[1.25em]"], ["cdkDrag", "", 1, "grid", 3, "gridArea", "gridTemplateColumns"], ["cdkDrag", "", 1, "grid"], ["class", "h-16 w-full border-2 border-dashed border-base-300 bg-base-200", 3, "gridArea", 4, "cdkDragPlaceholder"], [1, "z-0", "flex", "min-h-full", "items-center", "justify-center", "border-r", "border-base-200", "px-2"], ["icon", "", "matRipple", "", "cdkDragHandle", "", 1, "h-full", "w-full", "rounded-none"], [1, "text-2xl"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "h-16", "w-full", "border-2", "border-dashed", "border-base-300", "bg-base-200"], [1, "flex", "items-center", "justify-center", "p-4", "opacity-30"], [1, "z-0", "flex", "min-h-full", "items-center", "justify-between", "border-r", "border-base-200", "px-2", 3, "gridArea", "border-b", "background"], [1, "relative", "z-0", "flex", "min-h-full", "items-center", "justify-between", "border-base-200", 3, "gridArea", "border-b", "border-r", "width", "background"], [1, "z-0", "flex", "min-h-full", "items-center", "justify-between", "border-r", "border-base-200", "px-2", 3, "mouseenter", "touchstart"], [3, "change", "checked"], [1, "relative", "z-0", "flex", "min-h-full", "items-center", "justify-between", "border-base-200", 3, "mouseenter", "touchstart"], [1, "p-4"], [1, "opacity-30"]], template: function SimpleTableComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 1);
      \u0275\u0275listener("click", function SimpleTableComponent_Template_div_click_0_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onclick.emit(0));
      })("cdkDropListDropped", function SimpleTableComponent_Template_div_cdkDropListDropped_0_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.ondrop.emit([$event.previousIndex, $event.currentIndex]));
      });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SimpleTableComponent, [{
    ...
    `, imports: [CommonModule, MatCheckboxModule, DragDropModule, IconComponent], styles: ["/* angular:styles/component:css;b43c89d67a30cf5d1c58094c1d55872507506d7b96d5a4ccd35c127135301771;/home/runner/work/backoffice/backoffice/src/app/ui/simple-table.component.ts */\n:host,\n:host > button {\n  min-width: 100%;\n  overflow: hidden;\n}\n[header] icon {\n  opacity: 0;\n}\n[header]:hover icon {\n  opacity: 0.3;\n}\n[header]:hover.pointer-events-none icon {\n  opacity: 0;\n}\n[header].active icon {\n  opacity: 1;\n}\n/*# sourceMappingURL=simple-table.component.css.map */\n"] }]
  }], () => [], { selected: [{ type: Input, args: [{ isSignal: true, alias: "selected", required: false }] }, { type: Output, args: ["selectedChange"] }], data: [{ type: Input, args: [{ isSignal: true, alias: "data", required: false }] }], columns: [{ type: Input, args: [{ isSignal: true, alias: "columns", required: false }] }], selectable: [{ type: Input, args: [{ isSignal: true, alias: "selectable", required: false }] }], filter: [{ type: Input, args: [{ isSignal: true, alias: "filter", required: false }] }], sortable: [{ type: Input, args: [{ isSignal: true, alias: "sortable", required: false }] }], can_reorder: [{ type: Input, args: [{ isSignal: true, alias: "can_reorder", required: false }] }], page_size: [{ type: Input, args: [{ isSignal: true, alias: "page_size", required: false }] }], color: [{ type: Input, args: [{ isSignal: true, alias: "color", required: false }] }], empty_message: [{ type: Input, args: [{ isSignal: true, alias: "empty_message", required: false }] }], filter_on: [{ type: Input, args: [{ isSignal: true, alias: "filter_on", required: false }] }], selectedChange: [{ type: Output, args: ["selectedChange"] }], enter_row: [{ type: Output, args: ["enter_row"] }], onclick: [{ type: Output, args: ["onclick"] }], oncontext: [{ type: Output, args: ["oncontext"] }], ondrop: [{ type: Output, args: ["ondrop"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SimpleTableComponent, { className: "SimpleTableComponent", filePath: "src/app/ui/simple-table.component.ts", lineNumber: 259 });
})();
...
//# sourceMappingURL=chunk-54EBFT32.js.map
