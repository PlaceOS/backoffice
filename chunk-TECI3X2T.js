...
var UploadLibraryComponent = class _UploadLibraryComponent extends AsyncHandler {
  ...
  _uploads_list = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_uploads_list" } : (
    ...
    loader: async ({ params }) => {
      ...
      return response.data.map((_2) => __spreadProps(__spreadValues({}, _2), { mime_type: getMimeType(_2.file_name) })).sort((a, b) => a.file_name.localeCompare(b.file_name));
    }
  }));
        ...
        if (files.length) {
          ...
          const checkUploads = () => {
            ...
            for (const id of id_list) {
              const upload = list.find((_2) => _2.id === id);
              if (!upload)
                continue;
              if (upload.error)
                failed += 1;
  ...
  async downloadUpload(upload) {
    const tkn = V();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Qe()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=60;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UploadLibraryComponent, selectors: [["upload-library"]], inputs: { search_term: [1, "search_term"], domain: [1, "domain"] }, outputs: { search_term: "search_termChange", domain: "domainChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 24, vars: 14, consts: [[1, "flex", "h-full", "w-full", "flex-col"], [1, "mt-4", "mb-2", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-56"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "matRipple", "", 1, "relative", "h-12", "w-32"], ["type", "file", "multiple", "", 1, "pointer-events-auto", "absolute", "inset-0", "w-full", "opacity-0", 3, "change"], [1, "mb-4", "flex", "items-center", "justify-end", "space-x-2", "px-4"], ["appearance", "outline", 1, "no-subscript", "w-[20rem]", "max-w-full"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Search for file...", 3, "ngModelChange", "ngModel"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "sticky", "left-0", "w-full"], ["role", "table", 1, "mb-4", "block", "min-w-240", "overflow-hidden", "text-sm"], [1, "bg-base-200", "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "p-16"], ["header", "", 1, "divide-base-100", "border-base-300", "bg-base-200", "grid", "min-w-full", "grid-cols-5", "divide-x", "border"], [1, "flex", "items-center", "justify-between", "p-2", 3, "click"], [1, "p-2"], [1, "text-xl"], [1, "p-4"], ["itemSize", "48", 1, "min-h-[calc(100vh-13.25rem)]"], ["class", "divide-base-300 border-base-300 grid h-12 min-w-full grid-cols-5 divide-x overflow-hidden border-x border-b", 3, "grid-template-columns", 4, "cdkVirtualFor", "cdkVirtualForOf"], [1, "divide-base-300", "border-base-300", "grid", "h-12", "min-w-full", "grid-cols-5", "divide-x", "overflow-hidden", "border-x", "border-b"], [1, "flex", "h-full", "items-center", "p-4", "text-xs"], [1, "mono", "w-px", "flex-1", "truncate", 3, "matTooltip"], [1, "mono", "flex", "h-full", "items-center", "truncate", "p-4", "text-xs"], [1, "mono", "flex", "h-full", "w-full", "items-center", "justify-end", "p-4", "text-xs"], [1, "flex", "h-full", "items-center", "p-4"], [1, "flex", "w-full", "items-center", "justify-end", "space-x-2", "px-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-8xl", "opacity-30"], [1, "opacity-30"]], template: function UploadLibraryComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.uploads_list()?.length > 0 ? 22 : 23);
    }
  }, dependencies: [
    CommonModule,
    IconComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UploadLibraryComponent, { className: "UploadLibraryComponent", filePath: "src/app/admin/upload-library.component.ts", lineNumber: 365 });
})();
export {
  UploadLibraryComponent
};
//# sourceMappingURL=chunk-TECI3X2T.js.map
