...
} from "./chunk-Y45MCQIV.js";
import {
  DiffViewerComponent
} from "./chunk-TXDWXKP7.js";
import {
  validateJSONString
...
var MetadataHistoryModalComponent = class _MetadataHistoryModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MetadataHistoryModalComponent, selectors: [["metadata-history-modal"]], decls: 37, vars: 18, consts: [[1, "flex", "h-screen", "w-screen", "flex-col", "overflow-hidden", "bg-base-100"], [1, "m-4", "flex", "items-center", "justify-between", "rounded-sm", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "flex-1", "flex-col", "pb-4"], [1, "mb-2", "flex", "items-center", "space-x-2", "px-4"], [1, "relative", "h-14", "min-w-48", "rounded-sm", "border", "border-base-300", "px-4", "py-2"], [1, "absolute", "left-4", "top-0", "-translate-y-1/2", "rounded-sm", "bg-base-100", "px-2", "py-1", "text-xs"], [1, "truncate"], [1, "text-xs", "opacity-30"], [1, "relative", "flex", "h-14", "min-w-48", "items-center", "rounded-sm", "border", "border-base-300", "px-4", "py-2"], [1, "truncate", "font-mono", "text-lg"], [1, "mb-2", "flex", "items-center", "justify-between", "space-x-2", "px-4"], ["appearance", "outline", 1, "w-[20rem]"], ["placeholder", "Select metadata version", 3, "ngModelChange", "ngModel"], [1, "leading-tight", 3, "value"], ["placeholder", "Compare with", 3, "ngModelChange", "ngModel"], [1, "relative", "w-full", "flex-1", "px-4"], [3, "modified", "original"], [1, "flex", "h-full", "w-full", "items-center", "justify-center", "rounded-lg", "bg-base-200", "opacity-40"], [1, "leading-tight", 3, "click", "value"], [1, ""], [1, "truncate", "text-xs", "opacity-30"]], template: function MetadataHistoryModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var MetadataDisplayComponent = class _MetadataDisplayComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MetadataDisplayComponent, selectors: [["metadata-display"]], inputs: { item: [1, "item"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 12, vars: 5, consts: [["load_state", ""], [1, "flex", "items-center", "justify-between", "space-x-2"], ["btn", "", 3, "click"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Search metadata blocks...", 3, "ngModelChange", "ngModel"], [1, "mt-4", "space-y-2"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-8", "p-16", "opacity-30"], ["block", "", 1, "rounded-sm", "border", "border-base-300", 3, "id", "shadow", "opacity-30", "formGroup"], ["block", "", 1, "rounded-sm", "border", "border-base-300", 3, "id", "formGroup"], ["header", "", 1, "flex", "w-full", "items-center", "space-x-2", "bg-base-200", "px-2", "py-1", 3, "click"], [1, "truncate", "px-2", "font-mono", "text-sm"], [1, "flex-1"], [1, "whitespace-nowrap", "rounded-sm", "border", "border-base-300", "px-2", "py-1", "font-mono", "text-[0.625rem]"], [1, "flex", "items-center", "rounded-full", "border", "border-base-300", "bg-base-100", 3, "click"], ["icon", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], [1, "text-xl"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"], ["icon", "", "matRipple", ""], [1, "text-2xl"], ["body", "", 1, "expandable"], [1, "h-130", "border-t", "border-base-300", "p-1"], ["formControlName", "details", "lang", "json", 3, "schema", "readonly"], [1, "text-8xl"], ["diameter", "32"]], template: function MetadataDisplayComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MetadataDisplayComponent, { className: "MetadataDisplayComponent", filePath: "src/app/ui/metadata-display.component.ts", lineNumber: 203 });
})();

export {
  MetadataDisplayComponent
};
//# sourceMappingURL=chunk-OT7HWI7B.js.map
