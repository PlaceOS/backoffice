...
} from "./chunk-UYAMLVWQ.js";
import {
  Clipboard
} from "./chunk-JNUXXJ2D.js";
import {
  UploadsService
} from "./chunk-6RCFWLP6.js";
...
var ViewUploadModalComponent = class _ViewUploadModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewUploadModalComponent, selectors: [["view-upload-modal"]], decls: 12, vars: 3, consts: [[1, "flex", "items-center", "justify-between", "border-base-100", "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-lg", "border", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "px-2", "pb-2"], [1, "border-base-200", "relative", "flex", "h-[65vh]", "max-h-[65vh]", "w-[80vw]", "max-w-[80vw]", "items-center", "justify-center", "overflow-hidden", "rounded-xl", "border"], ["auth", "", "alt", "Uploaded content preview", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], ["auth", "", "autoplay", "", "controls", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [1, "border-base-200", "bg-base-100", "absolute", "top-2", "left-2", "max-w-[calc(100%-1rem)]", "rounded-full", "border", "px-2", "py-1", "font-mono", "text-sm"]], template: function ViewUploadModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ViewUploadModalComponent, [{
    ...
    args: [{ selector: "view-upload-modal", template: `
        <header
            class="flex items-center justify-between border-base-100 bg-base-200 sticky top-0 z-10 m-2 w-[calc(100%-1rem)] rounded-lg border px-4 py-2"
        >
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ViewUploadModalComponent, { className: "ViewUploadModalComponent", filePath: "src/app/admin/view-upload-modal.component.ts", lineNumber: 56 });
})();

// src/app/admin/upload-library.component.ts
var _forTrack0 = ($index, $item) => $item.id;
function UploadLibraryComponent_For_10_Template(rf, ctx) {
  if (rf & 1) {
...
function UploadLibraryComponent_Conditional_25_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(10, "dateFrom");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 31)(12, "button", 32);
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_25_div_28_Template_button_click_12_listener() {
      const upload_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.downloadUpload(upload_r7));
    });
    ...
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_25_div_28_Template_button_click_16_listener() {
      const upload_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.copyLink(upload_r7));
    });
    ...
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_25_div_28_Template_button_click_20_listener() {
      const upload_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.viewUpload(upload_r7));
    });
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_25_div_28_Template_button_click_24_listener() {
      const upload_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.removeUpload(upload_r7));
    });
  ...
  if (rf & 2) {
    const upload_r7 = ctx.$implicit;
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275styleProp("grid-template-columns", "auto 10rem 7rem 8rem 11.5rem");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", upload_r7.file_name);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", upload_r7.file_name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", upload_r7.mime_type, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r4.sizeOf(upload_r7.file_size), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 12, +upload_r7.created_at * 1e3), " ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("disabled", !upload_r7.mime_type.includes("image") && !upload_r7.mime_type.includes("video"))("matTooltip", \u0275\u0275pipeBind1(21, 18, "ADMIN.UPLOADS_LIB_VIEW"));
    \u0275\u0275advance(4);
...
function UploadLibraryComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_25_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.sortBy("file_name"));
    });
    \u0275\u0275elementStart(3, "div", 20);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "icon", 21);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "button", 19);
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_25_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.sortBy("mime_type"));
    });
    \u0275\u0275elementStart(9, "div", 20);
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "icon", 21);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "button", 19);
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_25_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.sortBy("file_size"));
    });
    \u0275\u0275elementStart(15, "div", 20);
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "icon", 21);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "button", 19);
    \u0275\u0275listener("click", function UploadLibraryComponent_Conditional_25_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.sortBy("created_at"));
    });
    \u0275\u0275elementStart(21, "div", 20);
    \u0275\u0275text(22);
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "icon", 21);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(26, "div", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "cdk-virtual-scroll-viewport", 23);
    \u0275\u0275template(28, UploadLibraryComponent_Conditional_25_div_28_Template, 28, 22, "div", 24);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    ...
    \u0275\u0275styleProp("grid-template-columns", "auto 10rem 7rem 8rem 11.5rem");
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r4.sorted_by()[0] === "file_name");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 19, "COMMON.FIELD_NAME"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r4.sorted_by()[1] ? "arrow_downward" : "arrow_upward");
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r4.sorted_by()[0] === "mime_type");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 21, "ADMIN.UPLOADS_LIB_FIELD_TYPE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r4.sorted_by()[1] ? "arrow_downward" : "arrow_upward");
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r4.sorted_by()[0] === "file_size");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 23, "ADMIN.UPLOADS_LIB_FIELD_SIZE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r4.sorted_by()[1] ? "arrow_downward" : "arrow_upward");
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r4.sorted_by()[0] === "created_at");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 25, "COMMON.CREATED_AT"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r4.sorted_by()[1] ? "arrow_downward" : "arrow_upward");
    \u0275\u0275advance(3);
    \u0275\u0275property("cdkVirtualForOf", ctx_r4.sorted_uploads());
  }
}
function UploadLibraryComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17)(1, "icon", 35);
...
var UploadLibraryComponent = class _UploadLibraryComponent extends AsyncHandler {
  ...
  search_term = this._admin_data.filter("upload-library:search");
  domain = this._admin_data.selectedDomain("upload-library");
  refresh = signal(
    0,
  ...
  sorted_by = this._admin_data.sort("upload-library:uploads");
  sorted_uploads = computed(
    () => {
      const [field, asc] = this.sorted_by();
      if (!field)
        return this.uploads_list();
      return [...this.uploads_list()].sort((a, b2) => {
        if (!field)
          return 0;
        const value_a = a[field];
        const value_b = b2[field];
  ...
  _uploads_list = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_uploads_list" } : (
    /* istanbul ignore next */
    {}
  )), {
    params: () => ({
    ...
    loader: async ({ params }) => {
      ...
      return response.data.map((_) => __spreadProps(__spreadValues({}, _), { mime_type: getMimeType(_.file_name) })).sort((a, b2) => a.file_name.localeCompare(b2.file_name));
    }
  }));
  uploads_list = computed(
    () => this._uploads_list.value() || [],
    ...ngDevMode ? [{ debugName: "uploads_list" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  async downloadUpload(upload) {
    const tkn = J();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Xe()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=60;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UploadLibraryComponent, selectors: [["upload-library"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 27, vars: 17, consts: [["upload_file", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "mt-4", "mb-2", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-56"], ["name", "type", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["icon", "", "default", "", "matRipple", "", 1, "relative", "text-xl", 3, "click", "matTooltip"], ["hidden", "", "type", "file", "multiple", "", 3, "change"], [1, "mb-4", "flex", "items-center", "justify-end", "space-x-2", "px-4"], ["appearance", "outline", 1, "no-subscript", "w-[20rem]", "max-w-full"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Search for file...", 3, "ngModelChange", "ngModel"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "sticky", "left-0", "w-full"], ["role", "table", 1, "mb-4", "block", "min-w-240", "overflow-hidden", "text-sm"], [1, "bg-base-200", "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "p-16"], ["header", "", 1, "divide-base-100", "border-base-300", "bg-base-200", "grid", "min-w-full", "grid-cols-5", "divide-x", "border"], [1, "flex", "items-center", "justify-between", "p-2", 3, "click"], [1, "p-2"], [1, "text-xl"], [1, "p-4"], ["itemSize", "48", 1, "min-h-[calc(100vh-13.25rem)]"], ["class", "divide-base-300 border-base-300 grid h-12 min-w-full grid-cols-5 divide-x overflow-hidden border-x border-b", 3, "grid-template-columns", 4, "cdkVirtualFor", "cdkVirtualForOf"], [1, "divide-base-300", "border-base-300", "grid", "h-12", "min-w-full", "grid-cols-5", "divide-x", "overflow-hidden", "border-x", "border-b"], [1, "flex", "h-full", "items-center", "p-4", "text-xs"], [1, "mono", "w-px", "flex-1", "truncate", 3, "matTooltip"], [1, "mono", "flex", "h-full", "items-center", "truncate", "p-4", "text-xs"], [1, "mono", "flex", "h-full", "w-full", "items-center", "justify-end", "p-4", "text-xs"], [1, "flex", "h-full", "items-center", "p-4"], [1, "flex", "w-full", "items-center", "justify-end", "space-x-2", "px-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-8xl", "opacity-30"], [1, "opacity-30"]], template: function UploadLibraryComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(8, "translate");
      \u0275\u0275twoWayListener("ngModelChange", function UploadLibraryComponent_Template_mat_select_ngModelChange_7_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.domain, $event) || (ctx.domain = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275repeaterCreate(9, UploadLibraryComponent_For_10_Template, 2, 2, "mat-option", 7, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275controlCreate();
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(12, "translate");
      \u0275\u0275pipe(13, "translate");
      \u0275\u0275listener("click", function UploadLibraryComponent_Template_button_click_11_listener() {
        \u0275\u0275restoreView(_r1);
        const upload_file_r3 = \u0275\u0275reference(17);
        return \u0275\u0275resetView(upload_file_r3.click());
      });
      \u0275\u0275elementStart(14, "icon");
      \u0275\u0275text(15, "upload");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(16, "input", 9, 0);
      \u0275\u0275listener("change", function UploadLibraryComponent_Template_input_change_16_listener($event) {
        return ctx.handleFileEvent($event);
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(18, "div", 10)(19, "mat-form-field", 11)(20, "icon", 12);
      \u0275\u0275text(21, "search");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "input", 13);
      \u0275\u0275twoWayListener("ngModelChange", function UploadLibraryComponent_Template_input_ngModelChange_22_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275element(24, "mat-progress-bar", 15);
      \u0275\u0275conditionalCreate(25, UploadLibraryComponent_Conditional_25_Template, 29, 27, "div", 16)(26, UploadLibraryComponent_Conditional_26_Template, 6, 3, "div", 17);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 9, "ADMIN.UPLOADS_LIB_HEADER"), " ");
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.domain);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 11, "ADMIN.SELECT_DOMAIN"));
      \u0275\u0275control();
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.domain_list());
      \u0275\u0275advance(2);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(12, 13, "COMMON.UPLOAD_FILE"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 15, "COMMON.UPLOAD_FILE"));
      \u0275\u0275advance(11);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.uploads_list()?.length > 0 ? 25 : 26);
    }
  }, dependencies: [
    IconComponent,
    ScrollingModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UploadLibraryComponent, { className: "UploadLibraryComponent", filePath: "src/app/admin/upload-library.component.ts", lineNumber: 364 });
})();
export {
  UploadLibraryComponent
};
//# sourceMappingURL=chunk-BDDTIYNH.js.map
