...
var ZonesStateService = class _ZonesStateService {
  ...
  async addTrigger(trigger) {
    ...
    return dh(this.active_item.id, __spreadProps(__spreadValues({}, this.active_item), {
  ...
  async removeTrigger(trigger) {
    ...
    if (!details?.reason)
      return;
    const zone = await dh(this.active_item.id, __spreadProps(__spreadValues({}, this.active_item), {
...
//# sourceMappingURL=chunk-UM4VUEMT.js.map
