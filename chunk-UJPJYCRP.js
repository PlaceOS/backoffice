...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-G2KWNOXE.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-CMGMNV23.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-WDTR7P37.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-6CRF4XNP.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
        loadComponent: () => import("./chunk-LJFDG7BR.js").then((m) => m.AdminAPIKeysComponent)
      },
      {
        path: "upload-storage",
...
//# sourceMappingURL=chunk-UJPJYCRP.js.map
