...
var CustomTooltipComponent = class _CustomTooltipComponent extends AsyncHandler {
  ...
  x_pos = input("end", ...ngDevMode ? [{ debugName: "x_pos", alias: "xPosition" }] : [{
    alias: "xPosition"
  }]);
  /** Vertical position of the rendered overlay */
  y_pos = input("top", ...ngDevMode ? [{ debugName: "y_pos", alias: "yPosition" }] : [{
    alias: "yPosition"
  }]);
...
//# sourceMappingURL=chunk-4H753LPO.js.map
