...
var SelectMethodComponent = class _SelectMethodComponent extends AsyncHandler {
  ...
  method_list = combineLatest([this._system, this._module]).pipe(distinctUntilChanged(), tap(() => this.loading.set(true)), switchMap(([id, { module, index }]) => !!id && !!module ? ca(id, module, index) : of({})), catchError(() => of({})), map((fn_mapping) => Object.keys(fn_mapping || {}).map((i) => __spreadValues({
    name: i
...
var SelectModuleComponent = class _SelectModuleComponent extends AsyncHandler {
  ...
  loading = signal(false, ...ngDevMode ? [{ debugName: "loading" }] : []);
  modules = combineLatest([this._system, this._change]).pipe(distinctUntilChanged(([id1, time1], [id2, time2]) => id1 === id2 && time1 === time2), tap(() => this.loading.set(true)), switchMap(([id]) => id ? ic({
...
//# sourceMappingURL=chunk-6ATC6RGJ.js.map
