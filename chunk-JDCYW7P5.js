...
var AdminClusterNodeComponent = class _AdminClusterNodeComponent {
  ...
  }, inputs: { show_name: [1, "show_name"], node: [1, "node"], history: [1, "history"] }, features: [\u0275\u0275NgOnChangesFeature], decls: 22, vars: 18, consts: [[1, "mb-2", "h-36", "w-full", "rounded", "border", "border-base-300", "p-2"], ["basic-line-graph", "", 1, "h-full", "w-full", 3, "lines"], [1, "memory-utilisation"], [1, "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-1", "rounded", "border", "border-base-300", "p-1"], [1, "mono", "text-4xl", "font-medium"], [1, "mono", "w-36", "text-center", "text-xs"]], template: function AdminClusterNodeComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var PlaceClusterDetailsComponent = class _PlaceClusterDetailsComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceClusterDetailsComponent, selectors: [["engine-cluster-details"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 7, vars: 4, consts: [[1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "max-h-full", "flex-wrap", "overflow-auto"], [1, "px-2"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-8", "opacity-30"], [1, "m-2", "space-y-2", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", "shadow"], [1, "mono", "mb-2", "rounded", "bg-base-200", "p-2", "text-lg", "font-medium", "uppercase"], [3, "show_name", "node", "history"], ["btn", "", "matRipple", "", 1, "w-full", 3, "routerLink"], [1, "text-8xl"], [1, "text"]], template: function PlaceClusterDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-JDCYW7P5.js.map
