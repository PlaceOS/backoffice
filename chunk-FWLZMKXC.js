...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-GVLGKLIE.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-5DHYF37E.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-UAQIXEY2.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-HJ2Y2SER.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-RZ5SDMFK.js").then((m) => m.AdminSignagePluginsComponent)
      },
      {
        path: "build-jobs",
...
//# sourceMappingURL=chunk-FWLZMKXC.js.map
