...
function ItemDetailsComponent_Conditional_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 1, "COMMON.EDIT_TYPE", \u0275\u0275pureFunction1(4, _c02, ctx_r1.type())), " ");
  }
}
...
function ItemDetailsComponent_Conditional_40_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 1, "COMMON.DELETE_TYPE", \u0275\u0275pureFunction1(4, _c02, ctx_r1.type())), " ");
  }
}
var ItemDetailsComponent = class _ItemDetailsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemDetailsComponent, selectors: [["item-details"]], inputs: { type: [1, "type"], item: [1, "item"], can_edit: [1, "can_edit"], extra_actions: [1, "extra_actions"] }, outputs: { create: "create", edit: "edit", delete: "delete" }, decls: 41, vars: 28, consts: [["action_menu", "matMenu"], [1, "flex", "items-center", "justify-between", "px-4", "py-2"], [1, "flex", "flex-col", "space-y-2"], ["name", "", 1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], [1, "mono", "text-xs", "opacity-60", 3, "click"], [1, "rounded-xl", "bg-info", "px-2", "py-1", "text-xs", "text-info-content"], [1, "mono", "rounded-xl", "bg-info", "px-2", "py-1", "text-xs", "text-info-content"], [1, "rounded-xl", "bg-info", "px-2", "py-1", "text-xs", "uppercase", "text-info-content"], [1, "rounded-xl", "bg-error", "px-2", "py-1", "text-xs", "text-error-content", 3, "!bg-success", "!text-success-content"], [1, "rounded-xl", "bg-info", "px-2", "py-1", "text-xs", "text-info-content", 3, "matTooltip"], [1, "flex", "items-center", "space-x-2", "rounded-xl", "bg-success", "px-2", "py-1", "text-xs", "text-success-content"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], [1, "min-w-[22rem]"], ["mat-menu-item", "", 1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", "disabled", "true", 1, "flex", "items-center", "space-x-2", 3, "click"], [1, "text-2xl"], ["mat-menu-item", "", 1, "flex", "items-center", "space-x-2", 3, "click"], [1, "rounded-xl", "bg-error", "px-2", "py-1", "text-xs", "text-error-content"], [1, "text"], [1, "flex-1"], [1, "keycap"], [1, "text-2xl", "text-error"]], template: function ItemDetailsComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(25, 13, "COMMON.CREATE_FROM_TYPE", \u0275\u0275pureFunction1(22, _c02, ctx.type())), " ");
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(31, 16, "COMMON.DUPLICATE_TYPE", \u0275\u0275pureFunction1(24, _c02, ctx.type())), " ");
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(37, 19, "COMMON.EXPORT_TYPE_AS_TSV", \u0275\u0275pureFunction1(26, _c02, ctx.type())), " ");
      \u0275\u0275advance(2);
...
function ItemSelectionComponent_Conditional_10_Conditional_15_a_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("routerLink", ctx_r1.subroute() ? \u0275\u0275pureFunction3(3, _c42, ctx_r1.route(), item_r5.id, ctx_r1.subroute()) : \u0275\u0275pureFunction2(7, _c52, ctx_r1.route(), item_r5.id));
    \u0275\u0275advance(2);
...
function ItemSelectionComponent_Conditional_10_Conditional_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 1, ctx_r1.search ? "COMMON.SEARCH_EMPTY" : "COMMON.LIST_EMPTY", \u0275\u0275pureFunction1(4, _c22, ctx_r1.title())), " ");
  }
}
function ItemSelectionComponent_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(7, 5, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction1(17, _c22, ctx_r1.title())));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(9, 8, ctx_r1.loading) ? 8 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(13, 12, "COMMON.TOTAL_ITEMS", \u0275\u0275pureFunction1(19, _c32, \u0275\u0275pipeBind1(12, 10, ctx_r1.total))), " ");
    \u0275\u0275advance(4);
...
var ItemSelectionComponent = class _ItemSelectionComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemSelectionComponent, selectors: [["item-selection"]], viewQuery: function ItemSelectionComponent_Query(rf, ctx) {
  ...
  }, inputs: { show: [1, "show"], title: [1, "title"], route: [1, "route"] }, outputs: { show: "showChange" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], ngContentSelectors: _c12, decls: 11, vars: 7, consts: [["search_input", ""], [1, "flex", "w-full", "items-center", "justify-center", "border-b", "border-base-200", "p-2"], [1, "flex", "max-w-[calc(100vw-1rem)]", "flex-1", "items-center", "rounded-lg", "border", "border-base-200", "sm:max-w-[512px]", "sm:flex-auto", 3, "click"], [1, "ml-2", "text-2xl"], [1, "w-1/2", "flex-1", "p-2", "text-left", "text-lg", "opacity-30"], [1, "keycap", "mr-2", "text-xs"], [1, "bg-base-100/80", "/30", "absolute", "inset-0", 3, "click", "keydown.esc"], [1, "absolute", "left-1/2", "top-2", "flex", "w-[512px]", "max-w-[calc(100vw-1rem)]", "-translate-x-1/2", "flex-col", "space-y-2", "overflow-hidden", "rounded", "bg-base-100", "shadow", 3, "click"], [1, "relative", "flex", "items-center", "border-b", "border-base-200"], [1, "pointer-events-none", "absolute", "left-2", "top-1/2", "-translate-y-1/2", "text-2xl"], [1, "bg-transparent", "flex-1", "border-none", "py-4", "pl-10", "pr-4", 3, "ngModelChange", "ngModel", "placeholder"], ["diameter", "24", 1, "absolute", "right-2", "top-1/2", "mr-2", "-translate-y-1/2"], [1, "w-full", "px-4", "text-sm", "opacity-60"], [1, "flex", "h-1/2", "flex-1", "flex-col"], ["itemSize", "48", 1, "h-[768px]", "max-h-[75vh]"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], ["itemSize", "48", 1, "h-[768px]", "max-h-[75vh]", 3, "scroll", "scrolledIndexChange"], ["routerLinkActive", "active", "class", "m-2 block max-w-[calc(100vw-2rem)] rounded p-2", 3, "routerLink", "click", 4, "cdkVirtualFor", "cdkVirtualForOf", "cdkVirtualForTrackBy"], [1, "bg-base-200", "p-2", "text-center", "text-sm", "opacity-30"], ["routerLinkActive", "active", 1, "m-2", "block", "max-w-[calc(100vw-2rem)]", "rounded", "p-2", 3, "click", "routerLink"], [1, "flex-1", "truncate"], [1, "inline-block", "w-full", "overflow-hidden"], ["extra", "", 1, "mono", "bg-base-content/10", "/5", "mt-1", "max-w-full", "truncate", "rounded", "px-2", "py-1", "text-xs", "opacity-60"]], template: function ItemSelectionComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
    ...
    if (rf & 2) {
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 2, "COMMON.VIEW_TYPE", \u0275\u0275pureFunction1(5, _c22, ctx.title())), " ");
      \u0275\u0275advance(4);
...
var _c13 = ["*"];
var _c23 = (a0, a1) => ({ item: a0, index: a1 });
...
function VirtualScrollComponent_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", ctx_r3.item_template())("ngTemplateOutletContext", \u0275\u0275pureFunction2(4, _c23, item_r2, ctx_r3.offset_start() + \u0275$index_5_r3));
  }
}
var VirtualScrollComponent = class _VirtualScrollComponent {
  ...
  }, inputs: { items: [1, "items"], item_size: [1, "item_size"], item_template: [1, "item_template"], buffer: [1, "buffer"] }, outputs: { scrolled: "scrolled" }, ngContentSelectors: _c13, decls: 7, vars: 6, consts: [["scroll_container", ""], [1, "relative", "h-full", "w-full", "overflow-auto", 3, "resize", "scroll"], ["scroll-fill", "", 1, "w-full"], [1, "absolute", "w-full", 3, "top"], [1, "absolute", "w-full"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"]], template: function VirtualScrollComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275projectionDef();
      \u0275\u0275elementStart(0, "div", 1, 0);
...
function ItemSidebarComponent_Conditional_17_ng_template_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", ctx_r2.subroute() ? \u0275\u0275pureFunction3(11, _c33, ctx_r2.route(), item_r7.id, ctx_r2.subroute()) : \u0275\u0275pureFunction2(15, _c43, ctx_r2.route(), item_r7.id))("matTooltip", item_r7.update_available && item_r7.commit !== item_r7.update_info.commit ? \u0275\u0275pipeBind1(1, 9, "COMMON.UPDATE_AVAILABLE") : "");
    \u0275\u0275advance(3);
...
function ItemSidebarComponent_Conditional_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 1, ctx_r2.search ? "COMMON.SEARCH_EMPTY" : "COMMON.LIST_EMPTY", \u0275\u0275pureFunction1(4, _c14, ctx_r2.title())), " ");
  }
}
var ItemSidebarComponent = class _ItemSidebarComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemSidebarComponent, selectors: [["item-sidebar"]], viewQuery: function ItemSidebarComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._input, _c05, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance();
    }
  }, inputs: { title: [1, "title"], route: [1, "route"], filter_options: [1, "filter_options"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 20, vars: 23, consts: [["search_input", ""], ["item_display", ""], [1, "flex", "h-full", "w-[24rem]", "min-w-64", "max-w-[25vw]", "flex-col", "space-y-2", "overflow-hidden", "rounded", "border-base-200", "bg-base-100", "shadow", "sm:border-r", 3, "click"], [1, "flex", "items-center", "space-x-2", "px-1", "pt-1"], [1, "relative", "flex", "flex-1", "items-center", "rounded-lg", "border", "border-base-300", "shadow"], [1, "pointer-events-none", "absolute", "left-1", "top-1/2", "-translate-y-1/2", "text-2xl"], [1, "bg-transparent", "w-full", "flex-1", "rounded-lg", "border-none", "py-2.5", "pl-9", "pr-4", 3, "ngModelChange", "ngModel", "placeholder"], ["diameter", "24", 1, "absolute", "right-2", "top-1/2", "mr-2", "-translate-y-1/2"], [1, "relative", "flex", "overflow-hidden"], [1, "w-full", "px-2", "text-sm", "opacity-60"], [1, "flex", "h-1/2", "flex-1", "flex-col", "border-t", "border-base-200"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], ["icon", "", "matRipple", ""], [1, "text-2xl"], ["appearance", "outline", 1, "no-subscript", "absolute", "-right-2", "top-1/2", "-translate-y-1/2", "opacity-0"], ["multiple", "", 3, "ngModelChange", "ngModel"], [1, "capitalize", 3, "value"], [3, "scrolled", "item_size", "items", "item_template"], [1, "bg-base-200", "p-2", "text-center", "text-sm", "opacity-30"], ["routerLinkActive", "active", 1, "relative", "m-1", "flex", "h-16", "w-[23rem]", "max-w-[calc(100%-0.5rem)]", "flex-col", "justify-center", "rounded", "border", "border-base-100", "px-2", "py-1", "hover:border-info", 3, "click", "routerLink", "matTooltip"], [1, "w-full", "truncate"], [1, "flex", "w-full"], ["extra", "", 1, "mono", "mt-1", "max-w-full", "truncate", "rounded", "border", "border-base-300", "p-1", "text-[0.625rem]", "opacity-60"], [1, "absolute", "-right-1", "-top-1", "rotate-12", "text-2xl", "text-info"], [1, "absolute", "-right-1", "-top-1", "flex", "h-8", "w-8", "rotate-12", "items-center", "justify-center", "rounded-full", "bg-warning", "text-2xl", "text-warning-content", 3, "matTooltip"], [1, "absolute", "-right-1", "-top-1", "flex", "h-8", "w-8", "rotate-12", "items-center", "justify-center", "rounded-full", "bg-error", "text-2xl", "text-error-content", 3, "matTooltip"]], template: function ItemSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(7, 6, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction1(19, _c14, ctx.title())));
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(15, 13, "COMMON.TOTAL_ITEMS", \u0275\u0275pureFunction1(21, _c24, t_r10), t_r10), " ");
      \u0275\u0275advance(3);
...
function ItemTablistComponent_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", "/" + ctx_r2.base() + "/" + ctx_r2.item_id() + "/" + link_r1.id)("queryParams", link_r1.query || \u0275\u0275pureFunction0(6, _c06))("active", rla_r2.isActive);
    \u0275\u0275advance(2);
...
var ItemTablistComponent = class _ItemTablistComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemTablistComponent, selectors: [["item-tablist"]], inputs: { base: [1, "base"], item_id: [1, "item_id"], tabs: [1, "tabs"], scrolled: [1, "scrolled"] }, outputs: { item_id: "item_idChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 7, vars: 3, consts: [["tabPanel", ""], ["rla", "routerLinkActive"], [1, "h-12", "w-full", "border-b", "border-base-300"], [1, "h-14", "w-full", "overflow-hidden"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", "routerLinkActive", "", 1, "tab", 3, "routerLink", "queryParams", "active"], [1, "hidden"], [1, "text-xl", 3, "icon"], [1, "name"], [1, "mono", "flex", "h-5", "min-w-[1.25rem]", "items-center", "justify-center", "rounded-full", "bg-base-200", "px-1.5", "text-[0.625rem]"]], template: function ItemTablistComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-ZQQKA6UB.js.map
