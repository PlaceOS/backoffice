...
import {
  ...
  addChipItem,
  removeChipItem
} from "./chunk-VDOVHCUZ.js";
import {
  AuthenticatedImageDirective
} from "./chunk-2V5TWTO7.js";
import {
  MatChipGrid,
  MatChipInput,
  MatChipRemove,
...
import {
  DateFromPipe
} from "./chunk-CYNTSSZZ.js";
import {
  Clipboard
} from "./chunk-YK26JLC5.js";
import {
  HotkeysService
...
function CsvUploadComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("dragenter", function CsvUploadComponent_Conditional_0_Template_button_dragenter_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.dragging = false);
    })("dragover", function CsvUploadComponent_Conditional_0_Template_button_dragover_0_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onDragOver($event));
    })("drop", function CsvUploadComponent_Conditional_0_Template_button_drop_0_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CsvUploadComponent, { className: "CsvUploadComponent", filePath: "src/app/overlays/bulk-item-modal/csv-upload.component.ts", lineNumber: 65 });
})();
...
function ListComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 4)(1, "input", 8);
    \u0275\u0275listener("ngModelChange", function ListComponent_Conditional_2_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setAllStartModules($event));
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r2.all_start_modules);
  }
}
function ListComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ListComponent_ng_template_10_Template_input_ngModelChange_0_listener($event) {
      const ctx_r4 = \u0275\u0275restoreView(_r4);
      const row_r6 = ctx_r4.row;
      const id_r7 = ctx_r4.key;
      \u0275\u0275twoWayBindingSet(row_r6[id_r7], $event) || (row_r6[id_r7] = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const name_r8 = ctx.name;
    const id_r7 = ctx.key;
    \u0275\u0275property("placeholder", name_r8);
    \u0275\u0275twoWayProperty("ngModel", row_r6[id_r7]);
  }
}
function ListComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ListComponent_ng_template_12_Template_label_click_0_listener($event) {
      \u0275\u0275restoreView(_r9);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(1, "input", 8);
    \u0275\u0275twoWayListener("ngModelChange", function ListComponent_ng_template_12_Template_input_ngModelChange_1_listener($event) {
      const row_r10 = \u0275\u0275restoreView(_r9).row;
      \u0275\u0275twoWayBindingSet(row_r10["start_modules"], $event) || (row_r10["start_modules"] = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", row_r10["start_modules"]);
  }
}
var ListComponent = class _ListComponent {
  ...
  show_start_modules = input(false, ...ngDevMode ? [{ debugName: "show_start_modules" }] : []);
  ...
  _start_tmpl = viewChild("start", ...ngDevMode ? [{ debugName: "_start_tmpl" }] : []);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListComponent, selectors: [["bulk-item-list"]], viewQuery: function ListComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._input_tmpl, _c02, 5);
      \u0275\u0275viewQuerySignal(ctx._start_tmpl, _c12, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance(2);
    }
  }, inputs: { list: [1, "list"], fields: [1, "fields"], show_start_modules: [1, "show_start_modules"] }, outputs: { list: "listChange", next: "next", previous: "previous" }, decls: 14, vars: 11, consts: [["input", ""], ["start", ""], [1, "flex", "max-h-[65vh]", "max-w-[80vw]", "flex-wrap", "overflow-auto", "px-4", "text-sm"], [3, "data", "columns"], [1, "mx-4", "mt-4", "flex", "items-center", "space-x-2", "text-sm"], [1, "flex", "items-center", "justify-end", "space-x-4", "p-4"], ["btn", "", "matRipple", "", 1, "inverse", "w-36", 3, "click"], ["btn", "", "matRipple", "", 1, "w-36", 3, "click"], ["type", "checkbox", 3, "ngModelChange", "ngModel"], [1, "p-4", 3, "ngModelChange", "placeholder", "ngModel"], [1, "flex", "w-full", "items-center", "justify-center", "p-4", 3, "click"]], template: function ListComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 2);
      \u0275\u0275element(1, "simple-table", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(2, ListComponent_Conditional_2_Template, 4, 1, "label", 4);
      \u0275\u0275elementStart(3, "div", 5)(4, "button", 6);
      \u0275\u0275listener("click", function ListComponent_Template_button_click_4_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275pipe(9, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(10, ListComponent_ng_template_10_Template, 1, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(12, ListComponent_ng_template_12_Template, 2, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275styleProp("min-width", 12.5 * (ctx.fields().length + (ctx.show_start_modules() ? 1 : 0)) + "rem");
      \u0275\u0275property("data", ctx.list())("columns", ctx.columns());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.show_start_modules() ? 2 : -1);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 7, "COMMON.BACK"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 9, "COMMON.SAVE_ITEMS"), " ");
    }
  }, dependencies: [
    FormsModule,
    DefaultValueAccessor,
...
(() => {
  ...
  }], null, { list: [{ type: Input, args: [{ isSignal: true, alias: "list", required: false }] }, { type: Output, args: ["listChange"] }], fields: [{ type: Input, args: [{ isSignal: true, alias: "fields", required: false }] }], show_start_modules: [{ type: Input, args: [{ isSignal: true, alias: "show_start_modules", required: false }] }], next: [{ type: Output, args: ["next"] }], previous: [{ type: Output, args: ["previous"] }], _input_tmpl: [{ type: ViewChild, args: ["input", { isSignal: true }] }], _start_tmpl: [{ type: ViewChild, args: ["start", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ListComponent, { className: "ListComponent", filePath: "src/app/overlays/bulk-item-modal/list.component.ts", lineNumber: 78 });
})();
...
function MatchFieldsComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, MatchFieldsComponent_For_2_For_6_Template, 2, 2, "mat-option", 8, _forTrack02);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
var MatchFieldsComponent = class _MatchFieldsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MatchFieldsComponent, selectors: [["bulk-item-match-fields"]], inputs: { list: [1, "list"], field_list: [1, "field_list"], mappings: [1, "mappings"] }, outputs: { mappings: "mappingsChange", mapping_done: "mapping_done", previous: "previous", new_mappings: "new_mappings" }, features: [\u0275\u0275NgOnChangesFeature], decls: 10, vars: 6, consts: [[1, "-mt-2", "flex", "max-h-[65vh]", "max-w-[80vw]", "flex-wrap", "overflow-auto", "px-2"], [1, "m-2", "flex", "min-w-[40%]", "flex-1", "flex-col"], [1, "flex", "items-center", "justify-end", "space-x-4", "p-4"], ["btn", "", "matRipple", "", 1, "inverse", "w-36", 3, "click"], ["btn", "", "matRipple", "", 1, "w-36", 3, "click"], [1, "uppercase", 3, "for"], ["appearance", "outline", 1, "no-subscript"], ["placeholder", "Select field", 3, "ngModelChange", "name", "ngModel"], [3, "value"]], template: function MatchFieldsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(1, MatchFieldsComponent_For_2_Template, 7, 4, "div", 1, _forTrack02);
      \u0275\u0275elementEnd();
...
function StatusListComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", ctx_r0.completed_count(), " / ", ctx_r0.list().length, " completed ");
    \u0275\u0275advance();
...
function StatusListComponent_For_4_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.status[\u0275$index_17_r2], " ");
  }
}
function StatusListComponent_For_4_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const \u0275$index_17_r2 = \u0275\u0275nextContext().$index;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275classProp("bg-error", ctx_r0.status[\u0275$index_17_r2] !== "done")("text-error-content", ctx_r0.status[\u0275$index_17_r2] !== "done")("bg-success", ctx_r0.status[\u0275$index_17_r2] === "done")("text-success-content", ctx_r0.status[\u0275$index_17_r2] === "done");
    \u0275\u0275property("matTooltip", ctx_r0.status[\u0275$index_17_r2]);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r0.status[\u0275$index_17_r2] === "done" ? "done" : "close", " ");
  }
}
function StatusListComponent_For_4_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 10);
  }
}
function StatusListComponent_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 5)(2, "div", 6);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, StatusListComponent_For_4_Conditional_4_Template, 2, 1, "div", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 8);
    \u0275\u0275conditionalCreate(6, StatusListComponent_For_4_Conditional_6_Template, 3, 10, "div", 9);
    \u0275\u0275conditionalCreate(7, StatusListComponent_For_4_Conditional_7_Template, 1, 0, "mat-spinner", 10);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.status[\u0275$index_17_r2] && ctx_r0.status[\u0275$index_17_r2] !== "done" ? 4 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.status[\u0275$index_17_r2] && ctx_r0.status[\u0275$index_17_r2] !== "loading" ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.status[\u0275$index_17_r2] === "loading" ? 7 : -1);
  }
}
var BATCH_SIZE = 5;
var StatusListComponent = class _StatusListComponent {
  ...
  is_done = signal(false, ...ngDevMode ? [{ debugName: "is_done" }] : []);
  /** Count of successfully completed items */
  completed_count = signal(0, ...ngDevMode ? [{ debugName: "completed_count" }] : []);
  /** Count of failed items */
  error_count = signal(0, ...ngDevMode ? [{ debugName: "error_count" }] : []);
  ngOnChanges(changes) {
    ...
    try {
      ...
      for (let i = 0; i < items.length; i += BATCH_SIZE) {
        ...
        const batch_promises = batch.map(async (item, batch_index) => {
          ...
          try {
            const saved_item = await firstValueFrom(this.save()(__spreadProps(__spreadValues({}, item), { id: "" })));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StatusListComponent, selectors: [["bulk-item-status-list"]], inputs: { list: [1, "list"], save: [1, "save"] }, outputs: { done: "done" }, features: [\u0275\u0275NgOnChangesFeature], decls: 5, vars: 1, consts: [[1, "flex", "flex-col", "items-center", "px-4", "pb-4"], [1, "mb-2", "text-sm"], [1, "border-base-200", "flex", "w-[24rem]", "items-center", "rounded-sm", "border", "p-2"], [1, "info"], [1, "text-base-content/60", "mb-2", "text-sm"], [1, "flex", "flex-1", "flex-col", "justify-center", "px-2"], [1, "name", "flex-1"], [1, "text-error", "text-xs"], [1, "status"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "text-2xl", "shadow-sm", 3, "bg-error", "text-error-content", "bg-success", "text-success-content", "matTooltip"], ["diameter", "24"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "text-2xl", "shadow-sm", 3, "matTooltip"]], template: function StatusListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      ...
      \u0275\u0275repeaterCreate(3, StatusListComponent_For_4_Template, 8, 4, "div", 2, _forTrack03);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StatusListComponent, { className: "StatusListComponent", filePath: "src/app/overlays/bulk-item-modal/status-list.component.ts", lineNumber: 88 });
})();
...
function BulkItemModalComponent_Case_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("fields", ctx_r1.available_fields)("show_start_modules", ctx_r1.is_system);
  }
}
...
var BulkItemModalComponent = class _BulkItemModalComponent {
  ...
  showStatus() {
    ...
    if (validation_errors.length > 0) {
      ...
      if (validation_errors.length > 5) {
        notifyWarn(`...and ${validation_errors.length - 5} more validation errors.`);
      }
      return;
    }
    ...
    if (duplicates.length > 0) {
      ...
      if (duplicates.length > 5) {
        notifyWarn(`...and ${duplicates.length - 5} more duplicate warnings.`);
      }
    }
  ...
  generateTemplate() {
    switch (this._data.constr) {
      case pi:
        return [new pi(SYSTEM_TEMPLATE).toJSON()];
      case di:
        return [new di(MODULE_TEMPLATE).toJSON()];
      case ci:
        return [new ci(DRIVER_TEMPLATE).toJSON()];
      case Vn:
        return [new Vn(USER_TEMPLATE).toJSON()];
      case rn:
        return [new rn(ZONE_TEMPLATE).toJSON()];
    }
  }
  getRequiredFields() {
    switch (this._data.constr) {
  ...
  findDuplicates() {
    ...
    const dedup_field = this._data.constr === Vn ? "email" : "name";
    this.item_list.forEach((item, index) => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BulkItemModalComponent, selectors: [["app-bulk-item-modal"]], decls: 10, vars: 8, consts: [[1, "bg-base-200", "m-4", "flex", "items-center", "justify-between", "rounded-sm", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [3, "save", "list"], [3, "list", "fields", "show_start_modules"], [3, "list", "field_list", "mappings"], [3, "template"], [3, "done", "save", "list"], [3, "listChange", "next", "previous", "list", "fields", "show_start_modules"], [3, "new_mappings", "mapping_done", "previous", "list", "field_list", "mappings"], [3, "list", "template"]], template: function BulkItemModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(6, BulkItemModalComponent_Case_6_Template, 1, 2, "bulk-item-status-list", 3)(7, BulkItemModalComponent_Case_7_Template, 1, 3, "bulk-item-list", 4)(8, BulkItemModalComponent_Case_8_Template, 1, 3, "bulk-item-match-fields", 5)(9, BulkItemModalComponent_Case_9_Template, 1, 1, "bulk-item-csv-upload", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_2_0;
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 3, "COMMON.BULK_ADD", \u0275\u0275pureFunction1(6, _c03, ctx.type)), " ");
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BulkItemModalComponent, { className: "BulkItemModalComponent", filePath: "src/app/overlays/bulk-item-modal/bulk-item-modal.component.ts", lineNumber: 141 });
})();
...
function DuplicateModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, DuplicateModalComponent_Conditional_5_For_3_Template, 6, 4, "div", 6, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function DomainFormComponent_Conditional_1_Conditional_7_For_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 20);
...
function DomainFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, DomainFormComponent_Conditional_1_Conditional_2_Template, 10, 9, "div", 4);
    \u0275\u0275conditionalCreate(3, DomainFormComponent_Conditional_1_Conditional_3_Template, 10, 11, "div", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, DomainFormComponent_Conditional_1_Conditional_4_Template, 8, 9, "div", 4);
    \u0275\u0275conditionalCreate(5, DomainFormComponent_Conditional_1_Conditional_5_Template, 8, 9, "div", 4);
    \u0275\u0275conditionalCreate(6, DomainFormComponent_Conditional_1_Conditional_6_Template, 7, 6, "div", 4);
...
var DomainFormComponent = class _DomainFormComponent extends AsyncHandler {
  ...
  form = generateDomainFormFields(this._data.item);
  loading;
  ...
  email_domain_list = this.form.controls.email_domains ? toSignal(this.form.controls.email_domains.valueChanges, {
  ...
  submit() {
    ...
    (form_item.id ? pc(form_item.id, form_item) : dc(form_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({ reason: "done", metadata: { item: _item } });
      notifySuccess(i18n(`${this._name}.SAVE_SUCCESS`));
      if (!this.form.value.id && this.form.controls.settings) {
        this.newSettings(_item, this.form.controls.settings.value).then(() => this._dialog_ref.close());
      } else {
  ...
  async newSettings(item, settings_string) {
    const new_settings = new Ue({
      parent_id: item.id,
      settings_string,
      encryption_level: Ge.Support
    });
    await Ul(new_settings).toPromise().catch((err) => {
      this.loading = null;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DomainFormComponent, selectors: [["domain-form"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 3, consts: [["chipList", ""], [3, "save", "heading", "loading"], ["domain", "", 1, "flex", "flex-col", 3, "formGroup"], [1, "fieldset"], [1, "field"], ["for", "domain-name"], ["appearance", "outline"], ["matInput", "", "name", "domain-name", "formControlName", "name", "required", "", 3, "placeholder"], ["for", "domain"], ["matInput", "", "name", "domain", "formControlName", "domain", 3, "placeholder"], ["for", "login-url"], ["matInput", "", "name", "login-url", "formControlName", "login_url", 3, "placeholder"], ["for", "logout-url"], ["matInput", "", "name", "logout-url", "formControlName", "logout_url", 3, "placeholder"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 3, "placeholder"], ["for", "email-domains-input"], ["appearance", "outline", 1, "w-full"], ["aria-label", "Image List"], ["id", "email-domains-input", 3, "matChipInputTokenEnd", "placeholder", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [3, "removed"], [1, "max-w-md", "truncate"], ["matChipRemove", ""]], template: function DomainFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(1, DomainFormComponent_Conditional_1_Template, 8, 7, "form", 2);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DomainFormComponent, { className: "DomainFormComponent", filePath: "src/app/domains/domain-form.component.ts", lineNumber: 280 });
})();
...
function generateDriverFormFields(driver) {
  const fields = {
    ...
    role: new FormControl(driver?.role || Ht.Logic),
...
function DriverFormComponent_Conditional_1_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275pipe(5, "async");
    \u0275\u0275twoWayListener("ngModelChange", function DriverFormComponent_Conditional_1_Conditional_6_Template_item_search_field_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.driver, $event) || (ctx_r1.driver = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function DriverFormComponent_Conditional_1_Conditional_6_Template_item_search_field_ngModelChange_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(4, 7, "DRIVERS.SEARCH"))("options", \u0275\u0275pipeBind1(5, 9, ctx_r1.driver_list))("loading", ctx_r1.loading_type().includes("drivers"));
...
function DriverFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, DriverFormComponent_Conditional_1_Conditional_6_Template, 6, 11);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(4, 8, "REPOS.SEARCH"))("options", \u0275\u0275pipeBind1(5, 10, ctx_r1.repo_list))("loading", ctx_r1.loading_type().includes("repository"));
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.repo);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.repo() ? 6 : -1);
  }
}
function DriverFormComponent_Conditional_2_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function DriverFormComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, DriverFormComponent_Conditional_2_Conditional_6_Template, 4, 6, "div", 7);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(4, 10, "DRIVERS.COMMIT_SEARCH"))("options", \u0275\u0275pipeBind1(5, 12, ctx_r1.commit_list))("loading", ctx_r1.loading_type().includes("commits"))("ngModel", ctx_r1.commit());
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.commit_error() ? 6 : -1);
  }
}
...
function DriverFormComponent_Conditional_3_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "label", 28);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 10)(5, "mat-select", 29);
    \u0275\u0275repeaterCreate(6, DriverFormComponent_Conditional_3_Conditional_13_For_7_Template, 3, 4, "mat-option", 27, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DriverFormComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(13, DriverFormComponent_Conditional_3_Conditional_13_Template, 8, 3, "div", 13);
    ...
    \u0275\u0275pipe(37, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 20)(39, "div", 13)(40, "label", 21);
    \u0275\u0275text(41);
    \u0275\u0275pipe(42, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(50, "div", 23)(51, "settings-toggle", 24);
    \u0275\u0275pipe(52, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(53, "label", 25);
    \u0275\u0275text(54);
    \u0275\u0275pipe(55, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "mat-form-field", 10)(57, "mat-select", 26);
    \u0275\u0275repeaterCreate(58, DriverFormComponent_Conditional_3_For_59_Template, 3, 4, "mat-option", 27, _forTrack05);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 23, "COMMON.FIELD_NAME"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 25, "COMMON.FIELD_NAME"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 27, "DRIVERS.NAME_REQUIRED"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!ctx_r1.is_editing() ? 13 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275classProp("error", ctx_r1.fieldInvalid("module_name"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 29, "DRIVERS.MODULE_NAME"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(22, 31, "DRIVERS.MODULE_NAME"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(25, 33, "DRIVERS.MODULE_NAME_REQUIRED"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(28, 35, "COMMON.FIELD_DESCRIPTION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(31, 37, "COMMON.FIELD_DESCRIPTION"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(34, 39, "DRIVERS.DEFAULT_URI"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(37, 41, "DRIVERS.DEFAULT_URI"));
    \u0275\u0275advance(4);
    \u0275\u0275classProp("error", ctx_r1.fieldInvalid("default_port"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(42, 43, "DRIVERS.DEFAULT_PORT"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(45, 45, "DRIVERS.DEFAULT_PORT"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(48, 47, "MODULES.PORT_REQUIRED"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(52, 49, "MODULES.IGNORE_CONNECTED"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(55, 51, "COMMON.ALERT_LEVEL"), " ");
    \u0275\u0275advance(4);
...
var DriverFormComponent = class _DriverFormComponent extends AsyncHandler {
  ...
  commit_error = signal(false, ...ngDevMode ? [{ debugName: "commit_error" }] : []);
  _details_request = signal(0, ...ngDevMode ? [{ debugName: "_details_request" }] : []);
  role_types = [
    { id: Ht.SSH, name: "DRIVERS.SSH" },
    { id: Ht.Device, name: "DRIVERS.DEVICE" },
    { id: Ht.Service, name: "DRIVERS.SERVICE" },
    { id: Ht.Websocket, name: "DRIVERS.WEBSOCKET" },
    { id: Ht.Logic, name: "DRIVERS.LOGIC" }
  ];
  alert_levels = [
  ...
  repo = signal(null, ...ngDevMode ? [{ debugName: "repo" }] : []);
  driver = signal(null, ...ngDevMode ? [{ debugName: "driver" }] : []);
  commit = signal(null, ...ngDevMode ? [{ debugName: "commit" }] : []);
  repo_list = el({ limit: 1e3 }).pipe(map(({ data }) => data.filter((repo) => repo.type === yi.Driver)), shareReplay(1));
  driver_list = toObservable(this.repo).pipe(filter((item) => !!item?.id), distinctUntilKeyChanged("id"), tap(() => this.loading_type.update((types) => [...types, "drivers"])), switchMap(({ id }) => al(id, { limit: 1e3 }).pipe(catchError(() => of([])))), map((list) => list.map((_) => ({
    id: _,
    name: _.replace(/\//g, " > ")
  }))), tap(() => this.loading_type.update((types) => types.filter((_) => _ !== "drivers"))), shareReplay(1));
  commit_list = combineLatest([
    toObservable(this.repo),
    toObservable(this.driver)
  ]).pipe(filter(([repo, driver]) => !!repo?.id && !!driver?.id), distinctUntilChanged(([prev_repo, prev_driver], [curr_repo, curr_driver]) => prev_repo?.id === curr_repo?.id && prev_driver?.id === curr_driver?.id), tap(() => this.loading_type.update((types) => [...types, "commits"])), switchMap(([{ id }, driver]) => ll(id, {
    driver: driver.id,
    limit: 1e3
  }).pipe(catchError(() => of([])))), map((list) => list.map((item) => ({
    id: item.commit,
    name: `${item.subject}`,
  ...
  async applyDriverCommit(commit) {
    ...
    const details = await lastValueFrom(pl(repo.id, {
      driver: `${driver.id}`,
      commit: `${commit.id}`
  ...
  submit() {
    ...
    const item_json = item.toJSON ? item.toJSON() : item;
    const form_item = item.id ? Ms(__spreadValues(__spreadValues({}, item_json), this.form.value), [void 0]) : __spreadValues(__spreadValues({}, item_json), this.form.value);
    (form_item.id ? vc(form_item.id, form_item) : bc(form_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({
        reason: "done",
        metadata: { item: _item }
  ...
  _applyDriverDetails(details) {
    ...
    this.form.patchValue({
      ...
      role: port_number ? port_number === 22 ? Ht.SSH : Ht.Device : details_any.uri_base ? details_any.uri_base.startsWith("ws") ? Ht.Websocket : Ht.Service : Ht.Logic,
  ...
  async _loadDetailsFromForm() {
    ...
    if (!id)
      return;
    this.loading.set("DRIVERS.DETAILS_LOADING");
    const repo = await lastValueFrom(tl(repository_id));
    const driver = {
      id: file_name,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DriverFormComponent, selectors: [["driver-form"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 5, vars: 6, consts: [[3, "save", "heading", "loading"], [1, "flex", "flex-col", 3, "formGroup"], [1, "bg-base-200", "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "px-8", "py-16"], ["for", "repos"], [3, "ngModelChange", "placeholder", "options", "loading", "ngModel"], ["for", "driver"], ["for", "commit"], [1, "text-error", "text-xs"], ["for", "driver-name"], ["required", ""], ["appearance", "outline"], ["matInput", "", "name", "driver-name", "formControlName", "name", "required", "", 3, "placeholder"], [1, "flex", "space-x-4"], [1, "flex", "flex-1", "flex-col"], ["for", "module-name"], ["matInput", "", "name", "module-name", "formControlName", "module_name", "required", "", 3, "placeholder"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 3, "placeholder"], ["for", "default-uri"], ["matInput", "", "name", "default-uri", "formControlName", "default_uri", 3, "placeholder"], [1, "flex", "items-center", "space-x-4"], ["for", "default-port"], ["matInput", "", "name", "default-port", "type", "number", "formControlName", "default_port", 3, "placeholder"], [1, "h-1", "w-full"], ["formControlName", "ignore_connected", 1, "w-full", 3, "name"], ["for", "alert-level"], ["name", "alert-level", "formControlName", "alert_level"], [3, "value"], ["for", "role"], ["name", "role", "formControlName", "role"], [3, "diameter"]], template: function DriverFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
      \u0275\u0275listener("save", function DriverFormComponent_Template_fullscreen_modal_shell_save_0_listener() {
        return ctx.submit();
      });
      \u0275\u0275conditionalCreate(1, DriverFormComponent_Conditional_1_Template, 7, 12);
      \u0275\u0275conditionalCreate(2, DriverFormComponent_Conditional_2_Template, 7, 14);
      \u0275\u0275conditionalCreate(3, DriverFormComponent_Conditional_3_Template, 60, 53, "div", 1);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.commit() && !ctx.loading() && ctx.form.controls.id ? 3 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.loading() ? 4 : -1);
    }
  }, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DriverFormComponent, { className: "DriverFormComponent", filePath: "src/app/drivers/driver-form.component.ts", lineNumber: 283 });
})();

// src/app/groups/groups.utilities.ts
function generateGroupFormFields(group) {
  return new FormGroup({
    name: new FormControl(group?.name || "", [Validators.required]),
    description: new FormControl(group?.description || ""),
    parent_id: new FormControl(group?.parent_id || ""),
    authority_id: new FormControl(group?.authority_id || Dt()?.id || ""),
...
function GroupFormComponent_For_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", domain_r2.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", domain_r2.name, " ");
  }
}
function GroupFormComponent_For_46_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 19);
    \u0275\u0275listener("removed", function GroupFormComponent_For_46_Template_mat_chip_row_removed_0_listener() {
      const subsystem_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.removeSubsystem(subsystem_r4));
    });
  ...
  if (rf & 2) {
    const subsystem_r4 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", subsystem_r4, " ");
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(4, 2, "COMMON.ITEM_REMOVE", \u0275\u0275pureFunction1(5, _c13, subsystem_r4)));
  }
}
var GroupFormComponent = class _GroupFormComponent extends AsyncHandler {
  ...
  _name = "GROUPS";
  event = new EventEmitter();
  form = generateGroupFormFields(this._data.item);
  loading;
  heading = i18n(`${this._name}.${this._data.item.id ? "EDIT" : "NEW"}`);
  domain_list = hc({ limit: 1e3 }).pipe(map(({ data }) => data), shareReplay(1));
  parent_group = signal(null, ...ngDevMode ? [{ debugName: "parent_group" }] : []);
  subsystem_list = signal(this.form.controls.subsystems.value || [], ...ngDevMode ? [{ debugName: "subsystem_list" }] : []);
  separators = [ENTER, COMMA];
  query_parent_groups = (_) => Vc({ q: _, limit: 20 }).pipe(map(({ data }) => data));
  exclude_parent_group = (group, __) => group.id === this._data.item.id;
  ngOnInit() {
    this.subscription("save_item_key", this._hotkey.listen(["KeyS"], () => this.submit()));
    this.loadParentGroup();
    this.subscription("subsystems", this.form.controls.subsystems.valueChanges.subscribe((list) => this.subsystem_list.set(list || [])));
  }
  setParentGroup(group) {
    ...
    if (!group?.subsystems?.length)
      return;
    this.form.controls.subsystems.setValue(Array.from(/* @__PURE__ */ new Set([
      ...this.form.controls.subsystems.value || [],
      ...group.subsystems
    ])));
  }
  addSubsystem = (event) => addChipItem(this.form.controls.subsystems, event);
  removeSubsystem = (subsystem) => removeChipItem(this.form.controls.subsystems, subsystem);
  submit() {
    this.form.markAllAsTouched();
    if (!this.form.valid) {
      return notifyError(i18n("COMMON.INVALID_FIELDS", {
    ...
    const form_item = Ms(__spreadProps(__spreadValues(__spreadValues({}, item), form_value), {
      subsystems: form_value.subsystems || []
    }), ["", void 0]);
    (form_item.id ? Yc(form_item.id, form_item) : Zc(form_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({ reason: "done", metadata: { item: _item } });
      notifySuccess(i18n(`${this._name}.SAVE_SUCCESS`));
      this._dialog_ref.close();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GroupFormComponent, selectors: [["group-form"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 49, vars: 48, consts: [["chipList", ""], [3, "save", "heading", "loading"], [1, "flex", "flex-col", 3, "formGroup"], [1, "field"], ["for", "group-name"], ["appearance", "outline"], ["matInput", "", "id", "group-name", "name", "group-name", "formControlName", "name", "required", "", 3, "placeholder"], ["for", "group-description"], ["matInput", "", "id", "group-description", "name", "group-description", "formControlName", "description", 3, "placeholder"], [1, "fieldset"], ["for", "group-parent"], [3, "ngModelChange", "placeholder", "query_fn", "exclude", "ngModel", "ngModelOptions"], ["for", "group-authority"], ["name", "group-authority", "formControlName", "authority_id", 3, "placeholder"], [3, "value"], ["for", "group-subsystems"], ["appearance", "outline", 1, "w-full"], ["aria-label", "Subsystem List"], ["id", "group-subsystems", "name", "group-subsystems", 3, "matChipInputTokenEnd", "placeholder", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [3, "removed"], [1, "max-w-md", "truncate"], ["matChipRemove", ""]], template: function GroupFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "fullscreen-modal-shell", 1);
      ...
      \u0275\u0275listener("ngModelChange", function GroupFormComponent_Template_item_search_field_ngModelChange_26_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.setParentGroup($event));
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275pipe(34, "translate");
      \u0275\u0275repeaterCreate(35, GroupFormComponent_For_36_Template, 2, 2, "mat-option", 14, _forTrack06);
      \u0275\u0275pipe(37, "async");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(38, "div", 3)(39, "label", 15);
      \u0275\u0275text(40);
      \u0275\u0275pipe(41, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(42, "mat-form-field", 16)(43, "mat-chip-grid", 17, 0);
      \u0275\u0275repeaterCreate(45, GroupFormComponent_For_46_Template, 7, 7, "mat-chip-row", null, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(47, "input", 18);
      \u0275\u0275pipe(48, "translate");
      \u0275\u0275listener("matChipInputTokenEnd", function GroupFormComponent_Template_input_matChipInputTokenEnd_47_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.addSubsystem($event));
      });
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275classProp("error", ctx.form.controls.name.invalid && ctx.form.controls.name.touched);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 23, "COMMON.FIELD_NAME"));
      \u0275\u0275advance(5);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(10, 25, "COMMON.FIELD_NAME"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 27, "GROUPS.NAME_REQUIRED"));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(17, 29, "COMMON.FIELD_DESCRIPTION"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(20, 31, "COMMON.FIELD_DESCRIPTION"));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(25, 33, "GROUPS.PARENT_ID"));
      \u0275\u0275advance(2);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(27, 35, "GROUPS.PARENT_SEARCH"))("query_fn", ctx.query_parent_groups)("exclude", ctx.exclude_parent_group)("ngModel", ctx.parent_group())("ngModelOptions", \u0275\u0275pureFunction0(47, _c05));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(31, 37, "GROUPS.AUTHORITY_ID"));
      \u0275\u0275advance(3);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(34, 39, "GROUPS.AUTHORITY_SELECT"));
      \u0275\u0275advance(2);
      \u0275\u0275repeater(\u0275\u0275pipeBind1(37, 41, ctx.domain_list));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(41, 43, "GROUPS.SUBSYSTEMS"));
      \u0275\u0275advance(5);
      \u0275\u0275repeater(ctx.subsystem_list());
      \u0275\u0275advance(2);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(48, 45, "GROUPS.SUBSYSTEMS_HINT"))("matChipInputFor", chipList_r6)("matChipInputSeparatorKeyCodes", ctx.separators)("matChipInputAddOnBlur", true);
    }
  }, dependencies: [
    MatFormFieldModule,
    MatFormField,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GroupFormComponent, { className: "GroupFormComponent", filePath: "src/app/groups/group-form.component.ts", lineNumber: 182 });
})();
...
function generateModuleFormFields(mod) {
  const fields = {
    ...
    role: new FormControl(mod?.role || Ht.Logic),
  ...
  if (!mod?.id) {
    ...
    fields.driver.valueChanges.subscribe((value) => {
      ...
      fields.role.setValue(value.role || Ht.Logic);
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "item-search-field", 14);
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_0_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.form.controls.system.value == null ? null : ctx_r0.form.controls.system.value.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.form.controls.system.value == null ? null : ctx_r0.form.controls.system.value.id);
  }
}
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_0_Conditional_5_Template, 2, 2)(6, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_0_Conditional_6_Template, 4, 2, "div", 13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_3_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, " * ");
    \u0275\u0275elementEnd();
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_3_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275conditionalCreate(4, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_3_Conditional_4_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "mat-form-field", 16);
    \u0275\u0275element(6, "input", 19);
    \u0275\u0275conditionalCreate(7, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_3_Conditional_7_Template, 3, 3, "mat-error");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_4_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, " * ");
    \u0275\u0275elementEnd();
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_4_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275conditionalCreate(4, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_4_Conditional_4_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "mat-form-field", 16);
    \u0275\u0275element(6, "input", 21);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275conditionalCreate(8, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_4_Conditional_8_Template, 3, 3, "mat-error");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 16)(5, "mat-select", 23);
    \u0275\u0275repeaterCreate(6, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_10_For_7_Template, 3, 4, "mat-option", 24, _forTrack07);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 1, "COMMON.ALERT_LEVEL"), " ");
    \u0275\u0275advance(4);
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 16);
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "label", 27);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 16);
...
function ModuleFormComponent_Conditional_1_Conditional_2_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "item-search-field", 29);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ModuleFormComponent_Conditional_1_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_1_Template, 12, 11, "div", 2);
    \u0275\u0275elementStart(2, "div", 6);
    \u0275\u0275conditionalCreate(3, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_3_Template, 8, 7, "div", 2);
    \u0275\u0275conditionalCreate(4, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_4_Template, 9, 10, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 7);
    \u0275\u0275conditionalCreate(6, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_6_Template, 2, 3, "settings-toggle", 8);
    \u0275\u0275conditionalCreate(7, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_7_Template, 2, 3, "settings-toggle", 9);
    \u0275\u0275conditionalCreate(8, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_8_Template, 2, 3, "settings-toggle", 10);
    \u0275\u0275conditionalCreate(9, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_9_Template, 2, 3, "settings-toggle", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(10, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_10_Template, 8, 3, "div", 2);
    \u0275\u0275conditionalCreate(11, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_11_Template, 7, 6, "div", 2);
    \u0275\u0275conditionalCreate(12, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_12_Template, 7, 6, "div", 2);
    \u0275\u0275conditionalCreate(13, ModuleFormComponent_Conditional_1_Conditional_2_Conditional_13_Template, 6, 7, "div", 2);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.form.controls.alert_level ? 10 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.form.controls.notes ? 11 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.form.controls.custom_name ? 12 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.form.controls.edge && !ctx_r0.form.controls.id.value ? 13 : -1);
  }
}
function ModuleFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form", 1);
    \u0275\u0275conditionalCreate(1, ModuleFormComponent_Conditional_1_Conditional_1_Template, 8, 7, "div", 2);
...
var ModuleFormComponent = class _ModuleFormComponent extends AsyncHandler {
  ...
  _hotkey = inject(HotkeysService);
  event = new EventEmitter();
  form = generateModuleFormFields(this._data.item);
  loading;
  heading = i18n(`${this._name}.${this._data.item.id ? "EDIT" : "NEW"}`);
  is_readonly = !!this._data.readonly;
  _driver = this.form.controls.driver ? toSignal(this.form.controls.driver.valueChanges, {
    initialValue: this.form.controls.driver.value || null
  }) : signal(null);
  _module_role = toSignal(this.form.controls.role.valueChanges, {
  ...
  driver_query_fn = (_) => yc({ q: _ }).pipe(map((resp) => resp.data));
  system_query_fn = (_) => Cl({ q: _ }).pipe(map((resp) => resp.data));
  edge_query_fn = (_) => Ic({ q: _ }).pipe(map((resp) => resp.data));
  ...
  submit() {
    ...
    const item_json = item.toJSON ? item.toJSON() : item;
    const form_item = item.id ? Ms(__spreadValues(__spreadValues({}, item_json), this.form.value), [void 0]) : __spreadValues(__spreadValues({}, item_json), this.form.value);
    (form_item.id ? Oa(form_item.id, form_item) : Ua(form_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({ reason: "done", metadata: { item: _item } });
      notifySuccess(i18n(`${this._name}.SAVE_SUCCESS`));
      if (!this.form.value.id && this.form.controls.settings) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModuleFormComponent, selectors: [["module-form"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 3, consts: [[3, "save", "heading", "loading"], ["module", "", 1, "flex", "flex-col", 3, "formGroup"], [1, "field"], ["for", "driver"], ["name", "driver", "formControlName", "driver", 3, "query_fn"], [1, "error"], [1, "fieldset"], [1, "-mx-2", "mb-4", "flex", "flex-wrap", "items-center"], ["formControlName", "tls", 1, "m-2", "max-w-1/2", "min-w-[40%]", "flex-1", 3, "name"], ["formControlName", "udp", 1, "m-2", "max-w-1/2", "min-w-[40%]", "flex-1", 3, "name"], ["formControlName", "makebreak", 1, "m-2", "max-w-1/2", "min-w-[40%]", "flex-1", 3, "name"], ["formControlName", "ignore_connected", 1, "m-2", "max-w-1/2", "min-w-[40%]", "flex-1", 3, "name"], ["for", "system"], [1, "value"], ["name", "system", "formControlName", "system", 3, "query_fn"], ["for", "uri"], ["appearance", "outline"], ["matInput", "", "name", "uri", "formControlName", "uri", 3, "placeholder"], ["for", "ip"], ["matInput", "", "name", "ip", "placeholder", "IP Address", "formControlName", "ip"], ["for", "port-number"], ["matInput", "", "name", "port-number", "type", "number", "formControlName", "port", 3, "placeholder"], ["for", "alert-level"], ["name", "alert-level", "formControlName", "alert_level"], [3, "value"], ["for", "notes"], ["matInput", "", "name", "notes", "formControlName", "notes", 3, "placeholder"], ["for", "custom-name"], ["matInput", "", "name", "custom-name", "formControlName", "custom_name", 3, "placeholder"], ["formControlName", "edge", 3, "placeholder", "query_fn"]], template: function ModuleFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
      \u0275\u0275listener("save", function ModuleFormComponent_Template_fullscreen_modal_shell_save_0_listener() {
        return ctx.submit();
      });
      \u0275\u0275conditionalCreate(1, ModuleFormComponent_Conditional_1_Template, 3, 3, "form", 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275property("heading", ctx.heading)("loading", ctx.loading);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModuleFormComponent, { className: "ModuleFormComponent", filePath: "src/app/modules/module-form.component.ts", lineNumber: 377 });
})();
...
function generateRepositoryFormFields(repository) {
  const fields = {
    ...
    repo_type: new FormControl(repository?.repo_type || yi.Driver),
...
function RepositoryFormComponent_Conditional_1_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(6, RepositoryFormComponent_Conditional_1_Conditional_3_For_7_Template, 2, 2, "mat-option", 9, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function RepositoryFormComponent_Conditional_1_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "mat-form-field", 5)(7, "input", 13);
    \u0275\u0275pipe(8, "translate");
...
function RepositoryFormComponent_Conditional_1_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 5)(5, "input", 15);
    \u0275\u0275pipe(6, "translate");
...
function RepositoryFormComponent_Conditional_1_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 5)(5, "input", 17);
    \u0275\u0275pipe(6, "translate");
...
function RepositoryFormComponent_Conditional_1_Conditional_9_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 9);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", branch_r6);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", branch_r6, " ");
  }
}
function RepositoryFormComponent_Conditional_1_Conditional_9_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function RepositoryFormComponent_Conditional_1_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "mat-form-field", 5)(7, "mat-select", 19);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275repeaterCreate(9, RepositoryFormComponent_Conditional_1_Conditional_9_For_10_Template, 2, 2, "mat-option", 9, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, RepositoryFormComponent_Conditional_1_Conditional_9_Conditional_12_Template, 2, 0, "div", 20);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 7, "REPOS.BRANCH"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", "Select Branch")("disabled", ctx_r0.loading_branches() || !((tmp_5_0 = \u0275\u0275pipeBind1(8, 9, ctx_r0.branch_list)) == null ? null : tmp_5_0.length));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(11, 11, ctx_r0.branch_list));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.loading_branches() ? 12 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(15, 13, "REPOS.BRANCH_REQUIRED"));
  }
}
function RepositoryFormComponent_Conditional_1_Conditional_10_For_15_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const commit_r9 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(commit_r9.author);
  }
}
function RepositoryFormComponent_Conditional_1_Conditional_10_For_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-option", 9)(1, "div", 29);
    \u0275\u0275listener("click", function RepositoryFormComponent_Conditional_1_Conditional_10_For_15_Template_div_click_1_listener() {
      const commit_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.base_commit = commit_r9);
    });
    ...
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(8, RepositoryFormComponent_Conditional_1_Conditional_10_For_15_Conditional_8_Template, 2, 1, "code", 33);
    \u0275\u0275elementStart(9, "code", 33);
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "slice");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275property("value", commit_r9.hash);
    \u0275\u0275advance();
    \u0275\u0275classProp("w-full!", ctx_r0.form.value.commit_hash === commit_r9.hash);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", commit_r9.subject, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 7, commit_r9.date, "medium"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(commit_r9.author ? 8 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind3(11, 10, commit_r9.hash, 0, 8));
  }
}
function RepositoryFormComponent_Conditional_1_Conditional_10_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275element(1, "mat-spinner", 21);
    \u0275\u0275elementEnd();
...
function RepositoryFormComponent_Conditional_1_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 5)(5, "mat-select", 24);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementStart(7, "mat-select-trigger")(8, "div", 25)(9, "div", 26);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(13, "slice");
    \u0275\u0275elementEnd()()();
    \u0275\u0275repeaterCreate(14, RepositoryFormComponent_Conditional_1_Conditional_10_For_15_Template, 12, 14, "mat-option", 9, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(16, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(17, RepositoryFormComponent_Conditional_1_Conditional_10_Conditional_17_Template, 2, 0, "div", 20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 2)(19, "settings-toggle", 28);
    \u0275\u0275listener("ngModelChange", function RepositoryFormComponent_Conditional_1_Conditional_10_Template_settings_toggle_ngModelChange_19_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 7, "REPOS.COMMIT"));
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", ctx_r0.loading_commits() || !((tmp_3_0 = \u0275\u0275pipeBind1(6, 9, ctx_r0.commit_list)) == null ? null : tmp_3_0.length));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", (ctx_r0.base_commit == null ? null : ctx_r0.base_commit.subject) || "Latest commit", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(13, 11, ctx_r0.form.value.commit_hash || "HEAD", 0, 8), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(16, 15, ctx_r0.commit_list));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.loading_commits() ? 17 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r0.follow_latest())("ngModelOptions", \u0275\u0275pureFunction0(17, _c06));
  }
}
function RepositoryFormComponent_Conditional_1_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "label", 34);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
...
function RepositoryFormComponent_Conditional_1_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "label", 36);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 5);
...
function RepositoryFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form", 1);
    \u0275\u0275conditionalCreate(1, RepositoryFormComponent_Conditional_1_Conditional_1_Template, 12, 11, "div", 2);
    \u0275\u0275elementStart(2, "div", 3);
    \u0275\u0275conditionalCreate(3, RepositoryFormComponent_Conditional_1_Conditional_3_Template, 8, 3, "div", 2);
    \u0275\u0275conditionalCreate(4, RepositoryFormComponent_Conditional_1_Conditional_4_Template, 12, 11, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, RepositoryFormComponent_Conditional_1_Conditional_5_Template, 12, 11, "div", 2);
    \u0275\u0275elementStart(6, "div", 3);
    \u0275\u0275conditionalCreate(7, RepositoryFormComponent_Conditional_1_Conditional_7_Template, 7, 6, "div", 2);
    \u0275\u0275conditionalCreate(8, RepositoryFormComponent_Conditional_1_Conditional_8_Template, 10, 7, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, RepositoryFormComponent_Conditional_1_Conditional_9_Template, 16, 15, "div", 2);
    \u0275\u0275conditionalCreate(10, RepositoryFormComponent_Conditional_1_Conditional_10_Template, 20, 18);
    \u0275\u0275conditionalCreate(11, RepositoryFormComponent_Conditional_1_Conditional_11_Template, 7, 6, "div", 2);
    \u0275\u0275conditionalCreate(12, RepositoryFormComponent_Conditional_1_Conditional_12_Template, 7, 6, "div", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var RepositoryFormComponent = class _RepositoryFormComponent extends AsyncHandler {
  ...
  loading_branches = signal(false, ...ngDevMode ? [{ debugName: "loading_branches" }] : []);
  /** Whether repository's commits are being loaded */
  loading_commits = signal(false, ...ngDevMode ? [{ debugName: "loading_commits" }] : []);
  /** Currently selected commit for the repository */
  base_commit;
  /** Whether to follow the latest branch commits(Auto-update) */
  follow_latest = signal(false, ...ngDevMode ? [{ debugName: "follow_latest" }] : []);
  ...
  credentials_blur = signal(0, ...ngDevMode ? [{ debugName: "credentials_blur" }] : []);
  _cred_blur = toObservable(this.credentials_blur);
  is_interface = computed(() => this.form?.value?.repo_type === yi.Interface, ...ngDevMode ? [{ debugName: "is_interface" }] : []);
  get hide_uri() {
  ...
  ngOnInit() {
    ...
    this.repo_types = [
      { id: yi.Driver, name: i18n("REPOS.TYPE_DRIVER") },
      {
        id: yi.Interface,
  ...
  submit() {
    ...
    this._dialog_ref.disableClose = true;
    const item_json = item.toJSON ? item.toJSON() : item;
    const form_value = __spreadValues({}, this.form.value);
    if (form_value.root_path) {
      form_value.root_path = form_value.root_path.replace(/^\/+|\/+$/g, "");
    }
    const form_item = item.id ? Ms(__spreadValues(__spreadValues({}, item_json), form_value), [void 0]) : __spreadValues(__spreadValues({}, item_json), form_value);
    (form_item.id ? nl(form_item.id, form_item) : rl(form_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({ reason: "done", metadata: { item: _item } });
      notifySuccess(i18n(`${this._name}.SAVE_SUCCESS`));
      if (!this.form.value.id && this.form.controls.settings) {
  ...
  _setupBranchAndCommitStreams() {
    ...
    const uri_valid$ = this.form.get("uri").valueChanges.pipe(debounceTime(1e3), filter((uri) => isValidUrl(uri) && uri.startsWith("http")), distinctUntilChanged());
    const credentials_trigger$ = merge(timer(300), this._cred_blur.pipe(skip(1)), uri_valid$);
    this.branch_list = credentials_trigger$.pipe(debounceTime(300), tap(() => this.loading_branches.set(true)), switchMap(() => {
      const { id, uri, username, password } = this.form.value;
      return (id ? hl(id) : isValidUrl(uri) && uri.startsWith("http") ? ul({
        repository_url: uri,
        username,
        password
    ...
    const default_branch = this.branch_list.pipe(debounceTime(300), switchMap(() => {
      const { id, uri, username, password } = this.form.value;
      return (id ? fl(id) : isValidUrl(uri) && uri.startsWith("http") ? ol({
        repository_url: uri,
        username,
        password
      }) : of("")).pipe(catchError(() => of("")));
    ...
    this.subscription("default_branch", combineLatest([this.branch_list, default_branch]).subscribe(([list, branch]) => {
      return !this.form.value.branch || !list.includes(this.form.value.branch) ? this.form.patchValue({ branch }) : "";
    }));
    this.commit_list = merge(timer(300), this._cred_blur.pipe(skip(1)), uri_valid$, this.form.get("branch").valueChanges).pipe(debounceTime(300), tap(() => this.loading_commits.set(true)), switchMap(() => {
      const { id, uri, branch, username, password } = this.form.value;
      return (id ? ll(id, { branch }) : isValidUrl(uri) && uri.startsWith("http") && branch ? cl({
        repository_url: uri,
        username,
        password,
        branch
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RepositoryFormComponent, selectors: [["repository-form"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 3, consts: [[3, "save", "heading", "loading"], ["repository", "", 1, "flex", "flex-col", 3, "formGroup"], [1, "field"], [1, "fieldset"], ["for", "repository-name"], ["appearance", "outline"], ["matInput", "", "name", "repository-name", "formControlName", "name", "required", "", 3, "placeholder"], ["for", "type"], ["name", "type", "formControlName", "repo_type"], [3, "value"], ["for", "folder-name"], ["matInput", "", "name", "folder-name", "formControlName", "folder_name", "required", "", 3, "placeholder"], ["for", "uri"], ["matInput", "", "name", "uri", "formControlName", "uri", "required", "", 3, "blur", "placeholder"], ["for", "repo-u"], ["matInput", "", "name", "repo-u", "autocomplete", "off", "formControlName", "username", 3, "blur", "placeholder"], ["for", "repo-p"], ["matInput", "", "name", "repo-pwd", "autocomplete", "new-password", "formControlName", "password", 3, "blur", "type", "placeholder"], ["matSuffix", "", 3, "click"], ["name", "type", "formControlName", "branch", 3, "placeholder", "disabled"], ["matSuffix", "", 1, "suffix", "ml-2"], ["diameter", "24"], [1, "field", "commit"], ["for", "commit"], ["formControlName", "commit_hash", "placeholder", "Select commit", 3, "disabled"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1", "truncate"], [1, "bg-base-200", "mr-4!", "rounded-sm", "px-1.5", "font-mono", "text-[0.625rem]"], ["name", "Follow latest commit", 1, "mb-4", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "flex", "w-[calc(100%-2.20rem)]", "flex-1", "items-center", "space-x-2", 3, "click"], [1, "flex", "w-1/2", "flex-1", "flex-col", "truncate", "leading-tight"], [1, "truncate"], [1, "text-base-content", "truncate", "font-mono", "text-[0.625rem]", "opacity-30"], [1, "bg-base-200", "rounded-sm", "p-1", "text-xs"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 3, "placeholder"], ["for", "root-path"], ["matInput", "", "name", "root-path", "formControlName", "root_path", 3, "placeholder"]], template: function RepositoryFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
      \u0275\u0275listener("save", function RepositoryFormComponent_Template_fullscreen_modal_shell_save_0_listener() {
        return ctx.submit();
      });
      \u0275\u0275conditionalCreate(1, RepositoryFormComponent_Conditional_1_Template, 13, 11, "form", 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275property("heading", ctx.heading)("loading", ctx.saving);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RepositoryFormComponent, { className: "RepositoryFormComponent", filePath: "src/app/repositories/repository-form.component.ts", lineNumber: 430 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CounterComponent, { className: "CounterComponent", filePath: "src/app/ui/counter.component.ts", lineNumber: 67 });
})();
...
var ImageListFieldComponent = class _ImageListFieldComponent extends AsyncHandler {
  ...
  /** List of images */
  upload_ids = signal([], ...ngDevMode ? [{ debugName: "upload_ids" }] : []);
  _upload_list = signal([], ...ngDevMode ? [{ debugName: "_upload_list" }] : []);
  ...
  length = computed(() => this.list().length + this.upload_list().length + 1, ...ngDevMode ? [{ debugName: "length" }] : []);
  uploads = computed(() => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ImageListFieldComponent, selectors: [["image-list-field"]], viewQuery: function ImageListFieldComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._list_el, _c07, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance();
    }
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(11, ImageListFieldComponent_For_12_Template, 4, 6, "button", 8, _forTrack08);
      ...
      \u0275\u0275repeaterCreate(17, ImageListFieldComponent_For_18_Template, 6, 2, "mat-chip-row", null, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      const chipList_r10 = \u0275\u0275reference(16);
      \u0275\u0275advance(2);
      ...
      \u0275\u0275repeater(ctx.list());
      \u0275\u0275advance(2);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(20, 10, "COMMON.IMAGE_ADD_URL"))("matChipInputFor", chipList_r10)("matChipInputSeparatorKeyCodes", ctx.separators)("matChipInputAddOnBlur", true);
    }
  }, dependencies: [
    IconComponent,
    MatFormFieldModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ImageListFieldComponent, { className: "ImageListFieldComponent", filePath: "src/app/ui/custom-fields/image-list-field.component.ts", lineNumber: 209 });
})();
...
function validateURLArray(control) {
  const value = control.value;
  if (!value || !Array.isArray(value) || !value.length) {
    return null;
  }
  return value.every((url) => !validateURL({ value: url })) ? null : { url: "invalid" };
}
...
function generateSystemsFormFields(system) {
  ...
  const fields = {
    ...
    camera_snapshot_urls: new FormControl(normaliseCameraSnapshotUrls(system), [validateURLArray]),
...
function SystemFormComponent_Conditional_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(6, "item-search-field", 20);
    \u0275\u0275conditionalCreate(7, SystemFormComponent_Conditional_1_Conditional_1_Conditional_7_Template, 3, 3, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function SystemFormComponent_Conditional_1_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 22);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementStart(4, "span");
    \u0275\u0275text(5, "*");
...
function SystemFormComponent_Conditional_1_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 32);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
...
function SystemFormComponent_Conditional_1_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 34);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "a-counter", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function SystemFormComponent_Conditional_1_Conditional_20_For_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", item_r4, " ");
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(4, 2, "SYSTEMS.REMOVE_ITEM", \u0275\u0275pureFunction1(5, _c08, item_r4)));
  }
}
function SystemFormComponent_Conditional_1_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 38);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 39)(5, "mat-chip-grid", 40, 1);
...
function SystemFormComponent_Conditional_1_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 45);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 13);
    \u0275\u0275element(5, "input", 46);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
...
function SystemFormComponent_Conditional_1_For_35_Template(rf, ctx) {
  if (rf & 1) {
...
function SystemFormComponent_Conditional_1_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 18);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function SystemFormComponent_Conditional_1_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 47);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
...
function SystemFormComponent_Conditional_1_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 49);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 13);
...
function SystemFormComponent_Conditional_1_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 51);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 13);
...
function SystemFormComponent_Conditional_1_Conditional_40_For_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 42);
    \u0275\u0275listener("removed", function SystemFormComponent_Conditional_1_Conditional_40_For_8_Template_mat_chip_row_removed_0_listener() {
      const item_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.removeCameraSnapshotUrl(item_r9));
    });
    \u0275\u0275elementStart(1, "div", 43);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(4, 2, "SYSTEMS.REMOVE_ITEM", \u0275\u0275pureFunction1(5, _c08, item_r9)));
  }
}
function SystemFormComponent_Conditional_1_Conditional_40_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function SystemFormComponent_Conditional_1_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 53);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 39)(5, "mat-chip-grid", 54, 2);
    \u0275\u0275repeaterCreate(7, SystemFormComponent_Conditional_1_Conditional_40_For_8_Template, 7, 7, "mat-chip-row", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "input", 55);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("matChipInputTokenEnd", function SystemFormComponent_Conditional_1_Conditional_40_Template_input_matChipInputTokenEnd_9_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.addCameraSnapshotUrl($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, SystemFormComponent_Conditional_1_Conditional_40_Conditional_11_Template, 3, 3, "mat-error");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const cameraSnapshotChipList_r10 = \u0275\u0275reference(6);
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275classProp("error", ctx_r0.form.controls.camera_snapshot_urls.invalid && ctx_r0.form.controls.camera_snapshot_urls.touched);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 8, "SYSTEMS.CAMERA_SNAPSHOT_URL"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275repeater(ctx_r0.camera_snapshot_url_list());
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(10, 10, "SYSTEMS.CAMERA_SNAPSHOT_URL"))("matChipInputFor", cameraSnapshotChipList_r10)("matChipInputSeparatorKeyCodes", ctx_r0.separators)("matChipInputAddOnBlur", true);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.form.controls.camera_snapshot_urls.invalid ? 11 : -1);
  }
}
function SystemFormComponent_Conditional_1_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 56);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 13);
...
function SystemFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, SystemFormComponent_Conditional_1_Conditional_1_Template, 8, 7, "div", 5);
    \u0275\u0275elementStart(2, "div", 6);
    \u0275\u0275conditionalCreate(3, SystemFormComponent_Conditional_1_Conditional_3_Template, 9, 6, "div", 5);
    \u0275\u0275conditionalCreate(4, SystemFormComponent_Conditional_1_Conditional_4_Template, 8, 9, "div", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 6);
    \u0275\u0275conditionalCreate(6, SystemFormComponent_Conditional_1_Conditional_6_Template, 7, 6, "div", 5);
    \u0275\u0275conditionalCreate(7, SystemFormComponent_Conditional_1_Conditional_7_Template, 7, 6, "div", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, SystemFormComponent_Conditional_1_Conditional_8_Template, 10, 11, "div", 5);
    \u0275\u0275elementStart(9, "div", 7);
    \u0275\u0275conditionalCreate(10, SystemFormComponent_Conditional_1_Conditional_10_Template, 5, 7, "div", 5);
    \u0275\u0275conditionalCreate(11, SystemFormComponent_Conditional_1_Conditional_11_Template, 5, 7, "div", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 8);
    \u0275\u0275element(13, "settings-toggle", 9);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275element(15, "settings-toggle", 10);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275element(17, "settings-toggle", 11);
    \u0275\u0275pipe(18, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(19, SystemFormComponent_Conditional_1_Conditional_19_Template, 7, 6, "div", 5);
    \u0275\u0275conditionalCreate(20, SystemFormComponent_Conditional_1_Conditional_20_Template, 11, 11, "div", 5);
    \u0275\u0275conditionalCreate(21, SystemFormComponent_Conditional_1_Conditional_21_Template, 6, 3, "div", 5);
    \u0275\u0275elementStart(22, "div", 5)(23, "label", 12);
    \u0275\u0275text(24);
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "mat-form-field", 13)(27, "div", 14)(28, "icon", 15);
    \u0275\u0275text(29, " search ");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275repeaterCreate(34, SystemFormComponent_Conditional_1_For_35_Template, 2, 2, "mat-option", 17, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(36, SystemFormComponent_Conditional_1_Conditional_36_Template, 3, 4, "mat-option", 18);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(37, SystemFormComponent_Conditional_1_Conditional_37_Template, 5, 3, "div", 5);
    \u0275\u0275conditionalCreate(38, SystemFormComponent_Conditional_1_Conditional_38_Template, 10, 11, "div", 5);
    \u0275\u0275conditionalCreate(39, SystemFormComponent_Conditional_1_Conditional_39_Template, 10, 11, "div", 5);
    \u0275\u0275conditionalCreate(40, SystemFormComponent_Conditional_1_Conditional_40_Template, 12, 12, "div", 5);
    \u0275\u0275conditionalCreate(41, SystemFormComponent_Conditional_1_Conditional_41_Template, 10, 11, "div", 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const auto_r11 = \u0275\u0275reference(33);
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroup", ctx_r0.form);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(31, 32, "COMMON.TIMEZONE"))("matAutocomplete", auto_r11);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r0.filtered_timezones());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r0.filtered_timezones().length ? 36 : -1);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.form.controls.camera_snapshot_urls ? 40 : -1);
    \u0275\u0275advance();
...
var SystemFormComponent = class _SystemFormComponent extends AsyncHandler {
  ...
  form = generateSystemsFormFields(this._data.item);
  loading;
  heading = i18n(`${this._name}.${this._data.item.id ? "EDIT" : "NEW"}`);
  feature_list = this.form.controls.features ? toSignal(this.form.controls.features.valueChanges, {
    initialValue: this.form.controls.features.value || []
  }) : signal([]);
  camera_snapshot_url_list = this.form.controls.camera_snapshot_urls ? toSignal(this.cameraSnapshotUrlsControl.valueChanges, {
    initialValue: this.cameraSnapshotUrlsControl.value || []
  }) : signal([]);
  /** Function for querying zones */
  query_fn = (_) => Ah({ q: _ }).pipe(map((resp) => resp.data));
  /** List of separator characters for features */
  separators = [ENTER, COMMA, SPACE];
  _timezone = toSignal(this.form.controls.timezone.valueChanges, {
    initialValue: this.form.controls.timezone.value || ""
  });
  filtered_timezones = computed(() => this.timezones.filter((_tz) => _tz.toLowerCase().includes(this._timezone().toLowerCase())), ...ngDevMode ? [{ debugName: "filtered_timezones" }] : []);
  get cameraSnapshotUrlsControl() {
    return this.form.controls.camera_snapshot_urls;
  }
  ngOnInit() {
    this.subscription("save_item_key", this._hotkey.listen(["KeyS"], () => this.submit()));
  }
  submit() {
    ...
    (processed_item.id ? Nl(processed_item.id, processed_item) : Hl(processed_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({ reason: "done", metadata: { item: _item } });
      notifySuccess(i18n(`${this._name}.SAVE_SUCCESS`));
      if (!this.form.value.id && this.form.controls.settings) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemFormComponent, { className: "SystemFormComponent", filePath: "src/app/systems/system-form.component.ts", lineNumber: 565 });
})();
...
function generateTriggerConditionForm(condition = {}) {
  ...
  const fields = {
    ...
    left: new FormControl(typeof left === "object" ? __spreadValues({}, left) : left || {}, [validateCompare]),
    operator: new FormControl(condition.operator || Mo.EQ),
...
function TriggerFormComponent_Conditional_1_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 14)(5, "mat-select", 15)(6, "mat-option", 16);
    \u0275\u0275text(7, "GET");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "mat-option", 17);
    \u0275\u0275text(9, "POST");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "mat-option", 18);
    \u0275\u0275text(11, "PUT");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-option", 19);
    \u0275\u0275text(13, "PATCH");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "mat-option", 20);
    \u0275\u0275text(15, "DELETE");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function TriggerFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form", 1);
    \u0275\u0275conditionalCreate(1, TriggerFormComponent_Conditional_1_Conditional_1_Template, 11, 8, "div", 2);
    \u0275\u0275conditionalCreate(2, TriggerFormComponent_Conditional_1_Conditional_2_Template, 7, 6, "div", 2);
    \u0275\u0275conditionalCreate(3, TriggerFormComponent_Conditional_1_Conditional_3_Template, 3, 3, "div", 3);
    \u0275\u0275elementStart(4, "div", 4);
    \u0275\u0275conditionalCreate(5, TriggerFormComponent_Conditional_1_Conditional_5_Template, 5, 9, "div", 2);
    \u0275\u0275conditionalCreate(6, TriggerFormComponent_Conditional_1_Conditional_6_Template, 16, 3, "div", 2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var TriggerFormComponent = class _TriggerFormComponent extends AsyncHandler {
  ...
  submit() {
    ...
    const item_json = item.toJSON ? item.toJSON() : item;
    const form_item = item.id ? Ms(__spreadValues(__spreadValues({}, item_json), this.form.value), [void 0]) : __spreadValues(__spreadValues({}, item_json), this.form.value);
    (form_item.id ? uh(form_item.id, form_item) : ch(form_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({ reason: "done", metadata: { item: _item } });
      notifySuccess(i18n(`${this._name}.SAVE_SUCCESS`));
      if (!this.form.value.id && this.form.controls.settings) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TriggerFormComponent, { className: "TriggerFormComponent", filePath: "src/app/triggers/trigger-form.component.ts", lineNumber: 168 });
})();
...
function UserFormComponent_Conditional_1_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 19);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
...
function UserFormComponent_Conditional_1_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function UserFormComponent_Conditional_1_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function UserFormComponent_Conditional_1_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementStart(7, "icon", 27);
    \u0275\u0275listener("click", function UserFormComponent_Conditional_1_Conditional_25_Template_icon_click_7_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function UserFormComponent_Conditional_1_Conditional_26_For_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 34);
    \u0275\u0275listener("removed", function UserFormComponent_Conditional_1_Conditional_26_For_8_Template_mat_chip_row_removed_0_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(4, 2, "COMMON.ITEM_REMOVE", \u0275\u0275pureFunction1(5, _c09, item_r7)));
  }
}
function UserFormComponent_Conditional_1_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 31)(5, "mat-chip-grid", 32, 0);
    \u0275\u0275repeaterCreate(7, UserFormComponent_Conditional_1_Conditional_26_For_8_Template, 7, 7, "mat-chip-row", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "input", 33);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("matChipInputTokenEnd", function UserFormComponent_Conditional_1_Conditional_26_Template_input_matChipInputTokenEnd_9_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function UserFormComponent_Conditional_1_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "label", 37);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 16);
...
function UserFormComponent_Conditional_1_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "settings-toggle", 14);
    \u0275\u0275pipe(1, "translate");
  }
  if (rf & 2) {
...
function UserFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(14, UserFormComponent_Conditional_1_Conditional_14_Template, 12, 11, "div", 5);
    \u0275\u0275conditionalCreate(15, UserFormComponent_Conditional_1_Conditional_15_Template, 12, 9, "div", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(16, UserFormComponent_Conditional_1_Conditional_16_Template, 12, 11, "div", 5);
    \u0275\u0275elementStart(17, "div", 10);
    \u0275\u0275conditionalCreate(18, UserFormComponent_Conditional_1_Conditional_18_Template, 7, 6, "div", 5);
    \u0275\u0275conditionalCreate(19, UserFormComponent_Conditional_1_Conditional_19_Template, 7, 6, "div", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 11);
    \u0275\u0275conditionalCreate(21, UserFormComponent_Conditional_1_Conditional_21_Template, 2, 3, "settings-toggle", 12);
    \u0275\u0275conditionalCreate(22, UserFormComponent_Conditional_1_Conditional_22_Template, 2, 3, "settings-toggle", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 10);
    \u0275\u0275conditionalCreate(24, UserFormComponent_Conditional_1_Conditional_24_Template, 12, 12, "div", 5);
    \u0275\u0275conditionalCreate(25, UserFormComponent_Conditional_1_Conditional_25_Template, 12, 12, "div", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(26, UserFormComponent_Conditional_1_Conditional_26_Template, 11, 11, "div", 5);
    \u0275\u0275conditionalCreate(27, UserFormComponent_Conditional_1_Conditional_27_Template, 10, 11, "div", 5);
    \u0275\u0275conditionalCreate(28, UserFormComponent_Conditional_1_Conditional_28_Template, 2, 3, "settings-toggle", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var UserFormComponent = class _UserFormComponent extends AsyncHandler {
  ...
  _hotkey = inject(HotkeysService);
  event = new EventEmitter();
  form = generateUserFormFields(this._data.item);
  loading;
  heading = i18n(`${this._name}.${this._data.item.id ? "EDIT" : "NEW"}`);
  /** Whether password should be visible in plaintext */
  show_password = signal(false, ...ngDevMode ? [{ debugName: "show_password" }] : []);
  /** Whether password confirm should be visible in plaintext */
  show_confirm = signal(false, ...ngDevMode ? [{ debugName: "show_confirm" }] : []);
  /** List of available domains */
  domain_list = hc().pipe(map(({ data }) => data), shareReplay(1));
  /** List of separator characters for groups */
  separators = [ENTER, COMMA];
  _email = toSignal(this.form.controls.email.valueChanges, {
    initialValue: this.form.controls.email.value || ""
  });
  group_list = toSignal(this.form.controls.groups.valueChanges, {
    initialValue: this.form.controls.groups.value || []
  });
  hide_password = computed(() => this._email().toLowerCase().startsWith("lynner") && !localStorage.getItem("PlaceOS.show_password"), ...ngDevMode ? [{ debugName: "hide_password" }] : []);
  ...
  submit() {
    ...
    this._dialog_ref.disableClose = true;
    const item_json = item.toJSON ? item.toJSON() : item;
    const form_item = item.id ? Ms(__spreadValues(__spreadValues({}, item_json), this.form.value), [
      void 0,
      null,
      ""
    ]) : __spreadValues(__spreadValues({}, item_json), this.form.value);
    (form_item.id ? _h(form_item.id, form_item) : mh(form_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({ reason: "done", metadata: { item: _item } });
      notifySuccess(i18n(`${this._name}.SAVE_SUCCESS`));
      this._dialog_ref.close();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserFormComponent, { className: "UserFormComponent", filePath: "src/app/users/user-form.component.ts", lineNumber: 405 });
})();
...
function ZoneFormComponent_Conditional_1_Conditional_5_For_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", item_r4, " ");
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(4, 2, "COMMON.ITEM_REMOVE", \u0275\u0275pureFunction1(5, _c010, item_r4)));
  }
}
...
function ZoneFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ZoneFormComponent_Conditional_1_Conditional_1_Template, 6, 8, "div", 4);
    \u0275\u0275elementStart(2, "div", 5);
    \u0275\u0275conditionalCreate(3, ZoneFormComponent_Conditional_1_Conditional_3_Template, 12, 11, "div", 4);
    \u0275\u0275conditionalCreate(4, ZoneFormComponent_Conditional_1_Conditional_4_Template, 7, 8, "div", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, ZoneFormComponent_Conditional_1_Conditional_5_Template, 11, 11, "div", 4);
    \u0275\u0275conditionalCreate(6, ZoneFormComponent_Conditional_1_Conditional_6_Template, 7, 6, "div", 4);
    \u0275\u0275elementStart(7, "div", 5);
    \u0275\u0275conditionalCreate(8, ZoneFormComponent_Conditional_1_Conditional_8_Template, 7, 6, "div", 4);
    ...
    \u0275\u0275conditionalCreate(25, ZoneFormComponent_Conditional_1_Conditional_25_Template, 7, 6, "div", 4);
    \u0275\u0275conditionalCreate(26, ZoneFormComponent_Conditional_1_Conditional_26_Template, 7, 6, "div", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 13);
    \u0275\u0275conditionalCreate(28, ZoneFormComponent_Conditional_1_Conditional_28_Template, 5, 5, "div", 4);
    \u0275\u0275conditionalCreate(29, ZoneFormComponent_Conditional_1_Conditional_29_Template, 5, 5, "div", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(30, ZoneFormComponent_Conditional_1_Conditional_30_Template, 7, 6, "div", 4);
    \u0275\u0275conditionalCreate(31, ZoneFormComponent_Conditional_1_Conditional_31_Template, 5, 3, "div", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var ZoneFormComponent = class _ZoneFormComponent extends AsyncHandler {
  ...
  _name = "ZONES";
  event = new EventEmitter();
  form = generateZoneFormFields(this._data.item);
  timezones = TIMEZONES_IANA;
  timezone = toSignal(this.form.valueChanges.pipe(startWith(this.form.getRawValue()), map(({ timezone }) => `${timezone || ""}`)), {
  ...
  submit() {
    ...
    const item_json = item.toJSON ? item.toJSON() : item;
    const form_item = item.id ? Ms(__spreadValues(__spreadValues({}, item_json), this.form.value), [void 0]) : __spreadValues(__spreadValues({}, item_json), this.form.value);
    (form_item.id ? Ph(form_item.id, form_item) : Eh(form_item)).subscribe((_item) => {
      this._dialog_ref.disableClose = false;
      this.event.emit({ reason: "done", metadata: { item: _item } });
      notifySuccess(i18n(`${this._name}.SAVE_SUCCESS`));
      if (!this.form.value.id && this.form.controls.settings) {
  ...
  async updateZone() {
    ...
    if (parent_id) {
      const zone = await wh(parent_id).toPromise();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneFormComponent, { className: "ZoneFormComponent", filePath: "src/app/zones/zone-form.component.ts", lineNumber: 348 });
})();
...
var domains = {
  ...
  show: (_) => fc(_),
  save: (item) => item.id ? pc(item.id, item) : dc(item),
...
var drivers = {
  ...
  show: (_) => gc(_),
  save: (item) => item.id ? vc(item.id, item) : bc(item),
  remove: (item) => $c(item.id),
  itemConstructor: ci,
  ...
  delete_extra: async (_) => {
    ...
    const count = await Ea(query).pipe(map(({ total }) => total)).toPromise().catch((_err) => 0);
    return count ? [
      "error",
...
var groups = {
  ...
  show: (_) => Kc(_),
  save: (item) => item.id ? Yc(item.id, item) : Zc(item),
  remove: (item) => Jc(item.id),
  itemConstructor: Kn,
...
var modules = {
  ...
  show: (_) => Ta(_),
  save: (item) => item.id ? Oa(item.id, item) : Ua(item),
...
var repositories = {
  ...
  show: (_) => tl(_),
  save: (item) => item.id ? nl(item.id, item) : rl(item),
  remove: (item) => il(item.id),
  itemConstructor: qo,
...
var systems = {
  ...
  remove: (item) => Fl(item.id),
  itemConstructor: pi,
  modalComponent: SystemFormComponent,
  delete_message: ``,
  name: "SYSTEMS"
};
function saveSystem(item) {
  ...
  if (item.id)
    return Nl(item.id, form_data);
  return Hl(form_data).pipe(switchMap((system) => from(finishSystemBulkAdd(system, driver_ids, !!start_modules)).pipe(map(() => system))));
}
async function finishSystemBulkAdd(system, driver_ids, start_modules) {
  await addLogicDriverModules(system, driver_ids);
  if (start_modules)
    await lastValueFrom(Wl(system.id));
}
async function addLogicDriverModules(system, driver_ids) {
  ...
  await Promise.all([...new Set(driver_ids)].map(async (driver_id) => {
    const driver = await lastValueFrom(gc(driver_id));
    if (driver.role !== Ht.Logic)
      return;
    await lastValueFrom(Ua({
      driver_id: driver.id,
...
var triggers = {
  ...
  show: (_) => oh(_),
  save: (item) => item.id ? uh(item.id, item) : ch(item),
  remove: (item) => ah(item.id),
  itemConstructor: de,
...
var users = {
  ...
  show: (_) => ph(_),
  save: (item) => item.id ? _h(item.id, item) : mh(item),
  remove: (item) => yh(item.id),
  itemConstructor: Vn,
...
var zones = {
  ...
  show: (_) => wh(_),
  save: (item) => item.id ? Ph(item.id, item) : Eh(item),
  remove: (item) => Th(item.id),
  itemConstructor: rn,
...
var ActiveItemService = class _ActiveItemService extends AsyncHandler {
  ...
  constructor() {
    ...
    this._search.subscribe((str2) => {
      this._loading_list.next(true);
      if (str2 || this._next_query.getValue()) {
  ...
  async updateSettings() {
    ...
    if (item && item.settings) {
      let settings = await lastValueFrom(El({ parent_id: item.id }).pipe(map((resp) => resp.data)));
      settings = new Array(5).fill(0).map((_, idx) => settings.find((_2) => _2.encryption_level === idx) || new Ue({
...
*/
//# sourceMappingURL=chunk-WL7WZJ5X.js.map
