...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-XK2CXHOC.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-3TZYRJJP.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-QHGTXG3O.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-LCWHAZTN.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
        loadComponent: () => import("./chunk-QMWSQWQF.js").then((m) => m.AdminAPIKeysComponent)
      },
      {
        path: "upload-storage",
...
//# sourceMappingURL=chunk-X3FBLGBV.js.map
