...
function queryStorage(query_params = {}) {
  return _({ query_params, fn: process, path: PATH });
}
...
function saveStorage(item) {
  const data = Ws(item, ["", void 0, null]);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StorageComponent, { className: "StorageComponent", filePath: "src/app/admin/storage/storage.component.ts", lineNumber: 181 });
})();
export {
  StorageComponent
};
//# sourceMappingURL=chunk-WNVH6F6T.js.map
