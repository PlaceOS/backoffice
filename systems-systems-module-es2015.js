...
/* harmony import */ var src_app_common_debug_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/common/debug.service */ "./src/app/common/debug.service.ts");
...
/* harmony import */ var _ui_custom_fields_system_exec_field_system_exec_field_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../ui/custom-fields/system-exec-field/system-exec-field.component */ "./src/app/ui/custom-fields/system-exec-field/system-exec-field.component.ts");
/* harmony import */ var _ui_context_menu_context_menu_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../ui/context-menu/context-menu.component */ "./src/app/ui/context-menu/context-menu.component.ts");
...
/* harmony import */ var _ui_icon_icon_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../ui/icon/icon.component */ "./src/app/ui/icon/icon.component.ts");
...
/* harmony import */ var _ui_binding_binding_directive__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../ui/binding/binding.directive */ "./src/app/ui/binding/binding.directive.ts");
...
var I18N_8;
if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
    const MSG_EXTERNAL_moduleStateLabel$$SRC_APP_SYSTEMS_SYSTEM_MODULES_SYSTEM_MODULES_COMPONENT_TS___9 = goog.getMsg("State");
...
var I18N_10;
if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
    const MSG_EXTERNAL_moduleNameLabel$$SRC_APP_SYSTEMS_SYSTEM_MODULES_SYSTEM_MODULES_COMPONENT_TS___11 = goog.getMsg("Name");
...
var I18N_12;
if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
    const MSG_EXTERNAL_moduleClassLabel$$SRC_APP_SYSTEMS_SYSTEM_MODULES_SYSTEM_MODULES_COMPONENT_TS___13 = goog.getMsg("Class");
...
var I18N_14;
if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
    const MSG_EXTERNAL_moduleIpLabel$$SRC_APP_SYSTEMS_SYSTEM_MODULES_SYSTEM_MODULES_COMPONENT_TS___15 = goog.getMsg("IP/URI");
...
var I18N_20;
if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
    const MSG_EXTERNAL_moduleListEmpty$$SRC_APP_SYSTEMS_SYSTEM_MODULES_SYSTEM_MODULES_COMPONENT_TS___21 = goog.getMsg("No devices for system");
...
class SystemModulesComponent extends src_app_common_base_class__WEBPACK_IMPORTED_MODULE_3__["BaseClass"] {
        ...
        if (device.running) {
            Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["stopModule"])(device.id)
                ...
                if (typeof err === 'string' && err.length < 64) {
                    ...
                    Object(src_app_common_notifications__WEBPACK_IMPORTED_MODULE_9__["notifyError"])(`Failed to stop module '${device.id}'.\nView Error?`, 'View', () => this.viewDetails(err));
                }
            });
        }
        else {
            Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["startModule"])(device.id)
                ...
                if (typeof err === 'string' && err.length < 64) {
                    ...
                    Object(src_app_common_notifications__WEBPACK_IMPORTED_MODULE_9__["notifyError"])(`Failed to start module '${device.id}'.\nView Error?`, 'View', () => this.viewDetails(err));
                }
            });
        }
    }
        ...
        this.subscription('confirm_ref', ref.componentInstance.event.subscribe((e) => {
            ...
            if (e.reason === 'done') {
                Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["recompileDriver"])(((_a = device.driver) === null || _a === void 0 ? void 0 : _a.id) || device.driver_id)
                    .toPromise()
                    .then((_) => Object(src_app_common_notifications__WEBPACK_IMPORTED_MODULE_9__["notifySuccess"])('Driver successfully recompiled.'), (err) => Object(src_app_common_notifications__WEBPACK_IMPORTED_MODULE_9__["notifyError"])(JSON.stringify(err.response || err.message || err)));
                ref.close();
    ...
    loadModule(device) {
        Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["loadModule"])(device.id)
            .toPromise()
            .then(() => Object(src_app_common_notifications__WEBPACK_IMPORTED_MODULE_9__["notifySuccess"])(`Successfully loaded module "${device.name || device.id}"`), (err) => Object(src_app_common_notifications__WEBPACK_IMPORTED_MODULE_9__["notifyError"])(`Error loading module. Error: ${JSON.stringify(err.response || err.message || err)}`));
    }
    editModule(device) {
            ...
            this.subscription('confirm_ref', ref.componentInstance.event.subscribe((e) => {
                if (e.reason === 'done') {
                    ...
                    Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["updateSystem"])(this.item.id, Object.assign(Object.assign({}, this.item.toJSON()), { modules: list }))
                        ...
                        Object(src_app_common_notifications__WEBPACK_IMPORTED_MODULE_9__["notifyError"])(`Error reording modules. Error: ${JSON.stringify(err.response || err.message || err)}`);
                    });
                }
            }));
        }
        ...
        this.subscription('confirm_ref', ref.componentInstance.event.subscribe((e) => {
            if (e.reason === 'done') {
                ...
                Object(_placeos_ts_client__WEBPACK_IMPORTED_MODULE_2__["removeSystemModule"])(this.item.id, device.id)
                    ...
                    this.hide_exec = false;
                    Object(src_app_common_notifications__WEBPACK_IMPORTED_MODULE_9__["notifyError"])(`Error removing module. Error: ${JSON.stringify(err.response || err.message || err)}`);
                    ref.close();
                    this.unsub('confirm_ref');
                });
            }
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SystemModulesComponent, [{
    ...
    }], function () { return [{ type: src_app_common_item_service__WEBPACK_IMPORTED_MODULE_10__["ActiveItemService"] }, { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__["MatDialog"] }, { type: src_app_common_debug_service__WEBPACK_IMPORTED_MODULE_12__["PlaceDebugService"] }]; }, null); })();
...
SystemsComponent.ɵfac = function SystemsComponent_Factory(t) { return new (t || SystemsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_common_item_service__WEBPACK_IMPORTED_MODULE_4__["ActiveItemService"])); };
SystemsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SystemsComponent, selectors: [["app-systems"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 6, vars: 30, consts: [[1, "container"], [1, "sidebar"], ["heading", "Systems", "name", "systems"], ["name", "system", "route", "systems", 3, "tabs"]], template: function SystemsComponent_Template(rf, ctx) { if (rf & 1) {
