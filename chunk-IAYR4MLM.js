...
var UserAvatarComponent = class _UserAvatarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserAvatarComponent, selectors: [["a-user-avatar"]], inputs: { user: [1, "user"] }, decls: 1, vars: 1, consts: [[1, "flex", "items-center", "justify-center", "overflow-hidden", "rounded-full"], ["initials", "", 1, "text-base-content", "text-opacity-80", "uppercase"], ["auth", "", 1, "h-full", "w-full", "object-cover", 3, "source"]], template: function UserAvatarComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-IAYR4MLM.js.map
