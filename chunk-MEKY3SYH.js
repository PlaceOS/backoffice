...
var SidebarMenuComponent = class _SidebarMenuComponent extends AsyncHandler {
  ...
  get alerts_url() {
    return Pt()?.config?.backoffice?.alerts_url;
  }
  get metrics_url() {
    return Pt()?.config?.backoffice?.metrics_url;
  }
  close = () => this._tooltip?.close();
  toggleCompactMode() {
...
//# sourceMappingURL=chunk-MEKY3SYH.js.map
