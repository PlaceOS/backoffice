...
function SystemZonesComponent_ng_template_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, SystemZonesComponent_ng_template_23_Conditional_2_Template, 3, 3, "span", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var SystemZonesComponent = class _SystemZonesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SystemZonesComponent, selectors: [["system-zones"]], decls: 27, vars: 44, consts: [["name_template", ""], ["description_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col", "p-4"], [1, "mb-2", "flex", "items-center", "space-x-2"], [1, "h-12", "flex-1", 3, "ngModelChange", "placeholder", "query_fn", "exclude", "clear_on_select", "ngModel"], ["btn", "", "matRipple", "", 1, "inverse", "flex-1", 3, "click", "disabled"], ["btn", "", "matRipple", "", 1, "inverse", "flex-1", 3, "mousedown", "touchstart", "mouseup", "touchend", "disabled"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click", "disabled"], [1, "mono", "bg-warning", "text-warning-content", "mb-2", "rounded-sm", "p-2", "text-center", "text-xs"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto"], ["mode", "indeterminate", 1, "w-full"], ["empty_message", "No zones for selected system", 1, "block", "min-w-lg", "text-sm", 3, "ondrop", "data", "columns", "color", "can_reorder"], [1, "h-12", "w-full"], [1, "flex", "w-full", "flex-col", "items-start", "px-4", "py-2", "leading-snug"], [1, "truncate", "text-left", "underline", 3, "routerLink"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "w-full", "overflow-hidden", "px-4", "py-2", "text-left", "text-xs", "select-text"], [1, "opacity-30"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function SystemZonesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementStart(17, "simple-table", 12);
      \u0275\u0275pipe(18, "translate");
      \u0275\u0275pipe(19, "translate");
...
//# sourceMappingURL=chunk-SGCRBXCW.js.map
