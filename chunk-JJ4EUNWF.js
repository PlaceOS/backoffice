...
var DriverUpdateListModalComponent = class _DriverUpdateListModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DriverUpdateListModalComponent, selectors: [["driver-update-list-modal"]], decls: 11, vars: 9, consts: [[1, "z-10", "mx-auto", "my-2", "w-[calc(100%-1rem)]", "rounded-sm", "border", "border-base-100", "bg-base-200", "px-4", "py-2"], [1, "flex", "items-center", "space-x-4", "text-xl", "font-medium"], [1, "mono", "rounded-sm", "bg-base-300", "px-2", "py-1", "text-xs"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "max-h-[65vh]", "w-[80vw]", "max-w-3xl", "overflow-y-auto"], [1, "flex", "h-48", "w-[20rem]", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "z-10", "mx-auto", "my-2", "flex", "w-[calc(100%-1rem)]", "justify-end", "space-x-2", "rounded-sm", "border", "border-base-100", "bg-base-200", "p-2"], [1, "mx-2", "w-[calc(100%-1rem)]", "rounded-sm"], [1, "sticky", "top-0", "z-10", "text-left"], [1, "bg-base-300!"], [3, "change", "checked", "indeterminate"], [3, "ngModelChange", "ngModel"], [3, "matTooltip"], ["colspan", "4", 1, "opacity-30"], [3, "diameter"], ["btn", "", "matRipple", "", 3, "click", "disabled"]], template: function DriverUpdateListModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var DriverStateService = class _DriverStateService {
  ...
  updates_available = this._poll.pipe(switchMap(() => cu({ update_available: true, limit: 1 }).pipe(catchError(() => of({ data: [], total: 0 })))), map((d) => d.total > 1), shareReplay(1));
...
//# sourceMappingURL=chunk-JJ4EUNWF.js.map
