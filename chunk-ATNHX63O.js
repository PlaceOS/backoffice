...
var RepositoryAboutComponent = class _RepositoryAboutComponent {
  ...
  local_url = computed(
    () => this.item()?.type === As.Interface ? `${location.origin}/${this.item()?.folder_name}/` : `${location.hash}`,
...
//# sourceMappingURL=chunk-ATNHX63O.js.map
