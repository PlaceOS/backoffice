...
function UserAboutComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, UserAboutComponent_Conditional_29_For_2_Template, 2, 1, "button", 16, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var UserAboutComponent = class _UserAboutComponent {
  ...
  _domain = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_domain" } : (
    ...
    loader: async ({ params: id }) => id ? Fo(id).catch(() => null) : null
  }));
  domain = computed(
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserAboutComponent, { className: "UserAboutComponent", filePath: "src/app/users/user-about.component.ts", lineNumber: 171 });
})();
export {
  UserAboutComponent
};
//# sourceMappingURL=chunk-PIAL4SEJ.js.map
