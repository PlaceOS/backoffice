...
var SettingsFieldComponent = class _SettingsFieldComponent extends AsyncHandler {
  ...
  fill = input(false, ...ngDevMode ? [{ debugName: "fill" }] : []);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsFieldComponent, { className: "SettingsFieldComponent", filePath: "src/app/ui/custom-fields/settings-field.component.ts", lineNumber: 53 });
})();

export {
  SettingsFieldComponent
};
//# sourceMappingURL=chunk-QISDDF6J.js.map
