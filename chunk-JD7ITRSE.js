...
var BasicLineGraphComponent = class _BasicLineGraphComponent extends AsyncHandler {
  ...
  }, inputs: { lines: [1, "lines"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 0, consts: [["canvas", ""], [1, "text-base-content", "h-full", "w-full"]], template: function BasicLineGraphComponent_Template(rf, ctx) {
    if (rf & 1) {
...
function AdminClusterNodeComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.node()?.hostname);
  }
}
var AdminClusterNodeComponent = class _AdminClusterNodeComponent {
  ...
  used_memory = computed(
    () => {
      return It((this.node()?.memory_usage || 0) * 1024).replace("GB", "").replace("MB", "").trim();
    },
  ...
  total_memory = computed(
    () => {
      return It((this.node()?.memory_total || 0) * 1024);
    },
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminClusterNodeComponent, selectors: [["admin-cluster-node"]], viewQuery: function AdminClusterNodeComponent_Query(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", ctx.node()?.total_cpu.toFixed(0), "% ");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(13, 11, "ADMIN.CLUSTERS_CPU_CORES", \u0275\u0275pureFunction1(16, _c1, ctx.node()?.cpu_count || 0)), " ");
      \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminClusterNodeComponent, { className: "AdminClusterNodeComponent", filePath: "src/app/admin/cluster-details/cluster-node.component.ts", lineNumber: 83 });
})();
...
function PlaceClusterDetailsComponent_Conditional_5_For_2_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("show_name", ctx_r2.cluster_nodes()[cluster_r2.id].length > 1)("node", node_r1)("history", (ctx_r2.usage_history[cluster_r2.id] || \u0275\u0275pureFunction0(3, _c12))[node_r1.hostname] || \u0275\u0275pureFunction0(4, _c2));
  }
}
...
var PlaceClusterDetailsComponent = class _PlaceClusterDetailsComponent extends AsyncHandler {
  ...
  cluster_list = signal(
    [],
    ...ngDevMode ? [{ debugName: "cluster_list" }] : (
      /* istanbul ignore next */
      []
    )
  );
  cluster_nodes = signal(
    {},
    ...ngDevMode ? [{ debugName: "cluster_nodes" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  constructor() {
    super();
    this.updateClusters();
    this.interval("clusters", () => this.updateClusters(), 2 * 1e3);
  }
  async updateClusters() {
    if (this.loading())
      return;
    this.loading.set(true);
    const response = await zo({ include_status: false }).catch(() => ({ data: [] }));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceClusterDetailsComponent, { className: "PlaceClusterDetailsComponent", filePath: "src/app/admin/cluster-details/cluster-details.component.ts", lineNumber: 85 });
})();
export {
  PlaceClusterDetailsComponent
};
//# sourceMappingURL=chunk-JD7ITRSE.js.map
