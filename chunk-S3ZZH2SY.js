...
var SelectMethodComponent = class _SelectMethodComponent extends AsyncHandler {
  ...
  ]).pipe(distinctUntilChanged(), tap(() => this.loading.set(true)), switchMap(([id, { module, index }]) => !!id && !!module ? _a(id, module, index) : of({})), catchError(() => of({})), map((fn_mapping) => Object.keys(fn_mapping || {}).map((i) => __spreadValues({
    name: i
...
var SelectModuleComponent = class _SelectModuleComponent extends AsyncHandler {
  ...
  ]).pipe(distinctUntilChanged(([id1, time1], [id2, time2]) => id1 === id2 && time1 === time2), tap(() => this.loading.set(true)), switchMap(([id]) => id ? hc({
...
//# sourceMappingURL=chunk-S3ZZH2SY.js.map
