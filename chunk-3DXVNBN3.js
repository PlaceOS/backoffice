...
function SettingsFormComponent_Conditional_5_For_5_Conditional_0_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 6, \u0275\u0275pipeBind1(3, 4, (tmp_15_0 = ctx_r1.settings()[\u0275$index_38_r7 - 1]) == null ? null : tmp_15_0.modified_by_id))?.name, " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind2(6, 8, ctx_r1.settings()[\u0275$index_38_r7 - 1]?.updated_at * 1e3 || 0, "medium"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind1(8, 11, "COMMON.LAST_EDIT"), ": ", \u0275\u0275pipeBind1(9, 13, ((tmp_17_0 = ctx_r1.settings()[\u0275$index_38_r7 - 1]) == null ? null : tmp_17_0.updated_at) * 1e3), " ");
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsFormComponent, { className: "SettingsFormComponent", filePath: "src/app/ui/forms/settings-form.component.ts", lineNumber: 228 });
})();
var MAPPING_CLASS = [
  "external-setting",
  "encryption-none",
...
//# sourceMappingURL=chunk-3DXVNBN3.js.map
