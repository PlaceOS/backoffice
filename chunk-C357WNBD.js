...
} from "./chunk-AD2SSF7G.js";
import {
  Clipboard
} from "./chunk-ORKO4FIK.js";
import {
  UploadsService
} from "./chunk-DAGGB6MU.js";
...
var UploadLibraryComponent = class _UploadLibraryComponent extends AsyncHandler {
  ...
  async downloadUpload(upload) {
    const tkn = X();
    document.cookie = `${tkn === "x-api-key" ? "api-key=" + encodeURIComponent(Ve()) : "bearer_token=" + encodeURIComponent(tkn)};max-age=60;path=/api/engine/v2/uploads;samesite=strict;${location.protocol === "https:" ? "secure;" : ""}`;
...
//# sourceMappingURL=chunk-C357WNBD.js.map
