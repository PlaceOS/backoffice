...
var SelectItemModalComponent = class _SelectItemModalComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SelectItemModalComponent, selectors: [["select-item-modal"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 8, vars: 9, consts: [[1, "mx-2", "mt-2", "flex", "items-center", "justify-between", "rounded-sm", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "h-[65vh]", "w-lg", "max-w-[calc(100vw-2rem)]", "px-2", "pt-2"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "p-16", "opacity-30"], [1, "flex", "justify-end", "border-t", "border-base-200", "px-4", "py-2"], [1, "block", "h-full", 3, "ngModelChange", "query_fn", "exclude", "ngModel", "display_list"], [1, "icon"], ["diameter", "32"], [1, "text"], ["btn", "", "matRipple", "", "type", "submit", 3, "click", "disabled"]], template: function SelectItemModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SelectItemModalComponent, { className: "SelectItemModalComponent", filePath: "src/app/overlays/select-item-modal.component.ts", lineNumber: 81 });
})();

export {
  SelectItemModalComponent
};
//# sourceMappingURL=chunk-3QS5QZFN.js.map
