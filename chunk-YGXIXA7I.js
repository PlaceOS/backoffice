...
var EdgeModalComponent = class _EdgeModalComponent {
  ...
  async save() {
    ...
    const method = edge.id ? au(edge.id, edge) : hu(edge);
...
function PlaceEdgeComponent_ng_template_25_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function PlaceEdgeComponent_ng_template_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, PlaceEdgeComponent_ng_template_25_Conditional_2_Template, 3, 3, "span", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PlaceEdgeComponent_ng_template_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 25)(1, "button", 26);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function PlaceEdgeComponent_ng_template_27_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function PlaceEdgeComponent_ng_template_27_Template_button_click_5_listener() {
      const row_r10 = \u0275\u0275restoreView(_r9).row;
      const ctx_r2 = \u0275\u0275nextContext();
...
var PlaceEdgeComponent = class _PlaceEdgeComponent {
  ...
  async token(edge) {
    const details = await du(edge.id);
  ...
  async remove(i) {
    ...
    const err = await lu(i.id).catch((_) => _);
    details.close();
    if (err)
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceEdgeComponent, selectors: [["", "admin-edge", ""]], decls: 29, vars: 43, consts: [["name_template", ""], ["time_template", ""], ["bool_template", ""], ["description_template", ""], ["actions_template", ""], ["matRipple", "", 1, "border-base-200", "bg-base-100", "absolute", "top-4", "right-4", "flex", "max-w-[calc(100%-11rem)]", "cursor-pointer", "items-center", "overflow-hidden", "rounded-sm", "border", "shadow-sm", 3, "matTooltip"], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["icon", "", "default", "", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-5xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], ["matRipple", "", 1, "border-base-200", "bg-base-100", "absolute", "top-4", "right-4", "flex", "max-w-[calc(100%-11rem)]", "cursor-pointer", "items-center", "overflow-hidden", "rounded-sm", "border", "shadow-sm", 3, "click", "matTooltip"], [1, "border-base-200", "flex", "h-full", "w-1/2", "flex-1", "items-center", "border-r", "p-2"], [1, "flex-1", "truncate"], [1, "rounded-none"], [1, "flex", "flex-col", "px-4", "py-2"], [1, "text-xs", "opacity-30"], [1, "flex", "flex-col", "p-4"], ["matTooltipPosition", "right", 1, "flex", "h-full", "w-full", "items-center", "justify-center", 3, "matTooltip"], [1, "h-3", "w-3", "rounded-full"], [1, "w-full", "overflow-hidden", "px-4", "py-2", "text-xs", "select-text"], [1, "opacity-30"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function PlaceEdgeComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(13, "mat-progress-bar", 12)(14, "simple-table", 13);
      \u0275\u0275pipe(15, "translate");
      \u0275\u0275pipe(16, "translate");
      \u0275\u0275pipe(17, "translate");
      \u0275\u0275pipe(18, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(19, PlaceEdgeComponent_ng_template_19_Template, 5, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(21, PlaceEdgeComponent_ng_template_21_Template, 4, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(23, PlaceEdgeComponent_ng_template_23_Template, 3, 7, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(25, PlaceEdgeComponent_ng_template_25_Template, 3, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(27, PlaceEdgeComponent_ng_template_27_Template, 9, 6, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const name_template_r11 = \u0275\u0275reference(20);
      const time_template_r12 = \u0275\u0275reference(22);
      const bool_template_r13 = \u0275\u0275reference(24);
      const description_template_r14 = \u0275\u0275reference(26);
      const actions_template_r15 = \u0275\u0275reference(28);
      \u0275\u0275conditional(ctx.last_change()?.x_api_key ? 0 : -1);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 10, "ADMIN.EDGE_HEADER"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(8, 12, "ADMIN.EDGE_ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(9, 14, "ADMIN.EDGE_ADD"));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.edges())("columns", \u0275\u0275pureFunction5(37, _c5, \u0275\u0275pureFunction1(24, _c0, bool_template_r13), \u0275\u0275pureFunction2(26, _c1, \u0275\u0275pipeBind1(15, 16, "COMMON.FIELD_NAME"), name_template_r11), \u0275\u0275pureFunction2(29, _c2, \u0275\u0275pipeBind1(16, 18, "COMMON.FIELD_DESCRIPTION"), description_template_r14), \u0275\u0275pureFunction2(32, _c3, \u0275\u0275pipeBind1(17, 20, "COMMON.LAST_SEEN"), time_template_r12), \u0275\u0275pureFunction1(35, _c4, actions_template_r15)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(18, 22, "ADMIN.EDGE_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceEdgeComponent, { className: "PlaceEdgeComponent", filePath: "src/app/admin/edge.component.ts", lineNumber: 190 });
})();
export {
  PlaceEdgeComponent
};
//# sourceMappingURL=chunk-YGXIXA7I.js.map
