...
var BrokerFormComponent = class _BrokerFormComponent extends AsyncHandler {
  ...
  async submit() {
    await submit(this.form, async () => {
      ...
      const result = await (form_item.id ? Oo(form_item.id, form_item) : wo(form_item)).catch(async (err) => {
...
//# sourceMappingURL=chunk-WPIVI4YM.js.map
