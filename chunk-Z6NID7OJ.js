...
var SignagePluginEmbedComponent = class _SignagePluginEmbedComponent extends AsyncHandler {
  ...
  send(type, payload = null) {
    this._plugin_el()?.nativeElement?.contentWindow.postMessage({ api: SIGNAGE_PLUGIN_API_VERSION, type, payload }, this.plugin_origin());
  }
  _setupChannels() {
    if (!this.plugin()?.uri)
      return;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePluginEmbedComponent, { className: "SignagePluginEmbedComponent", filePath: "src/app/admin/signage-plugins/signage-plugin-embed.component.ts", lineNumber: 100 });
})();
...
// src/app/admin/signage-plugins/signage-plugin-import-modal.component.ts
var _c02 = ["repository_search"];
var _c1 = () => ({ standalone: true });
var _c2 = () => ({ name: "repositories" });
var _forTrack0 = ($index, $item) => $item.id;
var _forTrack1 = ($index, $item) => $item.uri;
function SignagePluginImportModalComponent_For_17_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", repo_r1.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", repo_r1.name, " ");
  }
}
function SignagePluginImportModalComponent_For_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 14);
    \u0275\u0275listener("click", function SignagePluginImportModalComponent_For_21_Template_button_click_0_listener() {
      const probe_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.selectPlugin(probe_r4));
    });
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "icon", 19);
    \u0275\u0275text(9, "chevron_right");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const probe_r4 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", probe_r4.details.plugin.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", probe_r4.uri, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", probe_r4.details.plugin.type, " ");
  }
}
function SignagePluginImportModalComponent_ForEmpty_22_Template(rf, ctx) {
  if (rf & 1) {
...
var PROBE_LIMIT = 6;
var SignagePluginImportModalComponent = class _SignagePluginImportModalComponent extends AsyncHandler {
  _repository_search_el = viewChild(
    "repository_search",
    ...ngDevMode ? [{ debugName: "_repository_search_el" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  repositories = signal(
    [],
    ...ngDevMode ? [{ debugName: "repositories" }] : (
      /* istanbul ignore next */
      []
    )
  );
  repository_id = signal(
    "",
    ...ngDevMode ? [{ debugName: "repository_id" }] : (
      /* istanbul ignore next */
      []
    )
  );
  repository_filter = signal(
    "",
    ...ngDevMode ? [{ debugName: "repository_filter" }] : (
      /* istanbul ignore next */
      []
    )
  );
  /** Repositories that match the search. The selected one always shows. */
  filtered_repositories = computed(
    () => {
      const search = this.repository_filter().trim().toLowerCase();
      if (!search)
        return this.repositories();
      const selected = this.repository_id();
      return this.repositories().filter((repo) => repo.id === selected || repo.name.toLowerCase().includes(search));
    },
    ...ngDevMode ? [{ debugName: "filtered_repositories" }] : (
      /* istanbul ignore next */
      []
    )
  );
  loading_files = signal(
    false,
    ...ngDevMode ? [{ debugName: "loading_files" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  async ngOnInit() {
    try {
      ...
      this.repositories.set(data.filter((repo) => repo.repo_type === Ms.Interface));
    } catch (err) {
  ...
  setRepositoryOpen(open) {
    ...
    this.timeout("focus_repository_search", () => this._repository_search_el()?.nativeElement.focus());
  }
  ...
  async selectRepository(id) {
    ...
    let files = [];
    try {
      files = await Xc(id, { pattern: "*.html" });
    } catch (err) {
    ...
    await forEachWithLimit(files, PROBE_LIMIT, async (uri) => {
      ...
      if (controller.signal.aborted)
        return;
      this.probes.update((list) => list.map((probe) => probe.uri === uri ? {
        uri,
        details,
  ...
  _notifyError(err) {
    notifyError(i18n("ADMIN.SIGNAGE_PLUGINS_IMPORT_ERROR", {
      error: JSON.stringify(err.response || err.message || err)
    }));
  }
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275SignagePluginImportModalComponent_BaseFactory;
    return function SignagePluginImportModalComponent_Factory(__ngFactoryType__) {
      return (\u0275SignagePluginImportModalComponent_BaseFactory || (\u0275SignagePluginImportModalComponent_BaseFactory = \u0275\u0275getInheritedFactory(_SignagePluginImportModalComponent)))(__ngFactoryType__ || _SignagePluginImportModalComponent);
    };
  })();
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePluginImportModalComponent, selectors: [["signage-plugin-import-modal"]], viewQuery: function SignagePluginImportModalComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx._repository_search_el, _c02, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance();
    }
  }, features: [\u0275\u0275InheritDefinitionFeature], decls: 23, vars: 25, consts: [["repository_search", ""], [1, "bg-base-200", "mx-2", "mt-2", "flex", "items-center", "justify-between", "rounded-sm", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "h-[65vh]", "w-lg", "max-w-[calc(100vw-2rem)]", "flex-col", "px-4", "pt-4"], ["appearance", "outline", 1, "w-full"], [3, "valueChange", "openedChange", "placeholder", "value"], [1, "bg-base-100", "sticky", "-top-2", "z-20"], ["type", "search", "name", "repository-search", 1, "option-search-input", "focus:bg-info/10", "pointer-events-auto", "absolute", "inset-1", "h-auto", "cursor-text", "rounded-sm", "p-4", 3, "ngModelChange", "mousedown", "click", "keydown", "ngModel", "ngModelOptions", "placeholder"], [3, "value"], [3, "mode", "value"], [1, "flex-1", "space-y-2", "overflow-auto", "py-2"], ["matRipple", "", 1, "border-base-300", "hover:bg-base-200", "flex", "w-full", "items-center", "gap-4", "rounded-sm", "border", "px-4", "py-2", "text-left"], [1, "bg-base-200", "rounded-sm", "p-8", "text-center", "text-sm", "opacity-60"], ["matRipple", "", 1, "border-base-300", "hover:bg-base-200", "flex", "w-full", "items-center", "gap-4", "rounded-sm", "border", "px-4", "py-2", "text-left", 3, "click"], [1, "min-w-0", "flex-1"], [1, "truncate", "font-medium"], [1, "truncate", "font-mono", "text-xs", "opacity-60"], [1, "text-xs", "uppercase", "opacity-60"], [1, "text-xl"]], template: function SignagePluginImportModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "close");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(7, "main", 4)(8, "mat-form-field", 5)(9, "mat-select", 6);
      \u0275\u0275pipe(10, "translate");
      \u0275\u0275listener("valueChange", function SignagePluginImportModalComponent_Template_mat_select_valueChange_9_listener($event) {
        return ctx.selectRepository($event);
      })("openedChange", function SignagePluginImportModalComponent_Template_mat_select_openedChange_9_listener($event) {
        return ctx.setRepositoryOpen($event);
      });
      \u0275\u0275elementStart(11, "mat-option", 7)(12, "input", 8, 0);
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275pipe(15, "translate");
      \u0275\u0275listener("ngModelChange", function SignagePluginImportModalComponent_Template_input_ngModelChange_12_listener($event) {
        return ctx.repository_filter.set($event);
      })("mousedown", function SignagePluginImportModalComponent_Template_input_mousedown_12_listener($event) {
        return $event.stopPropagation();
      })("click", function SignagePluginImportModalComponent_Template_input_click_12_listener($event) {
        return $event.stopPropagation();
      })("keydown", function SignagePluginImportModalComponent_Template_input_keydown_12_listener($event) {
        return $event.stopPropagation();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275controlCreate();
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(16, SignagePluginImportModalComponent_For_17_Template, 2, 2, "mat-option", 9, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(18, "mat-progress-bar", 10);
      \u0275\u0275elementStart(19, "div", 11);
      \u0275\u0275repeaterCreate(20, SignagePluginImportModalComponent_For_21_Template, 10, 3, "button", 12, _forTrack1, false, SignagePluginImportModalComponent_ForEmpty_22_Template, 3, 3, "div", 13);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 12, "ADMIN.SIGNAGE_PLUGINS_IMPORT"), " ");
      \u0275\u0275advance(7);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(10, 14, "ADMIN.SIGNAGE_PLUGINS_IMPORT_REPOSITORY"))("value", ctx.repository_id());
      \u0275\u0275advance(3);
      \u0275\u0275property("ngModel", ctx.repository_filter())("ngModelOptions", \u0275\u0275pureFunction0(22, _c1))("placeholder", \u0275\u0275pipeBind2(14, 16, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction0(23, _c2)));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(15, 19, "COMMON.SEARCH_FOR", \u0275\u0275pureFunction0(24, _c2)));
      \u0275\u0275control();
      \u0275\u0275advance(4);
      \u0275\u0275repeater(ctx.filtered_repositories());
      \u0275\u0275advance(2);
      \u0275\u0275classProp("opacity-0", !ctx.loading_files() && ctx.progress() >= 100);
      \u0275\u0275property("mode", ctx.loading_files() ? "indeterminate" : "determinate")("value", ctx.progress());
      \u0275\u0275advance(2);
    ...
    MatOption,
    TranslatePipe
  ], styles: ["\n.option-search-input[_ngcontent-%COMP%] {\n  width: calc(100% - 0.5rem);\n  outline: none;\n}\n.option-search-input[_ngcontent-%COMP%]::placeholder {\n  color: var(--base-400, currentColor);\n  opacity: 0.65;\n}\n/*# sourceMappingURL=signage-plugin-import-modal.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SignagePluginImportModalComponent, [{
    type: Component,
    args: [{ selector: "signage-plugin-import-modal", template: `
        <div
    ...
    `, imports: [
      ...
      MatSelectModule,
      TranslatePipe
    ], styles: ["/* angular:styles/component:css;3b46df56f0a5e3974cdadd860fc19de61797233e1e86004c5c25e4e286271137;/home/runner/work/backoffice/backoffice/src/app/admin/signage-plugins/signage-plugin-import-modal.component.ts */\n.option-search-input {\n  width: calc(100% - 0.5rem);\n  outline: none;\n}\n.option-search-input::placeholder {\n  color: var(--base-400, currentColor);\n  opacity: 0.65;\n}\n/*# sourceMappingURL=signage-plugin-import-modal.component.css.map */\n"] }]
  }], null, { _repository_search_el: [{ type: ViewChild, args: ["repository_search", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePluginImportModalComponent, { className: "SignagePluginImportModalComponent", filePath: "src/app/admin/signage-plugins/signage-plugin-import-modal.component.ts", lineNumber: 162 });
})();
...
function SchemaFormComponent_Conditional_0_For_2_Case_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const field_r2 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngModel", ctx_r2.fieldValue(field_r2.key))("disabled", ctx_r2.disabled())("ngModelOptions", \u0275\u0275pureFunction0(5, _c03));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function SchemaFormComponent_Conditional_0_For_2_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(7, SchemaFormComponent_Conditional_0_For_2_Case_1_For_8_Template, 2, 2, "mat-option", 6, _forTrack12);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", field_r2.label, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(field_r2.required && ctx_r2.enforce_required() ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(field_r2.description ? 4 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.fieldValue(field_r2.key))("disabled", ctx_r2.disabled())("ngModelOptions", \u0275\u0275pureFunction0(7, _c03));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function SchemaFormComponent_Conditional_0_For_2_Case_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(field_r2.description ? 4 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.fieldValue(field_r2.key))("disabled", ctx_r2.disabled())("ngModelOptions", \u0275\u0275pureFunction0(8, _c03))("placeholder", field_r2.label);
    \u0275\u0275control();
  }
}
...
function SchemaFormComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SchemaFormComponent_Conditional_0_For_2_Template, 4, 1, null, null, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var SchemaFormComponent = class _SchemaFormComponent {
  ...
  enforce_required = input(
    true,
    ...ngDevMode ? [{ debugName: "enforce_required" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SchemaFormComponent, selectors: [["schema-form"]], inputs: { schema: [1, "schema"], enforce_required: [1, "enforce_required"] }, features: [\u0275\u0275ProvidersFeature([
    {
...
(() => {
  ...
  }], () => [], { schema: [{ type: Input, args: [{ isSignal: true, alias: "schema", required: false }] }], enforce_required: [{ type: Input, args: [{ isSignal: true, alias: "enforce_required", required: false }] }] });
})();
(() => {
...
function SignagePluginModalComponent_Conditional_2_Conditional_59_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("schema", ctx_r0.schema())("enforce_required", false)("formField", ctx_r0.form.defaults);
    \u0275\u0275control();
  }
}
...
function SignagePluginModalComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(59, SignagePluginModalComponent_Conditional_2_Conditional_59_Template, 3, 3, "div", 21);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.has_schema() ? 59 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.schema_loading() && !ctx_r0.has_schema() && !ctx_r0.schema_error() ? 60 : -1);
  }
}
...
var SignagePluginModalComponent = class _SignagePluginModalComponent extends AsyncHandler {
  ...
  has_schema = computed(
    ...
    ...ngDevMode ? [{ debugName: "has_schema" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  async submit() {
    ...
    await submit(this.form, async () => {
      ...
      const payload = __spreadProps(__spreadValues(__spreadValues({}, this._data.item), values), {
        params: schema ?? this._data.item?.params ?? {},
        // Only keep defaults for parameters in the loaded source schema.
        defaults: schema ? Object.fromEntries(Object.entries(values.defaults).filter(([key]) => Object.prototype.hasOwnProperty.call(schema.properties || {}, key))) : values.defaults
      });
      try {
  ...
  _loadPlugin(uri) {
    ...
    this.schema_error.set(false);
    this.embed_plugin.set(new mr({ uri }));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePluginModalComponent, { className: "SignagePluginModalComponent", filePath: "src/app/admin/signage-plugins/signage-plugin-modal.component.ts", lineNumber: 253 });
})();
...
var _c22 = (a0, a1) => ({ key: "plugin_type", name: a0, content: a1, size: "7rem" });
...
function AdminSignagePluginsComponent_ng_template_28_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminSignagePluginsComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, AdminSignagePluginsComponent_ng_template_28_Conditional_2_Template, 3, 3, "span", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminSignagePluginsComponent_ng_template_32_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminSignagePluginsComponent_ng_template_32_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminSignagePluginsComponent_ng_template_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, AdminSignagePluginsComponent_ng_template_32_Conditional_0_Template, 3, 0, "div", 17);
    \u0275\u0275conditionalCreate(1, AdminSignagePluginsComponent_ng_template_32_Conditional_1_Template, 3, 0, "div", 18);
  }
  if (rf & 2) {
...
function AdminSignagePluginsComponent_ng_template_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 21)(1, "button", 22);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function AdminSignagePluginsComponent_ng_template_34_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function AdminSignagePluginsComponent_ng_template_34_Template_button_click_5_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r6 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("click", function AdminSignagePluginsComponent_ng_template_34_Template_button_click_9_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r6 = \u0275\u0275nextContext();
...
var AdminSignagePluginsComponent = class _AdminSignagePluginsComponent extends AsyncHandler {
  ...
  importPlugin() {
    const ref = this._dialog.open(SignagePluginImportModalComponent);
    this.subscription("import_events", ref.afterClosed().subscribe((item) => {
      if (item)
        this.newPlugin(item);
    }));
  }
  newPlugin(item = new mr()) {
  ...
  editPlugin(item) {
    const ref = this._dialog.open(SignagePluginModalComponent, {
      data: {
        item,
        save: (updated) => cl(item.id, updated)
      }
    });
    this.subscription("modal_events", ref.afterClosed().subscribe((event) => {
      if (event?.reason !== "done")
  ...
  async deletePlugin(item) {
    ...
    const err = await hl(item.id).catch((_) => _);
    details.close();
    if (err)
  ...
  async loadPlugins() {
    ...
    try {
      const plugins = await ol().then((r) => r.data);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminSignagePluginsComponent, selectors: [["admin-signage-plugins"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 36, vars: 62, consts: [["mono_template", ""], ["description_template", ""], ["type_template", ""], ["enabled_template", ""], ["actions_template", ""], [1, "flex", "h-full", "w-full", "flex-col"], [1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], ["icon", "", "default", "", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-4"], ["mode", "indeterminate", 1, "w-full"], [1, "block", "min-w-6xl", "text-sm", 3, "data", "columns", "sortable", "empty_message"], [1, "max-w-[50vw]", "truncate", "p-4", "font-mono", "text-xs"], [1, "p-4", "text-xs"], [1, "opacity-30"], [1, "p-4", "text-xs", "uppercase"], [1, "bg-success", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "bg-error", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm"], [1, "text-success-content", "text-2xl"], [1, "text-error-content", "text-2xl"], [1, "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AdminSignagePluginsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function AdminSignagePluginsComponent_Template_button_click_6_listener() {
        return ctx.importPlugin();
      });
      \u0275\u0275elementStart(9, "icon");
      \u0275\u0275text(10, "travel_explore");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(11, "button", 9);
      \u0275\u0275pipe(12, "translate");
      \u0275\u0275pipe(13, "translate");
      \u0275\u0275listener("click", function AdminSignagePluginsComponent_Template_button_click_11_listener() {
      ...
      \u0275\u0275element(17, "mat-progress-bar", 11)(18, "simple-table", 12);
      \u0275\u0275pipe(19, "translate");
      \u0275\u0275pipe(20, "translate");
      \u0275\u0275pipe(21, "translate");
      \u0275\u0275pipe(22, "translate");
      ...
      \u0275\u0275pipe(25, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(26, AdminSignagePluginsComponent_ng_template_26_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(28, AdminSignagePluginsComponent_ng_template_28_Template, 3, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(30, AdminSignagePluginsComponent_ng_template_30_Template, 2, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(32, AdminSignagePluginsComponent_ng_template_32_Template, 2, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(34, AdminSignagePluginsComponent_ng_template_34_Template, 13, 9, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const mono_template_r8 = \u0275\u0275reference(27);
      const description_template_r9 = \u0275\u0275reference(29);
      const type_template_r10 = \u0275\u0275reference(31);
      const enabled_template_r11 = \u0275\u0275reference(33);
      const actions_template_r12 = \u0275\u0275reference(35);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 11, "ADMIN.SIGNAGE_PLUGINS_HEADER"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(7, 13, "ADMIN.SIGNAGE_PLUGINS_IMPORT"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(8, 15, "ADMIN.SIGNAGE_PLUGINS_IMPORT"));
      \u0275\u0275advance(5);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(12, 17, "ADMIN.SIGNAGE_PLUGINS_ADD"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 19, "ADMIN.SIGNAGE_PLUGINS_ADD"));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("opacity-0", !ctx.loading());
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.plugins())("columns", \u0275\u0275pureFunction7(54, _c7, \u0275\u0275pureFunction1(35, _c05, \u0275\u0275pipeBind1(19, 21, "COMMON.FIELD_NAME")), \u0275\u0275pureFunction2(37, _c12, \u0275\u0275pipeBind1(20, 23, "COMMON.FIELD_DESCRIPTION"), description_template_r9), \u0275\u0275pureFunction2(40, _c22, \u0275\u0275pipeBind1(21, 25, "ADMIN.SIGNAGE_PLUGINS_FIELD_TYPE"), type_template_r10), \u0275\u0275pureFunction2(43, _c3, \u0275\u0275pipeBind1(22, 27, "ADMIN.SIGNAGE_PLUGINS_FIELD_URI"), mono_template_r8), \u0275\u0275pureFunction2(46, _c4, \u0275\u0275pipeBind1(23, 29, "ADMIN.SIGNAGE_PLUGINS_FIELD_PLAYBACK_TYPE"), type_template_r10), \u0275\u0275pureFunction2(49, _c5, \u0275\u0275pipeBind1(24, 31, "ADMIN.SIGNAGE_PLUGINS_FIELD_ENABLED"), enabled_template_r11), \u0275\u0275pureFunction1(52, _c6, actions_template_r12)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(25, 33, "ADMIN.SIGNAGE_PLUGINS_LIST_EMPTY"));
    }
  }, dependencies: [
    IconComponent,
    MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminSignagePluginsComponent, { className: "AdminSignagePluginsComponent", filePath: "src/app/admin/signage-plugins/signage-plugins.component.ts", lineNumber: 208 });
})();
export {
  AdminSignagePluginsComponent
};
//# sourceMappingURL=chunk-Z6NID7OJ.js.map
