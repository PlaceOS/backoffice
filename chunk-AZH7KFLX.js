...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FunctionArgumentComponent, { className: "FunctionArgumentComponent", filePath: "src/app/ui/custom-fields/system-exec/function-argument.component.ts", lineNumber: 121 });
})();
...
var SelectMethodComponent = class _SelectMethodComponent extends AsyncHandler {
  ...
  _method_list = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_method_list" } : (
    ...
    loader: async ({ params }) => {
      ...
      try {
        const fn_mapping = await ua(id, module.module, module.index).catch(() => ({}));
...
//# sourceMappingURL=chunk-AZH7KFLX.js.map
