  ...
  return s.prototype.unsubscribe = function() {
    ...
    if (!this.closed) {
      ...
      if ($) {
        ...
        try {
          for (var m = nt($), v = m.next(); !v.done; v = m.next()) {
            var Kt = v.value;
            try {
              bt(Kt);
            } catch (y) {
...
var pt = (function(s) {
  ...
  function e(t) {
    ...
    return r.isStopped = false, t ? (r.destination = t, $t(t) && t.add(r)) : r.destination = te, r;
  }
...
function re(s) {
  return s.length === 0 ? zt : s.length === 1 ? s[0] : function(t) {
...
var lt = (function() {
  ...
  return s.prototype.lift = function(e) {
    ...
    var i = this, n = ie(e) ? e : new ut(e, t, r);
    return B(function() {
...
function vt(s) {
  var e;
  return (e = s ?? Jt.Promise) !== null && e !== void 0 ? e : Promise;
}
function se(s) {
  return s && P(s.next) && P(s.error) && P(s.complete);
}
function ie(s) {
  return s && s instanceof pt || se(s) && $t(s);
}
var ne = (function(s) {
  L(e, s);
...
var Ot = (function(s) {
  ...
  return e.prototype.lift = function(t) {
    ...
    return n || o ? At : (this.currentObservers = null, a.push(t), new J(function() {
...
var wt = (function(s) {
  ...
  return e.prototype.next = function(t) {
    ...
    var r, i;
    return (i = (r = this.source) === null || r === void 0 ? void 0 : r.subscribe(t)) !== null && i !== void 0 ? i : At;
  }, e;
})(Ot);
var he = new lt(function(s) {
  return s.complete();
});
var Lt = _t(function(s) {
  return function() {
...
var g = class _g {
  ...
  static _hex(e) {
    const t = _g.hexChars, r = _g.hexOut;
    let i, n, o, a;
    for (a = 0; a < 4; a += 1)
   ...
   */
    ...
    if (r[t] = 128, r[t + 1] = r[t + 2] = r[t + 3] = 0, i.set(_g.buffer32Identity.subarray(n), n), t > 55 && (_g._md5cycle(this._state, i), i.set(_g.buffer32Identity)), o <= 4294967295)
      i[14] = o;
    else {
      const a = o.toString(16).match(/(.*?)(.{0,8})$/);
      if (a === null) return e ? pe : "";
...
function Ee(s) {
  return s === Et.name ? Et : s === Ut.name ? Ut : s === dt.name ? dt : s === kt.name ? kt : (console.warn(`[UPLOADS] Unknown provider: "${s}", using EMPTY_PROVIDER`), Se);
}
...
function ke(s) {
  console.debug("[UPLOADS] Set an API key"), V = "API_KEY", Nt = s;
}
function xe() {
  return V === "API_KEY" ? { "x-api-key": Nt } : { Authorization: `Bearer ${V}` };
}
function j() {
...
async function Ae(s, e) {
  ...
  if (r.type === "direct_upload")
    return console.debug(`[UPLOADS] Direct upload for ${e.name}`), xt(
      r.upload_id,
      e,
      i,
      "",
...
var W = [];
var Ht = "/node_modules/ts-md5/dist/md5_worker.js";
function Le(s = Ht, e) {
...
async function qe(s) {
  ...
  try {
    const n = (await e.hash(s)).replace(/[^0-9a-fA-F]/g, ""), o = window.btoa(Bt(n));
...
async function Wt() {
  ...
  try {
    const i = A.get(`${e.id}:${s.part}`)?.base64 ?? "", n = mt(
      e.file,
    ...
    await Re(a, h);
    const c = e.state.getValue(), f = [...c.completed, s.part].sort(
      (m, v) => m - v
    ), $ = c.working.filter((m) => m !== s.part);
    if (d(e, {
      completed: f,
      working: $,
      progress: Math.round(f.length / n * 100)
    }), f.length === n)
      try {
        await je(e);
      } catch (m) {
...
async function gt(s, e = 1) {
  ...
  const n = /* @__PURE__ */ new Set(), o = async (a) => {
    ...
    if (!A.has(h)) {
      ...
      A.set(h, m), console.debug(`[UPLOADS] Part ${a}/${t} hash cached`);
    }
    const c = (a - 1) * s.provider.part_size, f = Math.min(
...
async function er(s, e = {}) {
  ...
  const o = (await i.hash(s.slice())).replace(/[^0-9a-fA-F]/g, ""), a = await Ae(
    {
      file_size: s.size,
      file_name: s.name,
      file_mime: s.type,
      file_id: window.btoa(Bt(o)),
      permissions: t,
      public: r
    },
    s
...
//# sourceMappingURL=chunk-5XL4QLJK.js.map
