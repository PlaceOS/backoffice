...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-NSEXAPYT.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-W262G6MZ.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-5K3OXLGI.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "brokers",
        loadComponent: () => import("./chunk-SARETJ3V.js").then((m) => m.AdminBrokersComponent)
      },
      {
        path: "edge",
      ...
      {
        path: "extensions",
        loadComponent: () => import("./chunk-TVCKQTRQ.js").then((m) => m.PlaceExtensionsComponent)
      },
      {
        path: "staff-api",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-YY2625SZ.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
...
//# sourceMappingURL=chunk-XHBHOQDR.js.map
