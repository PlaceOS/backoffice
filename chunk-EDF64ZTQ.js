...
var ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-K26QYN6Y.js").then((m) => m.PlaceComponent),
    canActivate: [AuthorisedAdminGuard],
    children: [
      {
        path: "about",
        loadComponent: () => import("./chunk-CB5VMAVQ.js").then((m) => m.PlaceDetailsComponent)
      },
      {
        path: "database",
      ...
      {
        path: "clusters",
        loadComponent: () => import("./chunk-PH2BSWAV.js").then((m) => m.PlaceClusterDetailsComponent)
      },
      {
        path: "clusters/:id",
      ...
      {
        path: "schemas",
        loadComponent: () => import("./chunk-VCWDYXC4.js").then((m) => m.AdminSchemasComponent)
      },
      {
        path: "api-keys",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-Z6NID7OJ.js").then((m) => m.AdminSignagePluginsComponent)
      },
      {
        path: "build-jobs",
...
//# sourceMappingURL=chunk-EDF64ZTQ.js.map
