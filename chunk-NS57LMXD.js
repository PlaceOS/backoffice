...
var BasicLineGraphComponent = class _BasicLineGraphComponent extends AsyncHandler {
  ...
  }, inputs: { lines: [1, "lines"] }, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c1, decls: 2, vars: 0, consts: [["canvas", ""], [1, "h-full", "w-full", "text-base-content"]], template: function BasicLineGraphComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BasicLineGraphComponent, { className: "BasicLineGraphComponent", filePath: "src/app/ui/basic-line-graph.component.ts", lineNumber: 36 });
})();
...
var AdminClusterNodeComponent = class _AdminClusterNodeComponent {
  ...
  used_memory = computed(() => {
    return vt((this.node()?.memory_usage || 0) * 1024).replace("GB", "").replace("MB", "").trim();
  }, ...ngDevMode ? [{ debugName: "used_memory" }] : []);
  total_memory = computed(() => {
    return vt((this.node()?.memory_total || 0) * 1024);
  ...
  }, inputs: { show_name: [1, "show_name"], node: [1, "node"], history: [1, "history"] }, features: [\u0275\u0275NgOnChangesFeature], decls: 22, vars: 18, consts: [[1, "mb-2", "h-36", "w-full", "rounded-sm", "border", "border-base-300", "p-2"], ["basic-line-graph", "", 1, "h-full", "w-full", 3, "lines"], [1, "memory-utilisation"], [1, "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-1", "rounded-sm", "border", "border-base-300", "p-1"], [1, "mono", "text-4xl", "font-medium"], [1, "mono", "w-36", "text-center", "text-xs"]], template: function AdminClusterNodeComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var PlaceClusterDetailsComponent = class _PlaceClusterDetailsComponent extends AsyncHandler {
  ...
  clusters$ = interval(2 * 1e3).pipe(startWith(0), filter(() => !this.loading()), switchMap(() => {
    ...
    return Xs({ include_status: false }).pipe(catchError((_) => ({ data: [] })));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaceClusterDetailsComponent, selectors: [["engine-cluster-details"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 7, vars: 4, consts: [[1, "my-4", "flex", "items-center", "justify-between", "space-x-2", "px-4"], [1, "text-2xl"], [1, "flex", "max-h-full", "flex-wrap", "overflow-auto"], [1, "px-2"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-8", "opacity-30"], [1, "m-2", "space-y-2", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", "shadow-sm"], [1, "mono", "mb-2", "rounded-sm", "bg-base-200", "p-2", "text-lg", "font-medium", "uppercase"], [3, "show_name", "node", "history"], ["btn", "", "matRipple", "", 1, "w-full", 3, "routerLink"], [1, "text-8xl"], [1, "text"]], template: function PlaceClusterDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaceClusterDetailsComponent, { className: "PlaceClusterDetailsComponent", filePath: "src/app/admin/cluster-details/cluster-details.component.ts", lineNumber: 92 });
})();
export {
  PlaceClusterDetailsComponent
};
//# sourceMappingURL=chunk-NS57LMXD.js.map
