import {
  UserPipe
} from "./chunk-XGUVANTT.js";
import {
  SettingsFieldComponent
} from "./chunk-YZU3SQA7.js";
import {
  DiffViewerComponent
} from "./chunk-LBA4CEEC.js";
import {
  openConfirmModal
...
var MetadataHistoryModalComponent = class _MetadataHistoryModalComponent {
  ...
  second = signal(
    null,
    ...ngDevMode ? [{ debugName: "second" }] : (
      /* istanbul ignore next */
      []
    )
  );
  first_details = signal(
    "",
    ...ngDevMode ? [{ debugName: "first_details" }] : (
      /* istanbul ignore next */
      []
    )
  );
  second_details = signal(
    "",
    ...ngDevMode ? [{ debugName: "second_details" }] : (
      /* istanbul ignore next */
      []
    )
  );
  ...
  select(idx, item) {
    if (idx === 0) {
      this.first_details.set(JSON.stringify(item.details, void 0, 4));
      if (this.first === this.second()) {
        this.second.set(null);
        this.second_details.set("");
      }
    } else {
      this.second_details.set(JSON.stringify(item.details, void 0, 4));
    }
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MetadataHistoryModalComponent, { className: "MetadataHistoryModalComponent", filePath: "src/app/overlays/metadata-history-modal.component.ts", lineNumber: 170 });
})();
...
function MetadataDisplayComponent_Conditional_9_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(9, 20, \u0275\u0275pipeBind1(8, 18, item_r2.modified_by_id))?.name);
    \u0275\u0275advance(3);
...
var MetadataDisplayComponent = class _MetadataDisplayComponent extends AsyncHandler {
  ...
  async deleteMetadata(field) {
    ...
    if (result.reason !== "done")
      return;
    await uc(this.item().id, { name: field }).catch((err) => {
  ...
  saveMetadata(field) {
    ...
    rc(this.item().id, __spreadProps(__spreadValues({}, value), {
      ...
      if (field.name !== value.name) {
        uc(this.item().id, { name: field.name }).catch((err) => notifyError(`Error removing old "${field.name}" metadata. Error: ${JSON.stringify(err.response || err.message || err)}`));
      }
      if (index >= 0) {
        this.metadata.update((l) => {
  ...
  async loadMetadata() {
    ...
    await nc(this.item().id).then((map) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MetadataDisplayComponent, { className: "MetadataDisplayComponent", filePath: "src/app/ui/metadata-display.component.ts", lineNumber: 231 });
})();

export {
  MetadataDisplayComponent
};
//# sourceMappingURL=chunk-B5BDGJU4.js.map
