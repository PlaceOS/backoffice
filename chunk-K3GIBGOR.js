...
function ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 28);
    \u0275\u0275listener("click", function ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_1_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r6);
...
function ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 22);
  }
}
function ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275conditionalCreate(1, ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_1_Template, 3, 2, "button", 21)(2, ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_2_Template, 1, 0, "span", 22);
    \u0275\u0275elementStart(3, "a", 23);
    \u0275\u0275listener("click", function ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Template_a_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_7_Template, 2, 1, "span", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Conditional_8_Template, 2, 1, "p", 27);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275styleProp("margin-left", 0.25 + node_r7.depth * 0.5, "rem");
    \u0275\u0275classProp("bg-base-200", $index_r8 % 2 === 1 && ctx_r2.selected_id() !== node_r7.group.id)("active", ctx_r2.selected_id() === node_r7.group.id);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.childCount(node_r7.group) > 0 ? 1 : 2);
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", ctx_r2.subroute() ? \u0275\u0275pureFunction3(11, _c32, ctx_r2.route(), node_r7.group.id, ctx_r2.subroute()) : \u0275\u0275pureFunction2(15, _c42, ctx_r2.route(), node_r7.group.id));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r2.displayName(node_r7.group), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.childCount(node_r7.group) > 0 ? 7 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(node_r7.group.description ? 8 : -1);
  }
}
function ItemSidebarComponent_Conditional_17_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275repeaterCreate(1, ItemSidebarComponent_Conditional_17_Conditional_0_For_2_Template, 9, 18, "div", 18, _forTrack02);
    \u0275\u0275elementStart(3, "div", 19);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.group_tree_items());
    \u0275\u0275advance(3);
...
function ItemSidebarComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ItemSidebarComponent_Conditional_17_Conditional_0_Template, 6, 3, "div", 17)(1, ItemSidebarComponent_Conditional_17_Conditional_1_Template, 4, 6, "div", 11);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function ItemSidebarComponent_Conditional_19_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, ItemSidebarComponent_Conditional_19_ng_template_5_Conditional_5_Template, 2, 1, "div", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, ItemSidebarComponent_Conditional_19_ng_template_5_Conditional_6_Template, 2, 0, "icon", 35);
    \u0275\u0275conditionalCreate(7, ItemSidebarComponent_Conditional_19_ng_template_5_Conditional_7_Template, 4, 3, "div", 36);
    \u0275\u0275conditionalCreate(8, ItemSidebarComponent_Conditional_19_ng_template_5_Conditional_8_Template, 4, 3, "div", 37);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ItemSidebarComponent_Conditional_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const item_display_r13 = \u0275\u0275reference(6);
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("item_size", 72)("items", \u0275\u0275pipeBind1(1, 4, ctx_r2.items))("item_template", item_display_r13);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 6, "COMMON.END_OF_LIST"), " ");
  }
}
...
var ItemSidebarComponent = class _ItemSidebarComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemSidebarComponent, selectors: [["item-sidebar"]], viewQuery: function ItemSidebarComponent_Query(rf, ctx) {
  ...
  }, inputs: { title: [1, "title"], route: [1, "route"], filter_options: [1, "filter_options"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 21, vars: 23, consts: [["search_input", ""], ["item_display", ""], [1, "border-base-200", "bg-base-100", "flex", "h-full", "w-[24rem]", "max-w-[25vw]", "min-w-64", "flex-col", "space-y-2", "overflow-hidden", "rounded-sm", "shadow-sm", "sm:border-r", 3, "click"], [1, "flex", "items-center", "space-x-2", "px-1", "pt-1"], [1, "border-base-300", "relative", "flex", "flex-1", "items-center", "rounded-lg", "border", "shadow-sm"], [1, "pointer-events-none", "absolute", "top-1/2", "left-1", "-translate-y-1/2", "text-2xl"], [1, "w-full", "flex-1", "rounded-lg", "border-none", "bg-transparent", "py-2.5", "pr-4", "pl-9", 3, "ngModelChange", "ngModel", "placeholder"], ["diameter", "24", 1, "absolute", "top-1/2", "right-2", "mr-2", "-translate-y-1/2"], [1, "relative", "flex", "overflow-hidden"], [1, "w-full", "px-2", "text-sm", "opacity-60"], [1, "border-base-200", "flex", "h-1/2", "flex-1", "flex-col", "border-t"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], ["icon", "", "matRipple", ""], [1, "text-2xl"], ["appearance", "outline", 1, "no-subscript", "absolute", "top-1/2", "-right-2", "-translate-y-1/2", "opacity-0"], ["multiple", "", 3, "ngModelChange", "ngModel"], [1, "capitalize", 3, "value"], [1, "h-full", "overflow-auto", "py-1"], [1, "border-base-100", "hover:border-info", "relative", "m-1", "flex", "min-h-16", "max-w-[calc(100%-0.5rem)]", "items-center", "rounded-sm", "border", "py-1", "pr-2", 3, "bg-base-200", "active", "margin-left"], [1, "bg-base-200", "p-2", "text-center", "text-sm", "opacity-30"], [1, "border-base-100", "hover:border-info", "relative", "m-1", "flex", "min-h-16", "max-w-[calc(100%-0.5rem)]", "items-center", "rounded-sm", "border", "py-1", "pr-2"], ["type", "button", "icon", "", "matRipple", "", 1, "h-8", "min-h-8", "w-8", "min-w-8"], [1, "mr-1", "h-8", "w-8", "shrink-0"], [1, "flex", "min-w-0", "flex-1", "flex-col", "justify-center", "rounded-sm", "px-2", "py-1", "no-underline", 3, "click", "routerLink"], [1, "flex", "min-w-0", "items-center", "gap-1"], [1, "min-w-0", "flex-1", "truncate"], [1, "bg-base-200", "-mr-2", "rounded-full", "px-2", "py-0.5", "text-xs"], [1, "w-full", "truncate", "text-xs", "opacity-60"], ["type", "button", "icon", "", "matRipple", "", 1, "h-8", "min-h-8", "w-8", "min-w-8", 3, "click"], [1, "text-xl"], [3, "scrolled", "item_size", "items", "item_template"], ["routerLinkActive", "active", 1, "border-base-100", "hover:border-info", "relative", "m-1", "flex", "h-16", "w-92", "max-w-[calc(100%-0.5rem)]", "flex-col", "justify-center", "rounded-sm", "border", "px-2", "py-1", 3, "click", "routerLink", "matTooltip"], [1, "w-full", "truncate"], [1, "flex", "w-full"], ["extra", "", 1, "mono", "border-base-300", "mt-1", "max-w-full", "truncate", "rounded-sm", "border", "p-1", "text-[0.625rem]", "opacity-60"], [1, "text-info", "absolute", "-top-1", "-right-1", "rotate-12", "text-2xl"], [1, "bg-warning", "text-warning-content", "absolute", "-top-1", "-right-1", "flex", "h-8", "w-8", "rotate-12", "items-center", "justify-center", "rounded-full", "text-2xl", 3, "matTooltip"], [1, "bg-error", "text-error-content", "absolute", "-top-1", "-right-1", "flex", "h-8", "w-8", "rotate-12", "items-center", "justify-center", "rounded-full", "text-2xl", 3, "matTooltip"]], template: function ItemSidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 2);
    ...
    if (rf & 2) {
      ...
      const t_r14 = \u0275\u0275pipeBind1(13, 11, ctx.total);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(15, 13, "COMMON.TOTAL_ITEMS", \u0275\u0275pureFunction1(21, _c22, t_r14), t_r14), " ");
      \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ItemSidebarComponent, [{
    ...
    `, imports: [
      ...
      VirtualScrollComponent,
      MatRippleModule
    ], styles: ["/* angular:styles/component:css;db22299e440acec88e8c42251ce7c5f1a6eb9f60dc2aedcd9975264b2909430c;/home/runner/work/backoffice/backoffice/src/app/ui/item-sidebar.component.ts */\n:host {\n  height: 100%;\n}\nscroll-item:nth-child(2n) > a {\n  background-color: var(--base-200);\n}\n.active {\n  background-color: var(--secondary) !important;\n  color: var(--secondary-content);\n}\n/*# sourceMappingURL=item-sidebar.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSidebarComponent, { className: "ItemSidebarComponent", filePath: "src/app/ui/item-sidebar.component.ts", lineNumber: 348 });
})();
...
//# sourceMappingURL=chunk-K3GIBGOR.js.map
