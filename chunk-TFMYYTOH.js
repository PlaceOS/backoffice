...
var DriverUpdateListModalComponent = class _DriverUpdateListModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DriverUpdateListModalComponent, selectors: [["driver-update-list-modal"]], decls: 10, vars: 7, consts: [[1, "border-base-100", "bg-base-200", "z-10", "mx-auto", "my-2", "w-[calc(100%-1rem)]", "rounded-sm", "border", "px-4", "py-2"], [1, "flex", "items-center", "space-x-4", "text-xl", "font-medium"], [1, "mono", "bg-base-300", "rounded-sm", "px-2", "py-1", "text-xs"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "max-h-[65vh]", "w-[80vw]", "max-w-3xl", "overflow-y-auto"], [1, "flex", "h-48", "w-[20rem]", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "border-base-100", "bg-base-200", "z-10", "mx-auto", "my-2", "flex", "w-[calc(100%-1rem)]", "justify-end", "space-x-2", "rounded-sm", "border", "p-2"], [1, "mx-2", "w-[calc(100%-1rem)]", "rounded-sm"], [1, "sticky", "top-0", "z-10", "text-left"], [1, "bg-base-300!"], [3, "change", "checked", "indeterminate"], [3, "ngModelChange", "ngModel"], [3, "matTooltip"], ["colspan", "4", 1, "opacity-30"], [3, "diameter"], ["btn", "", "matRipple", "", 3, "click", "disabled"]], template: function DriverUpdateListModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DriverUpdateListModalComponent, { className: "DriverUpdateListModalComponent", filePath: "src/app/drivers/driver-update-list-modal.component.ts", lineNumber: 156 });
})();
...
//# sourceMappingURL=chunk-TFMYYTOH.js.map
