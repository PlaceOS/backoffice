...
import {
  ...
  MatChipRow,
  MatChipsModule
} from "./chunk-CUWQT2GL.js";
import {
  DateFromPipe
} from "./chunk-CSI5PWUO.js";
import {
  Clipboard
} from "./chunk-AE4ZXYXF.js";
import {
  HotkeysService
...
import {
  UploadsService
} from "./chunk-5DDHIM3Z.js";
import {
  SettingsToggleComponent
} from "./chunk-TZHB3H2C.js";
import {
  MatInput,
  MatInputModule
...
} from "./chunk-HL4CJJK6.js";
import {
  SettingsService,
  format
} from "./chunk-QS2ZRKNC.js";
import {
  toDate
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSearchFieldComponent, { className: "ItemSearchFieldComponent", filePath: "src/app/ui/custom-fields/item-search-field.component.ts", lineNumber: 207 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DomainFormComponent, { className: "DomainFormComponent", filePath: "src/app/domains/domain-form.component.ts", lineNumber: 271 });
})();
...
function DriverFormComponent_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(4, 10, "DRIVERS.COMMIT_SEARCH"))("options", \u0275\u0275pipeBind1(5, 12, ctx_r1.commit_list))("loading", ctx_r1.loading_type().includes("commits"))("ngModel", ctx_r1.commit.getValue());
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.commit_error() ? 6 : -1);
  }
}
function DriverFormComponent_Conditional_4_Conditional_13_For_7_Template(rf, ctx) {
  if (rf & 1) {
...
function DriverFormComponent_Conditional_4_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(6, DriverFormComponent_Conditional_4_Conditional_13_For_7_Template, 3, 4, "mat-option", 27, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DriverFormComponent_Conditional_4_For_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 27);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function DriverFormComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(13, DriverFormComponent_Conditional_4_Conditional_13_Template, 8, 3, "div", 13);
    ...
    \u0275\u0275repeaterCreate(58, DriverFormComponent_Conditional_4_For_59_Template, 3, 4, "mat-option", 27, _forTrack05);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function DriverFormComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
var DriverFormComponent = class _DriverFormComponent extends AsyncHandler {
  ...
  driver_list = this.repo.pipe(filter((item) => !!item?.id), distinctUntilKeyChanged("id"), tap(() => this.loading_type.update((types) => [...types, "drivers"])), switchMap(({ id }) => Nc(id, { limit: 1e3 }).pipe(catchError(() => of([])))), map((list) => list.map((_) => ({
    id: _,
    name: _.replace(/\//g, " > ")
  }))), tap(() => this.loading_type.update((types) => types.filter((_) => _ !== "drivers"))), shareReplay(1));
  commit_list = combineLatest([this.repo, this.driver]).pipe(filter(([repo, driver]) => !!repo?.id && !!driver?.id), distinctUntilChanged(([prev_repo, prev_driver], [curr_repo, curr_driver]) => prev_repo?.id === curr_repo?.id && prev_driver?.id === curr_driver?.id), tap(() => this.loading_type.update((types) => [...types, "commits"])), switchMap(([{ id }, driver]) => Fc(id, {
    driver: driver.id,
    limit: 1e3
  ...
  async applyDriverCommit(commit) {
    ...
    this.subscription("driver_details", Hc(repo.id, {
      driver: `${driver.id}`,
      commit: `${commit.id}`
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DriverFormComponent, selectors: [["driver-form"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 7, vars: 10, consts: [[3, "save", "heading", "loading"], [1, "flex", "flex-col", 3, "formGroup"], [1, "bg-base-200", "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "px-8", "py-16"], ["for", "repos"], [3, "ngModelChange", "placeholder", "options", "loading", "ngModel"], ["for", "driver"], ["for", "commit"], [1, "text-error", "text-xs"], ["for", "driver-name"], ["required", ""], ["appearance", "outline"], ["matInput", "", "name", "driver-name", "formControlName", "name", "required", "", 3, "placeholder"], [1, "flex", "space-x-4"], [1, "flex", "flex-1", "flex-col"], ["for", "module-name"], ["matInput", "", "name", "module-name", "formControlName", "module_name", "required", "", 3, "placeholder"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 3, "placeholder"], ["for", "default-uri"], ["matInput", "", "name", "default-uri", "formControlName", "default_uri", 3, "placeholder"], [1, "flex", "items-center", "space-x-4"], ["for", "default-port"], ["matInput", "", "name", "default-port", "type", "number", "formControlName", "default_port", 3, "placeholder"], [1, "h-1", "w-full"], ["formControlName", "ignore_connected", 1, "w-full", 3, "name"], ["for", "alert-level"], ["name", "alert-level", "formControlName", "alert_level"], [3, "value"], ["for", "role"], ["name", "role", "formControlName", "role"], [3, "diameter"]], template: function DriverFormComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(\u0275\u0275pipeBind1(3, 6, ctx.driver) ? 2 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(\u0275\u0275pipeBind1(5, 8, ctx.commit) && !ctx.loading() && ctx.form.controls.id ? 4 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.loading() ? 6 : -1);
    }
  }, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModuleFormComponent, { className: "ModuleFormComponent", filePath: "src/app/modules/module-form.component.ts", lineNumber: 351 });
})();
...
function RepositoryFormComponent_Conditional_1_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("blur", function RepositoryFormComponent_Conditional_1_Conditional_5_Template_input_blur_7_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.credentials_blur$.next());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "mat-error");
    \u0275\u0275text(10);
...
var RepositoryFormComponent = class _RepositoryFormComponent extends AsyncHandler {
  ...
  credentials_blur$ = new Subject();
  get hide_uri() {
    return !this.is_interface && this.form.value.id;
  }
  get is_interface() {
    return this.form?.value?.repo_type === Yr.Interface;
  }
  ngOnInit() {
    const item = this._data.item;
    const edit = !!item.id;
  ...
  _setupBranchAndCommitStreams() {
    ...
    const credentials_trigger$ = merge(timer(300), this.credentials_blur$, uri_valid$);
    this.branch_list = credentials_trigger$.pipe(debounceTime(300), tap(() => this.loading_branches.set(true)), switchMap(() => {
      ...
      _.length ? this.form.get("branch").enable() : this.form.get("branch").disable();
    }), shareReplay(1));
    ...
    this.commit_list = merge(timer(300), this.credentials_blur$, uri_valid$, this.form.get("branch").valueChanges).pipe(debounceTime(300), tap(() => this.loading_commits.set(true)), switchMap(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RepositoryFormComponent, { className: "RepositoryFormComponent", filePath: "src/app/repositories/repository-form.component.ts", lineNumber: 425 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ImageListFieldComponent, { className: "ImageListFieldComponent", filePath: "src/app/ui/custom-fields/image-list-field.component.ts", lineNumber: 211 });
})();
...
var SystemFormComponent = class _SystemFormComponent extends AsyncHandler {
  ...
  ngOnInit() {
    ...
    this.subscription("tz-change", this.form.valueChanges.subscribe(({ timezone }) => this.filtered_timezones = this.timezones.filter((_tz) => _tz.toLowerCase().includes(timezone.toLowerCase()))));
    this.subscription("save_item_key", this._hotkey.listen(["KeyS"], () => this.submit()));
  }
  submit() {
    this.form.markAllAsTouched();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SystemFormComponent, { className: "SystemFormComponent", filePath: "src/app/systems/system-form.component.ts", lineNumber: 555 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserFormComponent, { className: "UserFormComponent", filePath: "src/app/users/user-form.component.ts", lineNumber: 387 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneFormComponent, { className: "ZoneFormComponent", filePath: "src/app/zones/zone-form.component.ts", lineNumber: 340 });
})();
...
*/
//# sourceMappingURL=chunk-QQIT5AXK.js.map
