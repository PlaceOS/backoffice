...
} from "./chunk-BMPGM7XW.js";
import {
  SettingsFieldComponent
} from "./chunk-UF4C45PF.js";
import {
  DiffViewerComponent
} from "./chunk-4R3NXDOF.js";
import {
  validateJSONString
...
var MetadataHistoryModalComponent = class _MetadataHistoryModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MetadataHistoryModalComponent, selectors: [["metadata-history-modal"]], decls: 37, vars: 18, consts: [[1, "flex", "h-screen", "w-screen", "flex-col", "overflow-hidden", "bg-base-100"], [1, "m-4", "flex", "items-center", "justify-between", "rounded", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "flex-1", "flex-col", "pb-4"], [1, "mb-2", "flex", "items-center", "space-x-2", "px-4"], [1, "relative", "h-14", "min-w-48", "rounded", "border", "border-base-300", "px-4", "py-2"], [1, "absolute", "left-4", "top-0", "-translate-y-1/2", "rounded", "bg-base-100", "px-2", "py-1", "text-xs"], [1, "truncate"], [1, "text-xs", "opacity-30"], [1, "relative", "flex", "h-14", "min-w-48", "items-center", "rounded", "border", "border-base-300", "px-4", "py-2"], [1, "truncate", "font-mono", "text-lg"], [1, "mb-2", "flex", "items-center", "justify-between", "space-x-2", "px-4"], ["appearance", "outline", 1, "w-[20rem]"], ["placeholder", "Select metadata version", 3, "ngModelChange", "ngModel"], [1, "leading-tight", 3, "value"], ["placeholder", "Compare with", 3, "ngModelChange", "ngModel"], [1, "relative", "w-full", "flex-1", "px-4"], [3, "modified", "original"], [1, "flex", "h-full", "w-full", "items-center", "justify-center", "rounded-lg", "bg-base-200", "opacity-40"], [1, "leading-tight", 3, "click", "value"], [1, ""], [1, "truncate", "text-xs", "opacity-30"]], template: function MetadataHistoryModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
function MetadataDisplayComponent_Conditional_8_For_2_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
...
function MetadataDisplayComponent_Conditional_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(30, MetadataDisplayComponent_Conditional_8_For_2_Conditional_30_Template, 1, 2, "settings-form-field", 23);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const item_r3 = ctx.$implicit;
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 16, item_r3.updated_at), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx_r3.edited[item_r3.name])("matTooltip", \u0275\u0275pipeBind1(10, 18, "COMMON.SAVE"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(14, 20, "COMMON.METADATA_EDIT"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(18, 22, "COMMON.METADATA_HISTORY"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(22, 24, "COMMON.METADATA_REMOVE"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r3.show_view() === item_r3.name ? "keyboard_arrow_down" : "chevron_right");
    \u0275\u0275advance();
    \u0275\u0275property("@show", ctx_r3.show_view() === item_r3.name ? "show" : "hide");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r3.show_view() === item_r3.name ? 30 : -1);
  }
}
function MetadataDisplayComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6);
    \u0275\u0275repeaterCreate(1, MetadataDisplayComponent_Conditional_8_For_2_Template, 31, 26, "div", 8, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
var MetadataDisplayComponent = class _MetadataDisplayComponent extends AsyncHandler {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MetadataDisplayComponent, selectors: [["metadata-display"]], inputs: { item: [1, "item"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 12, vars: 5, consts: [["load_state", ""], [1, "flex", "items-center", "justify-between", "space-x-2"], ["btn", "", 3, "click"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Search metadata blocks...", 3, "ngModelChange", "ngModel"], [1, "mt-4", "space-y-2"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-8", "p-16", "opacity-30"], ["block", "", 1, "rounded", "border", "border-base-300", 3, "id", "shadow", "opacity-30", "formGroup"], ["block", "", 1, "rounded", "border", "border-base-300", 3, "id", "formGroup"], ["header", "", 1, "flex", "w-full", "items-center", "space-x-2", "bg-base-200", "px-2", "py-1", 3, "click"], [1, "truncate", "px-2", "font-mono", "text-sm"], [1, "flex-1"], [1, "whitespace-nowrap", "rounded", "border", "border-base-300", "px-2", "py-1", "font-mono", "text-[0.625rem]"], [1, "flex", "items-center", "rounded-full", "border", "border-base-300", "bg-base-100", 3, "click"], ["icon", "", "matRipple", "", 3, "click", "disabled", "matTooltip"], [1, "text-xl"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"], ["icon", "", "matRipple", ""], [1, "text-2xl"], ["body", "", 1, "overflow-hidden"], [1, "h-[32.5rem]", "border-t", "border-base-300", "p-1"], ["formControlName", "details", "lang", "json", 3, "schema", "readonly"], [1, "text-8xl"], ["diameter", "32"]], template: function MetadataDisplayComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
    ...
    TranslatePipe,
    DateFromPipe
  ], styles: ["\n\n[block][_ngcontent-%COMP%] {\n  transition: opacity 0.2s ease-in-out;\n}\n/*# sourceMappingURL=metadata-display.component.css.map */"], data: { animation: [ANIMATION_SHOW_CONTRACT_EXPAND] } });
};
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MetadataDisplayComponent, { className: "MetadataDisplayComponent", filePath: "src/app/ui/metadata-display.component.ts", lineNumber: 205 });
})();

export {
  MetadataDisplayComponent
};
//# sourceMappingURL=chunk-PMOMFDQI.js.map
