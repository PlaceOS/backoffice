...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemDetailsComponent, { className: "ItemDetailsComponent", filePath: "src/app/ui/item-details.component.ts", lineNumber: 200 });
})();
...
var ItemSelectionComponent = class _ItemSelectionComponent extends AsyncHandler {
  ...
  _processItems(list) {
    for (const item of list) {
      if (item instanceof gs) {
        const detail = item.role === At.Service ? item.uri : item.role === At.Logic ? item.control_system_id : item.ip;
        item.display_name = item.custom_name || item.name || "<Unnamed>";
        item.extra = detail;
      } else if (item instanceof Gi) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSelectionComponent, { className: "ItemSelectionComponent", filePath: "src/app/ui/item-selection.component.ts", lineNumber: 185 });
})();
  ...
  _processItems(list) {
    for (const item of list) {
      if (item instanceof gs) {
        ...
        const detail = item.role === At.Service ? item.uri : item.role === At.Logic ? name ? `${name} | ${item.control_system_id} ` : item.control_system_id : item.ip;
        item.display_name = item.custom_name || item.name || "<Unnamed>";
        item.extra = detail;
      } else if (item instanceof Gi) {
        item.display_name = item.name || "<Unnamed>";
        item.extra = item.repo_type;
      } else if (item instanceof ms) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemSidebarComponent, { className: "ItemSidebarComponent", filePath: "src/app/ui/item-sidebar.component.ts", lineNumber: 355 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemTablistComponent, { className: "ItemTablistComponent", filePath: "src/app/ui/item-tablist.component.ts", lineNumber: 84 });
})();
...
//# sourceMappingURL=chunk-U3FWCTYU.js.map
