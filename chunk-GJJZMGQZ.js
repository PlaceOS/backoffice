...
var ViewUploadModalComponent = class _ViewUploadModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewUploadModalComponent, selectors: [["view-upload-modal"]], decls: 12, vars: 3, consts: [[1, "border-base-100", "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "px-2", "pb-2"], [1, "border-base-200", "relative", "flex", "h-[65vh]", "max-h-[65vh]", "w-[80vw]", "max-w-[80vw]", "items-center", "justify-center", "overflow-hidden", "rounded-xl", "border"], ["auth", "", "alt", "Uploaded content preview", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], ["auth", "", "autoplay", "", "controls", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [1, "border-base-200", "bg-base-100", "absolute", "top-2", "left-2", "max-w-[calc(100%-1rem)]", "rounded-full", "border", "px-2", "py-1", "font-mono", "text-sm"]], template: function ViewUploadModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-GJJZMGQZ.js.map
