...
var COMMON = {
  ...
  DEBUG_LISTENING_MSG: "Listening to {{ modules }} modules",
  DEBUG_LISTENING_MSG_1: "Listening to {{ modules }} module",
  DEBUG_LISTENING_MSG_N: "Listening to {{ modules }} modules",
  DEBUG_MSG_COUNT_MSG: "{{ count }} module messages",
  DEBUG_MSG_COUNT_MSG_1: "{{ count }} module message",
  DEBUG_MSG_COUNT_MSG_N: "{{ count }} module messages",
  ...
  COPY_LINK: "Copy Link",
  RETRY: "Retry",
  EDITOR_LOAD_ERROR: "Could not load the editor. Check your connection and retry.",
  IMAGES: "Images",
  NEW_ITEM: "New item",
  ITEM_ADD: "Add {{ item }}",
  ...
  MESSAGE_COUNT_1: "{{ count }} message",
  MESSAGE_COUNT_N: "{{ count }} messages",
  DEBUG_DOWNLOAD_MESSAGES: "Download messages",
  DEBUG_TOGGLE_POSITION: "Toggle Position",
  DEBUG_CLEAR_MESSAGES: "Clear messages",
  ...
  COMMIT_HASH_COPIED: "Commit hash copied to clipboard",
  ...
  DATE_FROM_IN_HOURS_1: "In {{ hours }} hour",
  DATE_FROM_IN_HOURS_N: "In {{ hours }} hours",
  DATE_FROM_HOURS_AGO_1: "{{ hours }} hour ago",
  DATE_FROM_HOURS_AGO_N: "{{ hours }} hours ago",
  DATE_FROM_IN_DAYS_1: "In {{ days }} day",
  DATE_FROM_IN_DAYS_N: "In {{ days }} days",
  DATE_FROM_DAYS_AGO_1: "{{ days }} day ago",
  DATE_FROM_DAYS_AGO_N: "{{ days }} days ago",
  DATE_FROM_IN_MONTHS_1: "In {{ months }} month",
  DATE_FROM_IN_MONTHS_N: "In {{ months }} months",
  DATE_FROM_MONTHS_AGO_1: "{{ months }} month ago",
  DATE_FROM_MONTHS_AGO_N: "{{ months }} months ago",
  DATE_FROM_IN_YEARS_1: "In {{ years }} year",
  DATE_FROM_IN_YEARS_N: "In {{ years }} years",
  DATE_FROM_YEARS_AGO_1: "{{ years }} year ago",
  DATE_FROM_YEARS_AGO_N: "{{ years }} years ago",
  CRON_CUSTOM: "Custom",
...
var SYSTEMS = {
  ...
  CAMERA_SNAPSHOT_URL: "Camera Snapshot URLs",
  ...
  SORT_BY_CLASS: "Sort by Class",
  SORT_MODULES_BY_CLASS_TOOLTIP: "Group modules with the same class name together",
  ...
  PLAYLISTS: "Playlists",
  PLAYLISTS_SEARCH: "Search playlists to add...",
  PLAYLISTS_EMPTY: "No playlists assigned to this trigger",
...
var ZONES = {
  ...
  GROUPS_EMPTY: "No groups associated with this zone",
  GROUPS_BULK: "Bulk add groups",
  GROUPS_BULK_EMPTY: "Select groups to add to this zone",
  GROUPS_BULK_SUCCESS: "Successfully added {{ count }} groups to zone.",
  GROUPS_BULK_ERROR: "Failed to add {{ count }} groups to zone.",
  GROUP_PERMISSIONS: "Group permissions",
  GROUP_ADD_SUCCESS: "Successfully added group to zone.",
  GROUP_ADD_ERROR: "Failed to add group to zone. Error: {{ error }}",
  GROUP_SAVE_SUCCESS: "Successfully updated group permissions.",
  GROUP_SAVE_ERROR: "Failed to update group permissions. Error: {{ error }}",
  GROUP_REMOVE: "Remove group from zone",
  GROUP_REMOVE_MSG: "<p>Are you sure you want remove {{ name }} from this zone?</p>",
  GROUP_REMOVE_LOADING: "Removing group from zone...",
  GROUP_REMOVE_SUCCESS: "Successfully removed group from zone.",
  GROUP_REMOVE_ERROR: "Failed to remove group from zone. Error: {{ error }}",
...
var REPOS = {
  ...
  DRIVER_LIST_LOAD_ERROR: "Failed to load repository drivers",
  COMMIT_LOAD_ERROR: "Failed to load latest commit details",
...
var USERS = {
  FORCE_DELETE: "Permanently delete user",
  FORCE_DELETE_MSG: 'Permanently delete "{{ name }}"? This cannot be undone.',
  REVIVE: "Restore user",
  REVIVE_MSG: 'Restore "{{ name }}" and make this user active again?',
  REVIVE_LOADING: "Restoring user...",
  REVIVE_SUCCESS: "User restored.",
  REVIVE_ERROR: "Could not restore user. Error: {{ error }}",
  DELETED: "Deleted",
  ...
  GROUPS_EMPTY: "No groups associated with this user",
  GROUPS_BULK: "Bulk add groups",
  GROUPS_BULK_EMPTY: "Select groups to add to this user",
  GROUPS_BULK_SUCCESS: "Successfully added {{ count }} groups to user.",
  GROUPS_BULK_ERROR: "Failed to add {{ count }} groups to user.",
  GROUP_PERMISSIONS: "Group permissions",
  GROUP_ADD_SUCCESS: "Successfully added user to group.",
  GROUP_ADD_ERROR: "Failed to add user to group. Error: {{ error }}",
  GROUP_SAVE_SUCCESS: "Successfully updated group permissions.",
  GROUP_SAVE_ERROR: "Failed to update group permissions. Error: {{ error }}",
  GROUP_REMOVE: "Remove user from group",
  GROUP_REMOVE_MSG: "<p>Are you sure you want remove this user from {{ name }}?</p>",
  GROUP_REMOVE_LOADING: "Removing user from group...",
  GROUP_REMOVE_SUCCESS: "Successfully removed user from group.",
  GROUP_REMOVE_ERROR: "Failed to remove user from group. Error: {{ error }}",
  GROUP_COPIED: "User's group copied to clipboard",
  ...
  IMAGE: "Profile Image",
  IMAGE_INVALID: "A valid URL is required for profile image",
  LOCATABLE: "Enable Location Tracking"
};
var GROUPS = {
  SINGULAR: "Group",
  PLURAL: "Groups",
  ...
  REMOVE: "Remove group",
  DELETE: "Delete group",
  DELETE_MSG: "<p>Are you sure you want delete this group?</p><p>The group will be deleted <strong>immediately.</strong></p>",
  DELETE_LOADING: "Deleting group...",
  DELETE_SUCCESS: "Successfully deleted group.",
  DELETE_ERROR: "Failed to delete group. Error: {{ error }}",
  SAVING: "Saving group...",
  SAVE_ERROR: "Failed to save group. Error: {{ error }}",
  SAVE_SUCCESS: "Successfully saved group.",
  LOADING: "Loading groups...",
  TAB_ABOUT: "About",
  TAB_USERS: "Users",
  TAB_ZONES: "Zones",
  NAME_REQUIRED: "A group name is required",
  AUTHORITY_ID: "Authority",
  AUTHORITY_SELECT: "Select domain",
  PARENT_ID: "Parent Group",
  PARENT_SEARCH: "Search for parent group...",
  SUBSYSTEMS: "Subsystems",
  SUBSYSTEMS_HINT: "Comma separated subsystems",
  SUBSYSTEMS_EMPTY: "No subsystems",
  ...
  ZONE_SEARCH: "Search for zones...",
  USERS_BULK: "Bulk add users",
  USERS_BULK_EMPTY: "Select users to add to this group",
  USERS_BULK_SUCCESS: "Successfully added {{ count }} users to group.",
  USERS_BULK_ERROR: "Failed to add {{ count }} users to group.",
  USERS_BULK_PERMISSIONS: "Permissions for added users",
  ZONES_BULK: "Bulk add zones",
  ZONES_BULK_EMPTY: "Select zones to add to this group",
  ZONES_BULK_SUCCESS: "Successfully added {{ count }} zones to group.",
  ZONES_BULK_ERROR: "Failed to add {{ count }} zones to group.",
  BULK_ADD_SELECTED: "Add {{ count }} selected",
  USERS_EMPTY: "No users associated with this group",
  ZONES_EMPTY: "No zones associated with this group",
  USER_ADD_SUCCESS: "Successfully added user to group.",
  USER_ADD_ERROR: "Failed to add user to group. Error: {{ error }}",
  USER_SAVE_SUCCESS: "Successfully updated user permissions.",
  USER_SAVE_ERROR: "Failed to update user permissions. Error: {{ error }}",
  USER_REMOVE: "Remove user from group",
  USER_REMOVE_MSG: "<p>Are you sure you want remove {{ name }} from this group?</p>",
  USER_REMOVE_LOADING: "Removing user from group...",
  USER_REMOVE_SUCCESS: "Successfully removed user from group.",
  USER_REMOVE_ERROR: "Failed to remove user from group. Error: {{ error }}",
  ZONE_ADD_SUCCESS: "Successfully added zone to group.",
  ZONE_ADD_ERROR: "Failed to add zone to group. Error: {{ error }}",
  ZONE_SAVE_SUCCESS: "Successfully updated zone permissions.",
  ZONE_SAVE_ERROR: "Failed to update zone permissions. Error: {{ error }}",
  ZONE_REMOVE: "Remove zone from group",
  ZONE_REMOVE_MSG: "<p>Are you sure you want remove {{ name }} from this group?</p>",
  ZONE_REMOVE_LOADING: "Removing zone from group...",
  ZONE_REMOVE_SUCCESS: "Successfully removed zone from group.",
  ZONE_REMOVE_ERROR: "Failed to remove zone from group. Error: {{ error }}",
...
var DOMAINS = {
  ...
  SETTINGS_ERROR: "Unable to save settings as they contain errors.",
  ...
  APPLICATIONS_SAVING: "Saving domain application...",
  APPLICATIONS_SAVE_ERROR: "Failed to save domain application",
  APPLICATIONS_SAVE_SUCCESS: "Successfully saved domain application",
  ...
  AZURE_INTEGRATION: "Integrate Azure",
  AZURE_INTEGRATION_ERROR: "Failed to start Azure integration. Error: {{ error }}",
...
var ADMIN = {
  ...
  TENANTS_BOOKING_RANGE: "Bookable Period",
  TENANTS_BOOKING_RANGE_HINT: "Maximum days in advance for each booking type, such as desk. Remove a row to allow bookings with no advance limit for that type.",
  TENANTS_BOOKING_RANGE_ERROR: "Enter a unique booking type and a whole number of days from 0 to 4294967295 for each row.",
  ...
  APP_KEYS_QUICK_CREATE: "Quick Create",
  APP_KEYS_NEW: "New Application Key",
  APP_KEYS_EDIT: "Edit Application Key",
  APP_KEYS_REMOVE: "Remove Application Key",
  APP_KEYS_LAST_DETAILS: "Last API Key",
  APP_KEYS_FIELD_SCOPES: "Scopes",
  APP_KEYS_FIELD_PERMISSIONS: "Access",
  APP_KEYS_FIELD_EXPIRES_AT: "Expires At",
  APP_KEYS_FIELD_TTL: "Time To Live",
  APP_KEYS_FIELD_TTL_HINT: "Seconds until the key expires",
  APP_KEYS_SECONDS: "seconds",
  APP_KEYS_TTL_NONE: "No expiry",
  APP_KEYS_TTL_HOUR: "1 Hour",
  APP_KEYS_TTL_6_HOURS: "6 Hours",
  APP_KEYS_TTL_DAY: "1 Day",
  APP_KEYS_TTL_WEEK: "1 Week",
  APP_KEYS_TTL_MONTH: "30 Days",
  APP_KEYS_TTL_90_DAYS: "90 Days",
  APP_KEYS_TTL_YEAR: "1 Year",
  ...
  STORAGE_IS_DEFAULT_LABEL: "Is Default",
  ...
  UPLOADS_LIB_COPY: "Copy Upload URL",
  ...
  SIGNAGE_PLUGINS_REMOVE_MSG: "<p>Are you sure you want to delete this signage plugin?</p><p>The plugin will be deleted <strong>immediately.</strong></p>",
  SIGNAGE_PLUGINS_REMOVE_LOADING: "Deleting signage plugin...",
  SIGNAGE_PLUGINS_REMOVE_ERROR: "Error deleting signage plugin. Error: {{ error }}",
  SIGNAGE_PLUGINS_REMOVE_SUCCESS: "Successfully deleted signage plugin.",
  SIGNAGE_PLUGINS_LOAD_ERROR: "Error loading signage plugins. Error: {{ error }}",
  SIGNAGE_PLUGINS_PLAYBACK_STATIC: "Static",
  SIGNAGE_PLUGINS_PLAYBACK_INTERACTIVE: "Interactive",
  SIGNAGE_PLUGINS_PLAYBACK_PLAYSTHROUGH: "Plays Through",
  SIGNAGE_PLUGINS_LIST_EMPTY: "No signage plugins available",
  SIGNAGE_PLUGINS_FIELD_TYPE: "Type",
  SIGNAGE_PLUGINS_TYPE_PLUGIN: "Plugin",
  SIGNAGE_PLUGINS_TYPE_WIDGET: "Widget",
  SIGNAGE_PLUGINS_FIELD_URI: "URI",
  SIGNAGE_PLUGINS_FIELD_PLAYBACK_TYPE: "Playback Type",
  SIGNAGE_PLUGINS_FIELD_ENABLED: "Enabled",
  SIGNAGE_PLUGINS_FIELD_DEFAULTS: "Defaults",
  SIGNAGE_PLUGINS_NAME_REQUIRED: "A plugin name is required",
  SIGNAGE_PLUGINS_URI_REQUIRED: "A plugin URI is required",
  SIGNAGE_PLUGINS_DEFAULTS_INVALID: "Please fix the invalid defaults fields before saving.",
  SIGNAGE_PLUGINS_SAVING: "Saving signage plugin...",
  SIGNAGE_PLUGINS_SAVE_SUCCESS: "Successfully saved signage plugin.",
  SIGNAGE_PLUGINS_SAVE_ERROR: "Error saving signage plugin. Error: {{ error }}",
  SIGNAGE_PLUGINS_SCHEMA_LOADING: "Loading plugin schema...",
  SIGNAGE_PLUGINS_SCHEMA_ERROR: "Failed to load schema from plugin. You can still edit defaults manually.",
  SIGNAGE_PLUGINS_SCHEMA_EMPTY: "Enter a plugin URI to load the configuration schema.",
  SIGNAGE_PLUGINS_TEST: "Test Plugin",
  SIGNAGE_PLUGINS_TEST_HEADING: "Test Signage Plugin",
  SIGNAGE_PLUGINS_TEST_CONFIG: "Configuration",
  SIGNAGE_PLUGINS_TEST_NO_SCHEMA: "This plugin does not provide a configuration schema.",
  SIGNAGE_PLUGINS_TEST_SEND: "Send Config",
  SIGNAGE_PLUGINS_TEST_PLAY: "Play",
...
var LocaleService = class _LocaleService {
  ...
  _load_promises = {};
  _default_mappings = removeNesting(en_AU_exports);
  _locale_mappings = {};
...
//# sourceMappingURL=chunk-7XGDNWGW.js.map
