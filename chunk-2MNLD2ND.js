...
import {
  SystemStateService
} from "./chunk-IWJNTKZE.js";
import "./chunk-NJ56ACBG.js";
import {
  BindingDirective
} from "./chunk-ISZWZ4XQ.js";
import "./chunk-BABHZE2B.js";
import "./chunk-LJCOWDUN.js";
import "./chunk-ZCNNP576.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
...
} from "./chunk-F2WGUHRC.js";
import "./chunk-5W5SQGOI.js";
import {
  SettingsFieldComponent
} from "./chunk-HJG72ZZO.js";
import "./chunk-UVS4UHCY.js";
import "./chunk-WKKSFDT2.js";
...
var ViewModuleStateModalComponent = class _ViewModuleStateModalComponent extends AsyncHandler {
  ...
  async updateState() {
    ...
    try {
      const state = await Ia(this.system.id, class_parts.slice(0, class_parts.length - 1).join("_"), num);
...
var SystemModulesComponent = class _SystemModulesComponent extends AsyncHandler {
  ...
  query_fn = (_) => dc({ q: _, no_logic: true }).then((resp) => resp.data.map((mod) => __spreadProps(__spreadValues({}, mod), {
  ...
  async loadModule(device) {
    await vc(device.id).then(() => notifySuccess(`Successfully loaded module "${device.name || device.id}"`), (err) => notifyError(`Error loading module. Error: ${JSON.stringify(err.response || err.message || err)}`));
  }
  /**
...
//# sourceMappingURL=chunk-2MNLD2ND.js.map
